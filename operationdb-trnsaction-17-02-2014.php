...
class xml_order{
	...
	$orderdataheader_phone_no,$orderdataheader_address,$orderdataheader_pin_code,$orderdataheader_area,$orderdataheader_sale_type,$orderdataheader_d_instruction,$orderdataheader_customer_flag;	
}
class xml_order_details{
	var $orderdatadetails_order_no,$orderdatadetails_sku_code,$orderdatadetails_qty,$orderdatadetails_TD,$orderdatadetails_mrp_code;
}
class xml_payment{
...
function contents($parser, $data){
	...
	$orderdataheader_phone_no,$orderdataheader_address,$orderdataheader_pin_code,$orderdataheader_area,$orderdataheader_sale_type,
	$orderdataheader_d_instruction,$orderdataheader_customer_flag,$orderdatadetails_order_no,$orderdatadetails_sku_code,$orderdatadetails_qty,$orderdatadetails_TD,$orderdatadetails_mrp_code,
			...
			for($i=0;$i<count($order_details_array);$i++){
				...
				$mrp=$recmrpdetails['mrp'];
					...
					if(!in_array($orderdatadetails_order_no,$order_array_trans_id))
					{
						...
						${mrpgrandtotal.$orderdatadetails_order_no}=${mrpgrandtotal.$orderdatadetails_order_no}+$totalmrp;
		...
		if(count($orderheader_array_mailbody)>0)
		{
			for($countarr=0;$countarr<count($orderheader_array_mailbody);$countarr++)
			{
				...
				if($orderdataheader_sale_type_array[$countarr]=='CREDIT'){
					$total_order_val="<br /><table>Total order value: <b>Rs. ".number_format(${mrpgrandtotal.$ordertansid_array_mailbody[$countarr]},2)."/-</b></table><br />";
				}
				if(no_of_filter==1){
				...
				".$ordercashreceived_array_mailbody[$countarr].$total_order_val."
