...
class xml_stockist_visit_details{
	var $visit_trans_id,$stockist_code,$customer_code,$sale,$folder;
}
...
$stockist_visit_emp_code,$stockist_visit_trans_id,$stockist_visit_latt,$stockist_visit_longi,$stockist_visit_trans_date,$visit_trans_id,$stockist_code,$customer_code,$sale,$folder;	
