...
$count=mysqli_num_rows($result);
	...
	$url = "http://www.acedns.in/acednsproduct/survey-form-details-incremental-6.0.7.php?nick_name=$nick_name&last_update_time=$last_update_time&incremental_download=$incremental_download&mode=$mode";
