...
while($row_emp_code = mysqli_fetch_assoc($res_emp_code)){
	...
	$res_check_transid_count = mysqli_query($link,$sql_check_transid_count);
	$row_check_transid_count = mysqli_fetch_assoc($res_check_transid_count);
	...
	if($total_count>0){
		...
		$res_stock_audit_id = mysqli_query($link,$sql_stock_audit_id);
		while($row_stock_audit_id = mysqli_fetch_assoc($res_stock_audit_id)){
