...
$sql_competitor_name = "SELECT DISTINCT competitor_name,display_name FROM competitor_group_master $branchcondition and acedns='yes' and branch_code <> '' ORDER BY FIELD(competitor_name, 'STAR PSC','STAR PPC','STAR') DESC,competitor_name ASC";
...
while($row_competitor_name = mysqli_fetch_assoc($res_competitor_name)){
	...
	$header.= $display_competitor_name."\t";
