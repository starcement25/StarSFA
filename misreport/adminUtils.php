...
// define("ADMIN_CSS","https://demo.acedns.in/css/adminStyle.css");

define("ADMIN_MASTER","admin_master");
//define("BASE_URL","https://salesmpower.acedns.in");
...
if(isset($_SESSION['nick_name']) && $_SESSION['nick_name'] != '') {
...
// $link = mysqli_connect("localhost", "root", "Passw0rd123#$", "acedns_STAR")or die("Setup Database Connection Error.");
	$linksetupadmin=mysqli_connect("localhost","root","Passw0rd123#$","acedns_acednsproduct") or die("Setup Database Connection Error.");
	//$linksetupadmin=mysqli_connect("3.7.158.23","sbdbadmin",'xA7V#FJ1Vv+q@5$K',"acedns_acednsproduct") or die("Setup Database Connection Error.");
...

{
	...
	$functionality ='';
	if(isset($_SESSION['nick_name']) && strtoupper($_SESSION['nick_name'])=='KHMER')
...
#menuLayer49{
	...
	overflow-y: auto;
			...
			?>
				...
				<!--<script async defer src="http://maps.googleapis.com/maps/api/js?key=AIzaSyBqSx3h3PfPlF28bgzeHO6a_m9ZwECzUs4&callback=initMap" type="text/javascript"></script>-->
				<!--<script async
					src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBqSx3h3PfPlF28bgzeHO6a_m9ZwECzUs4&region=IN&language=en&callback=initMap">
				</script>-->
			...
			if(isset($_SESSION['nick_name']) && (strtoupper($_SESSION['nick_name'])=='STAR' || strtoupper($_SESSION['nick_name'])=='START')){?>
				...
				<!--<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBqSx3h3PfPlF28bgzeHO6a_m9ZwECzUs4&sensor=true&libraries=places"></script>-->
			...
			?>
				...
				<script
					src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBqSx3h3PfPlF28bgzeHO6a_m9ZwECzUs4&region=EN&language=bn&callback=initMap">
				</script>
			...
			<!--<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBhJB9maJFpMdTZ_JXAbB7HBX4H8oDFURo&callback=initMap" type="text/javascript"></script>-->
			<script async
				src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBqSx3h3PfPlF28bgzeHO6a_m9ZwECzUs4&region=IN&language=bn&callback=initMap">
			</script>
		...
		<body  <?php if($_SERVER['PHP_SELF']=='/misreport/adminTransactionDetails.php' ||  $_SERVER['PHP_SELF']=='/misreport/adminCustomerLocation.php' ||  $_SERVER['PHP_SELF']=='/misreport/customerLocate.php'){ ?> onload="forload(Lat,Lon,Place,customer,route,emp_name,time);" onunload="GUnload()" <?php }
			...
			if(isset($_SESSION['admin_login']) && $_SESSION['admin_login']!=''){
				...
				//echo"<pre>";print_r($sql_select_emp_name);die;
				$res_select_emp_name = mysqli_query($link,$sql_select_emp_name);

				$row_select_emp_name = mysqli_fetch_assoc($res_select_emp_name);

				//$emp_name = isset($row_select_emp_name['emp_name'])??$row_select_emp_name['emp_name'];
				$emp_name = isset($row_select_emp_name['emp_name']) ? $row_select_emp_name['emp_name'] : '';
				//echo"<pre>";print_r($emp_name);die;
					...
					<td>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<?php $logo=strtoupper(isset($_SESSION['nick_name'])?$_SESSION['nick_name']:'');

								$final_logo=$logo.'.png';

								//echo '<pre>';print_r($_SERVER);

								if(file_exists($_SERVER['DOCUMENT_ROOT']."/logo/".$final_logo))
								...
								<td class="header" style="background: url(<?=ROOT_BASE_URL."/logo/".$final_logo?>) 2% 50% no-repeat #FFFFFF; background-size: 70px 40px;"" ><b>Administrator Control Panel</b>

									<br>

									<?php if(isset($_SESSION['admin_login']) && $_SESSION['admin_login']=='admin'){?><a href="#" style="color: #e40000" onclick="javascript:logout();">
									...
									<b style=\"color:#A92A61;\">Change Password</b></a>"; }else if(isset($_SESSION['admin_login']) && $_SESSION['admin_login']!='admin' && $_SESSION['admin_login']!=''){?><a href="#" style="color: #e40000" onclick="javascript:logout();">
									...
									<div style="width:50%; font-size:14px; color:#990000; text-align:left; font-style:italic; margin-top:15px;"><?php if(isset($_SESSION['admin_login']) && $_SESSION['admin_login']!=''){ echo "<strong>".$welcome_message."</strong>"; } if(strtoupper(isset($_SESSION['nick_name']) && $_SESSION['nick_name'])=='EMAMIT' && $_SESSION['admin_login']!=''){ ?><br /><font size="+2"><strong>Quality Testing</strong></font><?php }?></div>
								</td>
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										...
										<tr>
											...
											<td>
												...
												if(isset($_SESSION['admin_login']) && ($_SESSION['admin_login']!='' || strtolower(substr($_SESSION['admin_login'],0,1))=='c'))

												{
													...
													<?php
														...
														<?php
															...
															<a href="adminAttendanceTracker.php" name="link55" id="link55" onMouseOver="MM_showMenu(window.mm_menu_0716141155_0,0,26,null,'link55')" onMouseOut="MM_startTimeout();">REPORT</a>
											...
											<td>
												<?php if(isset($_SESSION['admin_login']) && $_SESSION['admin_login']=='admin' && strtoupper($_SESSION['nick_name'])=='RKBKL'){?><a href="adminAttendanceTracker.php" name="link10" id="link10" >Attendance Tracker</a><?php }?>

											</td>

											<td>

												<?php if(isset($_SESSION['admin_login']) && $_SESSION['admin_login']=='superadmin'){?><a href="adminMain.php" name="link6" id="link6" onMouseOver="MM_showMenu(window.mm_menu_0716141833_0,0,26,null,'link6')" onMouseOut="MM_startTimeout();">REPORT</a><?php }?>
											...
											<td>
													...
													<?php if(isset($_SESSION['admin_login']) && ($_SESSION['admin_login']=='admin' || strtolower(substr($_SESSION['admin_login'],0,1))=='c')){
												...
												?>
													...
													<?php if(isset($_SESSION['nick_name']) && (strtoupper($_SESSION['nick_name'])=='EMAMI')  && isset($_SESSION['admin_login']) && $_SESSION['admin_login']=='E0076'){?><a href="employee_access_verticalwise.php" name="link172" id="link172"  onMouseOver="MM_showMenu(window.mm_menu_0716141173_0,0,26,null,'link172')" onMouseOut="MM_startTimeout();">Employee Access</a>

													<?php }else if(isset($_SESSION['nick_name']) && strtoupper($_SESSION['nick_name'])=='EMAMIT' && isset($_SESSION['admin_login']) && $_SESSION['admin_login']=='E0076'){?>
													...
													else if((isset($_SESSION['nick_name']) && (strtoupper($_SESSION['nick_name'])=='EMAMIT' || strtoupper($_SESSION['nick_name'])=='EMAMI'))

													&& (isset($_SESSION['admin_login']) && ($_SESSION['admin_login']=='E0042' || strtoupper($_SESSION['admin_login'])=="GMHBC"))){?><a href="adminEmployeeAccess.php" name="link172" id="link172"  onMouseOver="MM_showMenu(window.mm_menu_0716141173_0,0,26,null,'link172')" onMouseOut="MM_startTimeout();">Employee Access</a><?php }

													else if(isset($_SESSION['nick_name']) && strtoupper($_SESSION['nick_name'])=='RUPA' && isset($_SESSION['admin_login']) && $_SESSION['admin_login']=='E1093'){?><a href="employee_access_verticalwise.php" name="link50" id="link50"  onMouseOver="MM_showMenu(window.mm_menu_0716141150_0,0,26,null,'link50')" onMouseOut="MM_startTimeout();">Employee Access</a><?php }
											...
											<td>
												<?php if((isset($_SESSION['admin_login']) && ($_SESSION['admin_login']=='admin' || strtolower($_SESSION['admin_login'])=='c0007')) && ace_integration=='yes'){?><a href="adminCustomerAccess.php" name="link21" id="link21">Customer Access</a><?php }?>
											</td>

											<td>
												<?php if(isset($_SESSION['admin_login']) && ($_SESSION['admin_login']=='admin' || strtolower($_SESSION['admin_login'])=='c0007') && ace_integration=='yes'){?><a href="adminProductAccess.php" name="link23" id="link23">Product Access</a><?php } else if(isset($_SESSION['admin_login']) && ($_SESSION['admin_login']=='admin' || strtolower($_SESSION['admin_login'])=='c0007') && isset($_SESSION['nick_name']) && strtoupper($_SESSION['nick_name'])=='MAITHAN'){?><a href="adminProductAccess.php" name="link23" id="link23">Product Access</a><?php }?>
											</td>
												...
												<?php if(isset($_SESSION['nick_name']) && (strtoupper($_SESSION['nick_name'])=='EMAMIT' || strtoupper($_SESSION['nick_name'])=='ASL')) { ?>

											<td>
												<a href="TD_allocation_main.php" name="link27" id="link27">TD Allocation</a>

											</td>

											<?php } elseif(isset($_SESSION['nick_name']) && strtoupper($_SESSION['nick_name'])=='EMAMI') {?>
											...
											<?php if(isset($_SESSION['nick_name']) && strtoupper($_SESSION['nick_name'])=='EMAMIT' && $_SESSION['admin_login']!='E0042') { ?>

											<td>
												<?php if(sauda_allocation == 'yes'){if($_SESSION['admin_login']=='admin' || $_SESSION['flag'] == 'yes'){?><a href="sauda_main.php" name="link27" id="link27">Sauda Allocation</a><?php }}?>
											...
											<td>
												...
												<?php if(isset($_SESSION['admin_login']) && $_SESSION['admin_login']!='' && (isset($_SESSION['nick_name']) && (strtoupper($_SESSION['nick_name'])=='EMAMI' || strtoupper($_SESSION['nick_name'])=='EMAMIT'))){?><a href="depotwise_pricelist_report_verticalwise.php" name="link90" id="link90" onMouseOver="MM_showMenu(window.mm_menu_0716141190_0,0,26,null,'link90')" onMouseOut="MM_startTimeout();">Pricelist</a><?php } ?>

											</td>

											<td>
												<?php if(isset($_SESSION['admin_login']) && strtoupper($_SESSION['admin_login'])!='' && (business_prospect == 'yes' || business_prospect == 'checkin')  && isset($_SESSION['nick_name']) && strtoupper($_SESSION['nick_name'])!='CDNS' && strtoupper($_SESSION['nick_name'])!='AJANTA'){?><a href="business_prospect.php" name="link28" id="link28" >Business Prospects</a><?php } else if(isset($_SESSION['nick_name']) && strtoupper($_SESSION['nick_name']) == 'CDNS' && business_prospect == 'yes' && (isset($_SESSION['admin_login']) && (strtoupper($_SESSION['admin_login'])=='ADMIN' || strtoupper($_SESSION['admin_login'])=='E0056'))){?>
											...
											<td>
												<?php  if(isset($functionality) && $functionality!='DOS'){
													if(isset($_SESSION['admin_login']) && (strtolower($_SESSION['admin_login'])=='admin' || $_SESSION['admin_login']=='c0007' ) &&
													...
													|| strtoupper($_SESSION['nick_name'])=='DNV'  ||strtoupper($_SESSION['nick_name'])=='NHPL' || strtoupper($_SESSION['nick_name'])=='GOLDSTONE' || strtoupper($_SESSION['nick_name'])=='GOLDSTONET' || strtoupper($_SESSION['nick_name'])=='AJANTA'  || strtoupper($_SESSION['nick_name'])=='NIMBUS' || strtoupper($_SESSION['nick_name'])=='DNVFOODS' || strtoupper($_SESSION['nick_name'])=='SUPRA' || strtoupper($_SESSION['nick_name'])=='EDIBLE' || strtoupper($_SESSION['nick_name'])=='MAGIK' || strtoupper($_SESSION['nick_name'])=='SAI' || strtoupper($_SESSION['nick_name'])=='SYLVAN' || strtoupper($_SESSION['nick_name'])=='SEPL' || strtoupper($_SESSION['nick_name'])=='ELEGANT' || strtoupper($_SESSION['nick_name'])=='SUPERSHAKTI' || strtoupper($_SESSION['nick_name'])=='SYLVAN'
														|| strtoupper($_SESSION['nick_name'])=='CORAL'
													|| strtoupper($_SESSION['nick_name'])=='SHAKTI'  || strtoupper($_SESSION['nick_name'])=='SUNLAM' || strtoupper($_SESSION['nick_name'])=='ILS' || strtoupper($_SESSION['nick_name'])=='PALSONS' )){
													if(sauda_allocation == 'no' && sale=='no' && strtoupper($_SESSION['nick_name'])!='VCONNECT' && strtoupper($_SESSION['nick_name'])!='START' && strtoupper($_SESSION['nick_name'])!='STAR' && strtoupper($_SESSION['nick_name'])!='GOLDSTONET'){
														?><a href="adminCsvReadIncremental.php" name="link26" id="link26">Upload Data</a><?php
														}
														else if(sauda_allocation == 'no' && sale=='yes'){?><a href="adminCsvReadIncrementalSalePurchase.php" name="link26" id="link26">Upload Data</a><?php }
													...
													else if( strtoupper($_SESSION['nick_name'])=='GOLDSTONET' ){

													?><a href="adminCsvReadIncremental.php" name="link147" id="link147" onMouseOver="MM_showMenu(window.mm_menu_07161417147_0,0,26,null,'link147')" onMouseOut="MM_startTimeout();">Upload Data</a><?php }
												...
												if((isset($_SESSION['admin_login']) && $_SESSION['admin_login']=='E0076') && (strtoupper($_SESSION['nick_name'])=='EMAMIT' || strtoupper($_SESSION['nick_name'])=='EMAMI')){

												?>

											<td>
												<a href="adminCsvReadIncrementalSaudaverticalwise.php" name="link63" id="link63" onMouseOver="MM_showMenu(window.mm_menu_0716141763_0,0,26,null,'link63')" onMouseOut="MM_startTimeout();">Upload Data</a>
											</td><?php } /*if($_SESSION['admin_login']=='E0076' && sauda_outstanding == 'yes' && (strtoupper($_SESSION['nick_name'])=='EMAMI' || strtoupper($_SESSION['nick_name'])=='EMAMIT')) {?>

												<!--td><a href="adminCsvReadIncrementalSaudaverticalwise.php" name="link94" id="link94">Upload Data</a></td-->

												<?php }*/if((isset($_SESSION['admin_login']) && ($_SESSION['admin_login']=='E0042'  || strtoupper($_SESSION['admin_login'])=="GMHBC" ))  && sauda_outstanding == 'yes' && (strtoupper($_SESSION['nick_name'])=='EMAMI' )) {

												?>

											<td>
												<a href="adminCsvReadIncrementalSaudaverticalwise.php" name="link43" id="link43" onMouseOver="MM_showMenu(window.mm_menu_0716141743_0,0,26,null,'link43')" onMouseOut="MM_startTimeout();">Upload Data</a>
											</td>
											...
											if(isset($_SESSION['nick_name']) && strtoupper($_SESSION['nick_name'])=='PRABHUJI'){

												?><td><a href="adminCsvReadIncrementalHaldiram.php" name="link43" id="link43" >Upload Data</a></td><?php }

												if(isset($_SESSION['admin_login']) && strtoupper($_SESSION['admin_login'])=='ADMIN' && strtoupper($_SESSION['nick_name'])=='ASL'){
											...
											if(isset($_SESSION['admin_login']) && strtoupper($_SESSION['admin_login'])=='ADMIN' && strtoupper($_SESSION['nick_name'])=='DURO'){
											...
											<td>
												<?php if(isset($_SESSION['admin_login']) && strtoupper($_SESSION['admin_login'])=='ADMIN' && (isset($_SESSION['nick_name']) && (strtoupper($_SESSION['nick_name'])=='RUPA'  || strtoupper($_SESSION['nick_name'])=='DNV' || strtoupper($_SESSION['nick_name'])=='MAGIK' || strtoupper($_SESSION['nick_name'])=='GOLDSTONET'))){?><a href="adminCatalogueUpload.php" name="Upload Catalogue" >Upload Catalogue</a><?php }?>

											</td>

											<td>
												<?php if((isset($_SESSION['admin_login']) && ($_SESSION['admin_login']=='admin' || (strtolower(substr($_SESSION['admin_login'],0,1))=='c'))) && (isset($_SESSION['nick_name']) && strtoupper($_SESSION['nick_name'])=='RKBK'  )){?><a href="adminAllTransactionDataDownload.php" name="link7" id="link7" onMouseOver="MM_showMenu(window.mm_menu_0716141933_0,0,26,null,'link7')" onMouseOut="MM_startTimeout();">Download</a><?php }?>

											</td>

											<td>
												<?php if(isset($_SESSION['admin_login']) && $_SESSION['admin_login']!='' && ( (isset($_SESSION['nick_name']) && strtoupper($_SESSION['nick_name'])!='RKBK') && (isset($_SESSION['nick_name']) && strtoupper($_SESSION['nick_name'])!='RKBKT')) || (isset($_SESSION['admin_login']) && $_SESSION['admin_login'] == 'supervisor') || (isset($_SESSION['admin_login']) && strtoupper($_SESSION['admin_login'])=='GMHBC')){

													if(sauda_allocation == 'no' && survey=='no' && strtoupper($_SESSION['nick_name'])!='PARLE' && strtoupper($_SESSION['nick_name'])!='RUPA' && strtoupper($_SESSION['nick_name'])!='DNV' && strtoupper($_SESSION['nick_name'])!='SKIPPER' && strtoupper($_SESSION['nick_name'])!='ILS' && strtoupper($_SESSION['nick_name'])!='PROPELLO'){?><a href="adminMonthlyAttendencePrint.php" name="link19" id="link19" onMouseOver="MM_showMenu(window.mm_menu_0716141733_0,0,26,null,'link19')" onMouseOut="MM_startTimeout();">Download Data</a><?php

													}


													else if(isset($_SESSION['admin_login']) && strtoupper($_SESSION['admin_login']) == 'ADMIN' && (isset($_SESSION['nick_name']) && strtoupper($_SESSION['nick_name']) == 'DNV' )){
													...
													else if(isset($_SESSION['admin_login']) && strtoupper($_SESSION['admin_login']) != '' && (isset($_SESSION['nick_name']) && strtoupper($_SESSION['nick_name']) == 'SKIPPER' )){
													...
													else if(isset($_SESSION['nick_name']) && strtoupper($_SESSION['nick_name']) == 'RUPA'){
													...
													else if(isset($_SESSION['nick_name']) && strtoupper($_SESSION['nick_name'])=='ILS'){?>
													...
													<?php }
													else if(isset($_SESSION['admin_login']) && $_SESSION['admin_login']!='' && (isset($_SESSION['nick_name']) && strtoupper($_SESSION['nick_name'])=='PARLE' || strtoupper($_SESSION['nick_name'])=='MAITHAN') )
													...
													{?><a href="adminMonthlyAttendencePrint.php" name="link57" id="link57" onMouseOver="MM_showMenu(window.mm_menu_0716141757_0,0,26,null,'link57')" onMouseOut="MM_startTimeout();">Download Data</a><?php
													...
													else if(isset($_SESSION['admin_login']) && sauda_allocation == 'no' && survey=='yes' && $_SESSION['admin_login']!='E0002' && strtoupper($_SESSION['nick_name'])=='LIPL'){
														...
														else if(sauda_allocation == 'no' && survey=='yes' && (strtoupper($_SESSION['nick_name'])=='STAR' || strtoupper($_SESSION['nick_name'])=='ECEMENT') && $_SESSION['admin_login']!='emovesfa_hr' && $_SESSION['admin_login']!='emovesfa_do'){?>
														...
														<?php }
															...
															<?php }
																...
																if((strtoupper($_SESSION['admin_login'])=='ADMIN' ||strtoupper($_SESSION['admin_login'])=='SUPERVISOR' || strtoupper($_SESSION['admin_login'])=='E0042') &&  strtoupper($_SESSION['nick_name'])=='EMAMI'){
											...
											<td>
												<?php if(isset($_SESSION['admin_login']) && $_SESSION['admin_login']!='' && survey == 'yes' && strtoupper($_SESSION['nick_name'])!='RUPA' && strtoupper($_SESSION['nick_name'])!='STAR' && strtoupper($_SESSION['nick_name'])!='CASHLESS' && strtoupper($_SESSION['nick_name'])!='AJANTA'

												&& strtoupper($_SESSION['nick_name'])!='EMAMI'

												&& strtoupper($_SESSION['nick_name'])!='EMAMIT' && strtoupper($_SESSION['nick_name'])!='DURO'){if($functionality!='DOS' && strtoupper($_SESSION['nick_name'])!='KHMER'){?><a href="exceldownloadSurvey.php" name="link30" id="link30" onMouseOver="MM_showMenu(window.mm_menu_0716141230_0,0,26,null,'link30')" onMouseOut="MM_startTimeout();" >Survey</a><?php }}

												if(isset($_SESSION['admin_login']) && $_SESSION['admin_login']!='' && survey == 'yes' && strtoupper($_SESSION['nick_name'])=='AJANTA'){ ?><a href="adminSurveyDownload.php">Survey</a><?php }

												if(isset($_SESSION['admin_login']) && $_SESSION['admin_login']!='' && survey == 'yes' && strtoupper($_SESSION['nick_name'])=='DURO'){ ?><a href="exceldownloadSurvey.php" name="link107" id="link107" onMouseOver="MM_showMenu(window.mm_menu_07161412107_0,0,26,null,'link107')" onMouseOut="MM_startTimeout();">Survey</a><?php } ?>
											...
											<td>
												...
												if(isset($_SESSION['admin_login']) && $_SESSION['admin_login']!='' && ((strtoupper($_SESSION['nick_name'])=='SKIPPER') || (strtoupper($_SESSION['nick_name'])=='RUPA') || (strtoupper($_SESSION['nick_name'])=='GOLDSTONE')  || (strtoupper($_SESSION['nick_name'])=='GOLDSTONET') || (strtoupper($_SESSION['nick_name'])=='ABDOS') || (strtoupper($_SESSION['nick_name'])=='ARCHITA')  || (strtoupper($_SESSION['nick_name'])=='PERFUME'))){
												...
												<?php
													...
													if(isset($_SESSION['admin_login']) && $_SESSION['admin_login']!='' && (strtoupper($_SESSION['nick_name'])=='STAR' || strtoupper($_SESSION['nick_name'])=='START'))
											...
											<td><?php if(isset($_SESSION['nick_name']) && strtoupper($_SESSION['nick_name'])=='VIPL' && $_SESSION['admin_login']=='admin'){?><a href="showMultiRouteVIPL.php" name="link8" id="link8">WOD</a><?php }?></td>

											<td><?php if(isset($_SESSION['nick_name']) && strtoupper($_SESSION['nick_name'])=='VALVO' && $_SESSION['admin_login']=='admin'){?>

											<a href="adminRoutePlanAccess.php" name="link9" id="link9">Route Plan Access</a><?php }?></td>

											<td><?php if(isset($_SESSION['nick_name']) && strtoupper($_SESSION['nick_name'])=='VALVO' && $_SESSION['admin_login']=='admin'){?><a href="adminRoutePlanChange.php" name="link10" id="link10">Route Plan Change</a><?php }?>

											</td>

											<td><?php if(isset($_SESSION['nick_name']) && strtoupper($_SESSION['nick_name'])=='AMPL' && $_SESSION['admin_login']=='admin'){?>
											...
											<td><?php if(isset($_SESSION['admin_login']) && ($_SESSION['admin_login']=='admin' || (strtolower(substr($_SESSION['admin_login'],0,1))=='c')) && (strtoupper($_SESSION['nick_name'])=='RKBK')){?><a href="adminLoyaltyReport.php"
											...
											<td><?php if(isset($_SESSION['admin_login']) && ($_SESSION['admin_login']=='admin' || (strtolower(substr($_SESSION['admin_login'],0,1))=='c')) && (strtoupper($_SESSION['nick_name'])=='RKBK' || strtoupper($_SESSION['nick_name'])=='RKBKT')){?><a href="adminSaleReport.php"

											name="link13" id="link13" >Transaction Details</a><?php }?>

											</td>

											<td><?php if(isset($_SESSION['admin_login']) && (strtolower($_SESSION['admin_login'])=='c0007' || strtolower($_SESSION['admin_login'])=='c0008') && (strtoupper($_SESSION['nick_name'])=='RKBK' || strtoupper($_SESSION['nick_name'])=='RKBKT'))
											...
											<?php if(isset($_SESSION['admin_login']) && $_SESSION['admin_login']!='' && strtoupper($_SESSION['nick_name'])=='RUPA'){?>
											...
											<td>
												...
												else if(isset($_SESSION['admin_login']) && $_SESSION['admin_login']!='' && vertical_fields != 'yes' && strtoupper($_SESSION['nick_name'])!='MINU'){
												...
												&& strtoupper($_SESSION['nick_name'])!='VCONNECT' && strtoupper($_SESSION['nick_name'])!='ALNADIR' && strtoupper($_SESSION['nick_name'])!='ASL' && strtoupper($_SESSION['nick_name'])!='PERFUME' && strtoupper($_SESSION['nick_name'])!='GOLDSTONE' && strtoupper($_SESSION['nick_name'])!='SUPERSHAKTI' && strtoupper($_SESSION['nick_name'])!='SEPL'  && strtoupper($_SESSION['nick_name'])!='ELEGANT' && strtoupper($_SESSION['nick_name'])!='GOLDSTONET'){
												...
												&& strtoupper($_SESSION['nick_name'])!='MAITHAN' && strtoupper($_SESSION['nick_name'])!='ECEMENT' && strtoupper($_SESSION['nick_name'])!='VCONNECT' && strtoupper($_SESSION['nick_name'])!='SHYAM' && $functionality!='DOS' && strtoupper($_SESSION['nick_name'])=='KHMER' && strtoupper($_SESSION['nick_name'])!='GOLDSTONE' && strtoupper($_SESSION['nick_name'])!='GOLDSTONET'){
												...
												&& strtoupper($_SESSION['nick_name'])!='MAITHAN' && strtoupper($_SESSION['nick_name'])!='ECEMENT' && strtoupper($_SESSION['nick_name'])!='GOLDSTONE'  && strtoupper($_SESSION['nick_name'])!='GOLDSTONET' && strtoupper($_SESSION['nick_name'])!='VCONNECT' && strtoupper($_SESSION['nick_name'])!='ALNADIR' && strtoupper($_SESSION['nick_name'])!='PERFUME' && strtoupper($_SESSION['nick_name'])!='SHYAM' && strtoupper($_SESSION['nick_name'])!='PALSONS' && strtoupper($_SESSION['nick_name'])!='SAI' && strtoupper($_SESSION['nick_name'])!='PROPELLO' && strtoupper($_SESSION['nick_name'])!='ILS' && strtoupper($_SESSION['nick_name'])!='MAGIK' && strtoupper($_SESSION['nick_name'])!='ABDOS' && strtoupper($_SESSION['nick_name'])!='NILESH' && strtoupper($_SESSION['nick_name'])!='DURO' && $functionality!='DOS' && collection=='no'){
												...
												&& strtoupper($_SESSION['nick_name'])!='MAITHAN' && strtoupper($_SESSION['nick_name'])!='SEPL' && strtoupper($_SESSION['nick_name'])!='ECEMENT' && strtoupper($_SESSION['nick_name'])!='DNVFOODS' && strtoupper($_SESSION['nick_name'])!='GOLDSTONET' && strtoupper($_SESSION['nick_name'])!='VCONNECT' && strtoupper($_SESSION['nick_name'])!='ALNADIR' && strtoupper($_SESSION['nick_name'])!='SHYAM' && strtoupper($_SESSION['nick_name'])!='NILESH'  && strtoupper($_SESSION['nick_name'])!='SUPERSHAKTI'
												...
												<a href="excel_download_new_customer.php" name="link149" id="link149" onMouseOver="MM_showMenu(window.mm_menu_07161418149_0,0,26,null,'link149')" onMouseOut="MM_startTimeout();">Customize Report</a>
												...
												&& $_SESSION['admin_login']!='emovesfa_hr' && $_SESSION['admin_login']!='emovesfa_do' && strtoupper($_SESSION['admin_login'])!='ADMIN' && strtoupper($_SESSION['admin_login'])!='E1071' && strtoupper($_SESSION['admin_login'])!='E0555' && strtoupper($_SESSION['admin_login'])!='E0556' && strtoupper($_SESSION['admin_login'])!='E0938' && strtoupper($_SESSION['admin_login'])!='E0658'){?>
												...
												<?php }
												else if((strtoupper($_SESSION['nick_name'])=='STAR' || strtoupper($_SESSION['nick_name'])=='START') && $_SESSION['admin_login']!='emovesfa_hr' && $_SESSION['admin_login']!='emovesfa_do' && strtoupper($_SESSION['admin_login'])=='E0938' || strtoupper($_SESSION['admin_login'])=='E0658'){?>
												...
												else if($_SESSION['admin_login']!='' && strtoupper($_SESSION['nick_name'])=='SEPL')
												{ ?>

												<a href="excel_download_new_customer.php" name="link141" id="link141" onMouseOver="MM_showMenu(window.mm_menu_07161418141_0,0,26,null,'link141')" onMouseOut="MM_startTimeout();">Customize Report</a><?php
												}
												...
												<?php }
												else if(isset($_SESSION['nick_name']) && strtoupper($_SESSION['nick_name'])=='SHAKTI'){
												...
												<?php }
												else if(isset($_SESSION['admin_login']) && strtoupper($_SESSION['admin_login'])=='ADMIN' && (strtoupper($_SESSION['nick_name'])=='EMAMI' || strtoupper($_SESSION['nick_name'])=='EMAMIT')){ ?>
												...
												<?php }else if(isset($_SESSION['admin_login']) && strtoupper($_SESSION['admin_login'])
												...
												else if(isset($_SESSION['admin_login']) && $_SESSION['admin_login']!='' && (strtoupper($_SESSION['nick_name'])=='VIPL'
												...
												else if(isset($_SESSION['admin_login']) && $_SESSION['admin_login']!='' && strtoupper($_SESSION['nick_name'])=='PANORAMA'){
												...
												else if(isset($_SESSION['admin_login']) && $_SESSION['admin_login']!=''
												...
												else if(isset($_SESSION['nick_name']) && strtoupper($_SESSION['nick_name'])=='ASL'){
											...
											<td>
												...
												<?php if(isset($_SESSION['admin_login']) && $_SESSION['admin_login']!='' && (strtoupper($_SESSION['nick_name'])=='STORE' || strtoupper($_SESSION['nick_name'])== 'LIPL')){?><a href="mall_add_edit.php" name="link35" id="link35" onMouseOver="MM_showMenu(window.mm_menu_0716141835_0,0,26,null,'link35')" onMouseOut="MM_startTimeout();">Master Input</a><?php }?>
											...
											<td>
												...
												if(isset($_SESSION['admin_login']) && strtoupper($_SESSION['admin_login']) =='SYSTEM')
											...
											if((isset($_SESSION['admin_login']) && strtoupper($_SESSION['admin_login']) != '') && (strtoupper($_SESSION['nick_name'])=='ABDOS' || strtoupper($_SESSION['nick_name'])=='ABDOST')){
											...
											<td>
												...
												<?php
													...
													if(isset($_SESSION['admin_login']) && $_SESSION['admin_login']!=''){
															...
															if(stk_audit == 'yes' && isset($functionality) && $functionality!='DOS'){
											...
											<td>
													...
													if(isset($_SESSION['nick_name']) && strtoupper($_SESSION['nick_name'])=='STAR' && isset($_SESSION['admin_login']) && $_SESSION['admin_login']=='E1204'){?>

														<a href="branding_verification_with_location_modified.php" name="link139" id="link139" onMouseOver="MM_showMenu(window.mm_menu_07161418137_0,0,26,null,'link139')" onMouseOut="MM_startTimeout();">Branding Verification</a>
											...
											<td>
												...
												<?php
													...
													<a href="stock_audit_report.php" name="link39" id="link39">Stock Audit</a>
														...
														}elseif( strtoupper($_SESSION['nick_name'])=='STAR' && $_SESSION['admin_login']=='E1697'&& $_SESSION['admin_login']!='emovesfa_hr'

														&& $_SESSION['admin_login']!='emovesfa_do'){?>

															<a href="branding_verification_with_location_modified.php" name="link138" id="link138" onMouseOver="MM_showMenu(window.mm_menu_07161418137_0,0,26,null,'link138')" onMouseOut="MM_startTimeout();">Branding Verification</a>
											...
											<?php
												...
												if(isset($_SESSION['nick_name']) && strtoupper($_SESSION['nick_name'])=='STAR' && isset($_SESSION['admin_login']) && strtoupper($_SESSION['admin_login'])=='ADMIN')
											...
											<td>
												...
												<?php
													...
													if(isset($_SESSION['admin_login']) && $_SESSION['admin_login']!='' && tour_exp == 'yes'){
											...
											<td>
												...
												if(isset($_SESSION['nick_name']) && strtoupper($_SESSION['nick_name']) == 'VIPL' && strtoupper($_SESSION['admin_login']) == 'E0001'){
											...
											<td>
												...
												if(isset($_SESSION['admin_login']) && ($_SESSION['admin_login'] == 'E1412') && strtoupper($_SESSION['nick_name']) == 'HALDIRAM'){
											...
											<td>
												...
												if(isset($_SESSION['admin_login']) && strtoupper($_SESSION['admin_login']) == 'ADMIN' && strtoupper($_SESSION['nick_name']) == 'EMAMI' ){
											...
											<td>
												...
												if(isset($_SESSION['admin_login']) && strtoupper($_SESSION['admin_login']) == 'ADMIN' && strtoupper($_SESSION['nick_name']) == 'STAR'){
											...
											<td>
												...
												if(isset($_SESSION['admin_login']) && strtolower($_SESSION['admin_login']) == 'emovesfa_do' && strtoupper($_SESSION['nick_name']) == 'STAR'){
											...
											<td>
												...
												if(isset($_SESSION['admin_login']) && strtolower($_SESSION['admin_login']) == 'admin' && (strtoupper($_SESSION['nick_name']) == 'SKIPPER' || strtoupper($_SESSION['nick_name']) == 'HALDIRAM' || strtoupper($_SESSION['nick_name']) == 'EMAMI'
												...
												else if(isset($_SESSION['admin_login']) && (strtoupper($_SESSION['admin_login']) == 'E0042' || strtoupper($_SESSION['admin_login'])=="GMHBC" ||
												...
												<?php }else if(isset($_SESSION['admin_login']) && strtoupper($_SESSION['admin_login'])=='ADMIN' && (strtoupper($_SESSION['nick_name']) == 'NHPL' || strtoupper($_SESSION['nick_name']) == 'PRAKASH' || strtoupper($_SESSION['nick_name']) == 'ARCHITA' || strtoupper($_SESSION['nick_name']) == 'RUPA' || strtoupper($_SESSION['nick_name']) == 'AKASH' || strtoupper($_SESSION['nick_name']) == 'AJANTA' || strtoupper($_SESSION['nick_name']) == 'VCONNECT' || strtoupper($_SESSION['nick_name']) == 'EDIBLE'

												|| strtoupper($_SESSION['nick_name']) == 'DNV' || strtoupper($_SESSION['nick_name']) == 'ASL'  || strtoupper($_SESSION['nick_name']) == 'MOREISH' || strtoupper($_SESSION['nick_name']) == 'EDIBLEH' || strtoupper($_SESSION['nick_name']) == 'NIMBUS' || strtoupper($_SESSION['nick_name']) == 'GOLDSTONE' || strtoupper($_SESSION['nick_name']) == 'GOLDSTONE' || strtoupper($_SESSION['nick_name']) == 'GOLDSTONET' || strtoupper($_SESSION['nick_name']) == 'MDPL'  || strtoupper($_SESSION['nick_name']) == 'DNVFOODS' || strtoupper($_SESSION['nick_name']) == 'STAR' || strtoupper($_SESSION['nick_name'])=='ILS' || strtoupper($_SESSION['nick_name']) == 'ABDOS' || strtoupper($_SESSION['nick_name']) == 'ABDOST' || strtoupper($_SESSION['nick_name']) == 'MAGIK' || strtoupper($_SESSION['nick_name']) == 'SUPERSHAKTI' || strtoupper($_SESSION['nick_name']) == 'SAI' || strtoupper($_SESSION['nick_name']) == 'SHAKTI' || strtoupper($_SESSION['nick_name']) == 'SUNLAM' || strtoupper($_SESSION['nick_name']) == 'SEPL' || strtoupper($_SESSION['nick_name']) == 'SYLVAN' || strtoupper($_SESSION['nick_name']) == 'CORAL' || strtoupper($_SESSION['nick_name']) == 'PROPELLO' || strtoupper($_SESSION['nick_name']) == 'ELEGANT')){?><a href="dump_download_new.php">Dump Download</a><?php

												}else if(isset($_SESSION['admin_login']) && strtoupper($_SESSION['admin_login'])!='' && strtoupper($_SESSION['nick_name']) == 'PALSONS'){?>

												<a href="dump_download_new.php">Dump Download</a>

												<?php }

												else if(isset($_SESSION['admin_login']) && strtoupper($_SESSION['admin_login'])=='ADMIN' && strtoupper($_SESSION['nick_name']) == 'DURO'){?>
											...
											<td>
												...
												if(isset($_SESSION['nick_name']) && strtoupper($_SESSION['nick_name']) != 'EMAMIT' && isset($_SESSION['admin_login']) && strtolower($_SESSION['admin_login']) == 'admin' && focus_product=='yes'){
											...
											if(isset($_SESSION['admin_login']) && $_SESSION['admin_login']!='' && isset($functionality) && $functionality=='DOS'){?>

											<a href="order_approval_process_modified.php">Order Approval</a><?php }?></td>

											<?php if((isset($_SESSION['admin_login']) && $_SESSION['admin_login']=='E0076') && (strtoupper($_SESSION['nick_name'])=='EMAMIT' || strtoupper($_SESSION['nick_name'])=='EMAMI')){?>
											...
											if(isset($_SESSION['admin_login']) && $_SESSION['admin_login']!='' && strtoupper($_SESSION['nick_name'])=='ASL' ){?>
											...
											if(isset($_SESSION['admin_login']) && strtoupper($_SESSION['admin_login']) == 'ADMIN' && distributor_route_emp_relation=='yes'){
											...
											if(isset($_SESSION['nick_name']) && (strtoupper($_SESSION['nick_name'])=='VCONNECT' || strtoupper($_SESSION['nick_name'])=='VCONNECTT')
											...
											if(isset($_SESSION['nick_name']) && (strtoupper($_SESSION['nick_name'])=='DNV' || strtoupper($_SESSION['nick_name'])=='DNVFOODS')
											...
											if(isset($_SESSION['nick_name']) && ((strtoupper($_SESSION['nick_name'])=='ARCHITA')  || (strtoupper($_SESSION['nick_name'])=='GOLDSTONE')) &&
											...
											if((isset($_SESSION['nick_name']) && strtoupper($_SESSION['nick_name'])=='AJANTA') && strtoupper($_SESSION['admin_login']) != ''){?>
											...
											if(isset($_SESSION['nick_name']) && strtoupper($_SESSION['nick_name'])=='MOREISH'){?>
											...
											<?php }if((isset($_SESSION['admin_login']) && strtoupper($_SESSION['admin_login'])=='ADMIN')  && strtoupper($_SESSION['nick_name'])=='ASL'){?>
											<td>
											...
											<?php }if(isset($_SESSION['nick_name']) && strtoupper($_SESSION['nick_name'])=='ASL' && $_SESSION['admin_login']!='' && strtoupper($_SESSION['admin_login'])
											!='ADMIN'){?>
											<td>
											...
											if(isset($_SESSION['admin_login']) && strtoupper($_SESSION['admin_login'])=='ADMIN' && (strtoupper($_SESSION['nick_name'])=='STAR' || strtoupper($_SESSION['nick_name'])=='START')){
												if(strtoupper($_SESSION['nick_name'])=='STAR'){
												?>
											<td >
											<a href="branding_verification_with_location_modified.php" name="link137" id="link137" onMouseOver="MM_showMenu(window.mm_menu_07161418137_0,0,26,null,'link137')" onMouseOut="MM_startTimeout();">Branding Verification</a></td>
											<?php
												}
												if(strtoupper($_SESSION['nick_name'])=='START'){
												?>
											...
											<?php
												...
												if(isset($_SESSION['admin_login']) && strtoupper($_SESSION['admin_login'])=='ADMIN' && strtoupper($_SESSION['nick_name'])=='MAGIK'){?>
											<td>
											<a href="adminschemeupload.php">Scheme Upload</a></td>

											<?php }
												if(isset($_SESSION['admin_login']) && strtoupper($_SESSION['admin_login'])=='ADMIN' && strtoupper($_SESSION['nick_name'])=='PROPELLO'){?>
											<td>
											<a href="adminTelecallerSubmitmod.php">Telecaller Form</a></td>
