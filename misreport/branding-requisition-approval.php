...
function Popup(data) 
{
	var mywindow = window.open('', 'Branding Approval Data', 'height=400,width=600');
...
function exporttocsv(divid)
{
	...
	a.download = 'Branding Approval Data' + postfix + '.xls';
...
<table cellpadding="4px" width="40%" class="border">
	<tr class="TDHEAD_SUB">
    	<td align="center" colspan="2">Branding Requisition Approval</td>
    </tr>
       <!--tr>
        ...
        <tr>
        <td align="right" width="25%"  valign="top">Requisition Type:<font color="#FF0000">*</font>&nbsp;&nbsp;</td>
         <td align="left">
        <?php $requisition_type=$_REQUEST['requisition_type'];?>
                        <input type="radio" name="requisition_type" id="requisition_type" value="branding" checked/>Branding
                         <input type="radio" name="requisition_type" id="requisition_type" value="technical_meet " />Technical meet
                          <input type="radio" name="requisition_type" id="requisition_type" value="pop" />POP
         </td>
        </tr>
        <tr >
...
function get_data(){
	...
	var requisition_type=document.getElementById("requisition_type").value;
	...
	GenericAjaxFunction('branding_reqisition_approval_data.php?requisition_type='+requisition_type+'&month='+month,'display',0);
}
</script>
<?php } ?>