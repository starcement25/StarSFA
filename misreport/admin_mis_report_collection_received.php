...
while($row_emp_code = mysqli_fetch_assoc($res_emp_code)){
	...
	$res_total_collection = mysqli_query($link,$sql_total_collection);
	$row_total_collection = mysqli_fetch_assoc($res_total_collection);
	...
	if($total_count>0){
		...
		$res_collection_id = mysqli_query($link,$sql_collection_id);
		while($row_collection_id = mysqli_fetch_assoc($res_collection_id)){
