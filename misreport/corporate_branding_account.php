...
function main(){
   ...
   <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js"></script>
	...
	echo "<span style=\"font-weight:bold; font-size:14px;\">Corporate Branding Account</span><br><br>";
	...
	function display_result(){
		...
		GenericAjaxFunction('corporate_branding_account_data.php?employee='+employee+'&start_date='+start_date+'&end_date='+end_date+'&zone='+zone+'&state='+state+'&branch='+branch+'&department='+department,'display',0);
	...
	function Popup(data) 
	{
		var mywindow = window.open('', 'Corporate Branding Account', 'height=400,width=600');
	...
	function exporttocsv(){
			...
			var report_name = 'Corporate Branding Account';
			var dt = new Date();
			var day = dt.getDate();
