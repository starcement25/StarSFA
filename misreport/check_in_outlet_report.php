...
<center>
	<span style="font-weight:bold; font-size:14px;">First Outlet Visit Report</span><br><br>
    ...
    <br />
     ...
     <div id="display" style="max-height: 350px; width:75%; overflow-y: scroll;" align="center"></div><br />
	...
	function display_result(){
		...
		GenericAjaxFunction('check_in_outlet_report_data.php?employee='+employee+'&start_date='+start_date+'&end_date='+end_date,'display',0);
	}
	...
	function Popup(data) 
	{
		var mywindow = window.open('', 'First Outlet Visit Report', 'height=400,width=600');
		mywindow.document.write('<html><head><title>First Outlet Visit Report</title>');
	...
	function exporttocsv(divid)
	{
		...
		a.download = 'First Outlet Visit Report' + postfix + '.xls';
