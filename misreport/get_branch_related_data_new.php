...
if($type == 'sale_access'){
	...
	echo $sql_sale_access = "SELECT DISTINCT sale_access FROM employee_master WHERE ".$sale_access_condition.$emp_hierarchy_condition_one." AND sale_access != '' ".$zone_condition.$state_condition." ORDER BY sale_access ASC";
	$res_sale_access = mysqli_query($link,$sql_sale_access);
