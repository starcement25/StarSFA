...
mysqli_select_db("acedns_DNV",$linksetup) or die("could not connect the setup database");
...
while($row_customer_master = mysqli_fetch_assoc($res_customer_master)){
	...
	mysqli_query($link,$sql_update_customer_master);
}
