...
function show_employeewise()
{
	...
	if(type != 'custom')
		GenericAjaxFunction('emamit_product_skuwise_data.php?type='+type,'display',0);
	else 
	{
		if(response1 != 0 && response2 != 0)
			GenericAjaxFunction('emamit_product_skuwise_data.php?type='+type+'&start_date='+start_date+'&end_date='+end_date,'display',0);
	}
}
