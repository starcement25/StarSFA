...
$sql_clear_menuaccess = "DELETE FROM OTP_menu_access WHERE emp_code = '".$emp_code."'";
$res_clear_menuaccess = mysqli_query($link,$sql_clear_menuaccess);

foreach($menu_checked_array as $value)
{
	$sql_insert_menuaccess = "INSERT INTO OTP_menu_access SET emp_code = '".$emp_code."', accessible_menu = '".$value."'";
