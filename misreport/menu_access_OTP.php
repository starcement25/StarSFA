...
function GetXmlHttpObject()
	...
	function display_result(){
		...
		document.getElementById("display").innerHTML = '<img src="ajax-loader.gif" id="ajaxloader">';
		var url="menu_access_OTP_data.php";
...
{
	document.getElementById("display").innerHTML = '<img src="ajax-loader.gif" id="ajaxloader">';
	GenericAjaxFunction('menu_access_OTP_data.php','display',0);
}
...
function update_data(emp_code)
{
	...
	$.post("update_menu_access_OTP.php",
    {
		emp_code: emp_code,
    ...
    function(data, status){
		...
		//alert(employee);
	document.getElementById("display").innerHTML = '<img src="ajax-loader.gif" id="ajaxloader">';
	GenericAjaxFunction('menu_access_OTP_data.php?employee='+employee,'display',0);
	});
