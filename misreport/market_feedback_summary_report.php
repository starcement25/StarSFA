...
<center>
	<span style="font-weight:bold; font-size:14px;">Market Feedback Summary Report</span><br><br>
	...
	function display_result(){
		...
		GenericAjaxFunction('market_feedback_summary_report_data.php?employee='+employee+'&start_date='+start_date+'&end_date='+end_date,'display',0);
	}
