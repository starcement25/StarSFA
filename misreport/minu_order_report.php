...
function Popup(data) 
{
	var mywindow = window.open('', 'Market Visit Report', 'height=400,width=600');
	mywindow.document.write('<html><head><title>Market Visit Report</title>');
...
function exporttocsv(divid)
{
	//alert(divid);
        ...
        a.download = 'Market Visit Report' + postfix + '.xls';
...
<br>
Employee:<select name="employee" id="employee" onChange="remove_selection();">
