...
function main()
{
	...
	if($_REQUEST['store_code']!=''){
		...
		$rsstore=mysqli_query($link,$sqlstore) or die(mysqli_error()." Error in select store : ".$sqlstore);	
		$rowstore=mysqli_fetch_assoc($rsstore);
	...
	if($operation_type=='O')
	{
		...
		$rsorderdetails=mysqli_query($link,$sqlorderdetails) or die(mysqli_error()." Error in select order details: ".$sqlorderdetails);
	}
	if($operation_type=='P')
	{
		...
		$rspaymentdetails=mysqli_query($link,$sqlpaymentdetails) or die(mysqli_error()." Error in select payment details: ".$sqlpaymentdetails);
	...
	if($operation_type=='C')
	{
		...
		$rsstockdetails=mysqli_query($link,$sqlstockdetails) or die(mysqli_error()." Error in select stock details: ".$sqlstockdetails);
	...
	if($operation_type=='M')
	{
		...
		$rsmtdetails=mysqli_query($link,$sqlmtdetails) or die(mysqli_error()." Error in select mt details: ".$sqlmtdetails);
	...
	<tr>
		<td valign="top" bgcolor="#FFFFFF">
            ...
            <table width="90%" align="center" border="0" cellpadding="5" cellspacing="2" class="border" style="display: run-in;height: 200px;overflow-y: scroll">
                ...
                <?php $cnt=$GLOBALS[start]+1;
					while($rowpaymentdetails=mysqli_fetch_assoc($rspaymentdetails))
					{
				?>
                		<tr> 
                            <td valign="top" align="center"><?=$cnt++ ?></td>
            ...
            <table width="90%" align="center" border="0" cellpadding="5" cellspacing="2" class="border" style="display: run-in;height: 200px;overflow-y: scroll">
                ...
                <?php $cnt=$GLOBALS[start]+1;
					while($rowstockdetails=mysqli_fetch_assoc($rsstockdetails))
					{
				?>
                		<tr> 
                            <td valign="top" align="center"><?=$cnt++ ?></td>
            ...
            <table width="90%" align="center" border="0" cellpadding="5" cellspacing="2" class="border" style="display: run-in;height: 200px;overflow-y: scroll">
                ...
                <?php $cnt=$GLOBALS[start]+1;
					while($rowmtdetails=mysqli_fetch_assoc($rsmtdetails))
					{
				?>
                		<tr> 
                            <td valign="top" align="center"><?=$cnt++ ?></td>
