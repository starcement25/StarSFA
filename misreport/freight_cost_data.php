...
$res_freight_cost = mysqli_query($link,$sql_freight_cost);
$total_rows = mysqli_num_rows($res_freight_cost);
...
if($total_rows>0){
    ...
    <?php
	$res_freight_cost = mysqli_query($link,$sql_freight_cost);
	while($row_freight_cost = mysqli_fetch_assoc($res_freight_cost)){
