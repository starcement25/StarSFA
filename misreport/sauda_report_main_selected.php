...
function saudawisereport(){
	...
	window.open('http://acedns.in/acednsproduct/misreport/saudawisereport_selected.php?type='+type+'&start_date='+start_date+'&end_date='+end_date,'_self');
}
function employeewisereport(){
	...
	window.open('http://acedns.in/acednsproduct/misreport/employeewisereportchanged_selected.php?type='+type+'&start_date='+start_date+'&end_date='+end_date,'_self');
}
function product_groupwise(){
	...
	window.open('http://acedns.in/acednsproduct/misreport/product_groupwise_report_selected.php?type='+type+'&start_date='+start_date+'&end_date='+end_date,'_self');
}
function product_skuwise(){
	...
	window.open('http://acedns.in/acednsproduct/misreport/product_skuwise_report_selected.php?type='+type+'&start_date='+start_date+'&end_date='+end_date,'_self');
}
function customerwisereport(){
	...
	window.open('http://acedns.in/acednsproduct/misreport/customerwise_report_selected.php?type='+type+'&start_date='+start_date+'&end_date='+end_date,'_self');
}
function depotwisereport(){
	...
	window.open('http://acedns.in/acednsproduct/misreport/depotwise_report_selected.php?type='+type+'&start_date='+start_date+'&end_date='+end_date,'_self');
}
function zonewisereport(){
	...
	window.open('http://acedns.in/acednsproduct/misreport/zonewise_report_selected.php?type='+type+'&start_date='+start_date+'&end_date='+end_date,'_self');
}
function statewisereport(){
	...
	window.open('http://acedns.in/acednsproduct/misreport/statewise_report_selected.php?type='+type+'&start_date='+start_date+'&end_date='+end_date,'_self');
}
function plantwisereport(){
	...
	window.open('http://acedns.in/acednsproduct/misreport/plantwise_report_selected.php?type='+type+'&start_date='+start_date+'&end_date='+end_date,'_self');
}
