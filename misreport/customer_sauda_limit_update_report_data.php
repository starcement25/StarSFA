...
$res_customer_saudalimit = mysqli_query($link,$sql_customer_saudalimit);
$total_rows = mysqli_num_rows($res_customer_saudalimit);
$count = 1;
if($total_rows>0){
	?>
    ...
    <thead>
     <tr>
      ...
      <tbody>
    <?php
	while($row_customer_saudalimit = mysqli_fetch_assoc($res_customer_saudalimit)){
