...
<center>
	<span style="font-weight:bold; font-size:14px;">Business Prospect Report</span><br><br>
    ...
    <div id="display_details" align="center" hidden></div><br />
	...
	function display_result(){
		...
		GenericAjaxFunction('business_prospect_report_export_data.php?employee='+employee+'&start_date='+start_date+'&end_date='+end_date,'display',0);
	}
	...
	function Popup(data) 
	{
		var mywindow = window.open('', 'Gift Delivery Report', 'height=400,width=600');
		mywindow.document.write('<html><head><title>Business Prospect Report</title>');
	...
	function exporttocsv()
	{
		...
		a.download = 'Business Prospect Report' + postfix + '.xls';
