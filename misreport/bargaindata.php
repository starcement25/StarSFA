...
<table width="100%" style="border-collapse:collapse;" class="border">
  <tr>
  	<td colspan="9" align="center" class="TDHEAD">Bargainwise: <?php echo $sauda_duration;?></td>
  </tr>
  <tr class="TDHEAD_SUB" align="center">
    ...
    <td width="9%">Bargain Valid From</td>
    <td width="9%">Valid Upto</td>
  </tr>
</table>
</div>
<br /><br />
...
if($_SESSION['admin_login']=="admin"){
   ...
   $sql_sauda_wise = "SELECT SD.sauda_no, PM.prod_desc,PM.UOM1,round(sum(PM.conversion_factor_two*SD.qty),2 )as mt_booked, 
					SD.sku_code, ((SD.sale_rate+SD.primary_freight+SD.freight_charge+SD.depot_cost+SD.margin_cost)-SD.TD) AS sale_rate, SD.TD, SD.amount, SH.customer_code, SH.sauda_valid_from, CM.sauda_validity_period, 
					...
					WHERE SH.sauda_no=SD.sauda_no $emp_hierarchy_condition_one $condition 
					AND SD.sku_code=PM.prod_code AND SH.customer_code=CM.customer_code 
	...
	while($row_sauda_wise = mysqli_fetch_assoc($res_sauda_wise))
	{
		...
		if(!in_array($sauda_date,$sauda_date_array))
		{
			...
			echo "<br /><tr style=\"background:grey;\"><td colspan=\"9\" align=\"center\"><b>$sauda_date</b></td></tr>";
		}
		...
		echo "<tr>
	<td width=\"5%\">$count</td>
    <td width=\"18%\">$row_sauda_wise[prod_desc]</td>
    <td align=\"right\" width=\"6%\">$row_sauda_wise[qty]</td>
	<td width=\"6%\">$row_sauda_wise[UOM1]</td>
    <td align=\"right\" width=\"6%\">".number_format(round($row_sauda_wise['sale_rate'],2),2)."</td>
    <td align=\"right\" width=\"6%\">$row_sauda_wise[TD]</td>
    <td align=\"right\" width=\"8%\">".number_format($row_sauda_wise['amount'],2)."</td>
    <td align=\"center\" width=\"10%\">$sauda_valid_from</td>
    <td align=\"center\" width=\"10%\">$valid_upto</td>
  </tr>";
...
echo "<tr style=\"font-weight:bold;\">
    ...
    <td align=\"right\" width=\"6%\"></td>
    <td align=\"right\" width=\"6%\"></td>
    <td align=\"right\" width=\"8%\">".number_format($total_amount,2)."</td>
