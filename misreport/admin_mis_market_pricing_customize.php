...
function main(){
	...
	$hidden = "";
	echo "<center>";
	echo "<span style=\"font-weight:bold; font-size:14px;\">MARKET FEEDBACK - PRICING</span><br><br>";
	...
	function exporttocsv(divid)
	{
		...
		if(nickname!='STAR')
			...
			{
				window.open('admin_mis_market_pricing_data_customize_export_modified.php?employee='+employee+'&start_date='+start_date+'&end_date='+end_date+'&zone='+zone+'&state='+state+'&branch='+branch,'mywindow')	;
