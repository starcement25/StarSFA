		...
		<td valign="top" bgcolor="#FFFFFF">		
			...
			?>
				...
				while($rec=mysqli_fetch_assoc($rs))
				{
					...
					$rsstatewiseactive=mysqli_query($link,$sqlstatewiseactive);
					$rowstatewiseactive=mysqli_fetch_assoc($rsstatewiseactive);
					...
					$rsstatewiseinactive=mysqli_query($link,$sqlstatewiseinactive);
					$rowstatewiseinactive=mysqli_fetch_assoc($rsstatewiseinactive);
