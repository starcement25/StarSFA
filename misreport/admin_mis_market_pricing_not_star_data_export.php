...
foreach($storedArray as $competitor_name){
	...
	$competitor_string .= "'" . strtoupper($competitor_name) . "',";
	$header_star .= strtoupper($competitor_name) . "\t" . "" . "\t" . "" . "\t" . "\t";
	array_push($competitor_name_array, strtoupper($competitor_name));
...
// echo "test";
	...
	// 	echo "competitor_name_val= ".$competitor_name_val."<br/>";
	// 	// if($_SESSION['nick_name']!='STAR'){
			
	// 		echo "dns_emp_code_val= ".$dns_emp_code_val."<br/>";
	// 		echo "dns_customer_code_val= ".$dns_customer_code_val."<br/>";
	// 		echo "date_val= ".$date_val."<br/>";
	// 		echo "competitorval= ".$competitorval."<br/>";
