...
if($current_month == '01' || $current_month == '02' || $current_month == '03'){
	...
	if(strtoupper($_SESSION['nick_name'])=='SKIPPER' || strtoupper($_SESSION['nick_name'])=='HALDIRAM' || strtoupper($_SESSION['nick_name'])=='RUPA' || strtoupper($_SESSION['nick_name'])=='PARLE' || strtoupper($_SESSION['nick_name'])=='MAGIK' || strtoupper($_SESSION['nick_name'])=='PALSONS' || strtoupper($_SESSION['nick_name'])=='SUPERSHAKTI')
	{*/
