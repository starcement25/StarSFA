...
/*--------> Employee Data Populate <--------*/
	...
	if(strpos($_SERVER['HTTP_REFERER'],'yellow_card_excel_report.php') > 0 || strpos($_SERVER['HTTP_REFERER'],'allocation_details_summary_report.php') > 0) $onclick = "emp_dealer(this.value);";
