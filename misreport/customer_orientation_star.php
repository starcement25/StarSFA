...
function main(){
	...
	echo "<center>";
	echo "<span style=\"font-weight:bold; font-size:14px;\">Customer Orientation Report</span><br><br>";
	...
	function display_result(){
		...
		GenericAjaxFunction('customer_orientation_data.php?employee='+employee+'&start_date='+start_date+'&end_date='+end_date,'display',0);
	}
	...
	function Popup(data) 
	{
		var mywindow = window.open('', 'Customer Orientation Report', 'height=400,width=600');
		mywindow.document.write('<html><head><title>Customer Orientation Report</title>');
	...
	function exporttocsv(divid)
	{
		...
		a.download = 'customer orientation' + postfix + '.xls';
