	...
	if($total_rows>0){
		...
		while($row_dealer = mysqli_fetch_assoc($res_dealer)){
			...
			if($dealername !=''){
				...
				$last_stock_audit_cnt=mysqli_num_rows($rslaststkaudit);
				...
				$last_stock_audit_prev_month_cnt=mysqli_num_rows($rslaststkauditprevmonth);
				...
				$purchase_cnt=mysqli_num_rows($rs_purchase);
				...
				$prev_month_purchase_cnt=mysqli_num_rows($rs_last_month_purchase);
