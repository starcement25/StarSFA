...
$resstockdetails = mysqli_query($link,$sqlstockdetails);
$totalstockdetails = mysqli_num_rows($resstockdetails);
if($totalstockdetails >0){
       ...
       <form name="frm_stock" method="post" action="" enctype="multipart/form-data" />
		...
		$DOcnt=1;
		$DOarray=array();
		while($rowstockdetails = mysqli_fetch_assoc($resstockdetails)){
