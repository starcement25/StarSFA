...
<br /><br />
<div id="display" style="max-height: 350px; width:60%; overflow-y: scroll; margin-left:10px;" align="center"></div>
<br><br>
...
<br><br>
<div><a href="order_register_employee_report.php" style="color:blue;">Back</a></div>
</center>
<br>
...
<table style="border-collapse:collapse; font-weight:bold;">
  <tr>
    ...
    <td align="left"><input type="radio" name="sauda_option" value="employeewise" onClick="hideproductoption();employeewisereport();" checked /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="left"><input type="radio" name="sauda_option" value="plantwise" onClick="hideproductoption();skuwisereport();" /></td>
  </tr>
</table>
</div>-->
</body>
...
function show_employeewise(){
	...
	if(type != 'custom')
		GenericAjaxFunction('order_register_sku_data.php?type='+type+'&emp_name='+emp_name,'display',0);
	else{
		if(response1 != 0 && response2 != 0)
			GenericAjaxFunction('order_register_sku_data.php?type='+type+'&start_date='+start_date+'&end_date='+end_date+'&emp_name='+emp_name,'display',0);
	}
}
