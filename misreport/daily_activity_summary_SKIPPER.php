...
function main(){
	...
	echo "<center>";
	echo "<span style=\"font-weight:bold; font-size:14px;\">DAILY ACTIVITY REPORT SUMMARY</span><br><br>";
	...
	function display_result(){
		...
		GenericAjaxFunction('daily_activity_summary_SKIPPER_data.php?employee='+employee+'&start_date='+start_date+'&end_date='+end_date,'display',0);
	}
	...
	function exporttocsv(divid)
	{
		...
		var start_date = document.getElementById("start_date").value;
		var end_date = document.getElementById("end_date").value;
		window.open('daily_activity_summary_SKIPPER_data_export.php?employee='+employee+'&start_date='+start_date+'&end_date='+end_date,'mywindow')	;
	}
