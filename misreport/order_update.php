...
$rspreviousval=mysqli_query($link,$sqlpreviousval);
$rowpreviousval=mysqli_fetch_assoc($rspreviousval);
...
if(mysqli_query($link,$upd_sql) && mysqli_query($link,$upd_prev_order)){
