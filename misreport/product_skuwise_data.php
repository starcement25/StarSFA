...
{
	$res_get_emp_code = mysqli_query($link,"SELECT emp_code FROM employee_master WHERE reporting_to = '' AND acedns!='N'");
	$row_get_emp_code = mysqli_fetch_assoc($res_get_emp_code);
