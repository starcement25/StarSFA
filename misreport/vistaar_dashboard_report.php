...
<center>
	<span style="font-weight:bold; font-size:14px;">Vistaar Dashboard</span><br><br>
    
    
    <table class="border" width="40%" style="border-collapse:collapse;" cellpadding="6px">
    <?php $table_data .= "<tr class=\"TDHEAD_SUB\"><td align=\"right\">Branch:</td>";
			...
			$sql_branch = "SELECT branch_name,branch_code FROM branch_master ORDER BY branch_name ASC";
			$res_branch = mysqli_query($link,$sql_branch);
    ...
    <br /> <br />
        <div id="display" style="max-height: 450px; width:70%; overflow-y: scroll;" align="center"></div><br />
	...
	function display_result(){
		...
		GenericAjaxFunction('vistaar_dashboard_report_data.php?employee='+employee+'&start_date='+start_date+'&end_date='+end_date,'display',0);
	}
	...
	function Popup(data) 
	{
		var mywindow = window.open('', 'Vistaar Dashboard Report', 'height=400,width=600');
		mywindow.document.write('<html><head><title>Vistaar DashboardReport</title>');
	...
	function exporttocsv(divid)
	{
		...
		a.download = 'Vistaar Dashboard Report' + postfix + '.xls';
