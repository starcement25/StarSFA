...
function show_order_status(distributor){
	...
	GenericAjaxFunction('order_approve_details.php?order_date='+order_date+'&distributor='+distributor,'display',0);
}
...
<table cellpadding="8px">
  <tr style="background:#EEE8CD;">
	...
	$resdate = mysqli_query($link,$sqldate);
	while($rowdate = mysqli_fetch_assoc($resdate)){
