...
while($row_customer_visit = mysqli_fetch_assoc($res_customer_visit)){
	...
	mysqli_query($link,$sql_update_customer_visit);
}
...
$res_cust_visit = mysqli_query($link,$sql_cust_visit);
while($row_cust_visit = mysqli_fetch_assoc($res_cust_visit)){
	...
	mysqli_query($link,$sql_update_cust_visit);
}*/
...
while($row_order_header = mysqli_fetch_assoc($res_order_header)){
	...
	mysqli_query($link,$sql_update_cv);
}
