...
<center>
	<span style="font-weight:bold; font-size:14px;">Gift Delivery REPORT</span><br><br>
	...
	function display_result(){
		...
		GenericAjaxFunction('gift_delivery_report_data.php?employee='+employee+'&start_date='+start_date+'&end_date='+end_date,'display',0);
	}
	...
	function Popup(data) 
	{
		...
		mywindow.document.write('<html><head><title>Gift Delivery Report</title>');
	...
	function exporttocsv(divid)
	{
		...
		a.download = 'Gift Delivery Report' + postfix + '.xls';
