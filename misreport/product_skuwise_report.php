...
function Popup(data) 
{
	var mywindow = window.open('', 'SKUwise Report', 'height=400,width=600');
	mywindow.document.write('<html><head><title>SKUwise Report Report</title>');
...
function exporttocsv(divid)
{
	//alert(divid);
        ...
        a.download = 'SKUwise Report' + postfix + '.xls';
...
<div id="display" style="max-height: 450px; width:90%; overflow-y: scroll;" align="center">
...
<br>
<div style="width:90%;" align="right"><input name="print" type="button" value="Print" id="print" onClick="PrintElem('#display');">&nbsp;<input name="export" type="button" value="Export" id="btnExport" onClick="exporttocsv();" ></div><br>
...
function show_employeewise()
{
	...
	if(type != 'custom')
		GenericAjaxFunction('product_skuwise_data.php?type='+type,'display',0);
	else 
	{
		if(response1 != 0 && response2 != 0)
			GenericAjaxFunction('product_skuwise_data.php?type='+type+'&start_date='+start_date+'&end_date='+end_date,'display',0);
	}
}
