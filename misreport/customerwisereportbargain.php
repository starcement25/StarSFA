...
function Popup(data) 
{
	var mywindow = window.open('', 'Customerwise Bargain Report', 'height=400,width=600');
	mywindow.document.write('<html><head><title>Customerwise Bargain Report</title>');
...
function exporttocsv(divid)
{
	//alert(divid);
        ...
        a.download = 'Customerwise Bargain Report' + postfix + '.xls';
...
<center>
<div style="width:95%; text-align:right;"><strong></strong></div><br>
...
function show_saudawise()
{
	...
	if(type != 'custom')
		GenericAjaxFunction('customerwisedatabargain.php?type='+type,'display',0);
	else 
	{
		if(response1 != 0 && response2 != 0)
			GenericAjaxFunction('customerwisedatabargain.php?type='+type+'&start_date='+start_date+'&end_date='+end_date,'display',0);
	}
}
...
function show_customerdata_datewise(customer_code, customer_name, emp_code, condition_value, start_date, end_date)
{
	...
	document.getElementById("product").innerHTML = '<img src="ajax-loader.gif" id="ajaxloader">';
	GenericAjaxFunction('customer_data_datewise_bargain.php?customer_code='+customer_code+'&customer_name='+customer_name+'&emp_code='+emp_code+'&condition_value='+condition_value+'&start_date='+start_date+'&end_date='+end_date,'product',0);
}
...
function show_empdata(emp_code, condition_value, start_date, end_date){
	...
	GenericAjaxFunction('customerwisedatabargain.php?emp_code='+emp_code+'&condition_value='+condition_value+'&start_date='+start_date+'&end_date='+end_date,'customerdata',0);
	document.getElementById("product").innerHTML = "";
	document.getElementById("customerwise").innerHTML = '';
}
