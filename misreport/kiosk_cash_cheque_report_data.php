...
$res_kiosk_details = mysqli_query($link,$sql_kiosk_details);
$count_kiosk_details=mysqli_num_rows($res_kiosk_details);
...
//if(!empty($date_array)){
    ...
    <?php
	$count=1;
	while($row_kiosk_details = mysqli_fetch_assoc($res_kiosk_details)){
