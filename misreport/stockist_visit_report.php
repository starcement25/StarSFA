...
<center>
	<span style="font-weight:bold; font-size:14px;">Stockist Visit Report</span><br><br>
    ...
    <br /> <br />
        <div id="display" style="max-height: 450px; width:80%; overflow-y: scroll;" align="center"></div><br />
	...
	function display_result(){
		...
		GenericAjaxFunction('stockist_visit_report_data.php?employee='+employee+'&start_date='+start_date+'&end_date='+end_date,'display',0);
	}
	...
	function Popup(data) 
	{
		var mywindow = window.open('', 'Stockist Visit Report', 'height=400,width=600');
		mywindow.document.write('<html><head><title>Kilometer Reading Report</title>');
	...
	function exporttocsv(divid)
	{
		...
		a.download = 'Stockist Visit Report' + postfix + '.xls';
