...
<form action="generate_pricing_details_formulationSF-testing.php" name="pricing_details" onSubmit="return validation();" method="post">
...
function validation()
{
	...
	for (i = 0; i < x.length; i++) {
	  ...
	  if ((x[i].value.search(/\S/) == -1) || isNaN(x[i].value)) {
		 //alert(x[i].value);
