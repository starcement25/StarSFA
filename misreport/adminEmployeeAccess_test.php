...
<script type="text/javascript" src="ajax1.js"></script>
	...
	if(strtoupper($_SESSION['nick_name'])=='RKBK')
	{
		...
		$sql_count ="SELECT COUNT(EM.emp_code) FROM employee_master EM,changepassword CH WHERE CH.emp_code=EM.emp_code AND 
					EM.app_access='Y' ".$emp_hierarchy_condition_one."";		
	}
	else
	{
	/*$sql_count = "SELECT COUNT(EM.emp_code) FROM employee_master EM,changepassword CH WHERE CH.emp_code=EM.emp_code 
	 ...
	 $sql_count = "SELECT COUNT(EM.emp_code) FROM employee_master EM,changepassword CH WHERE CH.emp_code=EM.emp_code 
				AND EM.app_access='Y' AND EM.emp_code<>'C0007'";			
	}
	...
	if(strtoupper($_SESSION['nick_name'])=='RKBK')
	{
		...
		$sql="SELECT EM.* FROM employee_master EM,changepassword CH WHERE CH.emp_code=EM.emp_code AND EM.app_access='Y' 
		...
		$row=mysqli_fetch_assoc(mysqli_query($link,"SELECT COUNT(EM.emp_code) FROM employee_master EM,changepassword CH WHERE CH.emp_code=EM.emp_code 
				AND EM.app_access='Y' ".$emp_hierarchy_condition_one." ORDER BY EM.emp_code ASC"));		
	}
	else
	{
	 /*$sql="SELECT EM.* FROM employee_master EM,changepassword CH WHERE CH.emp_code=EM.emp_code AND 
	 ...
	 $sql="SELECT EM.* FROM employee_master EM,changepassword CH WHERE CH.emp_code=EM.emp_code AND EM.app_access='Y' AND EM.emp_code<>'C0007' 
	...
	/*$row=mysqli_fetch_assoc(mysqli_query($link,"SELECT COUNT(EM.emp_code) FROM employee_master EM,changepassword CH WHERE CH.emp_code=EM.emp_code 
	 ...
	 $row=mysqli_fetch_assoc(mysqli_query($link,"SELECT COUNT(EM.emp_code) FROM employee_master EM,changepassword CH WHERE CH.emp_code=EM.emp_code 
		AND EM.app_access='Y' AND EM.emp_code<>'C0007' ORDER BY EM.emp_code ASC"));	
	}
	$count=$row[0];
	//echo $sql;
...
<div id="display_main" style="max-height: 400px; width:100%; overflow-y: scroll;" align="center">
		...
		<td valign="top" bgcolor="#FFFFFF">
			...
			<table width="50%" align="center" class="border" cellpadding="5" cellspacing="2">
                ...
                <tr>
                    ...
                    <option value="1"  <?php if($is_licensed=='1'){ echo 'selected';}?>>unblocked</option>
                    <option value="0" <?php if($is_licensed=='0'){ echo 'selected';}?>>blocked</option>
                    </select>
                    </td>
				</tr>
				<tr>
