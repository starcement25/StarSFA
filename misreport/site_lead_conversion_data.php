...
if($total_rows>0){
    ...
    <table border="1" style="border-collapse:collapse;" class="border" width="90%">
      ...
      <tr class="TDHEAD">
        ...
        <td width="3%">Source of Pucrchare Dealer/ RSSD(Name)</td>
        <td width="3%">Customer Code</td>
        <td width="3%">If 'No' Reasons for non-conversion</td>
        <td width="3%">If Other Remarks with appropriate reason</td>
		...
		<td width="3%">Name of the OTHER Brand</td>  
        <td width="3%">Price Per Bag (RSP)</td>
		 <td width="3%">Consumed Till Date (No. of Bags)</td>
		<td width="3%">Estimated Requirement (No. of Bags)</td>
		 <td width="3%">Meeting Person</td>
		 <td width="3%">Decision Maker</td>
		 <td width="3%">Product Demo</td>
		 <td width="3%">OVERALL REMARKS</td>
