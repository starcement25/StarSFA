...
$count = 1;
	foreach($customerwise_booked_mt as $customerwiseindex=>$customerwiseval){
		...
		$sql_check_emp_customer = "SELECT customer_code FROM sauda_header WHERE customer_code = '".$customer_code_name[1]."' AND (SUBSTRING(sauda_no,-14,8) BETWEEN ".$start_date." AND ".$end_date.")";
