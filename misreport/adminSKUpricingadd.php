...
function add_pricing_data($dns_prod_code)
{
	...
	$error_array=array();
		...
		$rowproddetails=mysqli_num_rows($rsproddetails);
                ...
                <td align="left" width="20%"  valign="top" class="tbllogin">Base Oil Formulation<font color="#FF0000"><strong>*</strong></font>&nbsp;&nbsp;</td>
                  ...
                  <td align="left" valign="top"><div style="max-height:200px; overflow-y: scroll;">
                    <table cellpadding="5" cellspacing="2">
                        ...
                        $rsbaseoils=mysqli_query($link,$sqlbaseoils);
                        while($rowbaseoils=mysqli_fetch_assoc($rsbaseoils))
                        {
	...
	$dns_prod_code= $_REQUEST['dns_prod_code'];
		if($_REQUEST['prod_type']=='parent')
		{
			if($_POST['baseoils_new']!='')
			{
				...
				if(mysqli_query($link,$sqlinsertbaseoil))
				{
					$sqloilformulationins  = "insert into loose_oilrate_formulation SET ";
					$sqloilformulationins .= "  plant_name='Bhiwadi'";
					$sqloilformulationins .= " , prod_code='".mysqli_real_escape_string($dns_prod_code)."'";
					$sqloilformulationins .= " , oils='".mysqli_real_escape_string($_POST['baseoils_new'])."'";
					$sqloilformulationins .= " , formulation='".mysqli_real_escape_string($_POST['baseformulation_new'])."'";
					...
					mysqli_query($link,$sqloilformulationins) or die(mysqli_error().".Internal error occur	in oilrate formulation base oil.Please check.");
		...
		$cntoilsval=0;
			...
			foreach($baseoil_formulation_array as $baseoil_val)
			{
				...
				if($_POST['baseoils_'.$baseoil_val_post]==$baseoil_val)
				{
					$baseformulation=$_POST['baseformulation_'.$baseoil_val_post];
						...
						$sqlbaseoilformulation .= " , prod_code='".mysqli_real_escape_string($dns_prod_code)."'";
						$sqlbaseoilformulation .= " , oils='".mysqli_real_escape_string($baseoil_val)."'";
						$sqlbaseoilformulation .= " , formulation='".mysqli_real_escape_string($baseformulation)."'";
						...
						mysqli_query($link,$sqlbaseoilformulation) or die(mysqli_error().".Internal error occur	in base oilrate formulation.Please check.");
				}
			}
			if($_POST['processoils_new']!='')
			{
				...
				$sqloilformulationporcess .= " , prod_code='".mysqli_real_escape_string($dns_prod_code)."'";
				$sqloilformulationporcess .= " , oils='".mysqli_real_escape_string($_POST['processoils_new'])."'";
				...
				mysqli_query($link,$sqloilformulationporcess) or die(mysqli_error().".Internal error occur	in oilrate formulation new process cost.Please check.");
				
				if($_POST['process_cost_new']!='')
				{
					$sqlprocessnew  = "insert into process_cost SET ";
					$sqlprocessnew .= "  oil_type='".mysqli_real_escape_string($_POST['processoils_new'])."'";
					$sqlprocessnew .= " , oil_category=''";
					$sqlprocessnew .= " , process_cost='".mysqli_real_escape_string($_POST['process_cost_new'])."'";
					...
					mysqli_query($link,$sqlprocessnew) or die(mysqli_error().".Internal error occurrs in Process cost new.Please check.");
				}
		...
		mysqli_query($link,$sqlprodupdate);
