...
<table cellpadding="4px">
  ...
  <!-- From Date and To Data Selection -->
  <tr>
  	<td align="right" width="25%">From Date:</td>
	<td align="left"><input type="date" name="from_date" id="from_date" value="" /></td>
	  </tr>
	  <tr>
	<td align="right" width="25%">To Date:</td>
	<td align="left"><input type="date" name="to_date" id="to_date" value="" /></td>
	  </tr>
  <tr >
  	<td></td>
    <td align="left"><input name="submit" type="button" value="Submit" id="submitdata" onClick="get_data();" ></td>
...
function get_data(){
	...
	if(document.getElementById("month_select").value.search(/\S/) == -1 && (document.getElementById("from_date").value.search(/\S/) == -1 || document.getElementById("to_date").value.search(/\S/) == -1)){
		alert('Provide month');
		return false;
	}
	...
	if(from_date!='' && to_date!='') {
		...
		GenericAjaxFunction('site_visit_report_data_modified_mz.php?emp_code='+valsemp+'&start_date='+start_date+'&end_date='+end_date,'display',0);
		// print url
		alert('site_visit_report_data_modified_mz.php?emp_code='+valsemp+'&start_date='+start_date+'&end_date='+end_date);
	}
	else{
		GenericAjaxFunction('site_visit_report_data_modified_mz.php?emp_code='+valsemp+'&month='+month,'display',0);
	}
}
</script>
<?php } ?>