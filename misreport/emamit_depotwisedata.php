...
{
  $sql_depot = "SELECT BM.branch_code, BM.branch_name FROM branch_master BM, sauda_transaction_log STL WHERE BM.branch_code=STL.branch_code AND SUBSTRING(STL.sauda_no,3,5)='".$row_emp['emp_code']."' ".$sauda_booked_condition." GROUP BY STL.branch_code";
