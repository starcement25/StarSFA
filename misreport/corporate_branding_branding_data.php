...
$sql_distinct_date = "SELECT DISTINCT survey_id, SUBSTRING(survey_id,3,5) AS emp_code,DATE_FORMAT(SUBSTRING(survey_id,-14,8),'%Y-%m-%d') AS survey_date,
					...
					AND SUBSTRING(survey_id,3,5) IN(".$employee.")  AND type = 'Corporate Branding'  
...
if($total_rows>0){
	?>
        <form action="corporate_branding_account.php" method="post">
    ...
    <table border="1" style="border-collapse:collapse;" class="border" width="90%">
      ...
      <tr class="TDHEAD">
		...
		<td width="5%">Shop/Dhaba Name/Wall Number</td>  
	...
	while($row_survey_ouput = mysqli_fetch_assoc($res_survey_output)){
		...
		/*echo "<tr>
			<td colspan='16' align='right' height=\"30\"><input type='submit' name='SUBMIT1' value='SUBMIT' /></td>
			</tr>";*/
	}
	else{
		echo "<tr><td colspan='16' align='center'>No Records</td><tr>";
	}
	?>
    </table>
    <br />
