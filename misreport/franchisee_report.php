...
<center>
	<span style="font-weight:bold; font-size:14px;">FRANCHISEE REPORT</span><br><br>
    <table class="border" width="40%" style="border-collapse:collapse;" cellpadding="6px">
      <tr class="TDHEAD_SUB">
        ...
        <?php
		$sql_emp = "SELECT emp_code, emp_name FROM employee_master WHERE acedns = 'Y' and designation='Business Owner' ".$emp_hierarchy_value_condition." ORDER BY emp_name ASC";
	...
	function display_result(){
		...
		GenericAjaxFunction('franchisee_report_data.php?employee='+employee+'&start_date='+start_date+'&end_date='+end_date,'display',0);
	}
	...
	function Popup(data) 
	{
		var mywindow = window.open('', 'FRANCHISEE REPORT', 'height=400,width=600');
		mywindow.document.write('<html><head><title>FRANCHISEE REPORT</title>');
	...
	function exporttocsv(divid)
	{
		...
		a.download = 'FRANCHISEE REPORT' + postfix + '.xls';
