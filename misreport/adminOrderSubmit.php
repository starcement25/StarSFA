		...
		<td valign="top" bgcolor="#FFFFFF">
			...
			<table width="65%" align="center" class="border" cellpadding="5" cellspacing="2">
              ...
              <?php
				...
				$resultcatalogue = mysqli_query($link,$sqlcatalogue);
				$countcatalogue=mysqli_num_rows($resultcatalogue);
				if($countcatalogue>0){
					$rowcatalogue = mysqli_fetch_assoc($resultcatalogue);
				...
				$resultscheme = mysqli_query($link,$sqlscheme);
				$countscheme=mysqli_num_rows($resultscheme);
				if($countscheme>0){
               ...
               <tr id="remarks_tr" >
                ...
                <tr id="remarks_tr" >
				 ...
				 <?php //echo $scheme;
					...
					$rscheckscheme=mysqli_query($link,$sqlcheckscheme);
					while($rowcheckscheme=mysqli_fetch_assoc($rscheckscheme))
					{
				 ?>
