...
<body onLoad="GenericAjaxFunction('saudatestnew.php','display',0);">
...
function updatedata()
{
	   ...
	   GenericAjaxFunction('saudatestnew.php','display',0);
}
...
{
	GenericAjaxFunction('saudatestnew.php?search_empl_name='+empl_name_value,'display',0);
}
