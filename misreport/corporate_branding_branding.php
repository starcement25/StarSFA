...
function main(){
   ...
   <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js"></script>
	...
	echo "<span style=\"font-weight:bold; font-size:14px;\">Corporate Branding for Branding</span><br><br>";
	...
	function display_result(){
		...
		GenericAjaxFunction('corporate_branding_branding_data.php?employee='+employee+'&start_date='+start_date+'&end_date='+end_date+'&zone='+zone+'&state='+state+'&branch='+branch+'&department='+department,'display',0);
	...
	function Popup(data) 
	{
		var mywindow = window.open('', 'Corporate Branding Branding', 'height=400,width=600');
	...
	function exporttocsv(){
			...
			var report_name = 'Corporate Branding Branding';
			var dt = new Date();
			var day = dt.getDate();
