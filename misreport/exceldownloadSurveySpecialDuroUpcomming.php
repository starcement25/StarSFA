...
?>
    <?php if (strtoupper($_SESSION['nick_name']) != 'DURO') { ?>
        ...
        function excelDownload()
        {
            ...
            if ($survey_type == 'no') {
                if ($survey_menu == 'yes') {
                    $sql_get_menu = "SELECT layout_name,menu_id,survey_sub_menu FROM survey_input_upcoming WHERE type='menu'  ORDER BY display_order ASC";
                    ...
                    while ($row_get_menu = mysqli_fetch_assoc($res_get_menu)) {
                        ...
                        ${'excelheader' . $menu_id} = '' . "\t" . '' . "\t" . '' . "\t" . "\t" . "\t";
                        if(strtoupper($_SESSION['nick_name']) == 'DURO'){
                            ${'excelsubheader' . $menu_id} = 'Sr. No' . "\t" . 'Unique Store ID' . "\t" . 'Emp Name' . "\t" .'Branch'. "\t" . 'Survey Date' . "\t" . 'Lattitude' . "\t" . 'Longitude' . "\t";
                        }else{
                        ...
                        $sql_get_display = "SELECT display_name,row_id,action,display_order FROM survey_input_upcoming WHERE  type!='menu' AND menu_id='" . $menu_id . "'  AND acedns='Y'
						...
						if($action!='')
						{
                            ...
                            } else if (strtoupper($_SESSION['nick_name']) == 'DURO' && $menu_id == 'RA163') {
                                $display_order = $row_get_display['display_order'];
                                if ($display_id == 'RA164') {
                                    ${'display_order' . $display_id} = $row_get_display['display_order'];
                                    ${'excelsubheader' . $menu_id} .= $display_name . "\t" . '' . "\t" . '' . "\t" . '' . "\t" . '' . "\t";
                                    ${'excelsubheader_one' . $menu_id} .= "\t" . 'Name' . "\t" . 'Location' . "\t" . 'Date' . "\t" . '' . "\t" . '' . "\t";
                                } else if ($display_id == 'RA085') {
                                    ${'excelsubheader' . $menu_id} .= $display_name . "\t" . 'Name' . "\t";
                                    ${'excelsubheader_one' . $menu_id} .= '' . "\t";
                                    ${'excelblankcontent' . $menu_id} .= '' . "\t";
                            ...
                            } else if (strtoupper($_SESSION['nick_name']) == 'DURO' && $menu_id == 'RA196') {
                                if ($display_id == 'RA197') {
                                    ${'excelsubheader' . $menu_id} .= 'Firm Name' . "\t" . 'Location' . "\t". 'Date' . "\t";
                                } else {
                                    ${'excelsubheader' . $menu_id} .= $display_name . "\t";
                                }
                            } else {
                        ...
                        while ($row_survey_output = mysqli_fetch_assoc($rs_survey_output)) {
                            ...
                            if (!in_array($survey_id, ${'survey_id_array' . $menu_id})) {
                                $sqllatlong = "SELECT EM.emp_name,EM.branch_code,LO.latt,LO.longi FROM location LO,employee_master EM 
								...
								${'sl_no'.$survey_id}=${'sl_no' . $menu_id};
                                ${'sl_no' . $menu_id}++;
                            }
                            $sqlmasterview = "SELECT type,display_table_name,insert_table_detail FROM survey_input_upcoming WHERE  row_id='" . $row_survey_output['row_id'] . "'";
                            ...
                            /*if($row_survey_output['row_id']=='RA003')
					{
						...
						$value=$valueparts[0];
                            ...
                            if (strtoupper($_SESSION['nick_name']) == 'DURO') {
                                ...
                                if ($row_survey_output['row_id'] == 'RA016' || $row_survey_output['row_id'] == 'RA017' || $row_survey_output['row_id'] == 'RA096' || $row_survey_output['row_id'] == 'RA097') {
                                    ...
                                    if(strtoupper($_SESSION['nick_name']) == 'DURO'){
                                        ...
                                        if (strpos($value, ":") !== false) {
                                            $valueparts = explode(":", $value);
                                            $value = $valueparts[1];
                                            $sql_empname = "SELECT customer_name FROM customer_master WHERE customer_code = '" . $value . "'";
                                        $res_empname = mysqli_query($link,$sql_empname);
                                        $row_empname = mysqli_fetch_assoc($res_empname);
                                        $emp_name = $row_empname['customer_name'];
                                        $value = $emp_name;
                                        } else {
                                            $valueparts = explode(";", $value);
                                        $value = $valueparts[0];
                                ...
                                }else if ($row_survey_output['row_id'] == 'RA197' || $row_survey_output['row_id'] == 'RA164') {
                                    $fir_n = "";
                                    $loc = "";
                                    $dat = "";
                                    $valueparts = explode("$", $value);
                                    $fld = "";
                                    foreach ($valueparts as $x) {
                                      ...
                                      $loc = $ld[0];
                                      $dat = $ld[1];
                                      $fld = $fld . "".$fir_n . "\t" .$loc . "\t" .$dat . "\t";
                                    }

                                    //$value=$valueparts[0].' - '.$f_type;
                                    $value = $fld;
                                }
                                else if ($row_survey_output['row_id'] == 'RA159' || $row_survey_output['row_id'] == 'RA230' || $row_survey_output['row_id'] == 'RA059') {
                                    $fir_n = "";
                                    $loc = "";
                                    $dat = "";
                                    $valueparts = explode("$", $value);
                                    ...
                                    foreach ($valueparts as $x) {
                                      ...
                                      $loc = $ld[0];
                                      $dat = $ld[1];
                                      $fld = $fld . "".$fir_n . " Qty-" .$loc . " Value-" .$dat . " Thickness -".$ld[2]. "/";
                                    }

                                    //$value=$valueparts[0].' - '.$f_type;
                                    $value = $fld;
                                }
                                else if ($row_survey_output['row_id'] == 'RA210' || $row_survey_output['row_id'] == 'RA015') {
                                    $fir_n = "";
                                    $loc = "";
                                    $dat = "";
                                    $valueparts = explode("$", $value);
                                ...
                                } else if ($row_survey_output['row_id'] == 'RA0590' && $value != '') {
                                    ...
                                    foreach ($product_cat_first_part as $product_cat_first_part_val) {
                                        ...
                                        if ($countfirstpart > 1) {
                                            ...
                                            //echo 'aaaaaaaaaaaaaaaaa'; FOR catecory repeated value
											$sqlsurveyotherval = "SELECT row_id,value FROM survey_output WHERE row_id IN('RA071','RA116','RA117','RA118') AND survey_id='".$survey_id."'";
								            $ressurveyotherval = mysqli_query($link,$sqlsurveyotherval);
											  while($rowsurveyotherval = mysqli_fetch_assoc($ressurveyotherval)){
												$row_id_otherval = $rowsurveyotherval['row_id'];
												$value_otherval = $rowsurveyotherval['value'];
												${'valueexcel_prod_category' . $survey_id . $menu_id . $row_id_otherval}=$value_otherval;
											}
								          
                                            ${'valueexcel' . $survey_id . $menu_id . $row_survey_output['row_id']} .=${'valueexcel_prod_category' . $survey_id . $menu_id . 'RA071'}."\t".${'valueexcel_prod_category' . $survey_id . $menu_id . 'RA116'}."\t".${'valueexcel_prod_category' . $survey_id . $menu_id . 'RA117'}."\t".${'valueexcel_prod_category' . $survey_id . $menu_id . 'RA118'}."\n" . ${'sl_no'.$survey_id} . "\t" . $survey_id . "\t" . $emp_name . "\t" . $emp_branch_name . "\t" . $survey_date . "\t" . $lattitude . "\t" .$longitude;
											
											 $row_id_string_SET_array=explode(",",$row_id_string_SET);
											foreach($row_id_string_SET_array as $row_id_string_SET_val){
												if($row_id_string_SET_val!='RA071' && $row_id_string_SET_val!='RA116' && $row_id_string_SET_val!='RA117' && $row_id_string_SET_val!='RA118'){
												${'valueexcel' . $survey_id . $menu_id . $row_survey_output['row_id']} .= "\t" . ${'valueexcel_prod_category' . $survey_id . $menu_id . $row_id_string_SET_val};
												}
											}
                                        }
                                 ...
                                 else if ($row_survey_output['row_id'] == 'RA164' && $value == '') {
                                    $value = '' . "\t" . '' . "\t" . '';
                                }
                                else if ($row_survey_output['row_id'] == 'RA16400' && $value != '') {
                                    $product_cat_first_part = explode("$", $value);
                                    
                                    $fld = "";
                                    foreach ($product_cat_first_part as $x) {
                            ...
                            ${'valueexcel' . $survey_id . $menu_id} .= $value . "\t";
							 if (strtoupper($_SESSION['nick_name']) == 'DURO' && $menu_id == 'RA002') {
								 ${'valueexcel_prod_category' . $survey_id . $menu_id . $row_survey_output['row_id']}=$value;
							 }
                    ...
                    if (strtoupper($_SESSION['nick_name']) == 'SAI' || strtoupper($_SESSION['nick_name']) == 'SHAKTI') {
                        $sql_get_menu = "SELECT DISTINCT survey_sub_menu FROM survey_input_upcoming WHERE survey_sub_menu!='KYC' ORDER BY survey_sub_menu ASC";
                        $res_get_menu = mysqli_query($link,$sql_get_menu);
                        $count_menu = mysqli_num_rows($res_get_menu);
                        $menu_no = 1;
                        //$menu_id_array=array();
                        ...
                        while ($row_get_menu = mysqli_fetch_assoc($res_get_menu)) {
                            ...
                            //$sql_get_display="SELECT display_name,row_id,action FROM survey_input_upcoming WHERE type!='menu' AND menu_id='".$menu_id."' ORDER BY display_order ASC";
                            $sql_get_display = "SELECT display_name,row_id,action FROM survey_input_upcoming WHERE 
                    ...
                    //$sql_get_menu = "SELECT layout_name,menu_id FROM survey_input_upcoming WHERE type='menu' ORDER BY display_order ASC";
                    $sql_get_menu = "SELECT DISTINCT survey_sub_menu FROM survey_input_upcoming ORDER BY survey_sub_menu ASC";
                    $res_get_menu = mysqli_query($link,$sql_get_menu);
                    $count_menu = mysqli_num_rows($res_get_menu);
                    $menu_no = 1;
                    //$menu_id_array=array();
						 ...
						 $value = $valuearray[0];
                            ...
                            if (!in_array($survey_id, ${'survey_id_array' . $survey_sub_menu})) {
                                ...
                                if (strtoupper($_SESSION['nick_name']) == 'SUPERSHAKTI') {
                                    // Type
                                    $sqlType = "SELECT row_id FROM survey_input_upcoming WHERE survey_sub_menu='Site Visit' AND display_name='Type'";
                                    ...
                                    // Area
                                    $sqlArea = "SELECT row_id FROM survey_input_upcoming WHERE survey_sub_menu='Site Visit' AND display_name='Area'";
                                    ...
                                    // Name Of site
                                    $sqlNameOfSite = "SELECT row_id FROM survey_input_upcoming WHERE survey_sub_menu='Site Visit' AND display_name='Name Of Site'";
                                    ...
                                    // Address
                                    $sqlAddress = "SELECT row_id FROM survey_input_upcoming WHERE survey_sub_menu='Site Visit' AND display_name='Address'";
                                    ...
                                    // Nearest Dealer
                                    $sqlNearestDealer = "SELECT row_id FROM survey_input_upcoming WHERE survey_sub_menu='Site Visit' AND display_name='Nearest Dealer'";
...
//$sqlNearestDealerName = "SELECT customer_name FROM customer_master WHERE dealer_code='" . $nearest_dealer . "'";
                                    ...
                                    // Total TMT needed
                                    $sqlTotalTMTNeeded = "SELECT row_id FROM survey_input_upcoming WHERE survey_sub_menu='Site Visit' AND display_name='Total TMT needed'";
                                    ...
                                    // TMT brands in use
                                    $sqlTMTBrandsInUse = "SELECT row_id FROM survey_input_upcoming WHERE survey_sub_menu='Site Visit' AND display_name='TMT brands in use'";
                                    ...
                                    // Reason
                                    $sqlReason = "SELECT row_id FROM survey_input_upcoming WHERE survey_sub_menu='Site Visit' AND display_name='Reason'";
							...
							if($row_survey_output['row_id'] == 'RA003' || $row_survey_output['row_id'] == 'RA004' || $row_survey_output['row_id'] == 'RA005' || $row_survey_output['row_id'] == 'RA006' || $row_survey_output['row_id'] == 'RA007' || $row_survey_output['row_id'] == 'RA008' || $row_survey_output['row_id'] == 'RA009' || $row_survey_output['row_id'] == 'RA010' || $row_survey_output['row_id'] == 'RA011' || $row_survey_output['row_id'] == 'RA012'){
							
							if($value!=""){
							    $nim_total = $nim_total +  $value;
							}
							
							
							}
							
							if($row_survey_output['row_id'] == 'RA016'){
                ...
                $sql_get_menu = "SELECT layout_name,menu_id FROM survey_input_upcoming WHERE type='menu' AND survey_type='" . $survey_type . "' ORDER BY display_order ASC";
                $res_get_menu = mysqli_query($link,$sql_get_menu);
                $count_menu = mysqli_num_rows($res_get_menu);
                $menu_no = 1;
                $menu_id_array = array();
                ...
                while ($row_get_menu = mysqli_fetch_assoc($res_get_menu)) {
                    ...
                    // ${array_header.$menu_id}=array();
                    $sql_layer_check = "SELECT row_id FROM survey_input_upcoming WHERE type = 'layer'";
                    $res_layer_check = mysqli_query($link,$sql_layer_check);
                    $total_layer_check = mysqli_num_rows($res_layer_check);


                    $sql_get_layer = "SELECT layout_name,row_id FROM survey_input_upcoming WHERE type='layer' AND 
                    ...
                    while ($row_get_layer = mysqli_fetch_assoc($res_get_layer)) {
                        ...
                        $sql_get_display = "SELECT display_name,row_id,action FROM survey_input_upcoming WHERE layout_name='" . $layout_name . "' 
            ...
            //$sql_get_menu = "SELECT layout_name,menu_id FROM survey_input_upcoming WHERE type='menu' AND survey_type='".$survey_type."' ORDER BY display_order ASC";die;
        }
            ?>