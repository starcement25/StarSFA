...
function main(){
   ...
   <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js"></script>
	...
	echo "<span style=\"font-weight:bold; font-size:14px;\">Godown Timing Report</span><br><br>";
	...
	function display_result(){
		...
		GenericAjaxFunction('godown_timing_report_data.php?employee='+employee+'&start_date='+start_date+'&end_date='+end_date+'&zone='+zone+'&state='+state+'&branch='+branch+'&department='+department,'display',0);
	...
	function Popup(data) 
	{
		var mywindow = window.open('', 'Godown Timing Report', 'height=400,width=600');
