...
$res_outstanding_ageing = mysqli_query($link,$sql_outstanding_ageing);
$total_rows = mysqli_num_rows($res_outstanding_ageing);
$count = 1;
if($total_rows>0){
	?>
    ...
    <?php
	$res_outstanding_ageing = mysqli_query($link,$sql_outstanding_ageing);
	while($row_outstanding_ageing = mysqli_fetch_assoc($res_outstanding_ageing)){
