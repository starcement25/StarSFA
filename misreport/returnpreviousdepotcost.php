<?php
	...
	$rspreviousdepotcost=mysqli_query($link,$selectpreviousdepotcost);
	$countpreviousdepotcost=mysqli_num_rows($rspreviousdepotcost);
	if($countpreviousdepotcost >0)
	{
		$rowpreviousdepotcost=mysqli_fetch_assoc($rspreviousdepotcost);
