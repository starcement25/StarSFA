<?php
    ...
    //             ],
    //             [
    //                 "email" => "santoshmohanty@starcement.co.in",
    ...
    $to_emails = [
        "roe" => [
            "emails" => [
                "jayanta.mondal@sbinfowaves.com"
            ],
            "ccs" => [
                [
    ...
    foreach($reportsFor as $reportFor)
    {
        ...
        {  
            $competitorsQuery = 'SELECT NE_P_C.is_compared_with,NE_P_C.company_display_name
        ...
        {  
            $competitorsQuery = 'SELECT ROE_P_C.is_compared_with,ROE_P_C.company_display_name
                ...
                $marketFeedBacksQuery = "WITH aggregated_data AS (
                                        SELECT 
                                            ...
                                            FROM 
                                                market_feedback MF
                                            JOIN 
                                                customer_master CM ON MF.customer_code = CM.customer_code
                                            JOIN 
                                                employee_master EM ON SUBSTRING(MF.market_feedback_id, 3, 5) = EM.emp_code
                                            JOIN 
                                                route_master RM ON CM.route_code = RM.route_code
                                            JOIN 
                                                branch_master BM ON CM.branch_code = BM.branch_code
                                            WHERE 
        ...
        // Save to file instead of browser
