...
$header_id = "0";
	...
	while($row_summary = mysqli_fetch_assoc($rssissummary)){
		...
		$sqlsisheader="SELECT * FROM  SIS_summary_header_new WHERE header_id='".$header_id."'";
		//echo $sqlsisheader;
	...
	while($row_header = mysqli_fetch_assoc($rssisheader)){
	    ...
	    $parameter_3_5t=$row_header['parameter_3_5'];
	    ...
	    $h6_l1=$row_header['h6_l1'];
	    $h6_l2=$row_header['h6_l2'];
	    $h6_l3=$row_header['h6_l3'];
	    $h6_l4=$row_header['h6_l4'];
   ...
   <table class="border" width="100%">
    ...
    <table width="100%" style="border-collapse:collapse;" border="1"  cellpadding="2px">
      <tr class="TDHEAD" align="center">
        ...
        <td><?php echo $h6_l1; ?></td>
        <td><?php echo $h6_l2; ?></td>
        <td><?php echo $h6_l3; ?></td>
        <td><?php echo $h6_l4; ?></td>
