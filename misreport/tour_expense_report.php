...
<center><br />
<?php
	echo "<span style=\"font-weight:bold; font-size:14px;\">TOUR EXPENSE REPORT</span><br><br>";
...
function display_result(){
  ...
  GenericAjaxFunction('tour_expense_report_data.php?employee='+employee+'&start_date='+start_date+'&end_date='+end_date,'display',0);
	  ...
	  if(document.getElementById("employee").value.search(/\S/) == -1){
		...
		document.getElementById("display").innerHTML = '<img src="ajax-loader.gif" id="ajaxloader">';
	  GenericAjaxFunction('multi_tour_expense_report_data.php?employee='+employee+'&start_date='+start_date+'&end_date='+end_date,'display',0);
