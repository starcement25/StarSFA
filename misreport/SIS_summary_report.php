...
ORDER BY ANY_VALUE(SUBSTRING(trans_id, -14, 8)) ASC";
	...
	function display_result(){
		...
		GenericAjaxFunction('SIS_summary_report_data_new.php?employee='+employee+'&month_data='+month_data+'&zone='+zone+'&state='+state+'&branch='+branch+'&department='+department,'display',0);
