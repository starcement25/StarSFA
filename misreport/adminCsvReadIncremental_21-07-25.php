...

		{
...

			{
			  ...
			  //print_r($data);
				...
				echo $sqlchkcustomercode="SELECT customer_code FROM self_appraisal_customer_wise WHERE customer_code='".$dns_customer_code."'";
				$customer_code=$dns_customer_code;
				}
				else
				{
					...
					echo $sqlchkcustomercode="SELECT customer_code FROM self_appraisal_customer_wise WHERE customer_code='".$customer_code."'";
				}
...

					{
						...
						if(in_array('employee_master',$upload_master_table_array))
						{
						   ...
						   $sqlupdatetableinfo="UPDATE master_tables_update_info set need_update='yes',download_time_yes=CURRENT_TIMESTAMP()
							...
							$url="http://salesmpower.acedns.in/misreport/uploademployeesdataSTARSATHICURL.php";
...

						{
						   ...
						   mysqli_query($link,$sqlupdatetableinfo);
							...
							$url="https://salesmpower.acedns.in/misreport/uploadskudataSTARSATHICURL.php";
...

						{
						   ...
						   $sqlupdatetableinfo="UPDATE master_tables_update_info set need_update='yes',download_time_yes=CURRENT_TIMESTAMP()
							...
							$url="https://salesmpower.acedns.in/misreport/uploaddataSTARSATHICURL.php";
...

						{
						   ...
						   $sqlupdatetableinfo="UPDATE master_tables_update_info set need_update='yes',download_time_yes=CURRENT_TIMESTAMP()
							...
							$url="https://salesmpower.acedns.in/misreport/uploadtargetdataSTARSATHICURL.php";
				...
				// 			echo "Test Res:".$result;
...

						{
						   ...
						   $sqlupdatetableinfo="UPDATE master_tables_update_info set need_update='yes',download_time_yes=CURRENT_TIMESTAMP()
							...
							$url="https://salesmpower.acedns.in/misreport/uploadbrokerdataSTARSATHICURL.php";
						...
						if(in_array('pop_product',$upload_master_table_array))
						{
						   $sqlupdatetableinfo="UPDATE master_tables_update_info set need_update='yes',download_time_yes=CURRENT_TIMESTAMP()
							...
							$url="https://salesmpower.acedns.in/misreport/upload_pop_product_data_curl.php";
...

						{
						   ...
						   $sqlupdatetableinfo="UPDATE master_tables_update_info set need_update='yes',download_time_yes=CURRENT_TIMESTAMP()
							...
							$url="https://salesmpower.acedns.in/misreport/uploadcustomerbrokerdataSTARSATHICURL.php";
					...
					{
							$url="https://salesmpower.acedns.in/misreport/uploaddataSUPERSHAKTICURL.php";
							$ch = curl_init();
							//set the url, number of POST vars, POST data
							curl_setopt($ch,CURLOPT_URL, $url);
							curl_setopt($ch,CURLOPT_POST, 1);
