...
function csv_upload(){
	...
	if(similar_file_exists("../csv/$folderName/Employee master_skip.csv")!=false)
...

			{
			  ...
			  //print_r($data);
				...
				if($countchkcustomercode ==0)
				{
					...
					$sqlselfappraisal .= "   customer_code='".addslashes($customer_code)."'";
				$sqlselfappraisal .= " , apr_30_target='".addslashes($april_target)."'";
				$sqlselfappraisal .= " , apr_30_achievement='".addslashes($april_achievement)."'";
				$sqlselfappraisal .= " , apr_prev_y_target='".addslashes($april_prev_target)."'";
				$sqlselfappraisal .= " , apr_prev_y_achievement='".addslashes($april_prev_achievement)."'";
				$sqlselfappraisal .= " , may_31_target='".addslashes($may_target)."'";
				$sqlselfappraisal .= " , may_31_achievement='".addslashes($may_achievement)."'";
				$sqlselfappraisal .= " , may_prev_y_target='".addslashes($may_prev_target)."'";
				$sqlselfappraisal .= " , may_prev_y_achievement='".addslashes($may_prev_achievement)."'";
				$sqlselfappraisal .= " , jun_30_target='".addslashes($june_target)."'";
				$sqlselfappraisal .= " , jun_30_achievement='".addslashes($june_achievement)."'";
				$sqlselfappraisal .= " , jun_prev_y_target='".addslashes($june_prev_target)."'";
				$sqlselfappraisal .= " , jun_prev_y_achievement='".addslashes($june_prev_achievement)."'";
				$sqlselfappraisal .= " , jul_31_target='".addslashes($july_target)."'";
				$sqlselfappraisal .= " , jul_31_achievement='".addslashes($july_achievement)."'";
				$sqlselfappraisal .= " , jul_prev_y_target='".addslashes($july_prev_target)."'";
				$sqlselfappraisal .= " , jul_prev_y_achievement='".addslashes($july_prev_achievement)."'";
				$sqlselfappraisal .= " , aug_31_target='".addslashes($august_target)."'";
				$sqlselfappraisal .= " , aug_31_achievement='".addslashes($august_achievement)."'";
				$sqlselfappraisal .= " , aug_prev_y_target='".addslashes($august_prev_target)."'";
				$sqlselfappraisal .= " , aug_prev_y_achievement='".addslashes($august_prev_achievement)."'";
				$sqlselfappraisal .= " , sep_30_target='".addslashes($september_target)."'";
				$sqlselfappraisal .= " , sep_30_achievement='".addslashes($september_achievement)."'";
				$sqlselfappraisal .= " , sep_prev_y_target='".addslashes($september_prev_target)."'";
				$sqlselfappraisal .= " , sep_prev_y_achievement='".addslashes($september_prev_achievement)."'";
				$sqlselfappraisal .= " , oct_31_target='".addslashes($october_target)."'";
				$sqlselfappraisal .= " , oct_31_achievement='".addslashes($october_achievement)."'";
				$sqlselfappraisal .= " , oct_prev_y_target='".addslashes($october_prev_target)."'";
				$sqlselfappraisal .= " , oct_prev_y_achievement='".addslashes($october_prev_achievement)."'";
				$sqlselfappraisal .= " , nov_30_target='".addslashes($november_target)."'";
				$sqlselfappraisal .= " , nov_30_achievement='".addslashes($november_achievement)."'";
				$sqlselfappraisal .= " , nov_prev_y_target='".addslashes($november_prev_target)."'";
				$sqlselfappraisal .= " , nov_prev_y_achievement='".addslashes($november_prev_achievement)."'";
				$sqlselfappraisal .= " , dec_31_target='".addslashes($december_target)."'";
				$sqlselfappraisal .= " , dec_31_achievement='".addslashes($december_achievement)."'";
				$sqlselfappraisal .= " , dec_prev_y_target='".addslashes($december_prev_target)."'";
				$sqlselfappraisal .= " , dec_prev_y_achievement='".addslashes($december_prev_achievement)."'";
				$sqlselfappraisal .= " , jan_31_target='".addslashes($january_target)."'";
				$sqlselfappraisal .= " , jan_31_achievement='".addslashes($january_achievement)."'";
				$sqlselfappraisal .= " , jan_prev_y_target='".addslashes($january_prev_target)."'";
				$sqlselfappraisal .= " , jan_prev_y_achievement='".addslashes($january_prev_achievement)."'";
				$sqlselfappraisal .= " , feb_28_target='".addslashes($february_target)."'";
				$sqlselfappraisal .= " , feb_28_achievement='".addslashes($february_achievement)."'";
				$sqlselfappraisal .= " , feb_prev_y_target='".addslashes($february_prev_target)."'";
				$sqlselfappraisal .= " , feb_prev_y_achievement='".addslashes($february_prev_achievement)."'";

				$sqlselfappraisal .= " , mar_31_target='".addslashes($march_target)."'";
				$sqlselfappraisal .= " , mar_31_achievement='".addslashes($march_achievement)."'";
				$sqlselfappraisal .= " , mar_prev_y_target='".addslashes($march_prev_target)."'";
				$sqlselfappraisal .= " , mar_prev_y_achievement='".addslashes($march_prev_achievement)."'";
				...
				else
				{
					...
					$sqlselfappraisalupdate .= " apr_30_target='".addslashes($april_target)."'";

					$sqlselfappraisalupdate .= " , apr_30_achievement='".addslashes($april_achievement)."'";

					$sqlselfappraisalupdate .= " , apr_prev_y_target='".addslashes($april_prev_target)."'";

					$sqlselfappraisalupdate .= " , apr_prev_y_achievement='".addslashes($april_prev_achievement)."'";

					$sqlselfappraisalupdate .= " , may_31_target='".addslashes($may_target)."'";

					$sqlselfappraisalupdate .= " , may_31_achievement='".addslashes($may_achievement)."'";

					$sqlselfappraisalupdate .= " , may_prev_y_target='".addslashes($may_prev_target)."'";

					$sqlselfappraisalupdate .= " , may_prev_y_achievement='".addslashes($may_prev_achievement)."'";

					$sqlselfappraisalupdate .= " , jun_30_target='".addslashes($june_target)."'";

					$sqlselfappraisalupdate .= " , jun_30_achievement='".addslashes($june_achievement)."'";

					$sqlselfappraisalupdate .= " , jun_prev_y_target='".addslashes($june_prev_target)."'";

				    $sqlselfappraisalupdate .= " , jun_prev_y_achievement='".addslashes($june_prev_achievement)."'";

					$sqlselfappraisalupdate .= " , jul_31_target='".addslashes($july_target)."'";

					$sqlselfappraisalupdate .= " , jul_31_achievement='".addslashes($july_achievement)."'";

					$sqlselfappraisalupdate .= " , jul_prev_y_target='".addslashes($july_prev_target)."'";

				    $sqlselfappraisalupdate .= " , jul_prev_y_achievement='".addslashes($july_prev_achievement)."'";

					$sqlselfappraisalupdate .= " , aug_31_target='".addslashes($august_target)."'";

					$sqlselfappraisalupdate .= " , aug_31_achievement='".addslashes($august_achievement)."'";

					$sqlselfappraisalupdate .= " , aug_prev_y_target='".addslashes($august_prev_target)."'";

				    $sqlselfappraisalupdate .= " , aug_prev_y_achievement='".addslashes($august_prev_achievement)."'";

					$sqlselfappraisalupdate .= " , sep_30_target='".addslashes($september_target)."'";

					$sqlselfappraisalupdate .= " , sep_30_achievement='".addslashes($september_achievement)."'";

					$sqlselfappraisalupdate .= " , sep_prev_y_target='".addslashes($september_prev_target)."'";

				    $sqlselfappraisalupdate .= " , sep_prev_y_achievement='".addslashes($september_prev_achievement)."'";

					$sqlselfappraisalupdate .= " , oct_31_target='".addslashes($october_target)."'";

					$sqlselfappraisalupdate .= " , oct_31_achievement='".addslashes($october_achievement)."'";

					$sqlselfappraisalupdate .= " , oct_prev_y_target='".addslashes($october_prev_target)."'";

				    $sqlselfappraisalupdate .= " , oct_prev_y_achievement='".addslashes($october_prev_achievement)."'";

					$sqlselfappraisalupdate .= " , nov_30_target='".addslashes($november_target)."'";

					$sqlselfappraisalupdate .= " , nov_30_achievement='".addslashes($november_achievement)."'";

					$sqlselfappraisalupdate .= " , nov_prev_y_target='".addslashes($november_prev_target)."'";

					$sqlselfappraisalupdate .= " , nov_prev_y_achievement='".addslashes($november_prev_achievement)."'";

					$sqlselfappraisalupdate .= " , dec_31_target='".addslashes($december_target)."'";

					$sqlselfappraisalupdate .= " , dec_31_achievement='".addslashes($december_achievement)."'";

					$sqlselfappraisalupdate .= " , dec_prev_y_target='".addslashes($december_prev_target)."'";

					$sqlselfappraisalupdate .= " , dec_prev_y_achievement='".addslashes($december_prev_achievement)."'";

					$sqlselfappraisalupdate .= " , jan_31_target='".addslashes($january_target)."'";

					$sqlselfappraisalupdate .= " , jan_31_achievement='".addslashes($january_achievement)."'";

					$sqlselfappraisalupdate .= " , jan_prev_y_target='".addslashes($january_prev_target)."'";

					$sqlselfappraisalupdate .= " , jan_prev_y_achievement='".addslashes($january_prev_achievement)."'";

					$sqlselfappraisalupdate .= " , feb_28_target='".addslashes($february_target)."'";

					$sqlselfappraisalupdate .= " , feb_28_achievement='".addslashes($february_achievement)."'";

					$sqlselfappraisalupdate .= " , feb_prev_y_target='".addslashes($february_prev_target)."'";

					$sqlselfappraisalupdate .= " , feb_prev_y_achievement='".addslashes($february_prev_achievement)."'";

					$sqlselfappraisalupdate .= " , mar_31_target='".addslashes($march_target)."'";

					$sqlselfappraisalupdate .= " , mar_31_achievement='".addslashes($march_achievement)."'";

					$sqlselfappraisalupdate .= " , mar_prev_y_target='".addslashes($march_prev_target)."'";

					$sqlselfappraisalupdate .= " , mar_prev_y_achievement='".addslashes($march_prev_achievement)."'";
...

					{
...

						{
						   ...
						   $sqlupdatetableinfo="UPDATE master_tables_update_info set need_update='yes',download_time_yes=CURRENT_TIMESTAMP()
							...
							$url="https://sfa.starcement.co.in/misreport/uploadbranchdataSTARSATHICURL.php";
							...
							//print_r($branch_ins_fields_string);
