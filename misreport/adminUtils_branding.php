...
<?php
$sql_select_emp_name = "SELECT emp_name,sale_access FROM employee_master WHERE emp_code = '".$_SESSION['admin_login']."'";
...
$sale_access = $row_select_emp_name['sale_access'];
if($emp_name != '')
				...
				<tr>
                    <td class="menubar">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<!--td>
								<a href="branding_verification_with_location_modified.php" name="link60" id="link60" >Branding Verification</a>
                                </td-->
                                <?php if($sale_access=='Branding verification vendor'){?>
                                <td>
                                <a href="branding_verification_vendor.php">BV VENDOR</a>
                                </td>
                                <?php }
								else
								{
                                ...
                                <a href="branding_verification_vendor.php">BV VENDOR</a>
                                 ...
                                 <td>
                                <a href="branding_verification_account.php">BV ACCOUNT</a>
                                </td>
                                 <td>
                                <a href="branding_verification_branding.php">BV BRANDING</a>
                                </td>
                                <?php }?>
							</tr>
						</table>
