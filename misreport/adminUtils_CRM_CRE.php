...
if($_SESSION['nick_name']!='' || $_REQUEST['nick_name']!=''){
	...
	$rsstkaudit=mysqli_query($link,$sqlstkaudit,$linksetupadmin);
				...
				<tr>
                     <td class="menubar">
							...
							<tr>
								<td>
                                <?php
								 if(($_SESSION['designation'] == 'CRM') && (strtoupper($_SESSION['nick_name']) == 'HALDIRAM' || strtoupper($_SESSION['nick_name']) == 'PRABHUJI')){
								?>
                                <a href="customer_allocation_CRM.php">Retailer CRM</a>
                                <?php
								}if(($_SESSION['designation'] == 'CRE') && (strtoupper($_SESSION['nick_name']) == 'HALDIRAM' || strtoupper($_SESSION['nick_name']) == 'PRABHUJI')){
								?>
                                <td><a href="cre_verification_modified.php">Retailer CRE</a></td>
                                <td><a href="adminNewCustomerUnblocked.php">New Customer Activation</a></td>
                                <?php
								}?>
                                </td>
				 ...
				 if(($_SESSION['designation'] == 'CRM') && (strtoupper($_SESSION['nick_name']) == 'HALDIRAM' || strtoupper($_SESSION['nick_name']) == 'PRABHUJI')){
								?>
                                <td><a href="customer_report_CRM.php">CRM Report</a> </td>
                                <td><a href="state_allocation_CRM.php">State Allocation</a></td>
                                <td><a href="adminStateAllocationReport.php">State Allocation Report</a></td>
                                <?php
								}?>
							</tr>
						</table>
