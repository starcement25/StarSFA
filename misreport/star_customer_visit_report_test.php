...
function main(){
	...
	function display_result(){
		...
		GenericAjaxFunction('star_customer_visit_report_data_test.php?employee='+employee+'&month_data='+month_data+'&zone='+zone+'&state='+state+'&branch='+branch+'&department='+department,'display',0);
...
function exporttocsv(){
	...
	tab = document.getElementById('display_table_one'); // id of table
