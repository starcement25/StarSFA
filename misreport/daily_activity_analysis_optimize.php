...
<body onLoad="GenericAjaxFunction('daily_activity_analysis_data_optimize.php','display',0);">
<center>
...
function show_emp()
{
	...
	GenericAjaxFunction('daily_activity_analysis_data_optimize.php?start_date='+start_date,'display',0);
}
