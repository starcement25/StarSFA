...
function show_saudawise()
{
	...
	if(type != 'custom')
		GenericAjaxFunction('emamit_customerwisedata.php?type='+type,'display',0);
	else 
	{
		if(response1 != 0 && response2 != 0)
			GenericAjaxFunction('emamit_customerwisedata.php?type='+type+'&start_date='+start_date+'&end_date='+end_date,'display',0);
	}
}
...
function show_customerdata_datewise(customer_code, customer_name, emp_code, condition_value, start_date, end_date)
{
	...
	document.getElementById("product").innerHTML = '<img src="ajax-loader.gif" id="ajaxloader">';
	GenericAjaxFunction('emamit_customer_data_datewise.php?customer_code='+customer_code+'&customer_name='+customer_name+'&emp_code='+emp_code+'&condition_value='+condition_value+'&start_date='+start_date+'&end_date='+end_date,'product',0);
...
function show_customerdata(customer_name,product_name,condition_value,product_group_code,selected_date)
{
	...
	GenericAjaxFunction('emamit_customer_product_details.php?customer_name='+customer_name+'&product_group_code='+product_group_code+'&condition_value='+condition_value+'&product_name='+product_name+'&selected_date='+selected_date,'customerwise',0);
}
...
function show_empdata(emp_code, condition_value, start_date, end_date){
	...
	GenericAjaxFunction('customerwisedata.php?emp_code='+emp_code+'&condition_value='+condition_value+'&start_date='+start_date+'&end_date='+end_date,'customerdata',0);
	document.getElementById("product").innerHTML = "";
	document.getElementById("customerwise").innerHTML = '';
}
