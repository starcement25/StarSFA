...
function main(){
	...
	$hidden = "";
	echo "<center>";
	echo "<span style=\"font-weight:bold; font-size:14px;\">STOCK AUDIT</span><br><br>";
	...
	function display_result(){
		...
		GenericAjaxFunction('star_stock_audit_data.php?employee='+employee+'&start_date='+start_date+'&end_date='+end_date,'display',0);
	...
	function exporttocsv(divid)
	{
		//alert(divid);
			...
			a.download = 'Stock Audit Report' + postfix + '.xls';
			...
			var start_date = document.getElementById("start_date").value;
			var end_date = document.getElementById("end_date").value;
			window.open('star_stock_audit_data_export.php?employee='+employee+'&start_date='+start_date+'&end_date='+end_date,'mywindow')	;
	}
	</script>
    <?php
}
