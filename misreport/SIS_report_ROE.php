...
";
	...
	echo "<center>";
	echo "<span style=\"font-weight:bold; font-size:14px;\">SIS Report ROE</span><br><br>";
	...
	attribute_selection_ROE($hidden,$get_control);
	...
	function display_result(){
		...
		GenericAjaxFunction('SIS_report_ROE_data.php?employee='+employee+'&region='+region+'&month_data='+month_data+'&zone='+zone+'&state='+state+'&branch='+branch+'&department='+department,'display',0);
	...
	function Popup(data) 
	{
		var mywindow = window.open('', 'SIS Report ROE', 'height=400,width=600');
	...
	function exporttocsv(divid)
	{
		...
		a.download = 'SIS Report ROE' + postfix + '.xls';
