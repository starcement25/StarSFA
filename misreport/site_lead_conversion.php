...
function main(){
   ...
   <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js"></script>
	...
	echo "<span style=\"font-weight:bold; font-size:14px;\">Site Lead And Conversion</span><br><br>";
	...
	function display_result(){
		...
		GenericAjaxFunction('site_lead_conversion_data.php?employee='+employee+'&start_date='+start_date+'&end_date='+end_date+'&zone='+zone+'&state='+state+'&branch='+branch+'&department='+department,'display',0);
	...
	function Popup(data) 
	{
		var mywindow = window.open('', 'Site Lead and conversion', 'height=400,width=600');
		mywindow.document.write('<html><head><title>Site Lead and conversion</title>');
	...
	function exporttocsv(){
			...
			var report_name = 'Site Lead and conversion'
			var dt = new Date();
			var day = dt.getDate();
