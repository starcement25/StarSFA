...
if($_GET['prospect_code'])
{
	...
	$res_prospect_details = mysqli_query($link,$sql_prospect_details);
	$row_prospect_details = mysqli_fetch_assoc($res_prospect_details);
}
?>
...
<tr>
    ...
    <?php
		...
		$res_oil_used = mysqli_query($link,$sql_oil_used);
		while($row_oil_used = mysqli_fetch_assoc($res_oil_used))
		{
