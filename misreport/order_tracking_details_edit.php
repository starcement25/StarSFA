...
if($select_val == 'hold' || $select_val == 'spl permission'){
	...
	$total_no_products = mysqli_num_rows($res_order_details);
	...
	while($row_order_details = mysqli_fetch_assoc($res_order_details)){
		...
		$res_product_name = mysqli_query($link,$sql_product_name);
		$row_product_name = mysqli_fetch_assoc($res_product_name);
