<?php
	...
	$res_vertical_wise_data = mysqli_query($link,$sql_vertical_wise_data);
	$total_vertical_rows = mysqli_num_rows($res_vertical_wise_data);
	...
	if($total_vertical_rows>0)
	{
		...
		$count = 1;
		$res_vertical_wise_data = mysqli_query($link,$sql_vertical_wise_data);
		while($row_vertical_wise_data = mysqli_fetch_assoc($res_vertical_wise_data))
		{
	...
	$setCounter = mysqli_num_fields($setRec); //This Header is used to make data download instead of display the data 
