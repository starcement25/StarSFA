...
function show_saudawise()
{
	...
	if(type != 'custom')
		GenericAjaxFunction('emamit_plantwisedata.php?type='+type,'display',0);
	else 
	{
		if(response1 != 0 && response2 != 0)
			GenericAjaxFunction('emamit_plantwisedata.php?type='+type+'&start_date='+start_date+'&end_date='+end_date,'display',0);
	}
...
function show_depot_data_datewise(branch_code, branch_name, condition_value, start_date, end_date)
{
	document.getElementById("depotwise").innerHTML = '';
	document.getElementById("product").innerHTML = '<img src="ajax-loader.gif" id="ajaxloader">';
	GenericAjaxFunction('emamit_depot_data_datewise.php?branch_code='+branch_code+'&branch_name='+branch_name+'&condition_value='+condition_value+'&start_date='+start_date+'&end_date='+end_date,'product',0);
}
...
function show_depotdata(branch_name,product_name,condition_value,product_group_code,selected_date)
{
	...
	GenericAjaxFunction('emamit_customer_product_details.php?branch_name='+branch_name+'&product_group_code='+product_group_code+'&condition_value='+condition_value+'&product_name='+product_name+'&selected_date='+selected_date,'depotwise',0);
}
...
function show_plant_branch(plant_name, condition_value, start_date, end_date){
	...
	document.getElementById("depotwise").innerHTML = '';
	document.getElementById("product").innerHTML = '';
	GenericAjaxFunction('emamit_plantwisebranchdata.php?plant_name='+plant_name+'&condition_value='+condition_value+'&start_date='+start_date+'&end_date='+end_date,'branch',0);
}
