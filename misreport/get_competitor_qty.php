...
(
    ...
    WHERE emp_code IN ($employee_hierarchy) AND customer_route_emp_relation.acedns='Y'
) c1
...
*/
    $sql = "
        ...
        (
            ...
            /* =========================================================
            CASE 1 : competitor_quantity DATA EXISTS
            ========================================================= */
            ...
            /* =========================================================
            CASE 2 : NO competitor_quantity DATA
            ========================================================= */
            ...
            (
                ...
                ON cq_check.customer_code = c.customer_code

            WHERE
                cq_check.customer_code IS NULL
                AND c.customer_name != ''
