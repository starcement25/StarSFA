...
<table width="40%" border="1" style="border-collapse:collapse;" cellpadding="8">
  ...
  <tr class="TDHEAD_SUB">
	...
	$res_check_designation = mysqli_query($link,$sql_check_designation);
	while($row_check_designation = mysqli_fetch_assoc($res_check_designation)){
  ...
  <tr class="TDHEAD_SUB">
   ...
   <tr class="TDHEAD_SUB">
	...
	$res_check_zone = mysqli_query($link,$sql_check_zone);
	while($row_check_zone = mysqli_fetch_assoc($res_check_zone)){
  ...
  <tr class="TDHEAD_SUB">
	...
	$res_check_region = mysqli_query($link,$sql_check_region);
	while($row_check_region = mysqli_fetch_assoc($res_check_region)){
   ...
   <tr class="TDHEAD_SUB">
	...
	$res_check_division = mysqli_query($link,$sql_check_division);
	while($row_check_division = mysqli_fetch_assoc($res_check_division)){
...
<tr class="TDHEAD_SUB">
	...
	$res_check_ccc = mysqli_query($link,$sql_check_ccc);
	while($row_check_ccc = mysqli_fetch_assoc($res_check_ccc)){
  ...
  <tr class="TDHEAD_SUB" id="otherccc" style="display:none">
    ...
    <tr class="TDHEAD_SUB">
       ...
       /* $sql_check_kiosk="SELECT  DISTINCT dns_customer_code FROM customer_master ORDER BY dns_customer_code ASC";
        $res_check_kiosk = mysqli_query($link,$sql_check_kiosk);
        while($row_check_kiosk = mysqli_fetch_assoc($res_check_kiosk)){
  ...
  <tr class="TDHEAD_SUB">
	...
	$res_get_emp = mysqli_query($link,$sql_get_emp);
	while($row_get_emp = mysqli_fetch_assoc($res_get_emp)){
