                        ...
                        while ($row_survey_output = mysqli_fetch_assoc($rs_survey_output)) {
						 ...
						 $value = $valuearray[0];
                            ...
                            if (!in_array($survey_id, ${'survey_id_array' . $survey_sub_menu})) {
                                ...
                                if (strtoupper($_SESSION['nick_name']) == 'SUPERSHAKTI' && $survey_sub_menu=='Site Visit_') {
                                    // Type
                                    ...
                                    $nearest_dealer_name =
                                    $rowNearestDealerValue['value'];//$rowNearestDealerName['customer_name'];
                            ...
                            if (strtoupper($_SESSION['nick_name']) == 'SUPERSHAKTI') {
                                ...
                                if ($row_survey_output['row_id'] == 'RA034' || $row_survey_output['row_id'] == 'RA012' || $row_survey_output['row_id'] == 'RA013' || $row_survey_output['row_id'] == 'RA014' ) {
                                    if ($value != '') {
                                        $imageval = $value;
                                        $imageval = ltrim($imageval, " ");
                                        $imageval = rtrim($imageval, " ");
                                        ...
                                        foreach ($site_image_array as $image) {
                                            ...
                                            if ($image != '') {
                                                ...
                                                $value = "http://demo.acedns.in/upload/" . strtoupper($_SESSION['nick_name']) . "/" . $image;
                                            }
                                        }
                                    } else {
                                        $value = $value;
