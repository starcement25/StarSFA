...
function main(){
   ...
   <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js"></script>
	...
	echo "<span style=\"font-weight:bold; font-size:14px;\">Dhalai Services</span><br><br>";
	...
	function display_result(){
		...
		GenericAjaxFunction('dhalai_services_data.php?employee='+employee+'&start_date='+start_date+'&end_date='+end_date+'&zone='+zone+'&state='+state+'&branch='+branch+'&department='+department,'display',0);
	...
	function Popup(data) 
	{
		var mywindow = window.open('', 'Dhalai Services Report', 'height=400,width=600');
		mywindow.document.write('<html><head><title>Dhalai Services Report</title>');
	...
	function exporttocsv(){
			...
			var report_name = 'Dhalai Services'
			var dt = new Date();
			var day = dt.getDate();
