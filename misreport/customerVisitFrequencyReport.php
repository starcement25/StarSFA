	...
	<tr>
		<td valign="top" bgcolor="#FFFFFF" >
                <table width="60%" align="center" border="0" cellpadding="5" cellspacing="2" class="border" >
                    ...
                    <?php
							$rscustomervisit=mysqli_query($link,$sqlcustomervisit) or die(mysqli_error()." Error in total visit: ".$sqlcustomervisit);
							$countcustomervisit=mysqli_num_rows($rscustomervisit);
							$count=1;
                    ...
                    <?php			
							...
							while($rowcustomervisit=mysqli_fetch_assoc($rscustomervisit))
							{
								...
								$res_total_quantity = mysqli_query($link,$sql_total_quantity);
								$row_total_quantity = mysqli_fetch_assoc($res_total_quantity);
