...
function main(){
   ...
   <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js"></script>
	...
	echo "<span style=\"font-weight:bold; font-size:14px;\">OFFICE VISIT REPORT DAYWISE</span><br><br>";
	...
	function display_result(){
		...
		GenericAjaxFunction('star_office_plant_visit_report_data.php?employee='+employee+'&start_date='+start_date+'&end_date='+end_date+'&zone='+zone+'&state='+state+'&branch='+branch+'&department='+department,'display',0);
	...
	function exporttocsv(){
		...
		var employee = document.getElementById("employee").value;
		window.open('star_office_plant_visit_report_data_export.php?employee='+employee+'&start_date='+start_date+'&end_date='+end_date+'&zone='+zone+'&state='+state+'&branch='+branch+'&department='+department,'mywindow')	;
}
	</script>
    <?php
}
