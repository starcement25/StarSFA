...
class ZipFile
{
	...
	//For survey excel download
		...
		if($survey_type == 'no'){
			if($survey_menu=='yes')
			{
			  $sql_get_menu = "SELECT layout_name,menu_id,survey_sub_menu FROM survey_input_lead WHERE type='menu' AND menu_id IN('RA253','RA254','RA280','RA281','RA514','RA515') and acedns='Y' ORDER BY display_order ASC";
