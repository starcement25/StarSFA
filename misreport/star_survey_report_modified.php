...
$sql_survey_type = "SELECT DISTINCT type FROM survey_output WHERE type NOT IN('Branding Verification')  ORDER BY type ASC";
	...
	$sql_technical_type = "SELECT display_name,row_id FROM survey_input_bkup WHERE type='menu' and survey_sub_menu='Technical Meets' ORDER BY display_order ASC";
	...
	function display_result(){
		...
		console.log(survey_type+" --> ojjrtyrtfk");
		console.log(survey_type == 'Site Lead and Conversion Tracking' ? "Same": "NO");
		...
		if(survey_type == 'Branding'){
			...
			{*/
				var url = 'star_survey_report_technical_meets_modified_one.php';
			//}
