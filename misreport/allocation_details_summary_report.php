...
function main(){
	...
	echo "<center>";
	echo "<span style=\"font-weight:bold; font-size:14px;\">ALLOCATION SUMMARY</span><br><br>";
	...
	function display_result(){
		...
		var url="allocation_details_summary_report_data.php";
...
function exporttocsv(divid)
	{
		...
		a.download = 'Allocation Summary Report' + postfix + '.xls';
	...
	function dealer_subdealer(dealer_code){
		...
		//var employee=document.getElementById("employee").value;
		var url="get_dealer_subdealer_data_starsaathi.php";
	...
	function emp_dealer(emp_code){
		...
		GenericAjaxFunction('get_dealer_data_starsaathi.php?employee='+employee,'dealer_div',0);
