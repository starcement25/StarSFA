...
$emp_string=substr($emp_string,0,-1);
    ...
    <table width="100%" style="border-collapse:collapse;" border="1"  cellpadding="2px">
      <tr class="TDHEAD" align="center">
        ...
        <td>Parameter 3</td>
        <td>Total Actual Sales</td>
        <td>Premium Actual sales</td>
        <td>Premium %</td>
        <td>WGT(%)</td>
        <td>SCORE(%)</td>
        ...
        <td>Parameter 6</td>
        <td>Active Dealer% Last Month</td>
   ...
   // echo $sqlsissummary;
	...
	while($rowsissummary = mysqli_fetch_assoc($rssissummary)){
    	...
    	$paramiter_seven = $rowsissummary['paramiter_seven'];
		$seven_TGT = $rowsissummary['seven_TGT'];
		$seven_ACH = $rowsissummary['seven_ACH'];
		$seven_ACH_percent = $rowsissummary['seven_ACH_percent'];
		$seven_WGT_percent = $rowsissummary['seven_WGT_percent'];
		$seven_SCORE_percent = $rowsissummary['seven_SCORE_percent'];
	...
	?>
      <tr>
        ...
        <td align="right"><?php echo $active_dealer_count_ACH_percent; ?></td>
        ...
        <td align="right"><?php echo $six_SCORE_percent; ?></td>
            ...
            <td align="right"><?php echo $paramiter_seven; ?></td>
        <td align="right"><?php echo $seven_TGT; ?></td>
        <td align="right"><?php echo $seven_ACH; ?></td>
        <td align="right"><?php echo $seven_ACH_percent; ?></td>
        <td align="right"><?php echo $seven_WGT_percent; ?></td>
        <td align="right"><?php echo $seven_SCORE_percent; ?></td>
