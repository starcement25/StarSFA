...
<body onLoad="GenericAjaxFunction('TD_data.php','display',0);">
...
function call_ajax()
{
	...
	GenericAjaxFunctionText('TD_quantity.php?emp_code='+emp_code+'&product_code='+product_group+'','quantity',0);
}
...
function updatedata()
{
	   ...
	   GenericAjaxFunction('TD_data.php','display',0);
}
