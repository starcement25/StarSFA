...
foreach ($routes as $route) {
    ...
    $cust_sql = "
        SELECT 
            customer_code,
            customer_name ,cust_type FROM
            
            
        customer_master 
        WHERE customer_code = '$customer_code'
        AND cust_type IN ('Dealer', 'Sub Dealer', 'Exclusive Dealer')
...
foreach ($customers as $cust) {
    $output .= $cust['customer_code'] . "^" . $cust['customer_name'] . "^" . $cust['customer_type'] . "\n";
}
// foreach ($customers as $cust) {

   
//     $type = ($cust['customer_type'] == "Exclusive Dealer") 
//             ? "RSAR" 
//             : $cust['customer_type'];

    
//     $output .= $cust['customer_code'] . "^" . $cust['customer_name'] . "^" . $type . "\n";
// }
