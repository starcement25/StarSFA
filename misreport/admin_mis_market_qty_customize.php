...
require ("attribute_selection_potential_report.php");
...
function main(){
	...
	$hidden = "";
	echo "<center>";
	echo "<span style=\"font-weight:bold; font-size:14px;\">SBG $type</span><br><br>";
	...
	function display_result(){
		...
		GenericAjaxFunction('admin_mis_market_pricing_data_customize.php?employee='+employee+'&start_date='+start_date+'&end_date='+end_date+'&branch='+branch,'display',0);
			...
			{*/
			if(nickname=='STAR'){
				GenericAjaxFunction('admin_mis_market_qty_data_customize_modified.php?employee='+employee+'&start_date='+start_date+'&end_date='+end_date+'&branch='+branch+'&type='+type,'display',0);
			}
			else
			{
			GenericAjaxFunction('admin_mis_market_pricing_data_customize.php?employee='+employee+'&start_date='+start_date+'&end_date='+end_date+'&branch='+branch,'display',0);
	...
	function Popup(data) 
	{
		var mywindow = window.open('', 'Market Feedback Report', 'height=400,width=600');
		mywindow.document.write('<html><head><title>Market Feedback Pricing</title>');
	...
	function exporttocsv(divid)
	{
		...
		//alert(divid);
			...
			a.download = 'Market Feedback Pricing' + postfix + '.xls';
		...
		if(nickname!='STAR')
			{
				// window.open('admin_mis_market_pricing_data_customize_export.php?employee='+employee+'&start_date='+start_date+'&end_date='+end_date+'&zone='+zone+'&state='+state+'&branch='+branch,'mywindow');

				//window.open('admin_mis_market_pricing_not_star_data_export.php?employee='+employee+'&start_date='+start_date+'&end_date='+end_date+'&zone='+zone+'&state='+state+'&branch='+branch,'mywindow');

			}
			else
			{
				window.open('admin_mis_market_qty_data_customize_export_modified.php?employee='+employee+'&start_date='+start_date+'&end_date='+end_date+'&zone='+zone+'&state='+state+'&branch='+branch+'&type='+type,'mywindow')	;
