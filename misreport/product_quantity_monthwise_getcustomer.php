...
echo $sql_select_customer = "SELECT CM.customer_code, CM.customer_name FROM customer_master CM, employee_master EM, prev_order_counting_master POCM WHERE ".$emp_hierarchy_condition." AND CM.emp_code=EM.emp_code AND POCM.customer_code=CM.customer_code ORDER BY CM.customer_name ASC";
