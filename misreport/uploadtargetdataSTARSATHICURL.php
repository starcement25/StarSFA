...
ini_set('memory_limit', '-1');
	...
	// uploadtargetdataSTARSATHICURL.php
...
// 			echo $sqlchkemployee;
			...
			$counchkemployee=mysqli_num_rows($rschkemployee);
...

				{
					...
					$sqlselfappraisalprod .= " , customer_code='".mysqli_real_escape_string($link,$customer_code)."'";

					$sqlselfappraisalprod .= " , prod_code='12001'";

				$sqlselfappraisalprod .= " , apr_30_target='".mysqli_real_escape_string($link,$april_target)."'";
				$sqlselfappraisalprod .= " , apr_30_achievement='".mysqli_real_escape_string($link,$april_achievement)."'";
				$sqlselfappraisalprod .= " , apr_prev_y_target='".mysqli_real_escape_string($link,$april_prev_target)."'";
				$sqlselfappraisalprod .= " , apr_prev_y_achievement='".mysqli_real_escape_string($link,$april_prev_achievement)."'";
				$sqlselfappraisalprod .= " , may_31_target='".mysqli_real_escape_string($link,$may_target)."'";
				$sqlselfappraisalprod .= " , may_31_achievement='".mysqli_real_escape_string($link,$may_achievement)."'";
				$sqlselfappraisalprod .= " , may_prev_y_target='".mysqli_real_escape_string($link,$may_prev_target)."'";
				$sqlselfappraisalprod .= " , may_prev_y_achievement='".mysqli_real_escape_string($link,$may_prev_achievement)."'";
				$sqlselfappraisalprod .= " , jun_30_target='".mysqli_real_escape_string($link,$june_target)."'";
				$sqlselfappraisalprod .= " , jun_30_achievement='".mysqli_real_escape_string($link,$june_achievement)."'";
				$sqlselfappraisalprod .= " , jun_prev_y_target='".mysqli_real_escape_string($link,$june_prev_target)."'";
				$sqlselfappraisalprod .= " , jun_prev_y_achievement='".mysqli_real_escape_string($link,$june_prev_achievement)."'";
				$sqlselfappraisalprod .= " , jul_31_target='".mysqli_real_escape_string($link,$july_target)."'";
				$sqlselfappraisalprod .= " , jul_31_achievement='".mysqli_real_escape_string($link,$july_achievement)."'";
				$sqlselfappraisalprod .= " , jul_prev_y_target='".mysqli_real_escape_string($link,$july_prev_target)."'";
				$sqlselfappraisalprod .= " , jul_prev_y_achievement='".mysqli_real_escape_string($link,$july_prev_achievement)."'";
				$sqlselfappraisalprod .= " , aug_31_target='".mysqli_real_escape_string($link,$august_target)."'";
				$sqlselfappraisalprod .= " , aug_31_achievement='".mysqli_real_escape_string($link,$august_achievement)."'";
				$sqlselfappraisalprod .= " , aug_prev_y_target='".mysqli_real_escape_string($link,$august_prev_target)."'";
				$sqlselfappraisalprod .= " , aug_prev_y_achievement='".mysqli_real_escape_string($link,$august_prev_achievement)."'";
				$sqlselfappraisalprod .= " , sep_30_target='".mysqli_real_escape_string($link,$september_target)."'";
				$sqlselfappraisalprod .= " , sep_30_achievement='".mysqli_real_escape_string($link,$september_achievement)."'";
				$sqlselfappraisalprod .= " , sep_prev_y_target='".mysqli_real_escape_string($link,$september_prev_target)."'";
				$sqlselfappraisalprod .= " , sep_prev_y_achievement='".mysqli_real_escape_string($link,$september_prev_achievement)."'";
				$sqlselfappraisalprod .= " , oct_31_target='".mysqli_real_escape_string($link,$october_target)."'";
				$sqlselfappraisalprod .= " , oct_31_achievement='".mysqli_real_escape_string($link,$october_achievement)."'";
				$sqlselfappraisalprod .= " , oct_prev_y_target='".mysqli_real_escape_string($link,$october_prev_target)."'";
				$sqlselfappraisalprod .= " , oct_prev_y_achievement='".mysqli_real_escape_string($link,$october_prev_achievement)."'";
				$sqlselfappraisalprod .= " , nov_30_target='".mysqli_real_escape_string($link,$november_target)."'";
				$sqlselfappraisalprod .= " , nov_30_achievement='".mysqli_real_escape_string($link,$november_achievement)."'";
				$sqlselfappraisalprod .= " , nov_prev_y_target='".mysqli_real_escape_string($link,$november_prev_target)."'";
				$sqlselfappraisalprod .= " , nov_prev_y_achievement='".mysqli_real_escape_string($link,$november_prev_achievement)."'";
				$sqlselfappraisalprod .= " , dec_31_target='".mysqli_real_escape_string($link,$december_target)."'";
				$sqlselfappraisalprod .= " , dec_31_achievement='".mysqli_real_escape_string($link,$december_achievement)."'";
				$sqlselfappraisalprod .= " , dec_prev_y_target='".mysqli_real_escape_string($link,$december_prev_target)."'";
				$sqlselfappraisalprod .= " , dec_prev_y_achievement='".mysqli_real_escape_string($link,$december_prev_achievement)."'";
				$sqlselfappraisalprod .= " , jan_31_target='".mysqli_real_escape_string($link,$january_target)."'";
				$sqlselfappraisalprod .= " , jan_31_achievement='".mysqli_real_escape_string($link,$january_achievement)."'";
				$sqlselfappraisalprod .= " , jan_prev_y_target='".mysqli_real_escape_string($link,$january_prev_target)."'";
				$sqlselfappraisalprod .= " , jan_prev_y_achievement='".mysqli_real_escape_string($link,$january_prev_achievement)."'";
				$sqlselfappraisalprod .= " , feb_28_target='".mysqli_real_escape_string($link,$february_target)."'";
				$sqlselfappraisalprod .= " , feb_28_achievement='".mysqli_real_escape_string($link,$february_achievement)."'";
				$sqlselfappraisalprod .= " , feb_prev_y_target='".mysqli_real_escape_string($link,$february_prev_target)."'";
				$sqlselfappraisalprod .= " , feb_prev_y_achievement='".mysqli_real_escape_string($link,$february_prev_achievement)."'";

				$sqlselfappraisalprod .= " , mar_31_target='".mysqli_real_escape_string($link,$march_target)."'";
				$sqlselfappraisalprod .= " , mar_31_achievement='".mysqli_real_escape_string($link,$march_achievement)."'";
				$sqlselfappraisalprod .= " , mar_prev_y_target='".mysqli_real_escape_string($link,$march_prev_target)."'";
				$sqlselfappraisalprod .= " , mar_prev_y_achievement='".mysqli_real_escape_string($link,$march_prev_achievement)."'";
				 //echo $sqlselfappraisalprod;
				...
				else
				{
					...
					$sqlselfappraisalupdateprod .= " apr_30_target='".mysqli_real_escape_string($link,$april_target)."'";

					$sqlselfappraisalupdateprod .= " , apr_30_achievement='".mysqli_real_escape_string($link,$april_achievement)."'";

					$sqlselfappraisalupdateprod .= " , apr_prev_y_target='".mysqli_real_escape_string($link,$april_prev_target)."'";

					$sqlselfappraisalupdateprod .= " , apr_prev_y_achievement='".mysqli_real_escape_string($link,$april_prev_achievement)."'";

					$sqlselfappraisalupdateprod .= " , may_31_target='".mysqli_real_escape_string($link,$may_target)."'";

					$sqlselfappraisalupdateprod .= " , may_31_achievement='".mysqli_real_escape_string($link,$may_achievement)."'";

					$sqlselfappraisalupdateprod .= " , may_prev_y_target='".mysqli_real_escape_string($link,$may_prev_target)."'";

					$sqlselfappraisalupdateprod .= " , may_prev_y_achievement='".mysqli_real_escape_string($link,$may_prev_achievement)."'";

					$sqlselfappraisalupdateprod .= " , jun_30_target='".mysqli_real_escape_string($link,$june_target)."'";

					$sqlselfappraisalupdateprod .= " , jun_30_achievement='".mysqli_real_escape_string($link,$june_achievement)."'";

					$sqlselfappraisalupdateprod .= " , jun_prev_y_target='".mysqli_real_escape_string($link,$june_prev_target)."'";

				    $sqlselfappraisalupdateprod .= " , jun_prev_y_achievement='".mysqli_real_escape_string($link,$june_prev_achievement)."'";

					$sqlselfappraisalupdateprod .= " , jul_31_target='".mysqli_real_escape_string($link,$july_target)."'";

					$sqlselfappraisalupdateprod .= " , jul_31_achievement='".mysqli_real_escape_string($link,$july_achievement)."'";

					$sqlselfappraisalupdateprod .= " , jul_prev_y_target='".mysqli_real_escape_string($link,$july_prev_target)."'";

				    $sqlselfappraisalupdateprod .= " , jul_prev_y_achievement='".mysqli_real_escape_string($link,$july_prev_achievement)."'";

					$sqlselfappraisalupdateprod .= " , aug_31_target='".mysqli_real_escape_string($link,$august_target)."'";

					$sqlselfappraisalupdateprod .= " , aug_31_achievement='".mysqli_real_escape_string($link,$august_achievement)."'";

					$sqlselfappraisalupdateprod .= " , aug_prev_y_target='".mysqli_real_escape_string($link,$august_prev_target)."'";

				    $sqlselfappraisalupdateprod .= " , aug_prev_y_achievement='".mysqli_real_escape_string($link,$august_prev_achievement)."'";

					$sqlselfappraisalupdateprod .= " , sep_30_target='".mysqli_real_escape_string($link,$september_target)."'";

					$sqlselfappraisalupdateprod .= " , sep_30_achievement='".mysqli_real_escape_string($link,$september_achievement)."'";

					$sqlselfappraisalupdateprod .= " , sep_prev_y_target='".mysqli_real_escape_string($link,$september_prev_target)."'";

				    $sqlselfappraisalupdateprod .= " , sep_prev_y_achievement='".mysqli_real_escape_string($link,$september_prev_achievement)."'";

					$sqlselfappraisalupdateprod .= " , oct_31_target='".mysqli_real_escape_string($link,$october_target)."'";

					$sqlselfappraisalupdateprod .= " , oct_31_achievement='".mysqli_real_escape_string($link,$october_achievement)."'";

					$sqlselfappraisalupdateprod .= " , oct_prev_y_target='".mysqli_real_escape_string($link,$october_prev_target)."'";

				    $sqlselfappraisalupdateprod .= " , oct_prev_y_achievement='".mysqli_real_escape_string($link,$october_prev_achievement)."'";

					$sqlselfappraisalupdateprod .= " , nov_30_target='".mysqli_real_escape_string($link,$november_target)."'";

					$sqlselfappraisalupdateprod .= " , nov_30_achievement='".mysqli_real_escape_string($link,$november_achievement)."'";

					$sqlselfappraisalupdateprod .= " , nov_prev_y_target='".mysqli_real_escape_string($link,$november_prev_target)."'";

					$sqlselfappraisalupdateprod .= " , nov_prev_y_achievement='".mysqli_real_escape_string($link,$november_prev_achievement)."'";

					$sqlselfappraisalupdateprod .= " , dec_31_target='".mysqli_real_escape_string($link,$december_target)."'";

					$sqlselfappraisalupdateprod .= " , dec_31_achievement='".mysqli_real_escape_string($link,$december_achievement)."'";

					$sqlselfappraisalupdateprod .= " , dec_prev_y_target='".mysqli_real_escape_string($link,$december_prev_target)."'";

					$sqlselfappraisalupdateprod .= " , dec_prev_y_achievement='".mysqli_real_escape_string($link,$december_prev_achievement)."'";

					$sqlselfappraisalupdateprod .= " , jan_31_target='".mysqli_real_escape_string($link,$january_target)."'";

					$sqlselfappraisalupdateprod .= " , jan_31_achievement='".mysqli_real_escape_string($link,$january_achievement)."'";

					$sqlselfappraisalupdateprod .= " , jan_prev_y_target='".mysqli_real_escape_string($link,$january_prev_target)."'";

					$sqlselfappraisalupdateprod .= " , jan_prev_y_achievement='".mysqli_real_escape_string($link,$january_prev_achievement)."'";

					$sqlselfappraisalupdateprod .= " , feb_28_target='".mysqli_real_escape_string($link,$february_target)."'";

					$sqlselfappraisalupdateprod .= " , feb_28_achievement='".mysqli_real_escape_string($link,$february_achievement)."'";

					$sqlselfappraisalupdateprod .= " , feb_prev_y_target='".mysqli_real_escape_string($link,$february_prev_target)."'";

					$sqlselfappraisalupdateprod .= " , feb_prev_y_achievement='".mysqli_real_escape_string($link,$february_prev_achievement)."'";

					$sqlselfappraisalupdateprod .= " , mar_31_target='".mysqli_real_escape_string($link,$march_target)."'";

					$sqlselfappraisalupdateprod .= " , mar_31_achievement='".mysqli_real_escape_string($link,$march_achievement)."'";

					$sqlselfappraisalupdateprod .= " , mar_prev_y_target='".mysqli_real_escape_string($link,$march_prev_target)."'";

					$sqlselfappraisalupdateprod .= " , mar_prev_y_achievement='".mysqli_real_escape_string($link,$march_prev_achievement)."'";

					$sqlselfappraisalupdateprod .= " , download_time=CURRENT_TIMESTAMP() WHERE customer_code='".$customer_code."' AND prod_code='12001'";

                     //echo $sqlselfappraisalupdateprod;
