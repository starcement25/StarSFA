...
<div class="competitor-page-wrap">
    ...
    <div class="competitor-upload-card">
        <div class="competitor-card-head">Competitor wise Counter Potential Upload</div>
                ...
                <table class="competitor-form-table">
                    ...
                    <tr>
                        ...
                        <td class="competitor-actions">
                            ...
                            <button type="button" class="competitor-btn competitor-btn-secondary" onclick="downloadCSV('ROE')">Download Sample CSV ROE</button>
                            <button type="button" class="competitor-btn competitor-btn-secondary" onclick="downloadCSV('NE')">Download Sample CSV NE</button>
                        </td>
                    </tr>
                </table>
            </form>
...
function downloadCSV(type){
    window.location.href = "download_sample.php?type=" + type;
}
</script>
<?php
}
