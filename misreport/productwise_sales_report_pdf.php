...
if(no_of_filter == 1){
	...
	while($row_order_details = mysqli_fetch_assoc($res_order_details)){
		...
		$res_prod_master = mysqli_query($link,$sql_prod_master);
		$row_prod_master = mysqli_fetch_assoc($res_prod_master);
	...
	while($row_order_details = mysqli_fetch_assoc($res_order_details)){
		...
		$res_subprodgroup_name = mysqli_query($link,$sql_subprodgroup_name);
		$row_subprodgroup_name = mysqli_fetch_assoc($res_subprodgroup_name);
	...
	while($row_order_details = mysqli_fetch_assoc($res_order_details)){
		...
		$res_prodbrand_name = mysqli_query($link,$sql_prodbrand_name);
		$row_prodbrand_name = mysqli_fetch_assoc($res_prodbrand_name);
