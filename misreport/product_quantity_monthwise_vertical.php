...
<center><br />
	<div>
    	Employee:<select name="emp_name" id="emp_name" onChange="show_customer_name(this.value);">
                            ...
                            <?php
							echo $sql_select_emp = "SELECT EM.emp_code, EM.emp_name FROM employee_master EM WHERE ".$emp_hierarchy_condition." AND EM.emp_code NOT LIKE 'C%' ORDER BY EM.emp_name ASC";
