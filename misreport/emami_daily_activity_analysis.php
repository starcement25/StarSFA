...
<body onLoad="GenericAjaxFunction('emami_daily_activity_analysis_data.php','display',0);">
<center>
...
function show_emp()
{
	...
	GenericAjaxFunction('emami_daily_activity_analysis_data.php?start_date='+start_date+'&end_date='+end_date,'display',0);
}
</script>
<?php
	}
