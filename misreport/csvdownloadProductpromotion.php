...
class ZipFile
{
 ...
 //For sauda csv download
	...
	$rs_promotion_download = mysqli_query($link,$sql_promotion_download) or die(mysqli_error()." Error in promotion data download: ".$sql_promotion_download);
	$linepromotion = ''; 
	while($rec_promotion_download = mysqli_fetch_assoc($rs_promotion_download)) 
	{ 
