...
$res_get_collection_forecast = mysqli_query($link,$sql_get_collection_forecast);
$total_rows = mysqli_num_rows($res_get_collection_forecast);
if($total_rows>0){
	...
	while($row_get_collection_forecast = mysqli_fetch_assoc($res_get_collection_forecast)){
