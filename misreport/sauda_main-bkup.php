...
$(document).ready(function () {
	$("#display").html('<table id="demo" width="800px" border="1" style="border-collapse:collapse;"><thead><tr><th colspan="<?php echo (($total_product*2)+3); ?>" class="TDHEAD" align="center"><b>Sauda Details&nbsp;&nbsp;<?php echo $sauda_date; ?></b></th></tr><tr class="TDHEAD_SUB" align="center"><th rowspan="2"><b>Employee</b></th><?php $res_count_product = mysqli_query($link,$sql_count_product); while($row_count_product = mysqli_fetch_assoc($res_count_product))echo "<th align=\"center\"><b>$row_count_product[$field_name2]</b></th>"; ?><th rowspan="2">Edit</th></tr><tr class="TDHEAD_SUB" align="center"><?php for($i=1;$i<=$total_product;$i++) echo "<th align=\"center\"><b>Alloted</b></th>"; ?></tr></thead>');
