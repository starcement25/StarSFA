...
class xml_order_details{
	var $orderdatadetails_order_no,$orderdatadetails_sku_code,$orderdatadetails_qty,$orderdatadetails_TD,$orderdatadetails_premium,$orderdatadetails_sale_rate,$orderdatadetails_VAT,$orderdatadetails_amount,$orderdatadetails_UOM,$orderdatadetails_mrp_code,$orderdatadetails_weightage,$orderdatadetails_remarks;
}
class xml_payment{
...
function contents($parser, $data){
	...
	$orderdataheader_cust_base_longi,$orderdataheader_cust_image,$orderdataheader_freight_component_value,$orderdatadetails_order_no,$orderdatadetails_sku_code,$orderdatadetails_qty,$orderdatadetails_TD,$orderdatadetails_premium,$orderdatadetails_sale_rate,$orderdatadetails_VAT,$orderdatadetails_amount,$orderdatadetails_UOM,$orderdatadetails_mrp_code,$orderdatadetails_weightage,$orderdatadetails_remarks,
...
$url = APICALLLOGURL."/operationdb-transaction-7.0.5.php?nick_name=$nick_name&emp_code=$emp_code&last_update_time=$last_update_time&last_git_master_update_time=$last_git_master_update_time&last_loyalty_purchase_update_time=$last_loyalty_purchase_update_time";
