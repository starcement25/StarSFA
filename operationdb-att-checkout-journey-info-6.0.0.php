...
class xml_att_checkout{
	var $attendance_id,$checkout_id,$emp_code,$create_date,$att_starting_km,$att_odometer,$att_necessary_items,$att_activities,$checkout_ending_km,$checkout_odometer;	
}
...
function contents($parser, $data){
    global $current_tag,$counter,$att_checkout_info_array,$attendance_id,$checkout_id,$emp_code,$create_date,$att_starting_km,$att_odometer,$att_necessary_items,$att_activities,$checkout_ending_km,$checkout_odometer;	
	...
	for($x=0;$x<count($att_checkout_info_array);$x++){
		...
		if($countchkattcheckout==0)
		{
			$sqlinsertattcheckout="INSERT INTO att_checkout_journey_info SET attendance_id ='".$attendance_id."',
									  ...
									  checkout_odometer				='".$checkout_odometer."'";											  				if(mysqli_query($link,$sqlinsertattcheckout))
				{
					$flag=5;
				}
				else
