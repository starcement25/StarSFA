...
$van_stock_return_reason = "*ROOT*VAN_STOCK_RETURN*VAN_STOCK_RETURN_DETAILS*RETURN_REASON";
...
class xml_van_stock_return_details{
	var $van_stock_return_transaction_id,$van_stock_return_customer_code,$van_stock_return_product_code,$van_stock_return_qty,$van_stock_return_order_no,$van_stock_return_reason;
}
...
function contents($parser, $data){
	...
	$van_stock_return_emp_code,$van_stock_return_trans_id,$van_stock_return_latt,$van_stock_return_longi,$van_stock_return_trans_date,$van_stock_return_transaction_id,$van_stock_return_customer_code,$van_stock_return_product_code,$van_stock_return_qty,$van_stock_return_order_no,$van_stock_return_reason;
	//echo $current_tag.'<br />';
	//echo $data;
	...
	if(substr($current_tag,0,47)=='*ROOT*VAN_STOCK_RETURN*VAN_STOCK_RETURN_DETAILS')
		{
			...
			switch($current_tag){
				...
				case $van_stock_return_order_no:
					...
					break;
			   case $van_stock_return_reason:
					$van_stock_details_array[$countervanstockdetails]->van_stock_return_reason = $data;
	...
	for($x=0;$x<count($van_stock_return_array);$x++){
		...
		if(count($van_stock_details_array)>0)
		{
			for($i=0;$i<count($van_stock_details_array);$i++){
			    ...
			    $van_stock_return_reason=$van_stock_details_array[$i]->van_stock_return_reason;
					...
					if(!in_array($van_stock_return_transaction_id,$van_stock_return_array_trans_id_exists))
					{
						$sqlinsertvanstockreturn="INSERT INTO van_stock_return SET 	return_trans_id ='".$van_stock_return_transaction_id."',
											  ...
											  return_reason 		='".$van_stock_return_reason."',
