...
$body="<?xml version='1.0' encoding='UTF-8'?><root><attendance><location><emp_code><![CDATA[E0027]]></emp_code><trans_id><![CDATA[AE002720150828135235]]></trans_id><latt><![CDATA[22.5642272]]></latt><longi><![CDATA[88.356839]]></longi><date><![CDATA[2015-08-28 13:52:35]]></date></location><attendancedata><emp_code><![CDATA[E0027]]></emp_code><date><![CDATA[2015-08-28]]></date></attendancedata></attendance><product_promotion><location><emp_code><![CDATA[E0027]]></emp_code><trans_id><![CDATA[PPE002720150828141710]]></trans_id><latt><![CDATA[22.5642223]]></latt><longi><![CDATA[88.3568797]]></longi><date><![CDATA[2015-08-28 14:17:10]]></date></location><product_promotion_details><PROSPECT_CODE><![CDATA[PPE002720150828141710]]></PROSPECT_CODE><PROSPECT_NAME><![CDATA[test]]></PROSPECT_NAME><PIN><![CDATA[700004]]></PIN><STREET_NAME><![CDATA[test]]></STREET_NAME><STREET_NO><![CDATA[test]]></STREET_NO><BUILDING_NO><![CDATA[test]]></BUILDING_NO><APARTMENT_NO><![CDATA[]]></APARTMENT_NO><PHONE_NO><![CDATA[9800123456]]></PHONE_NO><OIL_USED><![CDATA[Soyabean]]></OIL_USED></product_promotion_details></product_promotion><product_promotion><location><emp_code><![CDATA[E0027]]></emp_code><trans_id><![CDATA[PPE002720150828141711]]></trans_id><latt><![CDATA[22.5642223]]></latt><longi><![CDATA[88.3568797]]></longi><date><![CDATA[2015-08-28 14:17:11]]></date></location><product_promotion_details><PROSPECT_CODE><![CDATA[PPE002720150828141711]]></PROSPECT_CODE><PROSPECT_NAME><![CDATA[test]]></PROSPECT_NAME><PIN><![CDATA[700004]]></PIN><STREET_NAME><![CDATA[test]]></STREET_NAME><STREET_NO><![CDATA[test]]></STREET_NO><BUILDING_NO><![CDATA[test]]></BUILDING_NO><APARTMENT_NO><![CDATA[]]></APARTMENT_NO><PHONE_NO><![CDATA[9800123456]]></PHONE_NO><OIL_USED><![CDATA[Soyabean]]></OIL_USED></product_promotion_details></product_promotion><product_promotion><location><emp_code><![CDATA[E0027]]></emp_code><trans_id><![CDATA[PPE002720150828144621]]></trans_id><latt><![CDATA[22.5642373]]></latt><longi><![CDATA[88.3568023]]></longi><date><![CDATA[2015-08-28 14:46:23]]></date></location><product_promotion_details><PROSPECT_CODE><![CDATA[PPE002720150828144621]]></PROSPECT_CODE><PROSPECT_NAME><![CDATA[test]]></PROSPECT_NAME><PIN><![CDATA[700005]]></PIN><STREET_NAME><![CDATA[test]]></STREET_NAME><STREET_NO><![CDATA[test]]></STREET_NO><BUILDING_NO><![CDATA[test]]></BUILDING_NO><APARTMENT_NO><![CDATA[test]]></APARTMENT_NO><PHONE_NO><![CDATA[9800147258]]></PHONE_NO><OIL_USED><![CDATA[Mustard]]></OIL_USED></product_promotion_details></product_promotion></root>";*/
...
class xml_product_promotion{
	var $location_emp_code,$location_trans_id,$location_latt,$location_longi,$location_date,$prospect_code,$prospect_name,$pin,$street_name,$street_no,$building_no,$apartment_no,$phone_no,$email,$address,$competitor_name,$oil_used;	
}
...
function contents($parser, $data){
    global $current_tag,$attendance_emp_code, $attendance_trans_id,$attendance_latt,$attendance_longi,$attendance_date,$attendancedata_emp_code,$attendancedata_date,$counter,$counteratt,$location_emp_code,$location_trans_id,$location_latt,$location_longi,$location_date,$prospect_code,$prospect_name,$pin,$street_name,$street_no,$building_no,$apartment_no,$phone_no,$email,$address,$competitor_name,$oil_used,$product_promotion_array,$attendance_array;
	//echo $current_tag.'<br />';
	//echo $data.'<br />';
	...
	if(substr($current_tag,0,23)=='*ROOT*PRODUCT_PROMOTION')
	{
		...
		switch($current_tag){
			...
			case $competitor_name:
				...
				break;
			case $address:
				$product_promotion_array[$counter]->address = $data;
				break;		
			case $oil_used:
...
if(count($product_promotion_array)>0)
{
	for($x=0;$x<count($product_promotion_array);$x++){
		...
		$address_promotion=$product_promotion_array[$x]->address;
	  ...
	  if(mysqli_query($link,$sqlinsertorlocation))
		...
		$sqlinsertproductpromotion="INSERT INTO product_promotion SET prospect_code ='".$prospect_code."',
							   ...
							   address						='".$address_promotion."',
							   oil_used						='".$oil_used."'";
		if(mysqli_query($link,$sqlinsertproductpromotion))
		{
			$flag=5;
		}
		else
		...
		if(strpos($oil_used,',')==false){
			...
			$rs_generic_oil_chk=mysqli_query($link,$sql_generic_oil_chk);
			$countgeneric_oil_check=mysqli_num_rows($rs_generic_oil_chk);
			if($countgeneric_oil_check <1)
			{
				$sqlinsertgenericoil="INSERT INTO generic_oil_master SET oil_name ='".$oil_used."'";
				if(mysqli_query($link,$sqlinsertgenericoil))
				{
					$flag=5;
				}
				else
		...
		$rs_street_name_chk=mysqli_query($link,$sql_street_name_chk);
		$countstreet_name_chk=mysqli_num_rows($rs_street_name_chk);
		if($countstreet_name_chk <1)
		{
			$sqlinsertstreetname="INSERT INTO street_master SET street_name ='".$street_name."',pin_code='".$pin."'";
			if(mysqli_query($link,$sqlinsertstreetname))
			{
				$flag=5;
			}
			else
		...
		$rsprodgroup=mysqli_query($link,$sqlprodgroup);
		$rowprodgroup=mysqli_fetch_assoc($rsprodgroup);
		...
		$productpromotionmailbody = "<table><tr><td>This is an auto generated mail from <b>".$nick_name." aceDNS</b> mobile application from <b>"
								...
								<b>Road/Street Name: ".$street_name."</b><br /><br />
								<b>Road/Street No: ".$street_no."</b><br /><br />
								...
								<b>Address: ".$address_promotion."</b><br /><br />
...
$url = "http://www.acedns.in/acednsproduct/operationdb-product-promotion-6.0.1.php?nick_name=$nick_name&emp_code=$emp_code&last_update_time=$last_update_time";
