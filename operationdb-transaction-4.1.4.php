...
$sqlselect="SELECT is_update,db_version_code FROM table_structure_updation TSU,changepassword CH  
			WHERE CH.deviceid=TSU.device_id AND CH.emp_code=TSU.emp_code and CH.emp_code='".$emp_code."'";
...
if(($nick_name=='KUNJ' || $nick_name=='NAPTC' || $nick_name=='VIPL')  && $is_update=='1' && $db_version_code<'6.0')
	{
		echo '2';
		exit();
	}			
...
$body="<?xml version='1.0' encoding='UTF-8'?><root><order><location><emp_code><![CDATA[E0010]]></emp_code><trans_id><![CDATA[OE003120150108130402]]></trans_id><latt><![CDATA[0.0]]></latt><longi><![CDATA[0.0]]></longi><date><![CDATA[2015-01-08 13:04:02]]></date></location><orderdata><order_header><order_no><![CDATA[OE003120150108130402]]></order_no><customer_name><![CDATA[Alok Automobiles 193 S.d.road Contai]]></customer_name><Phone_no><![CDATA[9732642984]]></Phone_no><address><![CDATA[]]></address><pin_code><![CDATA[721401]]></pin_code><area><![CDATA[RT/11]]></area><area_name><![CDATA[RKB2]]></area_name><TD><![CDATA[0]]></TD><sale_type><![CDATA[CREDIT]]></sale_type><order_value><![CDATA[18390.00]]></order_value><d_instruction><![CDATA[Retail net R.K. Trans]]></d_instruction><tag_distributor_code><![CDATA[]]></tag_distributor_code><cust_type><![CDATA[R]]></cust_type><customer_flag><![CDATA[N]]></customer_flag><transaction_type><![CDATA[SO]]></transaction_type><vat><![CDATA[0.00]]></vat><grn_no><![CDATA[null]]></grn_no><customer_code><![CDATA[NE003120150108125741]]></customer_code></order_header><order_details><Order_no><![CDATA[OE003120150108130402]]></Order_no><Sku_code><![CDATA[21966]]></Sku_code><qty><![CDATA[20.0]]></qty><TD><![CDATA[0]]></TD><sale_rate><![CDATA[95]]></sale_rate><VAT><![CDATA[0]]></VAT><amount><![CDATA[1900.0]]></amount><mrp_code><![CDATA[v249]]></mrp_code></order_details><order_details><Order_no><![CDATA[OE003120150108130402]]></Order_no><Sku_code><![CDATA[21967]]></Sku_code><qty><![CDATA[10.0]]></qty><TD><![CDATA[0]]></TD><sale_rate><![CDATA[120]]></sale_rate><VAT><![CDATA[0]]></VAT><amount><![CDATA[1200.0]]></amount><mrp_code><![CDATA[v250]]></mrp_code></order_details><order_details><Order_no><![CDATA[OE003120150108130402]]></Order_no><Sku_code><![CDATA[34253]]></Sku_code><qty><![CDATA[50.0]]></qty><TD><![CDATA[0]]></TD><sale_rate><![CDATA[103]]></sale_rate><VAT><![CDATA[0]]></VAT><amount><![CDATA[5150.0]]></amount><mrp_code><![CDATA[v394]]></mrp_code></order_details><order_details><Order_no><![CDATA[OE003120150108130402]]></Order_no><Sku_code><![CDATA[22011]]></Sku_code><qty><![CDATA[400.0]]></qty><TD><![CDATA[0]]></TD><sale_rate><![CDATA[12]]></sale_rate><VAT><![CDATA[0]]></VAT><amount><![CDATA[4800.0]]></amount><mrp_code><![CDATA[v294]]></mrp_code></order_details><order_details><Order_no><![CDATA[OE003120150108130402]]></Order_no><Sku_code><![CDATA[21974]]></Sku_code><qty><![CDATA[30.0]]></qty><TD><![CDATA[0]]></TD><sale_rate><![CDATA[178]]></sale_rate><VAT><![CDATA[0]]></VAT><amount><![CDATA[5340.0]]></amount><mrp_code><![CDATA[v257]]></mrp_code></order_details></orderdata></order></root>";
			...
			if(mysqli_query($link,$sqlinsertattlocation) && mysqli_query($link,$sqlinsertattendance))
				{
					...
					if(mail($attendance_email,$attendanceemailsubj, $attendancemailbody, $headers,'-facedns@acedns.in'))
					{
						$flag=5;
					}
					else
			...
			//Add new rds to rds master
				...
				if(substr($order_trans_id,0,1)=='N')
				{
					...
					$headers .= "From: ".FROMTAG."<".FROMEMAIL."> \r\n" .
								...
								"Bcc: ".BCCEMAIL." \r\n".
								'X-Mailer: PHP/' . phpversion();
					if(mail($order_email,$noorderemailsubj, $noorderemailbody, $headers,'-facedns@acedns.in'))
					{
						$flag=5;
					}
					else
			...
			if(mysqli_query($link,$sqlinsertpaylocation) && mysqli_query($link,$sqlinsertpaymentheader))
				...
				if(substr($payment_trans_id,0,1)=='N')
				{
					...
					$headers .= "From: ".FROMTAG."<".FROMEMAIL."> \r\n" .
								...
								"Bcc: ".BCCEMAIL." \r\n" .
								'X-Mailer: PHP/' . phpversion();
					if(mail($payment_email, $nopaymentemailsubj, $nopaymentemailbody, $headers,'-facedns@acedns.in'))
					{
						$flag=5;
					}
					else
			...
			for($countpayarr=0;$countpayarr<count($paymentheader_array_mailbody);$countpayarr++)
			{
				if($paymentdataheader_sale_type_array[$countpayarr]!='CASH'){
					...
					$headers .= "From: ".FROMTAG."<".FROMEMAIL."> \r\n" .
								...
								"Bcc: ".BCCEMAIL." \r\n".
								'X-Mailer: PHP/' . phpversion();
					if(mail($payment_email, $paymentemailsubj, $paymentemailbody, $headers,'-facedns@acedns.in'))
					{
						$flag=5;
					}
					else
...
$url = "http://www.acedns.in/acednsproduct/operationdb-transaction-4.1.3.php?nick_name=$nick_name&emp_code=$emp_code&last_update_time=$last_update_time&last_git_master_update_time=$last_git_master_update_time&last_loyalty_purchase_update_time=$last_loyalty_purchase_update_time";
insertapilog($datetime,$emp_code,$url,$nick_name);
	/*$config = 'api_calllog.txt';
	$file=fopen($config,"r+");
	$date = date("F j, Y");
	$time = date("H:i:s");
	$newuser ="[$date $time]"."http://www.acedns.in/acednsproduct/operationdb-transaction-4.1.3.php?nick_name=$nick_name&emp_code=$emp_code&last_update_time=$last_update_time&last_git_master_update_time=$last_git_master_update_time&last_loyalty_purchase_update_time=$last_loyalty_purchase_update_time"."\r\n";
