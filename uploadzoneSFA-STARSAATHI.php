...
$sqlSFAcustomer="SELECT dns_customer_code,zone FROM customer_master WHERE dns_customer_code!=''  ORDER BY dns_customer_code ASC";
...
//exit();		
	...
	foreach($dns_customer_code_array as $dns_customer_code_val){
			...
			$zone=${zone.$dns_customer_code_val};
					...
					echo $sqlupdated .= " SET zone='".addslashes($zone)."'
									 WHERE  dns_customer_code='".$dns_customer_code."'";
					mysqli_query($link,$sqlupdated,$link);
