...
if($nick_name=='SKIPPER' ||  $nick_name=='STAR' ||  strtoupper($nick_name)=='START' || $nick_name=='DNV' || $nick_name=='HALDIRAM' || $nick_name=='KARMA' || $nick_name=='SHYAM' || $nick_name=='EMAMIT' || $nick_name=='EMAMI')
{
...
$orderdataheader_is_printed = "*ROOT*ORDER*ORDERDATA*ORDER_HEADER*IS_PRINTED";
...
class xml_order{
	...
	$orderdataheader_phone_no,$orderdataheader_address,$orderdataheader_pin_code,$orderdataheader_area,$orderdataheader_area_name,$orderdataheader_TD,$orderdataheader_sale_type,$orderdataheader_d_instruction,$orderdataheader_tag_distributor_code,$orderdataheader_cust_type,$orderdataheader_transaction_type,$orderdataheader_VAT,$orderdataheader_customer_flag,$orderdataheader_grn_no,$orderdataheader_vertical_value,$orderdataheader_destination_code,$orderdataheader_order_type,$orderdataheader_freight_component,$orderdataheader_hint_remarks,$orderdataheader_GST_type,$orderdataheader_is_printed;	
}
	...
	if(substr($current_tag,0,11)=='*ROOT*ORDER')
	{
		...
		switch($current_tag){
			...
			case $orderdataheader_GST_type:
				...
				break;
			case $orderdataheader_is_printed:
				$order_array[$counterorder]->orderdataheader_is_printed = $data;
				break;
...
if(count($order_array)>0)
{
	for($x=0;$x<count($order_array);$x++){
		...
		$orderdataheader_is_printed=$order_array[$x]->orderdataheader_is_printed;
		...
		else
		{
			...
			$sqlinsertorderheader="INSERT INTO order_header SET order_no='".$orderdataheader_order_no."',
								  ...
								  is_printed 		='".$orderdataheader_is_printed."',
