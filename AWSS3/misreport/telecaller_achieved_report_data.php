...
if($employee == 'all'){
	...
	$rschkktelecallerform=mysql_query($sqlchkktelecallerform);
	$countchkktelecallerform=mysql_num_rows($rschkktelecallerform);
		if($countchkktelecallerform > 0){
			//$tent_date_array=array();
			while($rowchkktelecallerform=mysql_fetch_array($rschkktelecallerform))
			{
