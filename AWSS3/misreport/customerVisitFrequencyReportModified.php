...
<table width="80%" align="center" cellpadding="2" cellspacing="2" border="0">
                    ...
                    <tr class="TDHEAD_SUB"> 
                        ...
                        <?php 
							...
							$table_data .= "<tr><td align=\"right\" colspan=\"2\" width=\"45%\">Cost Center:</td><td align=\"left\" width=\"\" style=\"vertical-align:top;\" colspan=\"2\">";
								...
								/*$table_data_dealer .= "<tr><td align=\"right\"  colspan=\"2\" width=\"45%\">Distributor:</td>";
								$table_data_dealer .= "<td align=\"left\" width=\"\" style=\"vertical-align:top;\" colspan=\"2\"><div id=\"dealer_div\"></div></td></tr>";
								echo $table_data_dealer .= "<td>";*/
								echo $table_data_date.="<tr><td colspan=\"4\" align=\"center\"><div id=\"date_div\">
    ...
    <input name="export" type="button" value="Export" id="btnExport" onClick="exporttocsv();" >
        ...
        //GenericAjaxFunction('customer_visit_report_data.php?employee='+employee+'&vertical='+vertical+'&state='+state+'&frequency='+frequency,'display',0);
				GenericAjaxFunction('customer_visit_report_data.php?employee='+employee+'&vertical='+vertical+'&state='+state+'&start_date='+start_date+'&end_date='+end_date,'display',0);
...
function exporttocsv()
{
	...
	function emp_dealer(emp_code){
		...
		GenericAjaxFunction('get_emp_dealer_data.php?employee='+employee,'dealer_div',0);
