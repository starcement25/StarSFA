...
function exporttocsv(divid)
{
	...
	a.download = 'Closing Stock Report' + postfix + '.xls';
...
<table width="40%" class="border" style="border-collapse:collapse;" border="1" cellpadding="4">
  <tr  class="TDHEAD">
  	<td colspan="2" align="center">Closing Stock Report</td>
  </tr>
...
function get_data(){
	...
	GenericAjaxFunction('closing_stock_report_data_verticalwise_modified.php?emp_code='+emp_code+'&vertical='+vertical,'display',0);
}
</script>
<?php } ?>