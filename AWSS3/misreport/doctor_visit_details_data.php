...
else
{
	...
	$res_doctor_visit = mysql_query($sql_doctor_visit);
	$cnt_doctor_visit=mysql_num_rows($res_doctor_visit);
	if($cnt_doctor_visit >0){
	while($row_doctor_visit = mysql_fetch_array($res_doctor_visit)){
