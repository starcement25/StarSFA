...
function saudawisereport(){
	...
	window.open('saudawisereport.php?type='+type+'&start_date='+start_date+'&end_date='+end_date,'_self');
}
function employeewisereport(){
	...
	window.open('employeewisereportchanged.php?type='+type+'&start_date='+start_date+'&end_date='+end_date,'_self');
}
function product_groupwise(){
	...
	window.open('product_groupwise_report.php?type='+type+'&start_date='+start_date+'&end_date='+end_date,'_self');
}
function product_skuwise(){
	...
	window.open('product_skuwise_report.php?type='+type+'&start_date='+start_date+'&end_date='+end_date,'_self');
}
function customerwisereport(){
	...
	window.open('customerwise_report.php?type='+type+'&start_date='+start_date+'&end_date='+end_date,'_self');
}
function depotwisereport(){
	...
	window.open('depotwise_report.php?type='+type+'&start_date='+start_date+'&end_date='+end_date,'_self');
}
function zonewisereport(){
	...
	window.open('zonewise_report.php?type='+type+'&start_date='+start_date+'&end_date='+end_date,'_self');
}
function statewisereport(){
	...
	window.open('statewise_report.php?type='+type+'&start_date='+start_date+'&end_date='+end_date,'_self');
}
function plantwisereport(){
	...
	window.open('plantwise_report.php?type='+type+'&start_date='+start_date+'&end_date='+end_date,'_self');
}
