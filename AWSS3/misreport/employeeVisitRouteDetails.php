	...
	<tr>
		<td valign="top" bgcolor="#FFFFFF" >
                <table width="70%" align="center" border="0" cellpadding="5" cellspacing="2" class="border" >
                    ...
                    <?php
							$rsempvisit=mysql_query($sqlempvisit) or die(mysql_error()." Error in route details: ".$sqlempvisit);
							$countempvisit=mysql_num_rows($rsempvisit);
							$count=1;
							if($countempvisit <1)
							{
					?>
                    ...
                    <?php			
							...
							while($rowempvisit=mysql_fetch_array($rsempvisit))
							{
					?>
							<tr> 
