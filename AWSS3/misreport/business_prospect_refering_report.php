...
<center>
	...
	function display_result(){
		...
		GenericAjaxFunction('business_prospect_refering_report_data.php?employee='+employee+'&start_date='+start_date+'&end_date='+end_date,'display',0);
	}
	...
	function Popup(data) 
	{
		var mywindow = window.open('', 'Business Prospect Report', 'height=400,width=600');
