...
function main(){
	...
	$hidden = "";
	echo "<center>";
	echo "<span style=\"font-weight:bold; font-size:14px;\">MARKET FEEDBACK - STOCK</span><br><br>";
	...
	function display_result(){
		...
		GenericAjaxFunction('admin_mis_market_feedback_data_customize.php?employee='+employee+'&start_date='+start_date+'&end_date='+end_date+'&branch='+branch,'display',0);
