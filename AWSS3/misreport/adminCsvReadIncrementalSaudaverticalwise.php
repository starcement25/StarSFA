			...
			{ 
			  ...
			  //print_r($data);
				...
				if($countbranchnamechk<1)
				{
					...
					$sqlbranch .= " , HQ='".mysql_real_escape_string($HQ)."'";
				...
				else
				{
					...
					$sqlbranch .= " , alternative_email_id='".mysql_real_escape_string($alternative_email_id)."'";
					$sqlbranch .= " , download_time=CURRENT_TIMESTAMP()";
					$sqlbranch .= " , plant_name='".mysql_real_escape_string($plant_name)."', HQ='".mysql_real_escape_string($HQ)."' 
		...
		if($cntproductgroupstatus>0)
		 {
			 ...
			 mysql_query($sqlupdateproductgroupstatustoY);
		 }
				...
				{ 
				  ...
				  $data[]=$value;
					...
					else
					{
						...
						mysql_query($sqlupdatedesignation);
				  ...
				  //print_r($data);
					...
					if($rds_tag!='' && $customer_type!='D')
					{
						...
						foreach($rds_tag_array as $rds_tag_val)
						{
							...
							$rsrdscode=mysql_query($sqlrdscode);
							$countrdscode=mysql_num_rows($rsrdscode);
							$rowrdscode=mysql_fetch_array($rsrdscode);
					...
					if($customer_type=='D'){
						...
						if($countcustomersaudalimit <1)
						{
							...
							mysql_query($sqlinsertlimitlog);
						}
						else
						{
							$rowcustomersaudalimit=mysql_fetch_array($rscustomersaudalimit);
			...
			foreach($lines as $line)
			{
				...
				//print_r($data);
					...
					if(strtolower($_SESSION['vertical_value'])=='specialty fats' && strtoupper($_SESSION['nick_name'])=='EMAMIT')
					{
						...
						$rsselmargin=mysql_query($sqlselmargin);	
						$rowselmargin=mysql_fetch_array($rsselmargin);
					...
					$rsisupload=mysql_query($sqlisupload);
					$rowisupload=mysql_fetch_array($rsisupload);
					...
					if($countmrpchk<1){
						...
						$sql .= " , mrp_code='".$max_mrp_code."'";
						$sql .= " , dns_mrp_code='".$dns_mrp_code."'";
						$sql .= " , mrp='".mysql_real_escape_string($sale_rate)."'";
						$sql .= " , sale_rate='".mysql_real_escape_string($sale_rate)."'";
						$sql .= " , vertical_value='".mysql_real_escape_string($vertical_value)."'";
						$sql .= " , UOM='".mysql_real_escape_string($UOM)."'";
						$sql .= " , basic_rate='".mysql_real_escape_string($sale_rate)."'";
						$sql .= " , primary_freight='".mysql_real_escape_string($primary_freight)."'";
						$sql .= " , depot_cost='".mysql_real_escape_string($depot_cost)."'";
						$sql .= " , margin_cost='".mysql_real_escape_string($margin_cost)."'";
						$sql .= " , download_time=CURRENT_TIMESTAMP()";
						mysql_query($sql)  or  array_push($error_array,"mysql_error().Duplicate key @row $csv_row_count on Mrp code  columns in Sauda mrp.csv.Please check.");
						$insertflag=1;
					...
					else
					{
						...
						if($mrp_db!=$mrp || $sale_rate_db!=$sale_rate){
							...
							$sqlupdate .= " SET mrp='".mysql_real_escape_string($sale_rate)."'";
							$sqlupdate .= " , sale_rate='".mysql_real_escape_string($sale_rate)."'";
							$sqlupdate .= " , basic_rate='".mysql_real_escape_string($sale_rate)."'";
							$sqlupdate .= " , primary_freight='".mysql_real_escape_string($primary_freight)."'";
							$sqlupdate .= " , depot_cost='".mysql_real_escape_string($depot_cost)."'";
							$sqlupdate .= " , margin_cost='".mysql_real_escape_string($margin_cost)."'";
							$sqlupdate .= " , vertical_value='".mysql_real_escape_string($vertical_value)."'";
							$sqlupdate .= " , download_time=CURRENT_TIMESTAMP() WHERE product_code='".$prod_code."' AND branch_code='".$branch_code."'";
							mysql_query($sqlupdate) or  array_push($error_array,".Internal error occurs @row $csv_row_count on Sauda mrp.csv.Please check.");
							$updateflag=1;
						}
					...
					$sqlinsertmrplog .= " , mrp='".mysql_real_escape_string($sale_rate)."'";
					$sqlinsertmrplog .= " , sale_rate='".mysql_real_escape_string($sale_rate)."'";
					$sqlinsertmrplog .= " , vertical_value='".mysql_real_escape_string($vertical_value)."'";
					$sqlinsertmrplog .= " , UOM='".mysql_real_escape_string($UOM)."'";
					$sqlinsertmrplog .= " , download_time=CURRENT_TIMESTAMP()";
					mysql_query($sqlinsertmrplog)  or  array_push($error_array,"mysql_error().Error on inserting sauda mrp insert log.");
				...
				{ 
				  ...
				  //print_r($data);
					...
					if($countbrokerchk<1)
					{
						...
						$sqlbroker .= " , brokerage_cost='".mysql_real_escape_string($brokerage_cost)."'";
						$sqlbroker .= " , state_code='".mysql_real_escape_string($state_code)."'";
					...
					else
					{
						...
						$sqlupdatebroker .= " , brokerage_cost='".mysql_real_escape_string($brokerage_cost)."'";
						$sqlupdatebroker .= " , acedns='".mysql_real_escape_string($acedns)."'
											  , state_code='".mysql_real_escape_string($state_code)."',download_time=CURRENT_TIMESTAMP()";
			...
			foreach($lines as $line)
			{
				...
				{ 
				 ...
				 //print_r($data);
					...
					$rscustomervertical=mysql_query($sqlcustomervertical);
					$countcustomervertical=mysql_num_rows($rscustomervertical);
					if($countcustomervertical <1)
					{
						...
						mysql_query($sqlinsertcustomervertical)  or die(mysql_error().".Internal error occurrs @row $csv_row_count in Customer Vertical.csv.Please check.");
					}
					else
					{
						...
						$rsupdateacednsstatus=mysql_query($sqlupdatecustomervertical)  or die(mysql_error().".Internal error occurrs @row $csv_row_count in Customer Vertical.csv.Please check.");
					}
				}
				 $rec_count++;
			}
					...
					{ 
					 ...
					 //print_r($data);
						...
						if($countcustomervertical <1)
						{
							...
							$sqlinsertcustomervertical .= " ,download_time=CURRENT_TIMESTAMP()";
							mysql_query($sqlinsertcustomervertical)  or die(mysql_error().".Internal error occurrs @row $csv_row_count in Customer vertical creditlimit.csv.Please check.");
						}
						else
						{
							...
							$rsupdatecustomervertical=mysql_query($sqlupdatecustomervertical)  or die(mysql_error().".Internal error occurrs @row $csv_row_count in Customer vertical creditlimit.csv.Please check.");
						}
					}
					 $rec_count++;
				}
					 ...
					 //print_r($data);
						...
						if($customer_code!='' && $route_code!='')
						{
							...
							if($countdistributorroute <1)
							{
								...
								mysql_query($sqlinsertdistributorroute)  or die(mysql_error().".Internal error occurrs @row $csv_row_count in Distributor route.csv.Please check.");
							}
							else
							{
								...
								if($acednsdb!=$acedns)
								{
									...
									$rsupdatedistributorroute=mysql_query($sqlupdatedistributorroute)  or die(mysql_error().".Internal error occurrs @row $csv_row_count in Distributor route.csv.Please check.");
								}
							}
						}
					}
		...
		foreach($lines as $line)
		{
			...
			{ 
			  ...
			  //print_r($data);
				...
				mysql_query($sqlbranchstateTD) or  array_push($error_array,"mysql_error().
				...
				$rsupdateprodtime=mysql_query($sqlupdateprodtime);								
			   }
			 $rec_count++;
		}		
		$successval=1;
