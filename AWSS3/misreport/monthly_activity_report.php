...
<table width="40%" class="border" style="border-collapse:collapse;" border="1" cellpadding="4">
  <tr  class="TDHEAD">
  	<td colspan="2" align="center">Monthly Activity Reports</td>
  </tr>
  <tr class="TDHEAD_SUB">
    ...
    <td align="left">
    	<select name="employee" id="employee" >
            ...
            <?php
			$sql_empl = "SELECT EM.emp_code, EM.emp_name FROM employee_master EM WHERE".$emp_hierarchy_condition." ORDER BY EM.emp_name ASC";
...
function get_data(){
	...
	if(nickname=='ARCHITA')
	{
		GenericAjaxFunction('monthly_activity_data_modified.php?emp_code='+emp_code+'&month='+month,'display',0);
	}
	else
	{
	GenericAjaxFunction('monthly_activity_data.php?emp_code='+emp_code+'&month='+month,'display',0);
	}
}
</script>
<?php } ?>