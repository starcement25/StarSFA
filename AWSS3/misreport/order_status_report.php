...
<body>
<center>
	<span style="font-weight:bold; font-size:14px;">Order Status Report</span><br><br>
...
function display_result(){
	...
	GenericAjaxFunction('order_status_report_data.php?employee='+employee+'&start_date='+start_date+'&end_date='+end_date,'display',0);
	}
...
function Popup(data) 
{
	var mywindow = window.open('', 'Order Status Report', 'height=400,width=600');
...
function exporttocsv(divid)
	{
		...
		a.download = 'Order Status Report' + postfix + '.xls';
