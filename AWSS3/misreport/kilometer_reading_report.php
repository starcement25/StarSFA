...
<center>
	<span style="font-weight:bold; font-size:14px;">Kilometer Reading Report</span><br><br>
	...
	function display_result(){
		...
		GenericAjaxFunction('kilometer_reading_report_data.php?employee='+employee+'&start_date='+start_date+'&end_date='+end_date,'display',0);
	}
	...
	function exporttocsv(divid)
	{
		...
		a.download = 'Kilometer Reading Report' + postfix + '.xls';
