    ...
    if (GBrowserIsCompatible()) {
		...
		// map.setCenter(new GLatLng(-33.89,151.27), 16);
		 ...
		 for (var i = 0; i < routes.length; i++) {
			...
			if(routes[i][0]!=''){
			var marker = createMarkerMultiple(point,'<table width="200" height="50"><tr><td valign="top"><strong>Mr. '+ routes[i][0]+' Gave Attendence on '+routes[i][4]+' @ '+routes[i][3]+ ' hrs.</strong></td></tr></table>');
			}
			else
			{
				var marker = createMarkerMultiple(point,'<table width="150" height="50"><tr><td valign="top"><strong>'+ routes[i][3] + '</strong></td></tr></table>');
			}
