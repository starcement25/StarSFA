...
if(count($count_total_calls)>0)
{
	...
	echo "<tr class='TDHEAD_SUB' align=\"center\">
		...
		foreach($productive_new_customer_array as $productive_new_customer_val)
		{
			...
			$rsactualproductivenewcustomer=mysql_query($sqlactualproductivenewcustomer);
			$rowactualproductivenewcustomer=mysql_fetch_array($rsactualproductivenewcustomer);	
