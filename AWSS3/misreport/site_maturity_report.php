...
<table cellpadding="4px" width="50%" class="border">
	<tr class="TDHEAD_SUB">
    	<td align="center">Site Maturity Report</td>
    </tr>
    <tr><td align="center">
<form action="site_maturity_report.php" name="site_maturity"  method="post">
<input type='hidden' name="mode" value="site_maturity" />
    ...
    <tr>
     ...
     <tr>
       ...
       <tr>
        ...
        <tr >
  		<td align="right" width="25%">Expected Month of Maturity:</td>
    	<td align="left">
    	<select name="month_select" id="month_select">
        <option value="">Select</option>
    	<?php
...
function get_data(){
	...
	if(document.getElementById("state").value.search(/\S/) == -1){
		...
		var is_checked=false;
	for(i=0; i<document.site_maturity.elements.length; i++){
		if(document.site_maturity.elements[i].type=="checkbox" && document.site_maturity.elements[i].checked==true 
				&& document.site_maturity.elements[i].name=='zone[]'){
			is_checked=true;
			break;
		}
	}
	...
	for(i=0; i<document.site_maturity.elements.length; i++){
		if(document.site_maturity.elements[i].type=="checkbox" && document.site_maturity.elements[i].checked==true 
				&& document.site_maturity.elements[i].name=='branch_code[]'){
	...
	for(i=0; i<document.site_maturity.elements.length; i++){
		if(document.site_maturity.elements[i].type=="checkbox" && document.site_maturity.elements[i].checked==true 
				&& document.site_maturity.elements[i].name=='emp_code[]'){
			is_checked_emp=true;
			break;
		}
	}
	...
	GenericAjaxFunction('site_maturity_report_data.php?emp_code='+valsemp+'&month='+month,'display',0);
}
</script>
<?php } ?>