...
function show_saudawise()
{
	...
	if(type != 'custom')
		GenericAjaxFunction('depotwisedata.php?type='+type,'display',0);
	else 
	{
		if(response1 != 0 && response2 != 0)
			GenericAjaxFunction('depotwisedata.php?type='+type+'&start_date='+start_date+'&end_date='+end_date,'display',0);
	}
