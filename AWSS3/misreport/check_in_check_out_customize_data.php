...
$res_checkin_time = mysql_query($sql_checkin_time);
while($row_checkin_time = mysql_fetch_array($res_checkin_time)){
...
while($row_checkout_time = mysql_fetch_array($res_checkout_time)){
