...
@$res_select_customer_name = mysql_query($sql_select_customer_name);
@$row_select_customer_name = mysql_fetch_array($res_select_customer_name);
				...
				<tr>
                    <td class="menubar">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td>
								<a href="latt_long_display.php" name="link60" id="link60" >Latttitude Longitude Report</a>
                                </td>
                                <td>
								<a href="adminCsvReadIncremental.php" name="link61" id="link61" >Upload Data</a>
                                </td>
							</tr>
						</table>
					</td>
