...
if($total_rows>0){
	...
	echo "<tr class='TDHEAD'><td colspan='11' align='center'>Daily Activity Analysis</td></tr>";
	...
	while($row_get_empdetails = mysql_fetch_array($res_get_empdetails)){
		...
		echo "<tr>
					...
					<td align='right'>".number_format(${'delivery_amount'.$emp_code.$trans_date_fetched},2)."</td>
				  </tr>";
