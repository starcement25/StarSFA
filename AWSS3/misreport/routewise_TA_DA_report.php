...
<center>
	<span style="font-weight:bold; font-size:14px;">TOUR EXPENSE REPORT</span><br><br>
    ...
    <table class="border" width="40%" style="border-collapse:collapse;" cellpadding="6px">
      <tr class="TDHEAD_SUB">
        ...
        <?php
		$sql_emp = "SELECT emp_code, emp_name FROM employee_master WHERE acedns = 'Y' ".$emp_hierarchy_value_condition." 
					AND emp_code IN(SELECT DISTINCT emp_code FROM route_plan ) ORDER BY emp_name ASC";
	...
	function display_result(){
		...
		GenericAjaxFunction('routewise_TA_DA_report_data.php?employee='+employee+'&start_date='+start_date+'&end_date='+end_date,'display',0);
	}
	...
	function Popup(data) 
	{
		var mywindow = window.open('', 'Route Wise TA DA Report', 'height=400,width=600');
		mywindow.document.write('<html><head><title>Route Wise TA DA Report</title>');
	...
	function exporttocsv(divid)
	{
		...
		a.download = 'Route Wise TA DA Report' + postfix + '.xls';
