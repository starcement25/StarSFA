...
<center>
	<span style="font-weight:bold; font-size:14px;">Doctor Visit Report</span><br><br>
	...
	function display_result(){
		...
		GenericAjaxFunction('doctor_visit_details_data.php?employee='+employee+'&start_date='+start_date+'&end_date='+end_date,'display',0);
	}
	...
	function Popup(data) 
	{
		var mywindow = window.open('', 'Doctor Visit Report', 'height=400,width=600');
		mywindow.document.write('<html><head><title>Doctor Visit Report</title>');
	...
	function exporttocsv(divid)
	{
		...
		a.download = 'Doctor Visit Report' + postfix + '.xls';
