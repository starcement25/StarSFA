...
<table width="90%" align="center" border="0" cellpadding="5" cellspacing="2" class="border" style="height: 320px;overflow-y: scroll;display:block;">
   ...
   $cnt=$GLOBALS[start]+1;
	while($rowproduct=mysql_fetch_array($resproduct))
	{
	   ...
	   $res_transaction_value=mysql_query($sql_transaction_value) or die(mysql_error()." Error in select transaction value: ".$sql_transaction_value);
	   $row_transaction_value=mysql_fetch_array($res_transaction_value);
