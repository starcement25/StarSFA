...
<center>
	<span style="font-weight:bold; font-size:14px;">Beat wise TC PC Report</span><br><br>
	...
	function display_result(){
		...
		GenericAjaxFunction('beatwise_TC_PC_report_data.php?employee_id='+employee_id+'&route='+route+'&start_date='+start_date+'&end_date='+end_date,'display',0);
	}
	...
	function Popup(data) 
	{
		var mywindow = window.open('', 'Beat Wise TC PC', 'height=400,width=600');
...
function exporttocsv(){
	...
	a.download = 'Beat Wise TC PC' + postfix + '.xls';
