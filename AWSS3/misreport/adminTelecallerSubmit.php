...
function add_record()
{
	...
	//exit();
		...
		$rschktelecallerform=mysql_query($sqlchktelecallerform);
		$countchktelecallerform=mysql_num_rows($rschktelecallerform);
		...
		$sqlinserttelecallerdetails="INSERT INTO telecaller_form_details SET telecaller_form_id='".addslashes($telecaller_form_id)."',
			...
			if(mysql_query($sqlinserttelecallerdetails))
			{
