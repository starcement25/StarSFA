...
<center>
	<span style="font-weight:bold; font-size:14px;">SALES EXECUTIVE WISE REPORT</span><br><br>
	...
	function display_result(){
		...
		GenericAjaxFunction('sales_executive_wise_report_data.php?employee='+employee+'&start_date='+start_date+'&end_date='+end_date,'display',0);
	}
	...
	function Popup(data) 
	{
		var mywindow = window.open('', 'SALES EXECUTIVE WISE REPORT', 'height=400,width=600');
		mywindow.document.write('<html><head><title>SALES EXECUTIVE WISE REPORT</title>');
	...
	function exporttocsv(divid)
	{
		...
		a.download = 'SALES EXECUTIVE WISE REPORT' + postfix + '.xls';
