...
function main(){
    ...
    <?php
	echo "</center>";
	$tour_plan_daywise_setup=tour_plan_daywise;
	?>
    <script>
	function display_result(){
		...
		var tour_plan_daywiseval='<?php echo $tour_plan_daywise_setup?>';
		
		document.getElementById("display").innerHTML = '<img src="ajax-loader.gif" id="ajaxloader">';
		if(tour_plan_daywiseval=='yes')
		{
		  GenericAjaxFunction('pjp_data_daywise.php?employee='+employee+'&start_date='+start_date+'&end_date='+end_date,'display',0);
		}
		else
		{
