...
function main(){
	...
	echo "<span style=\"font-weight:bold; font-size:14px;\">CUSTOMER VISIT REPORT</span><br><br>";
	...
	function display_result(){
		...
		GenericAjaxFunction('star_customer_visit_report_data.php?employee='+employee+'&month_data='+month_data+'&zone='+zone+'&state='+state+'&branch='+branch+'&department='+department,'display',0);
