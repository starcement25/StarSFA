...
function show_employeewise()
{
	...
	if(type != 'custom')
		GenericAjaxFunction('employeewisedatachanged.php?type='+type,'display',0);
	else 
	{
		if(response1 != 0 && response2 != 0)
			GenericAjaxFunction('employeewisedatachanged.php?type='+type+'&start_date='+start_date+'&end_date='+end_date,'display',0);
	}
