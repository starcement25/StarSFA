...
$date=gmdate('d',strtotime('+330 minute'));
	...
	$rsselfappraisal=mysql_query($sqlselfappraisal);
	while($rowselfappraisal=mysql_fetch_array($rsselfappraisal))
	{
	...
	$rssubdealerstat=mysql_query($sqlsubdealerstat);
	$sub_dealer_stat_array=array();
	while($rowsubdealerstat=mysql_fetch_array($rssubdealerstat))
	{
	...
	$sql_branch_yellowcard = "SELECT BM.branch_name,BM.branch_code,CM.dns_customer_code,RYC.*,CM.customer_name AS customer_name_db,CM.appointment_date AS appointment_date_db,CM.rds_tag FROM branch_master BM,RSSD_yellow_card_count RYC,customer_master CM WHERE
	...
	$res_branch_yellowcard = mysql_query($sql_branch_yellowcard);
	$countbranchyellowcard=mysql_num_rows($res_branch_yellowcard);
	if($countbranchyellowcard >0){
		...
		while($rowbranchyellowcard = mysql_fetch_array($res_branch_yellowcard)){
			...
			$linked_dealer_name=$row_dealer['customer_name'];
			...
			$rslinkdealercode=mysql_query($sqllinkdealercode);
			$rowlinkdealercode=mysql_fetch_array($rslinkdealercode);
			$dealer_dns_code = $rowlinkdealercode['dns_customer_code'];
			...
			echo "<tr>
				...
				echo "<tr>
				  ...
				  if($countbranchyellowcard==$loopcount)
				  {
					 ...
					 //For Branch Ach Avg
					/* ${avg_total_ach_branch.$previous_branch_code}=0;
					if(${curr_ach_01.$previous_branch_code} > 0) ${avg_total_ach_branch.$previous_branch_code}=${avg_total_ach_branch.$previous_branch_code}+1;
					if(${curr_ach_02.$previous_branch_code} > 0) ${avg_total_ach_branch.$previous_branch_code}=${avg_total_ach_branch.$previous_branch_code}+1;
					if(${curr_ach_03.$previous_branch_code} > 0) ${avg_total_ach_branch.$previous_branch_code}=${avg_total_ach_branch.$previous_branch_code}+1;
					if(${curr_ach_04.$previous_branch_code} > 0) ${avg_total_ach_branch.$previous_branch_code}=${avg_total_ach_branch.$previous_branch_code}+1;
					if(${curr_ach_05.$previous_branch_code} > 0) ${avg_total_ach_branch.$previous_branch_code}=${avg_total_ach_branch.$previous_branch_code}+1;
					if(${curr_ach_06.$previous_branch_code} > 0) ${avg_total_ach_branch.$previous_branch_code}=${avg_total_ach_branch.$previous_branch_code}+1;
					if(${curr_ach_07.$previous_branch_code} > 0) ${avg_total_ach_branch.$previous_branch_code}=${avg_total_ach_branch.$previous_branch_code}+1;
					if(${curr_ach_08.$previous_branch_code} > 0) ${avg_total_ach_branch.$previous_branch_code}=${avg_total_ach_branch.$previous_branch_code}+1;
					if(${curr_ach_09.$previous_branch_code} > 0) ${avg_total_ach_branch.$previous_branch_code}=${avg_total_ach_branch.$previous_branch_code}+1;
					if(${curr_ach_10.$previous_branch_code} > 0) ${avg_total_ach_branch.$previous_branch_code}=${avg_total_ach_branch.$previous_branch_code}+1;
					if(${curr_ach_11.$previous_branch_code} > 0) ${avg_total_ach_branch.$previous_branch_code}=${avg_total_ach_branch.$previous_branch_code}+1;
					if(${curr_ach_12.$previous_branch_code} > 0) ${avg_total_ach_branch.$previous_branch_code}=${avg_total_ach_branch.$previous_branch_code}+1;*/
