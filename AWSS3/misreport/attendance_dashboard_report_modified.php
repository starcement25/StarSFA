...
<center>
	<span style="font-weight:bold; font-size:14px;">Attendance Dashboard</span><br><br>
	...
	function display_result(){
		...
		GenericAjaxFunction('attendance_dashboard_report_modified_data.php?employee='+employee+'&start_date='+start_date+'&end_date='+end_date,'display',0);
	}
	...
	function Popup(data) 
	{
		var mywindow = window.open('', 'Attendance Dashboard Report', 'height=400,width=600');
		mywindow.document.write('<html><head><title>Attendance DashboardReport</title>');
	...
	function exporttocsv(divid)
	{
		...
		a.download = 'Attendance Dashboard Report' + postfix + '.xls';
