...
<center>
	<span style="font-weight:bold; font-size:14px;">Order Approval Details</span><br><br>
	...
	function display_result(){
		...
		GenericAjaxFunction('DMS_order_approval_SFA_data.php?start_date='+start_date+'&end_date='+end_date,'display',0);
	}
	...
	function Popup(data) 
	{
		var mywindow = window.open('', 'Order Approval Report', 'height=400,width=600');
	...
	function exporttocsv(divid)
	{
		...
		a.download = 'Order Approval Report' + postfix + '.xls';
