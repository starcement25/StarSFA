...
function download_xls(){
	...
	var url="download_order_xls_data.php";
	var params = "start_date="+start_date+"&end_date="+end_date+"&employee="+emp_code+"&vertical="+vertical+"&zone="+zone+"&state="+state;
