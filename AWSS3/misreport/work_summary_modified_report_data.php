...
/*---------------------------------> Count of productive call <--------------------------------*/
	...
	foreach($date_array as $visit_date_val)
	{
		...
		foreach($emp_code_array as $emp_code_val)
		{
			...
			$rsreportingname=mysql_query($sqlreportingname);
			$rowreportingname=mysql_fetch_array($rsreportingname);
			...
			if(${'route_string'.$emp_code_val.$visit_date_val}!='')
			{
			  ...
			  else
				{
					...
					$resinformation=mysql_query($sqlinformation);
					$count=mysql_num_rows($resinformation);
						...
						if($count==0)
						{
							...
							else
							{
								...
								$rscountroute=mysql_query($selcountroute);
								$rowcountroute=mysql_fetch_array($rscountroute);
