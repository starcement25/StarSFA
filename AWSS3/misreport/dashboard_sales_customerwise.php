...
<input type="submit" name="submit" value="Submit" onClick="show_sales();" />
</div>
...
function show_sales()
{
	...
	GenericAjaxFunction('dashboard_sales_customerwise_data.php?start_date='+start_date+'&end_date='+end_date,'display',0);
}
...
function Popup(data) 
{
	var mywindow = window.open('', 'Dashboard', 'height=400,width=600');
...
function exporttocsv(divid)
{
	...
	a.download = 'Dashboard Sales' + postfix + '.xls';
