...
function exporttocsv(divid)
{
	...
	a.download = 'Target vs sale Report' + postfix + '.xls';
...
<table width="40%" class="border" style="border-collapse:collapse;" border="1" cellpadding="4">
  <tr  class="TDHEAD">
  	<td colspan="2" align="center">Target Vs Sale Report</td>
  </tr>
  ...
  <tr class="TDHEAD_SUB">
    ...
    <td align="left">
		...
		AND EM.designation IN('RSM','ASM','SO','SR') ORDER BY PM.vertical_value ASC";
...
function get_data(){
	...
	GenericAjaxFunction('target_sale_order_data_verticalwise.php?emp_code='+emp_code+'&start_date='+start_date+'&end_date='+end_date+'&vertical='+vertical+'&cust_type='+cust_type,'display',0);
}
</script>
<?php } ?>