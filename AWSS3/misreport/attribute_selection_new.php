...
To:<input type=\"date\" name=\"end_date\" id=\"end_date\" style=\"height:15px;\" />
   ...
   function branch_saleaccess(branch){
	...
	function saleaccess_emp_type(sale_access){
	   ...
	   document.getElementById("emp_access").value='';
	}
	...
	function saleaccess_emp(sale_access){
		...
		document.getElementById("emp_select_div").innerHTML = '<img src="ajax-loader.gif" id="ajaxloader">';
		GenericAjaxFunction('get_saleaccess_related_data_new.php?sale_access='+sale_access+'&branch='+branch+'&state='+state+'&zone='+zone+'&useractive='+useractive+'&showall=1&type=emp','emp_select_div',0);
