...
function Popup(data) 
{
	var mywindow = window.open('', 'Loose Rate Report', 'height=400,width=600');
	mywindow.document.write('<html><head><title>Loose Rate Report</title>');
...
function exporttocsv(divid)
{
	//alert(divid);
        ...
        a.download = 'Loose Rate Report' + postfix + '.xls';
...
<center>
<br /><br />
<div id="display" style="max-height: 440px; width:45%; overflow-y: scroll; margin-left:10px;" align="center"></div>
...
function show_saudawise()
{
	...
	if(type != 'custom')
		GenericAjaxFunction('pricing_input_details_data.php?type='+type,'display',0);
	else 
	{
		if(response1 != 0 && response2 != 0)
			GenericAjaxFunction('pricing_input_details_data.php?type='+type+'&start_date='+start_date+'&end_date='+end_date,'display',0);
	}
}
</script>
<?php
