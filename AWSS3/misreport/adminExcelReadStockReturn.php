	...
	if($_REQUEST['mode']=="submit_stock_return")
	{
		...
		{	  
			...
			else
			{
				...
				$rsdeletebilling=mysql_query($sqldeletebilling);
				$customer_code_to='-';
			}
		   ...
		   <td>SI</td><td>IMEI</td><td>Return From</td><td>Return To</td></tr>';
				...
				{ 
					...
					{ 
						...
						$rsselcustomercode_from=mysql_query($sqlselcustomercode_from);
						$countselcustomercode_from=mysql_num_rows($rsselcustomercode_from); 
						...
						{
							$rowselcustomercode_from=mysql_fetch_array($rsselcustomercode_from);
						...
						if($dns_customer_code_to!='-')
						{
							...
							$rsselcustomercode_to=mysql_query($sqlselcustomercode_to);
							$countselcustomercode_to=mysql_num_rows($rsselcustomercode_to); 
							...
							{
								$rowselcustomercode_to=mysql_fetch_array($rsselcustomercode_to);
