...
function main(){
	...
	$table_data = "<div id=\"display_data\"><table id=\"criteria_tab\" class=\"border\" width=\"45%\" style=\"border-collapse:collapse;border:1px solid #A92A61; padding:6px;\" ><tr class=\"TDHEAD\"><td colspan=\"2\" align=\"center\">Select Criteria</td></tr>";
		...
		if(strtoupper($_SESSION['nick_name'])!='ABDOS' && strtoupper($_SESSION['nick_name'])!='DNV' && strtoupper($_SESSION['nick_name'])!='RUPA' && strtoupper($_SESSION['nick_name'])!='KARMA')
		{
		$table_data .="<option value=\"employee\">Employee</option>";
		}
		if(strtoupper($_SESSION['nick_name'])!='EMAMI' && strtoupper($_SESSION['nick_name'])!='ABDOS' && strtoupper($_SESSION['nick_name'])!='DNV')
		{
