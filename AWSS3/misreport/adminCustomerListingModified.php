...
function access_add_edit($row_id)
{
	...
	if($mod == 'change_mapping')
	{
		...
		$rowcustomercodechk=mysql_fetch_array($rscustomercodechk);
	...
	$rscustomerproductmapping=mysql_query($sqlcustomerproductmapping);
	while($rowcustomerproductmapping=mysql_fetch_array($rscustomerproductmapping))
	{
...
function change_mapping()
{
	...
	/*if(strtoupper($folderName)=='ASL')
	{
		...
		$rsdnscustomercode=mysql_query($sqldnscustomercode);
		$rowdnscustomercode=mysql_fetch_array($rsdnscustomercode);
		...
		$rsselcustomerbranch=mysql_query($sqlselcustomerbranch);
		$countcustomerbranch=mysql_num_rows($rsselcustomerbranch);
