...
if($type == 'branch'){
	...
	if(strpos($_SERVER['HTTP_REFERER'],'branchwise_schemes_PDF.php') > 0 || strpos($_SERVER['HTTP_REFERER'],'distributorwise_yellowcard_count.php') > 0 || strpos($_SERVER['HTTP_REFERER'],'customer_base_latt_longi_edit.php') > 0){
