...
<br>
<div id="display" style="max-height: 370px; width:95%;overflow-y: scroll;" align="center"></div><br />
...
function show_data()
{
	...
	GenericAjaxFunction('stock_balance_report_data_modified.php?start_date='+start_date+'&end_date='+end_date+'&fso_id='+fso_id+'&customer_code='+customer_code+'&prod_code='+prod_code,'display',0);
}
