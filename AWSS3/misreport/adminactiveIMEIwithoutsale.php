...
<table width="100%" align="center" cellpadding="2" cellspacing="2" border="0">
	<tr>
		<td width="100%" align="left" valign="middle" style="padding:10px;"><strong> Administrator >> Active IMEI without sale</strong></td>
	</tr>
    <tr>
		<td valign="top" >
...
function show_data()
{
	...
	GenericAjaxFunction('activeIMEIwithoutsaleoutdata.php?start_date='+start_date+'&end_date='+end_date+'&fso_id='+fso_id+'&customer_code='+customer_code+'&prod_code='+prod_code,'display',0);
}
