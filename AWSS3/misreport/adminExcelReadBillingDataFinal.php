...
if($_REQUEST['mode']=="xls_upload"){
	...
	if(file_exists($_FILES['zip_file']['tmp_name']))
	{
	  ...
	  //For billing information xls
	   if(similar_file_exists("../csv/$folderName/billing information.xlsx")!=false || similar_file_exists("../csv/$folderName/billing information.xls")!=false)
	    {
		$rec_count = 0;
		$ins_count = 0;
		$err = "";
		...
		//$lines = file($filename);
		if(similar_file_exists("../csv/$folderName/billing information.xlsx")!=false)
		{
			$inputfilename = "../csv/$folderName/billing information.xlsx";
		}
		if(similar_file_exists("../csv/$folderName/billing information.xls")!=false)
		{
			$inputfilename = "../csv/$folderName/billing information.xls";
		}
				...
				{ 
					...
					{ 
					  ...
					  if($countprodcode==0)
						...
						{
							$rowchkactiveallocation=mysql_fetch_array($rschkactiveallocation);
