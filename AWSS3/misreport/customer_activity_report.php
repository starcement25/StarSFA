...
<center>
	<span style="font-weight:bold; font-size:14px;">Customer Activity Report</span><br><br>
	...
	function display_result(){
		...
		GenericAjaxFunction('customer_activity_report_data.php?employee_id='+employee_id+'&route='+route+'&start_date='+start_date+'&end_date='+end_date,'display',0);
	}
	...
	function Popup(data) 
	{
		var mywindow = window.open('', 'Customer Activity List', 'height=400,width=600');
...
function exporttocsv(){
	...
	a.download = 'Customer_activity_list' + postfix + '.xls';
