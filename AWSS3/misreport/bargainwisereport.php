...
function Popup(data) 
{
	var mywindow = window.open('', 'Bargainwise Report', 'height=400,width=600');
	mywindow.document.write('<html><head><title>Bargainwise Report</title>');
...
function exporttocsv(divid)
{
	//alert(divid);
        ...
        a.download = 'Bargainwise Report' + postfix + '.xls';
...
<center>
<div style="width:95%; text-align:center;"><strong>Bargain Wise Report</strong></div><br>
<table width="100%">
  <tr>
...
function show_saudawise()
{
	...
	if(type != 'custom')
		GenericAjaxFunction('bargaindata.php?type='+type,'display',0);
	else 
	{
		if(response1 != 0 && response2 != 0)
			GenericAjaxFunction('bargaindata.php?type='+type+'&start_date='+start_date+'&end_date='+end_date,'display',0);
	}
}
