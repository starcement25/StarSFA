...
$countbranches=mysqli_num_rows($rsbranches);
 ...
 {
	  $sqlquery="SELECT DISTINCT c1.customer_code,c1.credit_limit FROM customer_master c1,emp_route_relation ERM
 ...
 {
 	$sqlquery="SELECT DISTINCT c1.customer_code,c1.credit_limit FROM customer_master c1,emp_route_relation ERM WHERE ".$emp_hierarchy_condition."
					 AND c1.route_code=ERM.route_code AND ERM.acends!='N' ".$login_condition." ORDER BY c1.customer_name ASC";
 }
...
$count=mysqli_num_rows($result);
	...
	$url = "http://www.acedns.in/acednsproduct/customer-master-credit-limit-incremental-6.0.1.php?nick_name=$nick_name&emp_code=$emp_code&last_update_time=$last_update_time&data_download_time=$data_download_time&incremental_download=$incremental_download";
