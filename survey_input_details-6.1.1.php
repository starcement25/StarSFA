...
$sqlsurveydetails="SELECT row_id,action_id,menu_id,layout_name,display_name,type,display_table_name,mandatory,action,validation,display_order,
				survey_type,survey_sub_menu,acedns,insert_table_detail FROM survey_input_lead WHERE 1 ".$login_condition."";
...
if($count>0){
	...
	$emp_code='';
	$url = "http://salesmpower.acedns.in/survey_input_details-6.1.1.php?nick_name=$nick_name&last_update_time=$last_update_time&type=$type&incremental_download=$incremental_download";
