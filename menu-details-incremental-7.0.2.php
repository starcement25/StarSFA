...
$count=mysqli_num_rows($result);
	...
	$url = APICALLLOGURL."/menu-details-incremental-7.0.2.php?nick_name=$nick_name&last_update_time=$last_update_time&incremental_download=$incremental_download&mode=$mode";
