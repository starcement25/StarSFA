...
if(strtoupper($nick_name)=='UCLINDIA')
{
	$acedns_conditions=" AND acedns='Y'";
}
else
{
	$acedns_conditions="";
...
{
	$sqlquery="SELECT MRP.* FROM mrp MRP WHERE 1 ".$acedns_conditions." ".$condition_one." ".$login_condition."";
}
...
$count=mysqli_num_rows($result);
	...
	$url = APICALLLOGURL."/mrp-txt-incremental-6.0.3.php?nick_name=$nick_name&emp_code=$emp_code&last_update_time=$last_update_time&data_download_time=$data_download_time&incremental_download=$incremental_download";
