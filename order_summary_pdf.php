...
require("include/functions.php");
	...
	$state = $row_emp_name['state'];
			...
			$pdf_html="<html><body>
				 <table border=\"1\" width=\"100%\" cellpadding=\"3\" cellspacing=\"3\"> 
					  ...
					  <tr>
						<td  width=\"7%\" style=\"height: 40px;\"><b>Sl.No</b></td>
						<td width=\"14%\" style=\"height: 40px;\"><b>Area Name</b></td>
						<td width=\"14%\" style=\"height: 40px;\"><b>Route Name</b></td>
						<td width=\"14%\" style=\"height: 40px;\"><b>Counter Name</b></td>
						<td width=\"14%\" style=\"height: 40px;\"><b>Product Name</b></td>
						<td  width=\"10%\" style=\"height: 40px;\"><b>Product Qty In Pcs</b></td>
						<td  width=\"10%\" style=\"height: 40px;\"><b>Product Qty In CS</b></td>
						<td  width=\"17%\" style=\"height: 40px;\"><b>Remarks</b></td>
					  </tr>";
	...
	while($rowordersummary=mysqli_fetch_assoc($resordersummary)){
		...
		if(!in_array($customer_name,$customer_name_array) )
		{
			...
			if(count($customer_name_array) > 0)
			{
			$pdf_html.="<tr><td colspan=\"8\" style=\"height: 15px;\"></td></tr>";
			}
		}
		else	$customer_name_val='';
		
		
			 $pdf_html.="<tr>
				<td style=\"height: 40px;\">$cntac</td>
				<td style=\"height: 40px;\">$area_name</td>
				<td style=\"height: 40px;\">$route_name</td>
				<td style=\"height: 40px;\">$customer_name_val</td>
				<td style=\"height: 40px;\">$prod_desc</td>
				<td align=\"center\" style=\"height: 40px;\">$qtyconvertedpcs</td>
				<td align=\"center\" style=\"height: 40px;\"> $qtyconvertedcase</td>
