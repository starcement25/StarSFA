...
class xml_customer_header{
    var $emp_code, $trans_id,$prospect_date,$latt,$longi,$prospectiveheader_trans_id,$prospectiveheader_customer_code,$customer_name,$address,$pin,$area,$phone_no,$remarks,$tagged_customer_code,$cust_type,$category_of_store;
}
...
function contents($parser, $data){
    global $current_tag, $emp_code,$trans_id,$prospect_date,$latt,$longi,$prospectiveheader_trans_id,$prospectiveheader_customer_code,$customer_name,$address,$pin,$area,$phone_no,$remarks,$tagged_customer_code,$cust_type,$category_of_store,$counter, $counterdetails,$prospectivedetails_trans_id,$prospectivedetails_product_code,$prospective_customer_array,$prospective_customer_details_array;
	//echo $current_tag.'<br />';
	//echo $data;
