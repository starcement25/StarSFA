...
if($countbranches>1)
{
   $sqlquery="SELECT DISTINCT PM.* FROM product_master PM WHERE PM.prod_desc <>'' ".$condition_one." ORDER BY PM.prod_desc ASC";
}
else
{
	$sqlquery="SELECT DISTINCT PM.* FROM product_master PM WHERE PM.prod_desc <>'' ".$condition_one." ORDER BY PM.prod_desc ASC";
...
$count=mysqli_num_rows($result);
	...
	$url = "http://salesmpower.acedns.in/OTP-product-master.php?nick_name=$nick_name&emp_code=$emp_code";
