...
$tour_expense_transport_mode2 ="*ROOT*TOUR_EXPENSE*TOUR_EXPENSE_DETAILS*TRAVEL_MODE2";
$tour_expense_transport_mode3 ="*ROOT*TOUR_EXPENSE*TOUR_EXPENSE_DETAILS*TRAVEL_MODE3";
$tour_expense_transport_fair ="*ROOT*TOUR_EXPENSE*TOUR_EXPENSE_DETAILS*TRANSPORT_FAIR";
$tour_expense_transport_fair2 ="*ROOT*TOUR_EXPENSE*TOUR_EXPENSE_DETAILS*TRANSPORT_FAIR2";
$tour_expense_transport_fair3 ="*ROOT*TOUR_EXPENSE*TOUR_EXPENSE_DETAILS*TRANSPORT_FAIR3";
...
$tour_expense_daily_assistance ="*ROOT*TOUR_EXPENSE*TOUR_EXPENSE_DETAILS*DAILY_ASSISTANCE";
$tour_expense_km_traveled="*ROOT*TOUR_EXPENSE*TOUR_EXPENSE_DETAILS*KM_TRAVELED";
...
class xml_tour_expense{
	...
	$tour_expense_arr_time,$tour_expense_place_from,$tour_expense_place_to,$tour_expense_local_conveyance,$tour_expense_transport_mode,$tour_expense_transport_mode2,$tour_expense_transport_mode3,$tour_expense_transport_fair,$tour_expense_transport_fair2,$tour_expense_transport_fair3,$tour_expense_fooding_allowance,
	...
	$tour_expense_other_expenses,$tour_expense_supporting_attachment_file,$tour_expense_fuel_bill_attachment,$tour_expense_misc,$tour_expense_daily_assistance,$tour_expense_km_traveled;
}
...
function contents($parser, $data){
	...
	$tour_food_lodge_trans_id,$tour_expense_emp_code,$tour_expense_tour_type,$tour_expense_tour_date_from,$tour_expense_tour_date_to,$tour_expense_dep_time,
	$tour_expense_arr_time,$tour_expense_place_from,$tour_expense_place_to,$tour_expense_local_conveyance,$tour_expense_transport_mode,$tour_expense_transport_mode2,$tour_expense_transport_mode3,
	$tour_expense_transport_fair,$tour_expense_transport_fair2,$tour_expense_transport_fair3,$tour_expense_fooding_allowance,
	$tour_expense_hotel_charge,$tour_expense_remarks,$tour_expense_transport_attachment,$tour_expense_fooding_attachment,$tour_expense_lodging_attachment,
	$tour_expense_other_expenses,$tour_expense_supporting_attachment_file,$tour_expense_fuel_bill_attachment,$tour_expense_misc,$tour_expense_array,$counter,$current_tag,$tour_expense_daily_assistance,$tour_expense_km_traveled;
	if(substr($current_tag,0,18)=='*ROOT*TOUR_EXPENSE')
	{
		...
		switch($current_tag){
			...
			case $tour_expense_transport_mode:
				...
				break;
			case $tour_expense_transport_mode2:
				$tour_expense_array[$counter]->tour_expense_transport_mode2 = $data;
				break;
			case $tour_expense_transport_mode3:
				$tour_expense_array[$counter]->tour_expense_transport_mode3 = $data;
				break;
			case $tour_expense_transport_fair:
				$tour_expense_array[$counter]->tour_expense_transport_fair = $data;
				break;
				case $tour_expense_transport_fair2:
				$tour_expense_array[$counter]->tour_expense_transport_fair2 = $data;
				break;
				case $tour_expense_transport_fair3:
				$tour_expense_array[$counter]->tour_expense_transport_fair3 = $data;
				break;
		   ...
		   case $tour_expense_remarks:
			...
			case $tour_expense_misc:
				...
				break;
			case $tour_expense_daily_assistance:
				$tour_expense_array[$counter]->tour_expense_daily_assistance = $data;
				break;
			case $tour_expense_km_traveled:
				$tour_expense_array[$counter]->tour_expense_km_traveled = $data;
				$counter++;
				break;				
		}
	}
...
if(count($tour_expense_array)>0)
{
	...
	for($x=0;$x<count($tour_expense_array);$x++){
		...
		$tour_expense_transport_mode2=$tour_expense_array[$x]->tour_expense_transport_mode2;
		$tour_expense_transport_mode3=$tour_expense_array[$x]->tour_expense_transport_mode3;
		$tour_expense_transport_fair=$tour_expense_array[$x]->tour_expense_transport_fair;
		$tour_expense_transport_fair2=$tour_expense_array[$x]->tour_expense_transport_fair2;
		$tour_expense_transport_fair3=$tour_expense_array[$x]->tour_expense_transport_fair3;
		...
		$tour_expense_daily_assistance=$tour_expense_array[$x]->tour_expense_daily_assistance;
		$tour_expense_km_traveled=$tour_expense_array[$x]->tour_expense_km_traveled;
		...
		if($countchkorlocation>0)
		{
		    ...
		    if($tour_expense_latt==""){
			    $tour_expense_latt ="0";
			}
			if($tour_expense_longi==""){
			    $tour_expense_longi ="0";
			}
		...
		else
		{
		    ...
		    if(is_null($tour_expense_tour_date_to)){
		        $tour_expense_tour_date_to = "1971-01-01";
		    }
		    if($tour_expense_tour_date_to==""){
		        $tour_expense_tour_date_to = "1971-01-01";
		    }
		    if($tour_expense_tour_date_to=="null"){
		        $tour_expense_tour_date_to = "1997-01-01";
		    }
		    if($tour_expense_transport_fair2==""){
		        $tour_expense_transport_fair2 = "0";
		    }
		    
		    if($tour_expense_transport_fair3==""){
		        $tour_expense_transport_fair3 = "0";
		    }
		    if($tour_expense_other_expenses==""){
		        $tour_expense_other_expenses = "0";
		    }
		    if($tour_expense_local_conveyance==""){
		        $tour_expense_local_conveyance = "0";
		    }
		    if($tour_expense_fooding_allowance==""){
		        $tour_expense_fooding_allowance = "0";
		    }
		    if($tour_expense_transport_fair==""){
		        $tour_expense_transport_fair = "0";
		    }
		     if($tour_expense_hotel_charge==""){
		        $tour_expense_hotel_charge = "0";
		    }
		    if($tour_expense_hotel_charge==""){
		        $tour_expense_hotel_charge = "0";
		    }
		    if($transport_fuel_charges==""){
		        $transport_fuel_charges = "0";
		    }
		    
		    
		    //echo "kjgjg".$tour_expense_tour_date_to;
			...
			$sqlinserttourexpense="INSERT INTO tour_expenses_details SET tour_exp_trans_id='".$tour_food_lodge_trans_id."',
								  ...
								  other_expenses			='".addslashes($tour_expense_other_expenses)."',
									...
									daily_assistance		='".addslashes($tour_expense_daily_assistance)."',
									km_traveled				='".addslashes($tour_expense_km_traveled)."',
									
									transport_mode_type2				='".addslashes($tour_expense_transport_mode2)."',
									transport_mode_type3				='".addslashes($tour_expense_transport_mode3)."',
									transport_fair2				='".addslashes($tour_expense_transport_fair2)."',
									transport_fair3				='".addslashes($tour_expense_transport_fair3)."',
									transport_fuel_charges				='".addslashes($transport_fuel_charges)."',
									
								  other_attachment_file		='".$tour_expense_supporting_attachment_file."'";
								  
								  //echo "lllll".$sqlinsertorlocation;
								  //echo "tututt".$sqlinserttourexpense;
