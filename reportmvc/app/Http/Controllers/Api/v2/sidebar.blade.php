...
$showmenu=Commonfunctions::getNameMenuDetails();
 ...
 $windowtimelatest=Reverseauction::getWindowtime($sdbname);
        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
            	@if(strtoupper(Session::get('nick_name'))=='EMAMIT' || strtoupper(Session::get('nick_name'))=='EMAMI')
                    ...
                    @php
                    if((strtotime($windowtimelatest) - strtotime($currenttime)) > 0) { @endphp
                    <li><a href="Javasript:void(0);" onclick="javasripe:show_message();">Release Rate</a></li>
					 @php }
                     else { @endphp
