...
<div class="right_col" role="main">
  <form name="upload_margin" method="post" action="/reportmvc/uploadmarginsubmit" enctype="multipart/form-data" onsubmit="return checking_windowtime();"/>
    {{ csrf_field() }}
   ...
   <div class="main-container">
   		 <h3 align="center"><u>Upload Margin Cost Csv File</u></h3>
         <div class="clearfix" style="height:10px;"></div>
         <div class="form-group" align="center">
          <label class="control-label col-md-3 col-sm-3 col-xs-12"></label>
           <div class="col-md-9 col-sm-9 col-xs-12" >
             {{ Form::file('margin_csv_file', null, array(
                 'class' => 'form-control',
                 'id' => 'uploaded_file',
             )) }}
           </div>
