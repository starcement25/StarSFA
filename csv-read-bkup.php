				...
				{ 
				  ...
				  //print_r($data);
					...
					else
					{
						...
						if($route_code_db!=$route_code || $emp_code_db!=$emp_code || $current_balance_db!=$current_balance || $credit_limit_db!=$credit_limit || $acedns_db!=$acedns || $black_list_db!=$black_list || $vertical_value_db!=$vertical_value)
						{
							$sqltemp  = "insert into customer_master_temp ";
