...
$count=mysqli_num_rows($result);
	...
	$url = APICALLLOGURL."/menu-details-incremental-8.1.9.php?nick_name=$nick_name&last_update_time=$last_update_time&incremental_download=$incremental_download&mode=$mode";
