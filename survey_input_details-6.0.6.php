...
if($count>0){
	...
	$emp_code='';
	$url = "http://salesmpower.acedns.in/survey_input_details-6.0..php?nick_name=$nick_name&last_update_time=$last_update_time&type=$type&incremental_download=$incremental_download";
