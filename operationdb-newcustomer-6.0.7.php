...
class xml_new_customer{
	var $location_emp_code,$location_trans_id,$location_latt,$location_longi,$location_date,$new_customer_code,$new_customer_name,$phone_no,$pin_code,$area,$area_name,$rds_tag,$address,$landline_no,$owner_name,$owner_phone,$cust_class,$weekly_closing_day,$coverage_type,$TIN,$PAN,$email,$acedns;	
}
...
function contents($parser, $data){
	...
	$email,$acedns,$new_customer_array;
	//echo $current_tag.'<br />';
	//echo $data.'<br />';
