...
class xml_market_feedback_data{
	var $market_feedback_id,$route_code,$customer_code,$product_group,$competitor_name,$PTD,$PTR,$PTC,$PV,$billing_ex_for,$wsp_ex_for;
}
...
function contents($parser, $data){
	...
	$billing_ex_for,$wsp_ex_for,$market_feedback_array,$market_feedback_data_array,$attendance_array;
	//echo $current_tag.'<br />';
	//echo $data.'<br />';
