			...
			foreach($lines as $line)
			{
				...
				{ 
				  ...
				  //print_r($data);
					...
					$sql .= " ,emp_code='".mysqli_real_escape_string($emp_code)."'";
...
<table width="70%" align="center" cellpadding="5" cellspacing="2" class="border">
	<form name="form_add_app" action="<?=$_SERVER['PHP_SELF']?>" method="post"  enctype="multipart/form-data" >
