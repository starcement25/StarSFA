...
function contents($parser, $data){
	...
	// For parsing 'purpose_of_visit' tag
    if ($current_tag === "*ROOT*MARKET_FEEDBACK_STKAUDIT*MF_STKAUDIT_DATA*MF_STKAUDIT_HEADER*PURPOSE_OF_VISIT") {
        // Do something with the 'purpose_of_visit' data here
