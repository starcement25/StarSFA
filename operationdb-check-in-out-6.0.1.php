...
class xml_check_in_out{
	var $location_emp_code,$location_trans_id,$location_latt,$location_longi,$location_date,$trans_id,$check_in_time,$customer_code,$check_out_time,
	$remarks,$hint_remarks,$product_tagging;	
}
...
function contents($parser, $data){
    global $current_tag,$counter,$countercheckin,$attendance_emp_code, $attendance_trans_id,$attendance_latt,$attendance_longi,$attendance_date,$attendancedata_emp_code,$attendancedata_date,$location_emp_code,$location_trans_id,$location_latt,$location_longi,$location_date,$trans_id,$check_in_time,$customer_code,$check_out_time,$remarks,$hint_remarks,$product_tagging,$check_in_out_array,$attendance_array;
	//echo $current_tag.'<br />';
	//echo $data.'<br />';
