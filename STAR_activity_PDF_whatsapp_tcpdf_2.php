...
require("include/functions.php");
	...
	function pdf_create($html, $filename, $messageid, $phoneno, $emp_name, $attach_file_name) 
	{
		...
		if($tcpdf=='')
		{
			...
			$sqlupdate="UPDATE whats_app_log SET PDF_URL_2='".$pdf_URL."' WHERE receive_emp_code='".substr($filename,0,5)."' AND 
						SUBSTRING(receive_date,1,10)='".$prevdatetimeserver."'";
	...
	$emp_val_rds=' AND (LO.emp_code IN('.$employee_hierarchy.'))';
		$pdf_html="<html><body>
				<table width=\"100%\" >
				  <tr>
					<td align=\"right\" width=\"65%\"><b>SFA MARKET ACTIVITY REPORT FOR LESS THAN 5 VISITS</b><br /><b>(DATE: $previous_day)</b></td><td align=\"right\" width=\"35%\"><img src=\"http://salesmpower.acedns.in/logo/STAR.png\"/ height=\"50\" width=\"90\"></td>
				  </tr>
				  </table>
				  <table width=\"100%\" >
				  <tr>
				 ...
				 <table border=\"1\" width=\"100%\" cellpadding=\"2\" cellspacing=\"2\"> 
					  <tr>
						...
						<td width=\"29%\"><b>EMPLOYEE NAME</b></td>
						<td width=\"26%\"><b>DESIGNATION</b></td>
						<td width=\"18%\"><b>HQ</b></td>
		...
		while($rowlocation = mysqli_fetch_assoc($resultlocation))
		{
		   ...
		   $total_customer_visit=$rowcustomervisit['tot_customer_visit'];
			...
			if($total_customer_visit <5){
				$cnt_less_five=$cnt_less_five+1;
			 $pdf_html.="<tr>
				<td >$cntac</td>
			...
			$pdf_html.="</table></body></html>";
			 //echo $pdf_html;
			$filename=$emp_code.'_less_5_visits_'.$prevdatetimeserver.'.pdf';
