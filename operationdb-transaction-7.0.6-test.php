...
/*if($nick_name=='ABDOS' || $nick_name=='ABDOST'  || $nick_name=='MAGIK' || $nick_name=='PALSONS' ||  strtoupper($nick_name)=='STAR' || strtoupper($nick_name)=='SYLVAN')
{
...
$body="<?xml version='1.0' encoding='UTF-8'?><root><order><location><emp_code><![CDATA[E0001]]></emp_code><trans_id><![CDATA[OE000120230607182202]]></trans_id><latt><![CDATA[22.5162114]]></latt><longi><![CDATA[88.3536054]]></longi><date><![CDATA[2023-06-07 18:22:02]]></date><TA_DA_MODE><![CDATA[]]></TA_DA_MODE></location><orderdata><order_header><order_no><![CDATA[OE000120230607182202]]></order_no><customer_name><![CDATA[]]></customer_name><Phone_no><![CDATA[]]></Phone_no><address><![CDATA[]]></address><pin_code><![CDATA[]]></pin_code><area><![CDATA[]]></area><area_name><![CDATA[]]></area_name><TD><![CDATA[0]]></TD><sale_type><![CDATA[CREDIT]]></sale_type><order_value><![CDATA[20]]></order_value><d_instruction><![CDATA[]]></d_instruction><tag_distributor_code><![CDATA[]]></tag_distributor_code><cust_type><![CDATA[]]></cust_type><customer_flag><![CDATA[]]></customer_flag><transaction_type><![CDATA[SO]]></transaction_type><vat><![CDATA[0.00]]></vat><grn_no><![CDATA[null]]></grn_no><vertical_value><![CDATA[]]></vertical_value><DESTINATION_CODE><![CDATA[]]></DESTINATION_CODE><ORDER_TYPE><![CDATA[]]></ORDER_TYPE><FREIGHT_COMPONENT><![CDATA[]]></FREIGHT_COMPONENT><HINT_REMARKS><![CDATA[]]></HINT_REMARKS><GST_type><![CDATA[]]></GST_type><customer_code><![CDATA[NE000120230509123036]]></customer_code><base_latt><![CDATA[ ]]></base_latt><base_longi><![CDATA[ ]]></base_longi><image><![CDATA[null]]></image><freight_component_value><![CDATA[]]></freight_component_value></order_header><order_details><Order_no><![CDATA[OE000120230607182202]]></Order_no><Sku_code><![CDATA[12002]]></Sku_code><qty><![CDATA[2.0]]></qty><TD><![CDATA[0.00]]></TD><PREMIUM><![CDATA[0]]></PREMIUM><sale_rate><![CDATA[05]]></sale_rate><VAT><![CDATA[0]]></VAT><amount><![CDATA[10.00]]></amount><UOM><![CDATA[MT]]></UOM><mrp_code><![CDATA[]]></mrp_code><weightage><![CDATA[]]></weightage><remarks><![CDATA[null]]></remarks><input_size><![CDATA[]]></input_size></order_details><order_details><Order_no><![CDATA[OE000120230607182202]]></Order_no><Sku_code><![CDATA[12003]]></Sku_code><qty><![CDATA[2.0]]></qty><TD><![CDATA[0.00]]></TD><PREMIUM><![CDATA[0]]></PREMIUM><sale_rate><![CDATA[05]]></sale_rate><VAT><![CDATA[0]]></VAT><amount><![CDATA[10.00]]></amount><UOM><![CDATA[MT]]></UOM><mrp_code><![CDATA[]]></mrp_code><weightage><![CDATA[]]></weightage><remarks><![CDATA[null]]></remarks><input_size><![CDATA[]]></input_size></order_details></orderdata></order></root>";
...
class xml_order{
	var $order_emp_code,$order_trans_id,$order_latt,$order_longi,$order_date,$order_TA_DA_mode,$orderdataheader_order_no,$orderdataheader_customer_code,$orderdataheader_customer_name,
...
function contents($parser, $data){
	...
	$order_emp_code,$order_trans_id,$order_latt,$order_longi,$order_date,$order_TA_DA_mode,$orderdataheader_order_no,$orderdataheader_customer_code,$orderdataheader_customer_name,
...
if(count($order_array)>0)
{
	for($x=0;$x<count($order_array);$x++){
		...
		else
		{
			...
			echo $sqlinsertorlocation="INSERT INTO location SET emp_code='".$order_emp_code."',
									...
									latt='".$order_latt."',
									longi='".$order_longi."',
									date='".$order_date."',".$TA_DA_condiion."
									updatetime='".$location_date."'"; 
	...
	//print_r($order_details_array);
	//exit();
	echo 'dfddfddfd'.count($order_details_array);
		if(count($order_details_array)>0)
		{
			for($i=0;$i<count($order_details_array);$i++){
				...
				if($nick_name=='DNV' || $nick_name=='HALDIRAM')
				{
					...
					if(no_of_filter==2){
						echo $sqlproductdetails="SELECT PGM.product_group_name,PM.prod_desc,PM.conversion_factor,PM.UOM1,PM.UOM2,PM.dns_prod_code,PM.category
					...
					//if(!in_array($orderdatadetails_order_no,$order_array_trans_id))
					{
						...
						//if(mysqli_query($link,$sqlinsertorderdetails))
						{
						   ...
						   if($nick_name=='RUPA')
							...
							if($nick_name=='ABDOS')
							{
								echo $qty=$orderdatadetails_qty;
								$trans_type='O';
								echo $orderdatadetails_weightage;
						...
						if(strtoupper($nick_name)=='GOLDSTONET')
						{
							echo $servername = "dealers.blacktigercement.com";
							$username = "goldstonedms";
							$password = "goldstonedms1234#";
							$db_name = "GOLDSTONEDMS";
							$conn = mysqli_connect($servername, $username, $password);
							if(!$conn){
							   die('Could not connect: ' . mysqli_error());
							}
							
							$sqllatestid="SELECT MAX(APPORDERNO) AS max_apporderno FROM $t_apperpdo WHERE APPORDERNO LIKE 'DO%'";
							$rslatestid=mysqli_query($link,$sqllatestid);
							$cntlatestid=mysqli_num_rows($rslatestid);
							$rowlatestid=mysqli_fetch_assoc($rslatestid);
							$max_apporderno=$rowlatestid['max_apporderno'];
							if($max_apporderno=='')
							{
								$max_apporderno='DO2000000';
							}
							else
							{
							...
							echo $sqlordersavedms="INSERT INTO T_APPERPDO  SET
											 	APPORDERNO='".$max_apporderno."',
												customer_code='".$orderdataheader_customer_code."',
												dns_customer_code='".$dns_customer_code."',
												 prod_display_name='".$prod_desc."',
												 QTY='".$orderdatadetails_qty."'";
						    if(mysqli_query($link,$sqlordersavedms))
							{
								$flag=5;
							}
						}
