...
$count=mysqli_num_rows($result);
	...
	$url = "http://salesmpower.acedns.in/order-form-details-incremental-7.1.3.php?nick_name=$nick_name&last_update_time=$last_update_time&incremental_download=$incremental_download&mode=$mode";
