...
$sqlquery="SELECT DISTINCT CPR.customer_code,PM.prod_code,CPR.acedns,CPR.mcx_rate_parameter FROM customer_product_relation CPR 
			INNER JOIN 
...
$count=mysqli_num_rows($result);
	...
	$url = "http://salesmpower.acedns.in/customer-product-relation-txt-6.0.1.php?nick_name=$nick_name&emp_code=$emp_code";
