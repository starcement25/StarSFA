...
/*$body="<?xml version='1.0' encoding='UTF-8'?><root><route_plan><routedata><route_plan_header><route_plan_trans_id><![CDATA[RPE004320190110171607]]></route_plan_trans_id><emp_code><![CDATA[E0043]]></emp_code><route_code><![CDATA[RT/12]]></route_code><route_name><![CDATA[Golaghat]]></route_name><visit_date><![CDATA[10-01-2019]]></visit_date><remarks><![CDATA[]]></remarks><create_date><![CDATA[2019-01-10 17:16:07]]></create_date><status><![CDATA[active]]></status></route_plan_header><route_plan_details><route_plan_trans_id><![CDATA[RPE004320190110171607]]></route_plan_trans_id><route_code><![CDATA[RT/12]]></route_code><visit_date><![CDATA[10-01-2019]]></visit_date><customer_code><![CDATA[C/0000039]]></customer_code><status><![CDATA[active]]></status></route_plan_details><route_plan_details><route_plan_trans_id><![CDATA[RPE004320190110171607]]></route_plan_trans_id><route_code><![CDATA[RT/12]]></route_code><visit_date><![CDATA[10-01-2019]]></visit_date><customer_code><![CDATA[C/0001561]]></customer_code><status><![CDATA[active]]></status></route_plan_details><route_plan_details><route_plan_trans_id><![CDATA[RPE004320190110171607]]></route_plan_trans_id><route_code><![CDATA[RT/12]]></route_code><visit_date><![CDATA[10-01-2019]]></visit_date><customer_code><![CDATA[C/0001565]]></customer_code><status><![CDATA[active]]></status></route_plan_details></routedata></route_plan></root>";*/
...
$route_plan_header_status ="*ROOT*ROUTE_PLAN*ROUTEDATA*ROUTE_PLAN_HEADER*STATUS";
...
$route_plan_details_status ="*ROOT*ROUTE_PLAN*ROUTEDATA*ROUTE_PLAN_DETAILS*STATUS";
...
class xml_route_plan{
	var $route_plan_header_trans_id,$route_plan_header_emp_code,$route_plan_header_route_code,$route_plan_header_route_name,$route_plan_header_visit_date,$route_plan_header_remarks,$route_plan_header_create_date,$route_plan_header_status;
}
class xml_route_plan_details{
	var $route_plan_details_trans_id,$route_plan_details_route_code,$route_plan_details_visit_date,$route_plan_details_customer_code,$route_plan_details_status;
}
...
function contents($parser, $data){
    global $current_tag,$route_plan_header_trans_id,$route_plan_header_emp_code,$route_plan_header_route_code,$route_plan_header_route_name,$route_plan_header_visit_date,$route_plan_header_remarks,$route_plan_header_create_date,$route_plan_header_status,$route_plan_details_trans_id,$route_plan_details_route_code,$route_plan_details_visit_date,$route_plan_details_customer_code,$route_plan_details_status,$route_plan_array,$counter,$counterdetails,$route_plan_details_array;
	if(substr($current_tag,0,16)=='*ROOT*ROUTE_PLAN')
	{
		...
		switch($current_tag){
			...
			case $route_plan_header_create_date:
				...
				break;
			case $route_plan_header_status:
				$route_plan_array[$counter]->route_plan_header_status = $data;
				$counter++;
				break;				
		}
	}
	if(substr($current_tag,0,45)=='*ROOT*ROUTE_PLAN*ROUTEDATA*ROUTE_PLAN_DETAILS')
	{
		...
		switch($current_tag){
			...
			case $route_plan_details_customer_code:
				...
				break;
			case $route_plan_details_status:
				$route_plan_details_array[$counterdetails]->route_plan_details_status = $data;
				$counterdetails++;
				break;			
		}
	}
...
if(count($route_plan_array)>0)
{
	...
	for($x=0;$x<count($route_plan_array);$x++){
		...
		$route_plan_header_status=$route_plan_array[$x]->route_plan_header_status;
		...
		if($countselectrouteplan<1)
		{
			$sqlinsertrouteplan="INSERT INTO route_plan SET route_plan_trans_id ='".$route_plan_header_trans_id."',
								  ...
								  status			='".$route_plan_header_status."',	
		...
		$sqlselectroutecustomerplan="DELETE FROM route_customer_plan WHERE route_code ='".$route_plan_header_route_code."' 
										AND visit_date	='".$route_plan_visit_date_database."' ";				  					  			
		$resselectroutecustomerplan = mysqli_query($link,$sqlselectroutecustomerplan) or die(mysqli_error()." Error in chk trans id for route customer plan: 
	...
	if(count($route_plan_details_array)>0)
	{
		for($i=0;$i<count($route_plan_details_array);$i++){
			...
			$route_plan_details_status=$route_plan_details_array[$i]->route_plan_details_status;
			...
			{*/
				$sqlinsertroutecustomerplan="INSERT INTO route_customer_plan SET route_plan_trans_id ='".$route_plan_details_trans_id."',
										  ...
										  status			='".$route_plan_details_status."',
										  download_time		=CURRENT_TIMESTAMP()";
				if(mysqli_query($link,$sqlinsertroutecustomerplan))
				{
					$flag=5;
				}
				else
			...
			/*else
			{
				...
				if(mysqli_query($link,$sqldeleteroutecustomerplan)){
					$flag=5;
				}
				else
				{
