...
require("include/functions.php");
		...
		$pdf_html="<HTML><BODY>
			...
			$valpart='KKD';
			$subject="Quotation generated for -".$farmer_name;
			$message = Swift_Message::newInstance()
						   ...
						   ->attach(Swift_Attachment::newInstance($pdf_content, "Quotation_".$mi_id."_".$mi_reference_no.".pdf", 'application/pdf')); // Attach the generated PDF from earlier
