...
$sqllocation = "SELECT emp_code,trans_id,date,latt,longi FROM location WHERE 1 ".$emp_val_rds.$login_condition;
...
$contentsdatetime =$year.'-'.$month.'-'.$date.'€'.$hour.':'.$minute.':'.$second."\n";
	...
	$url = "http://salesmpower.acedns.in/location-txt-incremental-6.0.0.php?nick_name=$nick_name&emp_code=$emp_code&last_update_time=$last_update_time&incremental_download=$incremental_download";
