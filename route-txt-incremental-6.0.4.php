...
else
{
	...
	if(modified_customer_emp_route=='yes' && $nick_name!='OSHEA' && $nick_name!='HALDIRAM' && $nick_name!='PRAKASH' && $nick_name!='ARCHITA' && $nick_name!='PRABHUJI' && $nick_name!='PRABHUJI' && $nick_name!='AJANTA' && $nick_name!='EDIBLE' && $nick_name!='ASL')
	{
		...
		|| $nick_name=='AJANTA' || $nick_name=='EDIBLE' || $nick_name=='ASL')
	{
