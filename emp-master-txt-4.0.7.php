...
$sqlquery="SELECT emp_code,emp_name,sale_access,reporting_to,designation FROM employee_master WHERE branch_code IN($branch_code_list) ORDER BY emp_name ASC";
}
else
{
$sqlquery="SELECT emp_code,emp_name,sale_access,reporting_to,designation FROM employee_master WHERE ".$emp_hierarchy_condition." ORDER BY emp_name ASC";
}
