...
$count=mysqli_num_rows($result);
	...
	$url = APICALLLOGURL."/survey-form-details-incremental-6.1.1.php?nick_name=$nick_name&last_update_time=$last_update_time&incremental_download=$incremental_download&mode=$mode";
