...
$body="<?xml version='1.0' encoding='UTF-8'?><root><check_in_out><location><emp_code><![CDATA[E0761]]></emp_code><trans_id><![CDATA[CIE076120190912114111]]></trans_id><latt><![CDATA[25.5547543]]></latt><longi><![CDATA[88.4785191]]></longi><date><![CDATA[2019-09-12 11:41:11]]></date></location><checkinoutdata><trans_id><![CDATA[CIE076120190912114111]]></trans_id><check_in_time><![CDATA[2019-09-12 11:40:16]]></check_in_time><customer_code><![CDATA[C/0136650]]></customer_code><check_out_time><![CDATA[2019-09-12 11:41:11]]></check_out_time><remarks><![CDATA[]]></remarks><hint_remarks><![CDATA[]]></hint_remarks><product_tagging><![CDATA[]]></product_tagging><uploaded_photo><![CDATA[]]></uploaded_photo><base_latt><![CDATA[25.554743]]></base_latt><base_longi><![CDATA[88.4785102]]></base_longi></checkinoutdata></check_in_out></root>";
...
if(count($check_in_out_array)>0)
{
	for($x=0;$x<count($check_in_out_array);$x++){
	  ...
	  if(mysqli_query($link,$sqlinsertorlocation))
		...
		$sqlcustomername="SELECT customer_name,base_latt,base_longi,need_location_update FROM customer_master WHERE customer_code='".$customer_code."'";
		...
		if(mysqli_query($link,$sqlinsertcheckinout))
		{
			...
			if(strtoupper($nick_name)=='STAR' || strtoupper($nick_name)=='START')
			{
				if($need_location_update=='yes'){
					...
					{
						echo $upd_sql="UPDATE customer_master SET base_latt='".$base_latt."',base_longi='".$base_longi."',need_location_update='no',
...
$url = APICALLLOGURL."/operationdb-check-in-out-6.0.1.php?nick_name=$nick_name&emp_code=$emp_code&last_update_time=$last_update_time";
