...
<center>
	<span style="font-weight:bold; font-size:14px;">BUMCHUMS DCR</span><br><br>
    ...
    <table class="border" width="40%" style="border-collapse:collapse;" cellpadding="6px">
      <tr class="TDHEAD_SUB">
        ...
        <?php
		$sql_emp = "SELECT emp_code, emp_name FROM employee_master WHERE FIND_IN_SET('BUMCHUMS',vertical_value) AND emp_code 
	...
	function display_result(){
		...
		GenericAjaxFunction('BUMCHUMS_vertical_DCR_data.php?employee='+employee,'display',0);
	...
	function Popup(data) 
	{
		var mywindow = window.open('', 'BUMCHUMS DCR', 'height=400,width=600');
		mywindow.document.write('<html><head><title>BUMCHUMS DCR Report</title>');
	...
	a.download = 'BUMCHUMS DCR' + postfix + '.xls';
