...
if($nick_name=='EMAMIT' ||  $nick_name=='MAITHAN')
{
...
class xml_order{
	...
	$orderdataheader_phone_no,$orderdataheader_address,$orderdataheader_pin_code,$orderdataheader_area,$orderdataheader_area_name,$orderdataheader_TD,$orderdataheader_sale_type,$orderdataheader_d_instruction,$orderdataheader_tag_distributor_code,$orderdataheader_cust_type,$orderdataheader_transaction_type,$orderdataheader_VAT,$orderdataheader_customer_flag,$orderdataheader_grn_no,$orderdataheader_vertical_value,$orderdataheader_destination_code,$orderdataheader_order_type,$orderdataheader_freight_component;	
}
...
if(count($order_array)>0)
{
	for($x=0;$x<count($order_array);$x++){
		...
		{
			$sqlempname="SELECT emp_name,SUBSTRING_INDEX( branch_code, ',', 1 ) AS branch_code,vertical_value FROM employee_master WHERE emp_code='".$order_emp_code."'";
			$rsempname=mysqli_query($link,$sqlempname);
			$rowempname=mysqli_fetch_assoc($rsempname);
			$emp_name=title_case_emp($rowempname['emp_name']);
			$branch_code=$rowempname['branch_code'];
...
$url = APICALLLOGURL."/operationdb-transaction-6.0.5.php?nick_name=$nick_name&emp_code=$emp_code&last_update_time=$last_update_time&last_git_master_update_time=$last_git_master_update_time&last_loyalty_purchase_update_time=$last_loyalty_purchase_update_time";
