...
//exit();
$body="<?xml version='1.0' encoding='UTF-8'?><root><stock_audit><location><emp_code><![CDATA[E1138]]></emp_code><trans_id><![CDATA[SE113820220407163800]]></trans_id><latt><![CDATA[26.3408141]]></latt><longi><![CDATA[88.0853435]]></longi><date><![CDATA[2022-04-07 16:38:00]]></date></location><stock_audit_details><transaction_id><![CDATA[SE113820220407163800]]></transaction_id><customer_code><![CDATA[C/0177551]]></customer_code><product_code><![CDATA[12060]]></product_code><prod_mrp><![CDATA[]]></prod_mrp><prod_details><![CDATA[]]></prod_details><remarks><![CDATA[]]></remarks><HINT_REMARKS><![CDATA[]]></HINT_REMARKS><mfd_date><![CDATA[]]></mfd_date><UOM><![CDATA[MT]]></UOM><quantity><![CDATA[5]]></quantity></stock_audit_details></stock_audit><stock_audit><location><emp_code><![CDATA[E1138]]></emp_code><trans_id><![CDATA[SE113820220407170701]]></trans_id><latt><![CDATA[26.3694227]]></latt><longi><![CDATA[88.1012186]]></longi><date><![CDATA[2022-04-07 17:07:01]]></date></location><stock_audit_details><transaction_id><![CDATA[SE113820220407170701]]></transaction_id><customer_code><![CDATA[C/0156877]]></customer_code><product_code><![CDATA[12060]]></product_code><prod_mrp><![CDATA[]]></prod_mrp><prod_details><![CDATA[]]></prod_details><remarks><![CDATA[]]></remarks><HINT_REMARKS><![CDATA[]]></HINT_REMARKS><mfd_date><![CDATA[]]></mfd_date><UOM><![CDATA[MT]]></UOM><quantity><![CDATA[10]]></quantity></stock_audit_details></stock_audit></root>";
...
class xml_stock_audit{
	...
	$stockaudit_remarks,$stockaudit_hint_remarks,$stockaudit_mfd_date,$stockaudit_UOM;
}
...
function contents($parser, $data){
	...
	$audit_emp_code,$audit_trans_id,$audit_latt,$audit_longi,$audit_trans_date,$stockaudit_trans_id,$stockaudit_customer_code,$stockaudit_product_code,$stockaudit_qty,$stockaudit_prod_mrp,$stockaudit_prod_details,$stockaudit_remarks,$stockaudit_hint_remarks,$stockaudit_mfd_date,$stockaudit_UOM;
	//echo $current_tag.'<br />';
	//echo $data;
...
if(count($audit_array)>0)
{
	for($x=0;$x<count($audit_array);$x++){
		...
		else
		{
			...
			echo $sqlinsertauditlocation="INSERT INTO location SET emp_code='".$audit_emp_code."',
				...
				$stockaudit_UOM=$stock_audit_array[$i]->stockaudit_UOM;
					...
					if(!in_array($stockaudit_trans_id,$audit_array_receipt_id_exists))
					{
						echo $sqlinsertstockaudit="INSERT INTO stock_audit SET transaction_id ='".$stockaudit_trans_id."',
											  ...
											  hint_remarks			='".$stockaudit_hint_remarks."',".$sqlinsertcond.$sqlinsertUOMcond."
