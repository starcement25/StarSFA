...
{
$sqlquery="SELECT emp_code,emp_name,sale_access,reporting_to,designation,vertical_value,branch_code,state,zone,acedns,lower_leaves FROM employee_master WHERE 
...
$count=mysqli_num_rows($result);
	...
	$url = "http://www.acedns.in/acednsproduct/emp-master-txt-6.0.3.php?nick_name=$nick_name&emp_code=$emp_code&last_update_time=$last_update_time&data_download_time=$data_download_time&incremental_download=$incremental_download";
