...
$count=mysqli_num_rows($result);
	...
	$url = APICALLLOGURL."/product-master-txt-incremental-6.0.7.php?nick_name=$nick_name&emp_code=$emp_code&last_update_time=$last_update_time&data_download_time=$data_download_time&incremental_download=$incremental_download";
