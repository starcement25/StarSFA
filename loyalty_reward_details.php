...
echo "<center>";
echo "<br>";
echo "<a href=\"loyalty_reward_details.php\" style=\"color:blue;\">Home</a>&nbsp;<a href=\"\" style=\"color:blue;\" onclick=\"window.history.back();\">Back</a><br><br>";
echo "<div id=\"display\" style=\"max-height: 420px; width:80%; overflow-y: scroll; position:fixed;\">";
if($_POST['submit'] == "Submit")
{
	...
	$res_reward_point = mysqli_query($link,$sql_reward_point);
	...
	echo "<table border=\"1\" style=\"border-collapse:collapse; width:100%;\" class=\"border\">
			...
			";
	while($row_reward_point = mysqli_fetch_assoc($res_reward_point))
	{
		...
		echo "<tr>
				<td style=\"width:20%\"><a href=\"loyalty_reward_details.php?card_no=$row_reward_point[loyalty_card_no]&empl_name=$row_reward_point[loyalty_card_holder_name]\" style=\"color:blue;\">$row_reward_point[loyalty_card_holder_name]</a></td>
...
{
	echo "<center><div id=\"display_reward_details\" style=\"max-height: 500px; width:80%; overflow-y: scroll; position:absolute; top:80px; left:10%;\" >";
	echo "<table border=\"1\" style=\"border-collapse:collapse; width:100%;\" class=\"border\">
			<tr>
	...
	$res_reward_details = mysqli_query($link,$sql_reward_details);
	while($row_reward_details = mysqli_fetch_assoc($res_reward_details))
	{
	...
	echo "</div>";
	echo "<br>";
	echo "<a href=\"loyalty_reward_details.php\" style=\"color:blue;\">Home</a>&nbsp;<a href=\"\" onclick=\"window.history.back();\" style=\"color:blue;\">Back</a>";
	echo "</center>";
}
...
<div style="position:absolute; top:220px; left:30%;">
