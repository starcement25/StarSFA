...
$body="<?xml version='1.0' encoding='UTF-8'?><root><order><location><emp_code><![CDATA[E0555]]></emp_code><trans_id><![CDATA[NOE055520190703113936]]></trans_id><latt><![CDATA[22.5144687]]></latt><longi><![CDATA[88.3105831]]></longi><date><![CDATA[2019-07-03 11:39:36]]></date></location><orderdata><order_header><order_no><![CDATA[NOE055520190703113936]]></order_no><d_instruction><![CDATA[]]></d_instruction><customer_code><![CDATA[C/0000016]]></customer_code></order_header></orderdata></order></root>";
...
if(count($attendance_array)>0)
{
	for($x=0;$x<count($attendance_array);$x++){
		...
		else
		{
			...
			echo $sqlinsertattlocation="INSERT INTO location SET emp_code='".$emp_code."',
									trans_id='".$trans_id."',
									latt='".$latt."',
									longi='".$longi."',
