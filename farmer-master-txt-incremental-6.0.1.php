...
$sqlquery="SELECT farmer_id,emp_code,farmer_name,address,district,taluka,locality,pin,farming_area,type_of_crops,mi_applied_for,spacing,
		...
		document_uploaded_to_TANHODA,total_area,mi_area,linked_dealer,mi_id,farmer_type,mi_reference_no,fittings_accessories FROM farmer_master WHERE 
...
$count=mysqli_num_rows($result);
	...
	$url = APICALLLOGURL."/farmer-master-txt-incremental-6.0.1.php?nick_name=$nick_name&emp_code=$emp_code&last_update_time=$last_update_time&incremental_download=$incremental_download";
