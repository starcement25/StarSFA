...
$count=mysqli_num_rows($result);
	...
	$url = "http://www.acedns.in/acednsproduct/setup-product-details-incremental-6.0.2.php?nick_name=$nick_name&last_update_time=$last_update_time&incremental_download=$incremental_download";
