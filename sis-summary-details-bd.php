...
$dns_emp_code=$rowempdnscode['dns_emp_code'];
	...
	$sql_summary = "SELECT * FROM BD_SIS_summary where emp_code='".$dns_emp_code."'";
	//echo"<pre>";print_r($sql_summary);die;
