...
public class ShowStateDataSetAdapter extends ArrayAdapter<StateDataSet> implements Filterable {
    private final Context context;
    private final ArrayList<StateDataSet> nameValues;
    private final int resourceId;
    private ArrayList<StateDataSet> mFinalSalesOfficerList;
    private final ItemFilter mFilter = new ItemFilter();

    public ShowStateDataSetAdapter(final Context context, final int resourceId, final ArrayList<StateDataSet> nameValue) {
    ...
    public StateDataSet getItem(int position) {
    ...
    private class ItemFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            final ArrayList<StateDataSet> customerDetailslist = nameValues;
            int count = customerDetailslist.size();
            final ArrayList<StateDataSet> newcustomerDetailslist = new ArrayList<>(count);
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            mFinalSalesOfficerList = (ArrayList<StateDataSet>) results.values;
