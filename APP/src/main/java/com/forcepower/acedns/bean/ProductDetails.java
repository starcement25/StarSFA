...
public class ProductDetails {
    ...
    String prod_size = "";
    String prod_size_seperator = "";
    String branchWiseMRP = "";
    ...
    public String getprod_size_seperator() {
        return prod_size_seperator;
    }

    public void setprod_size_seperator(String prod_size_seperator) {
        this.prod_size_seperator = prod_size_seperator;
    }

    public String getBranchWiseMRP() {
        return branchWiseMRP;
    }

    public void setBranchWiseMRP(String branchWiseMRP) {
        this.branchWiseMRP = branchWiseMRP;
    }
}
