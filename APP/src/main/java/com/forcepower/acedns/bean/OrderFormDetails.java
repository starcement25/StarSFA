...
public class OrderFormDetails {
    ...
    String cust_type_wise_UOM = "";
    String cust_type_wise_UOM_val = "";
    String visit_sequence = "";
    String add_customer_activation = "";
    String multiple_distributor = "";
    String GEO_fencing_variance = "";
    String route_wise_distributor = "";
    String mrp_sale_rate_text = "";
    String order_status_remarks = "";
    String tagged_distributor_business_prospect = "";
    String no_order_remarks = "";
    String product_wise_remarks = "";
    ...
    public String getcust_type_wise_UOM() {
        return cust_type_wise_UOM;
    }

    public void setcust_type_wise_UOM(String cust_type_wise_UOM) {
        this.cust_type_wise_UOM = cust_type_wise_UOM;
    }

    public String getcust_type_wise_UOM_val() {
        return cust_type_wise_UOM_val;
    }

    public void setcust_type_wise_UOM_val(String cust_type_wise_UOM_val) {
        this.cust_type_wise_UOM_val = cust_type_wise_UOM_val;
    }
    ...
    public String getadd_customer_activation() {
        return add_customer_activation;
    }

    public void setadd_customer_activation(String add_customer_activation) {
        this.add_customer_activation = add_customer_activation;
    }

    public String getmultiple_distributor() {
        return multiple_distributor;
    }

    public void setmultiple_distributor(String multiple_distributor) {
        this.multiple_distributor = multiple_distributor;
    }

    public String getGEO_fencing_variance() {
        return GEO_fencing_variance;
    }

    public void setGEO_fencing_variance(String GEO_fencing_variance) {
        this.GEO_fencing_variance = GEO_fencing_variance;
    }

    public String getroute_wise_distributor() {
        if (route_wise_distributor == null) {
            route_wise_distributor = "no";
        }
        return route_wise_distributor;
    }

    public void setroute_wise_distributor(String route_wise_distributor) {
        this.route_wise_distributor = route_wise_distributor;
    }

    public String getmrp_sale_rate_text() {
        if (mrp_sale_rate_text == null) {
            mrp_sale_rate_text = "no";
        }
        return mrp_sale_rate_text;
    }

    public void setmrp_sale_rate_text(String mrp_sale_rate_text) {
        this.mrp_sale_rate_text = mrp_sale_rate_text;
    }

    public String getOrder_status_remarks() {
        return order_status_remarks;
    }

    public void setOrder_status_remarks(String order_status_remarks) {
        this.order_status_remarks = order_status_remarks;
    }

    public String getTagged_distributor_business_prospect() {
        return tagged_distributor_business_prospect;
    }

    public void setTagged_distributor_business_prospect(String tagged_distributor_business_prospect) {
        this.tagged_distributor_business_prospect = tagged_distributor_business_prospect;
    }

    public String getNo_order_remarks() {
        return no_order_remarks;
    }

    public void setNo_order_remarks(String no_order_remarks) {
        this.no_order_remarks = no_order_remarks;
    }

    public String getProduct_wise_remarks() {
        return product_wise_remarks;
    }

    public void setProduct_wise_remarks(String product_wise_remarks) {
        this.product_wise_remarks = product_wise_remarks;
    }
}
