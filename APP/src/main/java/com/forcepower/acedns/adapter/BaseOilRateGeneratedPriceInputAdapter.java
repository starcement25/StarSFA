...
public class BaseOilRateGeneratedPriceInputAdapter extends ArrayAdapter<commonDatabaseHelper> {
    ...
    public BaseOilRateGeneratedPriceInputAdapter(Context context, int resourceId, ArrayList<commonDatabaseHelper> nameValues) {
...
//        viewHolder.txtViewProductDesc.setText(HtmlCompat.fromHtml(desc+"<font color='#D7B56D'>/</font>"+nameValuesProductListLocalDo.get(position).getuom4(),HtmlCompat.FROM_HTML_MODE_LEGACY));
    ...
    public class ViewHolder {
        TextView txtViewProductDesc, invisibleTVProdCode,matCostTV,proCostTV,packingTV,marginCostTV,bargainRateTV;
