...
public class TelecallerExixtingProductListAdapter extends BaseAdapter
{

	private Activity context;
	private ArrayList<TentProductList> menu_item_list = new ArrayList<>();

	public TelecallerExixtingProductListAdapter(final Activity context, final ArrayList<TentProductList> menu_item_list_)
	{
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		try
		{
			...
			holder.tvProduct.setText(menu_item_list.get(position).getDate().toString());
			holder.tvLifeProduct.setText(menu_item_list.get(position).getBrand());
			holder.tvBrand.setText(menu_item_list.get(position).getLife());
