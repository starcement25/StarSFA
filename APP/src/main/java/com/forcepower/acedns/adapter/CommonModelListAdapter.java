...
public class CommonModelListAdapter extends BaseAdapter
{

	private Activity context;
	private ArrayList<CommonModel> menu_item_list = new ArrayList<>();

	public CommonModelListAdapter(final Activity context, final ArrayList<CommonModel> menu_item_list_)
	{
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		try
		{
			...
			if (convertView == null)
			{
				...
				convertView = mInflater.inflate(R.layout.customer_broker_list_child, null);
