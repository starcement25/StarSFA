...
public class CustomerInfoDetailsListAdapter5Additional extends ArrayAdapter<commonDatabaseHelper>
{
    ...
    public CustomerInfoDetailsListAdapter5Additional(Context context, int resourceId, ArrayList<commonDatabaseHelper> nameValues) {
