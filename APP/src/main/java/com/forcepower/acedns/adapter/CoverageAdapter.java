...
public class CoverageAdapter extends RecyclerView.Adapter<CoverageAdapter.ViewHolder> {
    ...
    public CoverageAdapter(Context context, int resourceId, ArrayList<commonDatabaseHelper> nameValues) {
    ...
    @Override
    public CoverageAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.secondValueTV.setText(Html.fromHtml(Integer.parseInt(priceListOilGrp.get(position).getItem1())+""));
        holder.thirdValueTV.setText(Html.fromHtml(Integer.parseInt(priceListOilGrp.get(position).getItem2())+""));
        holder.forthValueTV.setText(Html.fromHtml(Integer.parseInt(priceListOilGrp.get(position).getItem3())+""));
        holder.fifthValueTV.setText(Html.fromHtml(Integer.parseInt(priceListOilGrp.get(position).getItem4())+""));
        holder.sixthValueTV.setText(Html.fromHtml(priceListOilGrp.get(position).getItem5())+"");
        holder.seventhValueTV.setText(Html.fromHtml(defaultFormatWithComma.format(Double.parseDouble(priceListOilGrp.get(position).getItem6()))));
        ...
        holder.ninthValueTV.setText(Html.fromHtml(defaultFormatWithComma.format(Double.parseDouble(priceListOilGrp.get(position).getItem8()))));
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public TextView firstValueTV,secondValueTV,thirdValueTV,forthValueTV,fifthValueTV,sixthValueTV,seventhValueTV,eighthValueTV,ninthValueTV, invisibleTVProdCode;
