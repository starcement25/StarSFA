...
public class CustomerInfoDetailsListAdapter3New extends ArrayAdapter<commonDatabaseHelper>
{
    ...
    public CustomerInfoDetailsListAdapter3New(Context context, int resourceId, ArrayList<commonDatabaseHelper> nameValues) {
