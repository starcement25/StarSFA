...
public class CustomerInfoDetailsListAdapter2 extends ArrayAdapter<commonDatabaseHelper>
{
    ...
    public CustomerInfoDetailsListAdapter2(Context context, int resourceId, ArrayList<commonDatabaseHelper> nameValues) {
