...
public class CustomerInfoDetailsListAdapterNew extends ArrayAdapter<commonDatabaseHelper>
{
    ...
    public CustomerInfoDetailsListAdapterNew(Context context, int resourceId, ArrayList<commonDatabaseHelper> nameValues) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.thirdValueTV.setVisibility(View.GONE);
//        viewHolder.secondValueTV.setVisibility(View.GONE);
        ...
        viewHolder.secondValueTV.setText(priceListOilGrp.get(position).getItem1());
        return convertView;
    }
