...
public class SelfAppraisalProductGroupWiseListAdapter extends BaseAdapter {
    private final int resourceId;
    ArrayList<SelfAppraisalDetailsProductGroupWise> values;
    Context mContext;
    private ViewHolder viewHolder;

    public SelfAppraisalProductGroupWiseListAdapter(Context context, int resourceid, ArrayList<SelfAppraisalDetailsProductGroupWise> values) {
        mContext = context;
        this.values = values;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.tvCustomerName.setText(values.get(position).getproductGroupName());
