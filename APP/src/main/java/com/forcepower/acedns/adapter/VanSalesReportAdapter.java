...
public class VanSalesReportAdapter extends ArrayAdapter<OrderReportDetails> implements Filterable {
    ...
    public VanSalesReportAdapter(Context context, int resourceId, ArrayList<OrderReportDetails> orderReportDetailsList, boolean isStock) {
