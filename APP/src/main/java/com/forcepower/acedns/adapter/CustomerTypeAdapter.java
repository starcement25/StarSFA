...
public class CustomerTypeAdapter extends ArrayAdapter<CustomerDetails> implements Filterable {
    ...
    public CustomerTypeAdapter(Context context, int resourceId, ArrayList<CustomerDetails> customerDetailsList) {
    ...
    public CustomerTypeAdapter(Context context, int resourceId, ArrayList<CustomerDetails> customerDetailsList, Boolean showPhoneNumber) {
        super(context, resourceId, customerDetailsList);
        this.context = context;
        this.mOriginalCustomerDetailsList = customerDetailsList;
        this.mFinalCustomerDetailsList = customerDetailsList;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String menuItem = mFinalCustomerDetailsList.get(position).getCustomerName();
        viewHolder.txtView.setText(menuItem);
        if (!showPhoneNumber) {
            viewHolder.mTextViewCustType.setText(mFinalCustomerDetailsList.get(position).getCustomerType());
        } else {
            viewHolder.mTextViewCustType.setText(mFinalCustomerDetailsList.get(position).getNumber());
        }
