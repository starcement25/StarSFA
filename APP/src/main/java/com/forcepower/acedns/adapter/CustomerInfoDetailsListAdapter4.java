...
public class CustomerInfoDetailsListAdapter4 extends ArrayAdapter<commonDatabaseHelper>
{
    ...
    public CustomerInfoDetailsListAdapter4(Context context, int resourceId, ArrayList<commonDatabaseHelper> nameValues) {
