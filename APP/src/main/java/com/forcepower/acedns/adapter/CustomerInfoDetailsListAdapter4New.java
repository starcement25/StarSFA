...
public class CustomerInfoDetailsListAdapter4New extends ArrayAdapter<commonDatabaseHelper>
{
    ...
    public CustomerInfoDetailsListAdapter4New(Context context, int resourceId, ArrayList<commonDatabaseHelper> nameValues) {
