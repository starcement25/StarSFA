...
public class CustomerInfoDetailsListAdapter5New extends ArrayAdapter<commonDatabaseHelper>
{
    ...
    public CustomerInfoDetailsListAdapter5New(Context context, int resourceId, ArrayList<commonDatabaseHelper> nameValues) {
