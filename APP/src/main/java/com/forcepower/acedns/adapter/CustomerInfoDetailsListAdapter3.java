...
public class CustomerInfoDetailsListAdapter3 extends ArrayAdapter<commonDatabaseHelper>
{
    ...
    public CustomerInfoDetailsListAdapter3(Context context, int resourceId, ArrayList<commonDatabaseHelper> nameValues) {
