...
public class CustomerInfoDetailsListAdapter4Additional extends ArrayAdapter<commonDatabaseHelper>
{
    ...
    public CustomerInfoDetailsListAdapter4Additional(Context context, int resourceId, ArrayList<commonDatabaseHelper> nameValues) {
