...
public class MisAdapter extends ArrayAdapter<MisDetails> implements Filterable {
	...
	private String mPreviousTypeName="";
	private boolean isChange=false;*/

    public MisAdapter(Context context, int resourceId, ArrayList<MisDetails> misDetailsList) {
        super(context, resourceId, misDetailsList);
        this.context = context;
        this.mMisDetailsList = misDetailsList;
        this.resourceId = resourceId;
        //mPreviousTypeName=mMisDetailsList.get(0).getType();
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.mLinearLayoutChildLayout = (LinearLayout) convertView.findViewById(R.id.childLayout);
            viewHolder.mTextViewType = (TextView) convertView.findViewById(R.id.textViewType);
        ...
        viewHolder.mTextViewType.setText(mMisDetailsList.get(position).getType());
    ...
    public class ViewHolder {
        ...
        LinearLayout mLinearLayoutChildLayout;
