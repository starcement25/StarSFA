...
public class CustomerInfoDetailsListAdapter extends ArrayAdapter<commonDatabaseHelper>
{
    ...
    public CustomerInfoDetailsListAdapter(Context context, int resourceId, ArrayList<commonDatabaseHelper> nameValues) {
