...
public class CustomerInfoDetailsListAdapter2New extends ArrayAdapter<commonDatabaseHelper>
{
    ...
    public CustomerInfoDetailsListAdapter2New(Context context, int resourceId, ArrayList<commonDatabaseHelper> nameValues) {
