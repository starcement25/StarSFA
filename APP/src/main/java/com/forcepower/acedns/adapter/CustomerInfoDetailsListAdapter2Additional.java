...
public class CustomerInfoDetailsListAdapter2Additional extends ArrayAdapter<commonDatabaseHelper>
{
    ...
    public CustomerInfoDetailsListAdapter2Additional(Context context, int resourceId, ArrayList<commonDatabaseHelper> nameValues) {
