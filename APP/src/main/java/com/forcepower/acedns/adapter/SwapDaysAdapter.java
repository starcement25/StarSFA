...
public class SwapDaysAdapter extends ArrayAdapter<String> implements Filterable {
    ...
    public SwapDaysAdapter(Context context, int resourceId, ArrayList<String> nameValues) {
