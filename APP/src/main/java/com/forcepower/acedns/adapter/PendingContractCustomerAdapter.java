...
public class PendingContractCustomerAdapter extends ArrayAdapter<PendingContract> implements Filterable {
    ...
    public PendingContractCustomerAdapter(Context context, int resourceId, ArrayList<PendingContract> pendingContractList) {
