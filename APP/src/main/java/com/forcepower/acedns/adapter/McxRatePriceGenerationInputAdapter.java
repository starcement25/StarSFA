...
public class McxRatePriceGenerationInputAdapter extends ArrayAdapter<commonDatabaseHelper>
{
    ...
    public McxRatePriceGenerationInputAdapter(Context context, int resourceId, ArrayList<commonDatabaseHelper> nameValues) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        String desc = Utils.capitalizeWord(priceListOilGrp.get(position).getItem0().replace("_"," "));
...
//        viewHolder.txtViewProductDesc.setText(HtmlCompat.fromHtml(desc+"<font color='#D7B56D'>/</font>"+nameValuesProductListLocalDo.get(position).getuom4(),HtmlCompat.FROM_HTML_MODE_LEGACY));
        ...
        String currentqty = priceListOilGrp.get(position).getItem1();
    ...
    private class GenericTextWatcherQty implements TextWatcher {
        ...
        public void afterTextChanged(Editable editable) {
            ...
            priceListOilGrp.get(pos).setItem1(text);
        }
    }
