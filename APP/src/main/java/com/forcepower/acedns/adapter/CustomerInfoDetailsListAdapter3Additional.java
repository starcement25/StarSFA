...
public class CustomerInfoDetailsListAdapter3Additional extends ArrayAdapter<commonDatabaseHelper>
{
    ...
    public CustomerInfoDetailsListAdapter3Additional(Context context, int resourceId, ArrayList<commonDatabaseHelper> nameValues) {
