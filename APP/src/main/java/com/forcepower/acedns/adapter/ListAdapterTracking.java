...
public class ListAdapterTracking extends BaseAdapter
{
    private Activity activity;
    private ArrayList<CommonHelper> participentListItemGlobal;

    public ListAdapterTracking(Activity activity, ArrayList<CommonHelper> participentListItemGlobal)
    {
