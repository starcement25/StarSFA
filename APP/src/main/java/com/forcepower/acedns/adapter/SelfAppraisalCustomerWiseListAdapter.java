...
public class SelfAppraisalCustomerWiseListAdapter extends BaseAdapter {
    private final int resourceId;
    ArrayList<SelfAppraisalDetailsCustomerWise> values;
    Context mContext;
    private ViewHolder viewHolder;

    public SelfAppraisalCustomerWiseListAdapter(Context context, int resourceid, ArrayList<SelfAppraisalDetailsCustomerWise> values) {
        mContext = context;
        this.values = values;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.tvCustomerName.setText(values.get(position).getcustomerName());
