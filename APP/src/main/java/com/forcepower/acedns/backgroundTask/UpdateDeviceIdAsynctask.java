...
public class UpdateDeviceIdAsynctask extends AsyncTask<String, Void, String> {
    Context mContext;
    AceDnsDatabase dbHelper;
    String lastUpdate = "2014-06-09 18:19:20"; //Just to know the format

    public UpdateDeviceIdAsynctask(Context context) {
    ...
    protected void onPreExecute() {
        super.onPreExecute();
        Utils.changeProgressDialogMsg(mContext, "Updating User Information..");
    }
    ...
    protected String doInBackground(String... params) {
        ...
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ UpdateDeviceIdAsynctask: " +BaseUrl.baseUrl + AceDnsWebServiceURL.updateDeviceIdURL);
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ UpdateDeviceIdAsynctask value: " +values);
        String httpResponse = HttpCalling.httpGetCallWithXmlResponse(BaseUrl.baseUrl + AceDnsWebServiceURL.updateDeviceIdURL, values);
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ UpdateDeviceIdAsynctask result: " +httpResponse);
        return httpResponse;
    }
