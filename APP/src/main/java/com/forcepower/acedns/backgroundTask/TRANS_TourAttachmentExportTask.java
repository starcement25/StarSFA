...
public class TRANS_TourAttachmentExportTask extends AsyncTask<String, Void, Void> {
    Context mContext;
    ...
    public TRANS_TourAttachmentExportTask(Context mContext, String source, String prevResponse, boolean isFinish) {
    ...
    public TRANS_TourAttachmentExportTask(Context mContext, String source, String prevResponse, boolean isFinish,boolean showLoader ){
        this.mContext = mContext;
        dataHelperObj = new AceDnsTransactionDatabase(mContext);
        lastUpdate = dataHelperObj.getlastDownloadTime("download_dictionary");
        this.source = source;
    ...
    protected Void doInBackground(String... params) {
        ...
        if (attachmentFileNames.size() > 0 && !Constants.employeeDetailObject.getEmpCode().startsWith("C")) {
            ...
            Log.d("_DOWNLOAD_", "_DOWNLOAD_ TRANS_TourAttachmentExportTask: " +urlServer);
