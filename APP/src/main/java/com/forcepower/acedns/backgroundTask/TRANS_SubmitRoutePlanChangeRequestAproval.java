...
public class TRANS_SubmitRoutePlanChangeRequestAproval extends AsyncTask<String, Void, String> {
    ...
    public TRANS_SubmitRoutePlanChangeRequestAproval(Context context, boolean finish, String status, ArrayList<RoutePlanMasterDetails> selectedRouteList) {
    ...
    protected String doInBackground(String... params) {
        ...
        if (HTTPUtils.isConnectionPossible(mContext)) {
            try {
                ...
                String url = BaseUrl.baseUrl + AceDnsWebServiceURL.operationdb_route_plan_change_approval + "?nick_name=" + Constants.nickName + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
                Log.d("_DOWNLOAD_", "_DOWNLOAD_ TRANS_SubmitRoutePlanChangeRequestAproval: " +url);
                Log.d("_DOWNLOAD_", "_DOWNLOAD_ TRANS_SubmitRoutePlanChangeRequestAproval value: " +xmlData);
        ...
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ TRANS_SubmitRoutePlanChangeRequestAproval result: " +POST_result);
        return POST_result;
    }
    ...
    public String prepareXMLData() {
        ...
        xmlData += "<route_plan_change_approval>";
