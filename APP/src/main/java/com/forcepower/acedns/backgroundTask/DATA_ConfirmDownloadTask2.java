...
public class DATA_ConfirmDownloadTask2 extends AsyncTask<String, Void, String> {
    Context mContext;
    String dbVersion = "";
    AceDnsDatabase mAceDnsDatabase;

    public DATA_ConfirmDownloadTask2(Context context) {
    ...
    protected void onPostExecute(String result) {
        ...
        if (Constants.downloadTableList != null && Constants.downloadTableList.contains("mis_transaction_delete")) {
            ...
            pd.show();
            new DATA_DeleteTransactionTask2(mContext, pd, true, Constants.employeeDetailObject.getEmpCode()).execute();
        } else {
