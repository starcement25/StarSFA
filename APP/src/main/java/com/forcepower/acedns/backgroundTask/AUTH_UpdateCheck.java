...
public class AUTH_UpdateCheck extends AsyncTask<String, Void, Void> {
    Context mContext;
    String httpResponse = "";
    String empCode = "";
    String version = "1.0";
    ...
    public AUTH_UpdateCheck(Context context) {
        this.mContext = context;
        downloadData = true;
        PhoneStateChangeListener.ringing = false;
    }

    public AUTH_UpdateCheck(Context context, boolean downloadData) {
        this.mContext = context;
    ...
    protected void onPreExecute() {
        super.onPreExecute();
        Utils.showProgressDialog(mContext, "Checking for App Updates..");
            ...
            if (downloadData) {
                if (httpResponse.equalsIgnoreCase("0")) {
                    ...
                    if (PhoneStateChangeListener.ringing) {
                        new AUTH_UpdateCheck(mContext).execute(empCode);
                    } else {
