...
public class TRANS_SubmitFeedBack extends AsyncTask<String, Void, String> {
    ...
    public TRANS_SubmitFeedBack(Context context, boolean finish, String status) {
    ...
    protected String doInBackground(String... params) {
        ...
        if (HTTPUtils.isConnectionPossible(mContext) && !Constants.employeeDetailObject.getEmpCode().startsWith("C")) {
            try {
                ...
                Log.d("_DOWNLOAD_", "_DOWNLOAD_ TRANS_SubmitFeedBack: " +uri);
                Log.d("_DOWNLOAD_", "_DOWNLOAD_ TRANS_SubmitFeedBack value: " +xmlData);
        ...
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ TRANS_SubmitFeedBack result: " +POST_result);
        return POST_result;
    }
