...
public class TRANS_SubmitRoutePlanTask extends AsyncTask<String, Void, String> {
    ...
    public TRANS_SubmitRoutePlanTask(Context context, boolean finish, String status) {
    ...
    protected String doInBackground(String... params) {
        ...
        if (HTTPUtils.isConnectionPossible(mContext)) {
            try {
                ...
                Log.d("_DOWNLOAD_", "_DOWNLOAD_ TRANS_SubmitRoutePlanTask: " +url);
                Log.d("_DOWNLOAD_", "_DOWNLOAD_ TRANS_SubmitRoutePlanTask value: " +xmlData);
        ...
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ TRANS_SubmitRoutePlanTask result: " +POST_result);
        return POST_result;
    }
    ...
    protected void onPostExecute(String result) {
        ...
        if (str_status.equals("SUBMIT")) {
            if (result.equalsIgnoreCase("1") || result.equalsIgnoreCase("2")) {
                ...
                if (true == Constants.isNewRoute) {
                    new TRANS_SubmitNewRoute(mContext, "SUBMIT").execute();
                } else {
                    if (finish) {
