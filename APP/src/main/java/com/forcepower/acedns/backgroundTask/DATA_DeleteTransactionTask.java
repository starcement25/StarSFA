...
public class DATA_DeleteTransactionTask extends AsyncTask<Void, Void, Void> {
    Context mContext;
    String httpResponse = "";
    ...
    public DATA_DeleteTransactionTask(Context context, Dialog deletionDialog, boolean isMIS, String empCode) {
    ...
    protected void onPostExecute(Void result) {
        ...
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ DATA_DeleteTransactionTask result: " + httpResponse);
