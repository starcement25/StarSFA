...
public class TRANS_NewCustomerImageTask extends AsyncTask<String, Void, Void> {
    Context mContext;
...
String source="";
    public TRANS_NewCustomerImageTask(Context mContext,ArrayList<String> mFileNamesList,String source, boolean isFinish) {
        this.mContext = mContext;
        mAceDnsTransactionDatabase = new AceDnsTransactionDatabase(mContext);
        lastUpdate = mAceDnsTransactionDatabase.getlastDownloadTime("download_dictionary");
        this.mFileNamesList = mFileNamesList;
        this.source = source;
    ...
    protected Void doInBackground(String... params) {
        if (mFileNamesList.size() > 0 ) {
            ...
            String twoHyphens = "--";
            String boundary = "*****";
            Log.d("_DOWNLOAD_", "_DOWNLOAD_ TRANS_NewCustomerImageTask: " +urlServer);
