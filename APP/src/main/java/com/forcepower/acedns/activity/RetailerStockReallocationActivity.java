...
import com.forcepower.acedns.adapter.ProductMasterWithQtyInputAdapterRetailerStockReallocation;
...
public class RetailerStockReallocationActivity extends AceDnsParentActivity {
    ...
    int lastProdPos = 0;
    ProductMasterWithQtyInputAdapterRetailerStockReallocation ProductMasterWithQtyInputAdapterObject;

    @Override
    public void onCreate(Bundle savedInstanceState) {
        requestWindowFeature(Window.FEATURE_NO_TITLE);
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_retailer_stock_reallocation);
        RegisterActivities.registerActivity(this);

        Constants.isFromConfirmationActivity = false;
        filterNo = Integer.parseInt(Constants.productDetailsObj.getNoFilter());
        mContext = RetailerStockReallocationActivity.this;
    ...
    public void generateDataIncustomerList() {
        customerList = mAceDnsDatabase.getCustomerListStockReallocation();
    ...
    public void InitializeView() {
        ...
        btnCheckOut.setOnClickListener(RetailerStockReallocationActivity.this);
        btnBack = (Button) findViewById(R.id.back);
        btnBack.setTag(105);
        btnBack.setOnClickListener(RetailerStockReallocationActivity.this);
        ...
        btnCustomer.setOnClickListener(RetailerStockReallocationActivity.this);
            ...
            switch (tag) {
                ...
                case 2:
                    ...
                    if (selectedGrp != null) {
                        ...
                        Toast.makeText(RetailerStockReallocationActivity.this,
...
//            submitProcess();
    ...
    private void submitProcess() {
        if (Constants.selectedProductMasterList != null && Constants.selectedProductMasterList.size() > 0) {
            ...
            Boolean isSuccessInsertRequisitionOutDetails, isSuccessInsertToLocationTable, isSuccessUpdateRemainingQty;
            mAceDnsTransactionDatabase.beginTransaction();
            isSuccessInsertRequisitionOutDetails = mAceDnsTransactionDatabase.insertCustomerProductReallocation(timeStamp);
            isSuccessInsertToLocationTable = mAceDnsTransactionDatabase.insertToLocationTable1("RA", timeStamp);
            isSuccessUpdateRemainingQty = mAceDnsTransactionDatabase.UpdateRemainStockForStockReallocation();
            if (isSuccessInsertRequisitionOutDetails && isSuccessInsertToLocationTable && isSuccessUpdateRemainingQty) {
    ...
    public void ShowChooseCustomerDialog() {
        final Dialog customerListDialog = new Dialog(RetailerStockReallocationActivity.this, R.style.PauseDialog);
        ...
        final NewCustomerAdapter adapterCust = new NewCustomerAdapter(RetailerStockReallocationActivity.this, R.layout.customer_list_child, mCustomerDetails);
    ...
    public void showGrpDialog() {
        ...
        if (productGroupList.size() > 0) {
            ...
            grpDialog = new Dialog(RetailerStockReallocationActivity.this,
                    R.style.PauseDialog);
            ...
            ProductGrpAdapter adapter1 = new ProductGrpAdapter(
                    RetailerStockReallocationActivity.this, R.layout.product_list_child,
                    productGroupList);
    ...
    public void showSubGrpDialog(String parentItem) {
        ...
        if (productSubGroupList.size() > 0) {
            ...
            subGrpDialog = new Dialog(RetailerStockReallocationActivity.this,
                    R.style.PauseDialog);
    ...
    public void showBrandDialog(String parentItemId) {
        ...
        if (productBrandList.size() > 0) {
            ...
            brandDialog = new Dialog(RetailerStockReallocationActivity.this,
                    R.style.PauseDialog);
    ...
    public void showMasterDialog(String parentItem) {
        productMasterList = mAceDnsDatabase.getProductMasterListWithRetailerStockAllocation();
        if (productMasterList.size() > 0) {
            tempProductList = new ArrayList<>();
            reInitialiseProductList();
            ProductMasterWithQtyInputAdapterObject = new ProductMasterWithQtyInputAdapterRetailerStockReallocation(RetailerStockReallocationActivity.this, R.layout.product_list_item_with_quantity_input_stock_in, tempProductList);

            masterDialog = new Dialog(RetailerStockReallocationActivity.this,
                    R.style.PauseDialog);
    ...
    private void addtocartProcess() {
        Boolean isValidNumericQtyProvidedForAllProducts = true,isQtyZeroForAllProducts=true;
        ...
        for (int i = 0; i < Constants.selectedProductMasterList.size(); i++)
        {
            ...
            String remainingQty = Constants.selectedProductMasterList.get(i).getQtyRemaining();
            ...
            if (!InputQuantityHigerthanAllocatedQuantity)
            {
                ...
                {
                    isQtyZeroForAllProducts=false;
                    if (Double.parseDouble(currentqty) > Double.parseDouble(remainingQty))
                    {
        ...
        if (isValidNumericQtyProvidedForAllProducts)
        {
            if (InputQuantityHigerthanAllocatedQuantity)
            {
                Toast.makeText(mContext, "Input quantity is higher than remaining allocated quantity for " + productForWhichInputQtyIsHigherThanAllocQty, Toast.LENGTH_SHORT).show();
            }
            else
            {
                if(isQtyZeroForAllProducts)
                {
                    showCustomerSpinner();//false transaction
                }
                else
                {
                    submitProcess();
