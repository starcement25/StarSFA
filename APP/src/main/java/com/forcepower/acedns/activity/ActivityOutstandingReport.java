...
import com.forcepower.acedns.adapter.OutstandingReportAdapter;
...
public class ActivityOutstandingReport extends FragmentActivity implements OnClickListener {
    ...
    OutstandingReportAdapter SalesReportAdapterObject;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContext = ActivityOutstandingReport.this;
        ...
        mReportHandler = new Handler() {
            public void handleMessage(@NonNull Message msg) {
                ...
                ActivityOutstandingReport.this.runOnUiThread(() -> {
                    if (job == 1) {
                        SalesReportAdapterObject = new OutstandingReportAdapter(mContext, R.layout.outstanding_report_child, mOrderReportDetailsList);
    ...
    public void FetchSaudaTransactionLogData(final int whattodo) {
        ...
        new Thread() {
            public void run() {
                if (whattodo == 1) {
                    mOrderReportDetailsList = mAceDnsDatabaseHelper.GetOutStandingReportData(mQuery);
                }
