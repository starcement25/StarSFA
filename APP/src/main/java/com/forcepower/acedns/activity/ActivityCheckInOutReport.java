...
import com.forcepower.acedns.adapter.CheckInOutReportAdapter;
...
public class ActivityCheckInOutReport extends FragmentActivity implements OnClickListener {
    ...
    public AceDnsTransactionDatabase mAceDnsTDatabase;
    ...
    CheckInOutReportAdapter orderReportAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_check_in_out_report);
        mContext = ActivityCheckInOutReport.this;
        ...
        if (Constants.menuDetailsObj.getDoctor_visit().toLowerCase().matches("yes")) {
            textViewHeader.setText("Doctor Name");
        }
        ...
        mListViewList.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                checkInOutDetails(obj.getName(), obj.getremarks(),obj.getCode());
//                mCustomerName=obj.getName();
//                currentSelectedCustomerCode=obj.getCode();
//                    FetchSaudaTransactionLogData(2);
                //Utils.showToast(mContext,"click"+obj.getCode());
        ...
        mReportHandler = new Handler() {
            public void handleMessage(Message msg) {
                ...
                ActivityCheckInOutReport.this.runOnUiThread(new Runnable() {
                    public void run() {
                        switch (job) {
                            case 1:
                                orderReportAdapter = new CheckInOutReportAdapter(ActivityCheckInOutReport.this, R.layout.check_in_out_report_list_item, mOrderReportDetailsList, true);
    ...
    public String BuildQuery(int select) {
        ...
        switch (select) {
            case 1:
                condition = "substr(CIID.trans_id,-14,8)='" + mToday + "' ";
                break;
            case 2:
                condition = "substr(CIID.trans_id,-14,4)='" + mCurrentYear + "' AND substr(CIID.trans_id,-10,2)='" + mCurrentMonth + "' ";

                break;
            case 3:
                condition = "substr(CIID.trans_id,-14,8) BETWEEN '" + mStartDate + "' AND '" + mEndDate + "' ";
    ...
    public void FetchSaudaTransactionLogData(final int whattodo) {
        ...
        new Thread() {
            public void run() {
                switch (whattodo) {
                    case 1:
                        mOrderReportDetailsList = mAceDnsDatabaseHelper.GetCheckInOutCustomerData(mQuery);
    ...
    public void ShowProductDetailsDialog(final String titlename, ArrayList<YellowCard> yellowReportDetailsList) {
        final Dialog mDetailsDialog = new Dialog(ActivityCheckInOutReport.this, R.style.PauseDialog);
        ...
        final YellowCardReportAdapter orderreportAdapter = new YellowCardReportAdapter(ActivityCheckInOutReport.this, R.layout.yellow_card_report_list_item, yellowReportDetailsList);
    ...
    private void checkInOutDetails(String customerName, String remarks,String dCode) {
        ...
        title.setText("Check in details");
        ...
        if(Constants.menuDetailsObj.getDoctor_visit().toLowerCase().matches("yes")){
            ...
            mAceDnsTDatabase = new AceDnsTransactionDatabase(mContext);
            String rem = mAceDnsTDatabase.getILSRemark(""+dCode);
            remark_box.setText(rem+"\n"+Constants.ilsRemarkOther);
        }
