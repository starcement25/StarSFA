...
import com.forcepower.acedns.adapter.ProductMasterWithQtyInputAdapterCollectionForecast;
...
import static com.forcepower.acedns.constants.Constants.retailerRequisitionList;
...
public class CollectionForecastActivity extends AceDnsParentActivity {
    ...
    ArrayList<MenuOutstandingParent> outstandingList;
    ...
    int lastProdPos = 0;
    ProductMasterWithQtyInputAdapterCollectionForecast ProductMasterWithQtyInputAdapterObject;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mContext = CollectionForecastActivity.this;
...
//        showMasterDialog("");
        ArrayList<MenuOutstandingParent> getOutstandingDetails=mAceDnsDatabase.getOutstandingDetails();
        ProductMasterWithQtyInputAdapterObject = new ProductMasterWithQtyInputAdapterCollectionForecast(CollectionForecastActivity.this, R.layout.collection_forecast_list_item, getOutstandingDetails);
        retailerRequisitionList = (ListView) findViewById(R.id.retailerRequisitionList);
        retailerRequisitionList.setAdapter(ProductMasterWithQtyInputAdapterObject);
    }
...
//				getCustomerListAndShow(todaysRouteListFormatted);
    ...
    public void InitializeView() {
        ...
        btnCheckOut.setOnClickListener(CollectionForecastActivity.this);
        btnBack = (Button) findViewById(R.id.back);
        btnBack.setTag(105);
        btnBack.setOnClickListener(CollectionForecastActivity.this);
        ...
        btnCustomer.setOnClickListener(CollectionForecastActivity.this);
            ...
            switch (tag) {
                ...
                case 2:
                    ...
                    if (selectedGrp != null) {
                        ...
                        Toast.makeText(CollectionForecastActivity.this,
...
//            submitProcess();
    ...
    private void submitProcess() {
        if (Constants.selectedForecastList != null && Constants.selectedForecastList.size() > 0) {
            ...
            isSuccessInsertRequisitionOutDetails = mAceDnsTransactionDatabase.insertCollectionForecastDetails(timeStamp);
            isSuccessInsertToLocationTable = mAceDnsTransactionDatabase.insertToLocationTable1("CF", timeStamp);
            if (isSuccessInsertRequisitionOutDetails && isSuccessInsertToLocationTable) {
                ...
                if (HTTPUtils.isConnectionPossible(mContext)) {
                    new TRANS_SubmitCollectionForecastTask(mContext, true).execute();
                } else {
            ...
            Toast.makeText(CollectionForecastActivity.this, "Please add product in cart.", Toast.LENGTH_LONG).show();
        }
    }
    ...
    public void ShowChooseCustomerDialog() {
        final Dialog customerListDialog = new Dialog(CollectionForecastActivity.this, R.style.PauseDialog);
        ...
        final NewCustomerAdapter adapterCust = new NewCustomerAdapter(CollectionForecastActivity.this, R.layout.customer_list_child, mCustomerDetails);
    ...
    public void showGrpDialog() {
        ...
        if (productGroupList.size() > 0) {
            ...
            grpDialog = new Dialog(CollectionForecastActivity.this,
                    R.style.PauseDialog);
            ...
            ProductGrpAdapter adapter1 = new ProductGrpAdapter(
                    CollectionForecastActivity.this, R.layout.product_list_child,
                    productGroupList);
    ...
    public void showSubGrpDialog(String parentItem) {
        ...
        if (productSubGroupList.size() > 0) {
            ...
            subGrpDialog = new Dialog(CollectionForecastActivity.this,
                    R.style.PauseDialog);
            ...
            Toast.makeText(
                    CollectionForecastActivity.this,
    ...
    public void showBrandDialog(String parentItemId) {
        ...
        if (productBrandList.size() > 0) {
            ...
            brandDialog = new Dialog(CollectionForecastActivity.this,
                    R.style.PauseDialog);
...
//        outstandingList = mAceDnsDatabase.getProductMasterListRetailserStockin("", filterNo);
//        outstandingList = mAceDnsDatabase.getOutstandingDetails();
...
//            ProductMasterWithQtyInputAdapterObject = new ProductMasterWithQtyInputAdapterRetailerStockIn(CollectionForecastActivity.this, R.layout.product_list_item_with_quantity_input_stock_in, tempProductList);
//
//            masterDialog = new Dialog(CollectionForecastActivity.this,
//                    R.style.PauseDialog);
...
//        }
    ...
    private void addtocartProcess() {
        ...
        for (int i = 0; i < Constants.selectedForecastList.size(); i++) {
            String currentqty = Constants.selectedForecastList.get(i).getForecastAmount();
            String allocqty = Constants.selectedForecastList.get(i).getTotalInvoice();
            ...
            if (!InputQuantityHigerthanAllocatedQuantity) {
                if (Utils.isNumeric(currentqty) && Double.parseDouble(currentqty) > 0) {
                    if (Double.parseDouble(currentqty) > Double.parseDouble(allocqty)) {
                        ...
                        productForWhichInputQtyIsHigherThanAllocQty = Constants.selectedForecastList.get(i).getCustomerName();
                    }
                }
            }
        ...
        if (isValidNumericQtyProvidedForAllProducts) {
            if (InputQuantityHigerthanAllocatedQuantity) {
                Toast.makeText(mContext, "Forecast amount is higher than outstanding amount for " + productForWhichInputQtyIsHigherThanAllocQty, Toast.LENGTH_SHORT).show();
            } else {
                submitProcess();
            }

        } else {
            Toast.makeText(mContext, "Please provide value for all customers even if it is zero.", Toast.LENGTH_SHORT).show();
        }
    }
...
//                    if (outstandingList.get(x).getProdCode()
...
//        int size = tempProductList.size();
//        int size1 = outstandingList.size();
//        System.out.println("SIZE" + size + "_____" + size1);
//        for (int kk = 0; kk < outstandingList.size(); kk++) {
//            tempProductList.add(outstandingList.get(kk));
//        }
    }
