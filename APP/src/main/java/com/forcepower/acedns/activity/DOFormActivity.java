...
import com.forcepower.acedns.adapter.ProductMasterWithQtyInputAdapterDO;
...
import static com.forcepower.acedns.adapter.ProductMasterWithQtyInputAdapterDO.nameValuesProductListLocalDo;
...
import static com.forcepower.acedns.constants.Constants.selectedProductMasterListTemp;
...
public class DOFormActivity extends AppCompatActivity implements OnClickListener
{
    double minCapacityOfCurrentTransportMode=0;
    public static ImageView mImageViewHeaderLogo = null;
    public static TextView mTextViewUOM1 = null;
    public static TextView stkTVHeader = null;
    public static ArrayList<ProductMasterDetails> productList;
    ...
    public static TextView textViewQtyLimit = null;
    ...
    EditText edAmount;
    LinearLayout bodyLayout, optionLayout,
            filterLayout;
    /*
     * Custom Views
     */
    ...
    public static ArrayList<ProductMasterDetails> productMasterList;
    public static ArrayList<ProductMasterDetails> productMasterListBeforeRemovingRepeatedProduct;
    ...
    ProductMasterWithQtyInputAdapterDO ProductMasterWithQtyInputAdapterObjectAlternateDesignObject;
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_do_form_alternate_design);
        SchemeCheckedBeforeSubmittingOrder = true;
        carttv = (TextView) findViewById(R.id.carttv);
        Constants.remainingDOLimit = (TextView) findViewById(R.id.remainingDOLimit);
        ...
        InitializeView();
        customerInfoTV.setText("Customer: "+Constants.selectedCustomerDeliveryAddress.getCustomerName() );
        mHandlerPrepareSaudaData = new Handler() {
            public void handleMessage(Message msg) {
                ...
                DOFormActivity.this.runOnUiThread(new Runnable() {
                    public void run() {
                        switch (jobToDo) {
                            case 1:
...
//        showSkuSpinner();
        ...
        mSelectedUomList = mAceDnsDatabase.getUniqueUom1ListDO();
        if(mSelectedUomList.size()==1)
        {
            mChosenUomType=mSelectedUomList.get(0);
            selecteduom=mChosenUomType;
            if(selecteduom.equalsIgnoreCase("loose"))
            {
                selecteduom="MT";
            }
            getProductsShowOnList();
    ...
    private void showUom1ChooseDialog()
    {
        ...
        title.setText("Please select Uom for DO products");
        ListView dialogList = (ListView) incotermsSelectionDialog.findViewById(R.id.list);
        IncotermsAdapter branchadapter = new IncotermsAdapter(mContext, R.layout.list_item_single_radio_material ,mSelectedUomList);
    ...
    public void onBackPressed() {
        Constants.doBackToShippingAddressList=true;
        super.onBackPressed();
    }
    ...
    public void onResume() {
        ...
        if (mrpSpinner != null) {
            ...
            spinnerAdapter = new ArrayAdapter(DOFormActivity.this, android.R.layout.simple_spinner_item, tempSpinnerArray);
    ...
    public void InitializeView() {
        ...
        {
            stkTVHeader=findViewById(R.id.stkTVHeader);
            stkTVHeader.setVisibility(VISIBLE);
        }
        ...
        mButtonAddtoCart.setOnClickListener(DOFormActivity.this);
        mButtonAddtoCart.setTag(101);


        mButtonCheckOut = (Button) findViewById(R.id.btn_order_form);
        mButtonCheckOut.setTag(102);
        mButtonCheckOut.setOnClickListener(DOFormActivity.this);

        mButtonNoOrder = (Button) findViewById(R.id.no_ordr);
        mButtonNoOrder.setTag(104);
        mButtonNoOrder.setOnClickListener(DOFormActivity.this);
        mButtonNoOrder.setEnabled(true);

        mButtonBack = (Button) findViewById(R.id.back);
        mButtonBack.setTag(105);
        mButtonBack.setOnClickListener(DOFormActivity.this);
        customerInfoTV = (TextView) findViewById(R.id.customerInfoTV);
        mTextViewCustomerName = (TextView) findViewById(R.id.textViewCustomername);
        totalAllocationTV = (TextView) findViewById(R.id.totalAllocationTV);
        remainingAllocationTV = (TextView) findViewById(R.id.remainingAllocationTV);
        textViewQtyLimit = (TextView) findViewById(R.id.textViewQtyLimit);
        ...
        if (Constants.orderFormDetailsObj.getInputScreenSpecial().equalsIgnoreCase("yes")) {
            ...
            LayoutParams lay = (LayoutParams) list_details.getLayoutParams();
            lay.weight = 0.3f;
    ...
    {
        uomTV.setText("Unit: "+selecteduom);
        prepareProdData(1, "");
    }
...
//                        minCapacityOfCurrentTransportMode= mAceDnsDatabase.GetMinCapacityOfTransportMode( Constants.selectedCustomer.getBranchCode(), Constants.selectedCustomer.getRouteCode(),Constants.selectedCustomer.getTransportMode());
                        minCapacityOfCurrentTransportMode= Double.parseDouble(Constants.selectedCustomer.getLoadabilityTon());
//                        productMasterList = mAceDnsDatabase.getProductMasterListDO(selectedProductOfBargain.getDnsProdCode());
                        productMasterList = mAceDnsDatabase.getProductMasterListDO();
                        productMasterListBeforeRemovingRepeatedProduct=new ArrayList<>(productMasterList);
                        ...
                        {
                            DOFormActivity.this.runOnUiThread(() -> {
                                totalAllocationTV.setText("Total bargain Quantity : "+defaultFormat.format(totalDoQty)+" "+selecteduom);
                                remainingAllocationTV.setText("Balance Quantity : "+defaultFormat.format(totalDoQty)+" "+selecteduom);
                            });
                        }
                        ProductMasterWithQtyInputAdapterObjectAlternateDesignObject = new ProductMasterWithQtyInputAdapterDO(DOFormActivity.this, R.layout.list_item__product_with_quantity_input_material_do, tempProductList);
                        break;
                }
    ...
    private boolean currentProductPresentInList(String prodCode)
    {
        Boolean currentProductPresentInList=false;
        for(int i=0;i<productMasterListBeforeRemovingRepeatedProduct.size();i++)
        {
            String currentProdCode=productMasterListBeforeRemovingRepeatedProduct.get(i).getProdCode();
...
//					}
    ...
    public void showSaleRateDialog(ProductMasterDetails productObj, String selectedUOM) {
        ...
        if (mrpSpinnerList.size() > 0) {
            ...
            ArrayAdapter adapter = new ArrayAdapter(DOFormActivity.this, android.R.layout.simple_spinner_item, tempSpinnerArray);
    ...
    public void onClick(View clkdView) {
            ...
            switch (tag) {
                ...
                case 2:
                    ...
                    if (selectedGrp != null) {
                        ...
                        Toast.makeText(DOFormActivity.this,
        ...
        if (clkdView == mButtonBack) {
            if (carryInSales && selectedProductMasterList.size() > 0) {
    ...
    {
        Constants.selectedProductMasterListTemp=new ArrayList<>();
        for(int i=0;i<nameValuesProductListLocalDo.size();i++)
        {
            ProductMasterDetails productMasterDetails=nameValuesProductListLocalDo.get(i);
            ...
            {
//                double totalInputQty = Double.parseDouble(qty);
//                if(mChosenUomType.equalsIgnoreCase("loose"))
//                {
//                    totalInputQty= mAceDnsDatabase.calculatedValueC2MBargain(productMasterDetails.getProdCode(), totalInputQty);
//                Double  limitOfQty=  minCapacityOfCurrentTransportMode-1;
//                if(!selecteduom.equalsIgnoreCase("MT"))
//                {
//                    totalInputQty = mAceDnsDatabase.calculatedValueC2MBargain(productMasterDetails.getProdCode(), totalInputQty);//case to mt
//                }
//                if(Constants.selectedCustomer.getIncoTerms().toLowerCase().contains("for") && totalInputQty <limitOfQty)
//                    {
//                        Utils.showToast(mContext,"Input Qty must be >= "+limitOfQty+" MT for "+productMasterDetails.getDesc() );
//                        return;
//                    }
//                }


                if(isMaxQtyForDeliveryNotExceeded(0.0,productMasterDetails.gettotalBargainQuantity(),productMasterDetails.getparentProdCode()))
                {
                    double amnt = Double.parseDouble(qty) * Double.parseDouble(rate);
                    productMasterDetails.setAmount(defaultFormat.format(amnt));
                    Constants.selectedProductMasterListTemp.add(productMasterDetails);
                }
                else
                {
        ...
        if(Constants.selectedCustomer.getIncoTerms().toLowerCase().contains("for"))
        {
            double totalQty=0.0;
            for(int x=0;x<selectedProductMasterListTemp.size();x++)
            {
                ProductMasterDetails productMasterDetails = selectedProductMasterListTemp.get(x);
                double totalQtyCaseCurrent= Double.parseDouble(productMasterDetails.getQty());
                if(!selecteduom.equalsIgnoreCase("MT"))
                {
                    totalQtyCaseCurrent = mAceDnsDatabase.calculatedValueC2MBargain(productMasterDetails.getProdCode(), totalQtyCaseCurrent);//case to mt
                }
                totalQty=totalQty+totalQtyCaseCurrent;
...
//                totalQtyLoose=totalQtyLoose+totalQtyLooseCurrent;
            ...
            Double  limitOfQty=  minCapacityOfCurrentTransportMode-1;
            if(totalQty< limitOfQty)
            {
                selectedProductMasterListTemp=new ArrayList<>();
                Utils.showToast(mContext,"Total Input Qty >= "+limitOfQty+" MT (Minimum Capacity)" );
                return;
            }
        }

        if (selectedProductMasterListTemp.size() > 0)
        {
            ...
            {
            Toast.makeText(DOFormActivity.this,
                    "Please provide data for at least one product", Toast.LENGTH_LONG).show();
        }
    }
    public class TRANS_Bqargain_Transaction_Asynctask extends AsyncTask<String, Void, String>
    {
        ...
        protected String doInBackground(String... params)
        {
            ...
            if (HTTPUtils.isConnectionPossible(mContext))
            {
                ...
                {
                    String prodDetails="";
                    for(int i=0;i<selectedProductMasterListTemp.size();i++)
                    {
                        String currentItemDetails=selectedProductMasterListTemp.get(i).getProdCode()+"-"+selectedProductMasterListTemp.get(i).getQty()+"-"+selectedProductMasterListTemp.get(i).getparentProdCode();
                        if(prodDetails.matches(""))
                        {
                            prodDetails=currentItemDetails;
                        }
                        else
                        {
                            prodDetails=prodDetails+"$"+currentItemDetails;
                        }

                    }
                    //product_details=12105-DO_input_qty_for_the_product-ASR12X1L0101$12109- DO_input_qty_for_the_product-AMO15KT00109
                    //dns_prod_code^prod_desc^bargain_qty^bargain_rate
                    String url = BaseUrl.baseUrl + AceDnsWebServiceURL.doTransactionDisplayFIFOWiseUrl
                            + "?nick_name=" + Constants.nickName
                            + "&customer_code=" + Constants.selectedCustomer.getCustomerCode()
                            + "&product_details=" + prodDetails;
                    Log.d("_DOWNLOAD_", "_DOWNLOAD_ DOFormActivity: " + url);
                    downloader(url);

                    File csvFile = new File(Utils.getAppStoragePath(mContext) + "DO_transaction_display_fifo_wise.txt");
                        ...
                        while ((line = buffer.readLine()) != null) {
                            if (line.indexOf("¥") > 0) {
                                ...
                                if (RowData.length == noColumn)
                                {
                                    ...
                                    String prodCode = RowData[1];
                                    temp.setProdCode(prodCode);
                                    temp.setDesc(RowData[2]);
                                    temp.setVat(RowData[3]);
                                    temp.setQty(RowData[4]);
                                    String rate = RowData[5];
                                    ArrayList<String> getAddMinusFreight=getAddMinusFreight(prodCode);
                                    double addFreighjt=0.00,minusFreight=0.00;
                                    double rateInDouble=Double.parseDouble(rate);
                                    if(Utils.isNumeric(getAddMinusFreight.get(0)))
                                    {
                                        addFreighjt=Double.parseDouble(getAddMinusFreight.get(0));

                                    }
                                    if(Utils.isNumeric(getAddMinusFreight.get(1)))
                                    {
                                        minusFreight=Double.parseDouble(getAddMinusFreight.get(1));
                                    }
                                    rateInDouble=rateInDouble+addFreighjt-minusFreight;
                                    rate=rateInDouble+"";
                                    temp.setMrpValue(rate);
                                    double amnt = Double.parseDouble(RowData[4]) * Double.parseDouble(rate);
                                    temp.setAmount(defaultFormat.format(amnt));
...
//                    mAceDnsDatabase.UpdateDOTransactionStatus(gitList);
        ...
        protected void onPostExecute(String result)
        {
            ...
            Intent intent = new Intent(DOFormActivity.this, DOConfirmationActivity.class);
    ...
    private ArrayList<String> getAddMinusFreight(String prodCode)
    {
        ArrayList<String> getAddMinusFreight=new ArrayList<>();

        for (int i=0;i<productMasterList.size();i++)
        {

            String prodCOdeCurrent=productMasterList.get(i).getProdCode();
            if(prodCOdeCurrent.matches(prodCode))
            {
                getAddMinusFreight.add(productMasterList.get(i).getaddFreight());
                getAddMinusFreight.add(productMasterList.get(i).getminusFreight());
                break;
            }
        }
        return getAddMinusFreight;
    }
    ...
    private void downloader(String urlstr) {
        ...
        try {
            outputFile = new File(Utils.getAppStoragePath(mContext) + "DO_transaction_display_fifo_wise.txt");
    ...
    public static boolean isMaxQtyForDeliveryNotExceeded(Double currentQty,String maxavailableQty,String parentProdCode)
    {
        ...
        for(int i=0;i<nameValuesProductListLocalDo.size();i++)
        {
            ...
            {
                if(currentItem.getparentProdCode().equalsIgnoreCase(parentProdCode))
                {
...
//							String currentSaleRate = mrpSpinnerList.get(mrpSelected).getSaleRate();
            ...
            if (qty_status && mrp_status && tdStatus) {
                selectedProductMasterList.add(currentProductMasterObj);
                CalculateTotal();
                ...
                if (!mOrderPriceValidationType.matches("DOPS")) {
                    Toast.makeText(DOFormActivity.this, "Product has been added to cart.", Toast.LENGTH_LONG).show();
                ...
                if (false == qty_status) {
                    Toast.makeText(DOFormActivity.this, "Please provide valid quantity.", Toast.LENGTH_LONG).show();
            ...
            Toast.makeText(DOFormActivity.this, "Please select a product", Toast.LENGTH_LONG).show();
        }
        edQty.setText("");
    ...
    public void showChooseCustomerDialog() {
        customerListDialog = new Dialog(DOFormActivity.this,
                R.style.PauseDialog);
    ...
    public void ShowNoOrderDialog() {
        final Dialog noOrderDialog = new Dialog(DOFormActivity.this, R.style.PauseDialog);
            ...
            public void onClick(View v) {
                ...
                if (isTimeAutomatic) {
                    ...
                    if (Constants.menuDetailsObj.getRoutePlan().equalsIgnoreCase("yes")) {
                        ...
                        if (true == isExist) {
                            new TRANS_PendingRoutePlanBeforeOtherTxn(DOFormActivity.this, "ORDER").execute();
                        } else {
                            new TRANS_SubmitOrderTask(DOFormActivity.this, true).execute();
                        }
                    } else {
                        new TRANS_SubmitOrderTask(DOFormActivity.this, true).execute();
                    }
    ...
    public void showGrpListDialog() {
        if (productGroupList.size() > 0) {
            ...
            groupAdapter = new ProductGrpAdapter(DOFormActivity.this,
                    R.layout.product_list_child, tempProductGroupList);
            grpDialog = new Dialog(DOFormActivity.this, R.style.PauseDialog);
    ...
    public void showSubGrpListDialog() {
        if (productSubGroupList.size() > 0) {
            ...
            subGroupAdapter = new ProductSubGrpAdapter(DOFormActivity.this,
                    R.layout.product_list_child, tempProductSubGroupList);
            subGrpDialog = new Dialog(DOFormActivity.this,
                    R.style.PauseDialog);
    ...
    public void showBrandListDialog() {
        if (productBrandList.size() > 0) {
            ...
            brandAdapter = new ProductBrandAdapter(DOFormActivity.this,
                    R.layout.product_list_child, tempProductBrandList);
            brandDialog = new Dialog(DOFormActivity.this,
                    R.style.PauseDialog);
    ...
    public void showMasterListDialog() {
        if (productMasterList.size() > 0) {
            ...
            if (mOrderPriceValidationType.matches("DOPS")) {
                ProductMasterWithQtyInputAdapterObject = new ProductMasterWithQtyInputAdapter(DOFormActivity.this, R.layout.product_list_item_with_quantity_input, tempProductList);
            } else {
                prodAdapter = new ProductMasterAdapter(DOFormActivity.this, R.layout.product_list_child, tempProductList);
            }

            masterDialog = new Dialog(DOFormActivity.this, R.style.PauseDialog);
...
//					title.setText(Html.fromHtml("Please provide valid inputs for each <font color='#F58322'> focused </font> product"));
    ...
    public void showUomListDialogForMultipleUom() {
        final Dialog payTypeDialog = new Dialog(DOFormActivity.this, R.style.PauseDialog);
    ...
    public void showRouteListDialog(final ArrayList<RouteDetails> routeList) {
        routeDialog = new Dialog(DOFormActivity.this, R.style.PauseDialog);
        ...
        RouteAdapter adapter1 = new RouteAdapter(DOFormActivity.this,
        ...
        dialogList.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                ...
                if (customerList.size() > 0) {
                    ...
                    reInitialiseCustomerList();
                    adapterCust = new CustomerAdapter(DOFormActivity.this,
    ...
    public void removeRepeatedProductItems() {
        for (int kk = 0; kk < selectedProductMasterList.size(); kk++) {
            ProductMasterDetails currentItem = selectedProductMasterList
                    .get(kk);
    ...
    public void showUOMDialog(final ArrayList<String> uomList) {
        SimpleStringAdapter adapterUOM = new SimpleStringAdapter(DOFormActivity.this, R.layout.simple_list_child, uomList);
        uomDialog = new Dialog(DOFormActivity.this, R.style.PauseDialog);
    ...
    public void ShowVericalValueList() {
        final Dialog mPincodeDialog = new Dialog(DOFormActivity.this, R.style.PauseDialog);
    ...
    public void ShowPreviousOrderDialog() {
        ...
        if (data.length() > 0) {
            final Dialog mPreviousOrderDialog = new Dialog(DOFormActivity.this,
                    R.style.PauseDialog);
