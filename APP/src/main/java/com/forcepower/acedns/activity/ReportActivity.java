            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                if (reportType.equalsIgnoreCase("ORDER")) {
                    ...
                    if (reportList.get(arg2).getTransId().substring(0, 2).equalsIgnoreCase("NC")) {
                        ...
                        ReportData currentObj = reportList.get(arg2);
                        Intent intent = new Intent(ReportActivity.this, ReportDetailsActivity.class);
                        intent.putExtra("CustomerName", currentObj.getCustomerName());
                        intent.putExtra("ReportType", reportType);
                        intent.putExtra("SearchKey", currentObj.getTransId());
                        intent.putExtra("TotalMoney", Double.parseDouble(currentObj.getAmount()));
                        startActivity(intent);
                    }
                } else {
                    Intent intent = new Intent(ReportActivity.this, ReportDetailsActivity.class);
...
//		 endDateTxt.setText(dateFormat.format(new Date()));
            ...
            public void run() {
                if (reportType.equalsIgnoreCase("ORDER")) {
                    if (reportDuration.equalsIgnoreCase("TODAY")) {
                        ...
                        dataList = transDataHelperObj.getReportList("O", timeStamp, customerCode);
                    } else if (reportDuration.equalsIgnoreCase("MTD")) {
                    ...
                    if (reportDuration.equalsIgnoreCase("TODAY")) {
                        //String timeStamp = new SimpleDateFormat("yyyyMMdd").format(Calendar.getInstance().getTime());
                        String timeStamp = Constants.dateString;
                        dataList = transDataHelperObj.getReportList("P", timeStamp, customerCode);
                    } else if (reportDuration.equalsIgnoreCase("MTD")) {
                        //String timeStamp = new SimpleDateFormat("yyyyMM").format(Calendar.getInstance().getTime());
                        String timeStamp = Constants.dateString.substring(0, 6);
                        dataList = transDataHelperObj.getReportList("P", timeStamp, customerCode);
                    ...
                    if (reportDuration.equalsIgnoreCase("TODAY")) {
                        //String timeStamp = new SimpleDateFormat("yyyyMMdd").format(Calendar.getInstance().getTime());
                        String timeStamp = Constants.dateString;
                        dataList = transDataHelperObj.getReportList("DC", timeStamp, customerCode);
                    } else if (reportDuration.equalsIgnoreCase("MTD")) {
                        //String timeStamp = new SimpleDateFormat("yyyyMM").format(Calendar.getInstance().getTime());
                        String timeStamp = Constants.dateString.substring(0, 6);
                        dataList = transDataHelperObj.getReportList("DC", timeStamp, customerCode);
    ...
    public void showCustomReport() {
        new Thread() {
            public void run() {
                if (reportType.equalsIgnoreCase("ORDER")) {
                    dataList = transDataHelperObj.getCustomReportList("O", startDate, endDate, customerCode);
                } else if (reportType.equalsIgnoreCase("COLLECTION")) {
                    dataList = transDataHelperObj.getCustomReportList("P", startDate, endDate, customerCode);
                } else {
                    dataList = transDataHelperObj.getCustomReportList("DC", startDate, endDate, customerCode);
                }
                Message msgObj = mHandler.obtainMessage();
                Bundle b = new Bundle();
                b.putString("message", "JobDone");
