...
public class LuxEventActivity extends AceDnsParentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lux_event);

        btnBack = findViewById(R.id.back);
        buttonSubmit = findViewById(R.id.buttonSubmit);
        button_site_name = findViewById(R.id.button_site_name);
        mContext = LuxEventActivity.this;
    ...
    public void ShowEventDialog(String parentText) {
        ...
        final Dialog routePlanAccessDialog = new Dialog(LuxEventActivity.this,
                R.style.PauseDialog);
        ...
        SimpleStringAdapter adapter1 = new SimpleStringAdapter(
                LuxEventActivity.this, R.layout.routeplan_access_dialog_child,
                accessMonthList);
