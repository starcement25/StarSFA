...
import com.forcepower.acedns.adapter.TechnicalMeetApprovalAdapter;
...
public class TechnicalMeetApprovalActivity extends AceDnsParentActivity
{
    ...
    TechnicalMeetApprovalAdapter  TechnicalMeetApprovalAdapterObject;
    @Override
    protected void onCreate(Bundle savedInstanceState)
    {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_technical_meet_approval);
        RegisterActivities.registerActivity(this);
        status="";
        remarks="";
        exFor="";
        mContext = TechnicalMeetApprovalActivity.this;
        ...
        textViewTitle.setText("Technical Meet Approval");
        ...
        mHandlerPrepareSaudaData = new Handler() {
            public void handleMessage(Message msg) {
                ...
                TechnicalMeetApprovalActivity.this.runOnUiThread(new Runnable() {
                    public void run() {
                        switch (jobToDo) {
                            case 1:
        ...
        try
        {
            ...
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                    ...
                    UnapprovedTechnicalMeetsList=new ArrayList<>();
                    UnapprovedTechnicalMeetsList= mAceDnsDatabase.getMeetDetailsByChosenDate(chosenMeetDate);
                    TechnicalMeetApprovalAdapterObject=new TechnicalMeetApprovalAdapter(mContext,R.layout.list_item_technical_meet_approval);
