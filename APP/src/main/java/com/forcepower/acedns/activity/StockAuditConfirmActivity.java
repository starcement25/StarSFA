...
public class StockAuditConfirmActivity extends AceDnsParentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContext = StockAuditConfirmActivity.this;
        ...
        mHandler = new Handler() {
            public void handleMessage(Message msg) {
                ...
                if (aResponse.equalsIgnoreCase("SubmitJobDone")) {
                    loader.cancel();
                    StockAuditConfirmActivity.this.runOnUiThread(new Runnable() {
                        public void run() {
                            ...
                            if (Constants.menuDetailsObj.getRoutePlan().equalsIgnoreCase("yes")) {
                                ...
                                if (true == isExist) {
                                    new TRANS_PendingRoutePlanBeforeOtherTxn(StockAuditConfirmActivity.this, "STOCK").execute();
                                } else {
                                    new TRANS_SubmitStockAuditTask(StockAuditConfirmActivity.this, true, "SUBMIT").execute();
                                }
                            } else {
                                new TRANS_SubmitStockAuditTask(StockAuditConfirmActivity.this, true, "SUBMIT").execute();
                            }
    ...
    public void initView() {
        ...
        adapter = new StockAuditConfirmAdapter(StockAuditConfirmActivity.this, R.layout.ordr_confrm_list_child, Constants.selectedProductMasterListStockAudit);
        productListView.setAdapter(adapter);
        productListView.setOnItemClickListener(StockAuditConfirmActivity.this);
        productListView.setOnItemLongClickListener(StockAuditConfirmActivity.this);
        ...
        btnSubmit.setOnClickListener(StockAuditConfirmActivity.this);
        btnAddProduct.setOnClickListener(StockAuditConfirmActivity.this);
        btnBack.setOnClickListener(StockAuditConfirmActivity.this);
        btnRemarks.setOnClickListener(StockAuditConfirmActivity.this);
    ...
    private void showOneTimeHelp(final String type, String header) {
        try {
            if (!PreferenceData.getHelpStockAuditConfirm(mContext).matches("disable") && android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
...
//						.icon(getResources().getDrawable( R.drawable.add_prod ))                     // Specify a custom drawable to draw as the target
    ...
    public void onClick(View arg0) {
        ...
        if (arg0 == btnSubmit) {
            if (Utils.isTimeAutomatic(mContext)) {
                ...
                if (isPhysicalStockLessThanMinimumStock()) {
                    physicalStockLessThanMinimumStockDialog();
                } else {
                    saveStockData();
                }
            } else {
    ...
    public void physicalStockLessThanMinimumStockDialog() {
        ...
        TextView message = (TextView) masterDialog.findViewById(R.id.message);
        message.setVisibility(View.VISIBLE);
        title.setText("Please Note!");
        message.setText("Physical stock less than minimum stock level, kindly take order.");
    ...
    public void showDeleteItemDialog(final int pos) {
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(StockAuditConfirmActivity.this);
    ...
    public void showEditQuantityDialog(final int position) {
        ...
        final Dialog edQtyDialog = new Dialog(StockAuditConfirmActivity.this);
        ...
        submit.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (boolQty == true) {
                    edQtyDialog.cancel();
                    adapter.notifyDataSetChanged();
                    Toast.makeText(StockAuditConfirmActivity.this, "Quantity has been edited for this product.", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(StockAuditConfirmActivity.this, "Please provide a valid input", Toast.LENGTH_SHORT).show();
                }
            }
        });
        edQtyDialog.show();
    ...
    public void saveStockData() {
        ...
        new Thread() {
            public void run() {
                ...
                Boolean isSuccessInsertToStockAuditTable, isSuccessInsertToHintRemarksDetailsTable = true, isSuccessInsertToLocationTable;
                dataHelperObj.beginTransaction();
                isSuccessInsertToStockAuditTable = dataHelperObj.insertToStockAuditTable(timeStamp, remarks);
                if (selectedHintRemarksId != -1) {
                    isSuccessInsertToHintRemarksDetailsTable = dataHelperObj.insertToHintRemarksDetailsTable1("S", timeStamp, hintRemarksValList.get(selectedHintRemarksId - 1));
                }
                isSuccessInsertToLocationTable = dataHelperObj.insertToLocationTable1("S", timeStamp);

                gpstracker.stopUsingGPS();
                if (isSuccessInsertToStockAuditTable && isSuccessInsertToHintRemarksDetailsTable && isSuccessInsertToLocationTable) {
