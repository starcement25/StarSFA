...
public class commonAsyncTaskMaster {
    Context mContext;
    Activity activity;
    AceDnsDatabase dbHelper;
    int noRows = -1, noColumn = -1;
    String timeStamp = "";
    String lastUpdate = "2014-06-09 18:19:20", status = "";
    String dwnldDictTime = "2014-06-09 18:19:20";
    ...
    public commonAsyncTaskMaster(Context context, String statusOBJ) {
...
//             DOWNLOAD_RA_Window_Time_Download();
    ...
    public commonAsyncTaskMaster(Context context, String statusOBJ, boolean isIndependantDownload) {
    ...
    public commonAsyncTaskMaster(Context context, String statusOBJ, boolean isnavigationon, String empty) {
    ...
    public void _DOWNLOAD_product_master() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.productMasterDetailsURL
        ...
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ product_master: " + URL);

        Download_txt(URL);

        File csvFile = new File(Utils.getAppStoragePath(mContext) + status + ".txt");
        ArrayList<ProductMasterDetails> prodList = new ArrayList<ProductMasterDetails>();
    ...
    public void DOWNLOAD_imei_status() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.imeiStatusURL
                + "?nick_name=" + Constants.nickName
                + "&IMEI=" + Constants.imei;

        Log.d("_DOWNLOAD_", "_DOWNLOAD_ imei_status: " + URL);
        Download_txt(URL);
    ...
    public void DOWNLOAD_iprod_unit_conv_matrix() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.conversionDataDownloadURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ iprod_unit_conv_matrix: " + URL);
        Download_txt(URL);
    ...
    public void DOWNLOAD_cat_subcat_brand_mapping() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.catSubcatBrandMappingURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ cat_subcat_brand_mapping: " + URL);
        Download_txt(URL);
    ...
    public void _DOWNLOAD_emp_mtl_mapping() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.mtl_no_download_detailsURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ emp_mtl_mapping: " + URL);
        Download_txt(URL);
        ...
        ArrayList<MallMaster> mMallMasterList = new ArrayList<MallMaster>();
        BufferedReader buffer = new BufferedReader(file);
        try {
            String line = "";
            while ((line = buffer.readLine()) != null) {
        ...
        Log.i("mtl MASTER:", "Saving " + noRows
                + " records for \n mtl Details..");
    ...
    public void DOWNLOAD_cat_subcat_prod_mapping() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.catSubcatProdMappingURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ cat_subcat_prod_mapping: " + URL);
        Download_txt(URL);
    ...
    public void _DOWNLOAD_mall_master() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.mallMasterURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ mall_master: " + URL);
        Download_txt(URL);
    ...
    public void DownloadSelfAppraisalSummary() {
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.selfAppraisalCustomerWise
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ SelfAppraisalSummary: " + URL);
        Download_txt(URL);
    ...
    public void DownloadSelfAppraisalEmpWise() {
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.selfAppraisalEmpWise
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ SelfAppraisalEmpWise: " + URL);
        Download_txt(URL);
    ...
    public void DownloaddesingnationWiseTATDLimit() {
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.desingnationWiseTATDLimitUrl
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ desingnationWiseTATDLimit: " + URL);
        Download_txt(URL);
    ...
    public void _DOWNLOAD_route_master() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.routeDetailsURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ route_master: " + URL);
        Download_txt(URL);
...
//            Constants.isDownLoadComplete=false;
    ...
    public void DOWNLOAD_route_master_crm() {
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.routeDetailsAlternateURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ route_master_crm: " + URL);
        Download_txt(URL);
...
//            Constants.isDownLoadComplete=false;
    ...
    public void _DOWNLOAD_product_group_master() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.productGroupDetailsURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ product_group_master: " + URL);
        Download_txt(URL);

        File csvFile = new File(Utils.getAppStoragePath(mContext) + status + ".txt");
        ArrayList<ProductGroupDetails> grpList = new ArrayList<ProductGroupDetails>();
        FileReader file = null;
        try {
            file = new FileReader(csvFile);
        } catch (FileNotFoundException e1) {
        ...
        Log.i("product Group", "Saving " + noRows
                + " records for \n Product Group..");
    ...
    public void _DOWNLOAD_load_distribution() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.loadDistributionDetailsURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&last_update_time=" + lastUpdate
                + "&incremental_download=" + mIsInCremental
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ load_distribution: " + URL);
        Download_txt(URL);
    ...
    public void _DOWNLOAD_branch_route_freight() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.branchRouteFreightDetailsURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&last_update_time=" + lastUpdate
                + "&incremental_download=" + mIsInCremental
        ...
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ branch_route_freight: " + URL);
    ...
    public void _DOWNLOAD_bank_master() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.bankURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ bank_master: " + URL);

        Download_txt(URL);

        File csvFile = new File(Utils.getAppStoragePath(mContext) + status + ".txt");
        ArrayList<BankDetails> bnkList = new ArrayList<BankDetails>();
        FileReader file = null;
        try {
            file = new FileReader(csvFile);
        } catch (FileNotFoundException e1) {
        ...
        Log.i("BANK DETAILS", "Saving " + noRows
                + " records for \n Bank Details..");
    ...
    public void _DOWNLOAD_attendance_report() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.attendanceReportURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ attendance_report: " + URL);
    ...
    public void _DOWNLOAD_broker_master() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.brokerDetailsURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ broker_master: " + URL);
        ...
        ArrayList<BrokerMaster> mBrokerMastersList = new ArrayList<BrokerMaster>();
        BufferedReader buffer = new BufferedReader(file);
        try {
            String line = "";
            while ((line = buffer.readLine()) != null) {
    ...
    public void _DOWNLOAD_credit_limit() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.creditLimitURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ credit_limit: " + URL);
    ...
    public void _DOWNLOAD_outstanding_master() {
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.outstandingDetailsURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + (Constants.isFirstLoginOfApp ? "no" : "yes")
                + "&last_update_time=" + lastUpdate;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ outstanding_master: " + URL);

        Download_txt(URL);

        File csvFile = new File(Utils.getAppStoragePath(mContext) + status + ".txt");
        ArrayList<OutstandingDetails> outList = new ArrayList<OutstandingDetails>();
        FileReader file = null;
        try {
            file = new FileReader(csvFile);
        } catch (FileNotFoundException e1) {
        ...
        Log.i("Outstanding Details", "Saving " + noRows
                + " records for \n Outstanding Details..");
    ...
    public void _DOWNLOAD_travel_category() {
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.travelExpCategoryURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + (Constants.isFirstLoginOfApp ? "no" : "yes")
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ travel_category: " + URL);

        Download_txt(URL);

        File csvFile = new File(Utils.getAppStoragePath(mContext) + status + ".txt");
        ArrayList<TravelExpCategory> catList = new ArrayList<TravelExpCategory>();
        FileReader file = null;
        try {
            file = new FileReader(csvFile);
        } catch (FileNotFoundException e1) {
    ...
    public void _DOWNLOAD_product_sub_group_master() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.productSubGroupDetailsURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ product_sub_group_master: " + URL);

        Download_txt(URL);

        File csvFile = new File(Utils.getAppStoragePath(mContext) + status + ".txt");
        ArrayList<ProductSubGrpDetails> subGrpList = new ArrayList<ProductSubGrpDetails>();
        FileReader file = null;
        try {
            file = new FileReader(csvFile);
        } catch (FileNotFoundException e1) {
        ...
        Log.i("Product Sub Group", "Saving " + noRows
                + " records for \n Product SubGroup..");
    ...
    public void _DOWNLOAD_product_brand_master() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.productBrandDetailsURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ product_brand_master: " + URL);

        Download_txt(URL);

        File csvFile = new File(Utils.getAppStoragePath(mContext) + status + ".txt");
        ArrayList<ProductBrandDetails> brandList = new ArrayList<ProductBrandDetails>();
        FileReader file = null;
        try {
            file = new FileReader(csvFile);
        } catch (FileNotFoundException e1) {
    ...
    public void _DOWNLOAD_closing_stock() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.closingStockURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ closing_stock: " + URL);

        Download_txt(URL);

        File csvFile = new File(Utils.getAppStoragePath(mContext) + status + ".txt");
        ArrayList<ClosingStock> clStkList = new ArrayList<ClosingStock>();
        FileReader file = null;
        try {
            file = new FileReader(csvFile);
        } catch (FileNotFoundException e1) {
        ...
        Log.i("Closing Stock", "Saving " + noRows
                + " records for \n Closing Stock..");
    ...
    public void _DOWNLOAD_mrp_master() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.mrpURL
                ...
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ mrp_master: " + URL);
    ...
    public void _DOWNLOAD_prev_stock_counting_master() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.prevStockCountingURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ prev_stock_counting_master: " + URL);

        Download_txt(URL);

        File csvFile = new File(Utils.getAppStoragePath(mContext) + status + ".txt");
        ArrayList<PrevStockCountingDetails> stockList = new ArrayList<PrevStockCountingDetails>();
        FileReader file = null;
        try {
            file = new FileReader(csvFile);
        } catch (FileNotFoundException e1) {
    ...
    public void _DOWNLOAD_prodqty_custclass_wise_TD() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.prodQtyCustClassWiseTD
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ prodqty_custclass_wise_TD: " + URL);
    ...
    public void _DOWNLOAD_route_plan() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.routePlanURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + (Constants.isFirstLoginOfApp ? "no" : "yes")
                + "&last_update_time=" + lastUpdate
                + "&current_date=" + currentDate;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ route_plan: " + URL);
        ...
        Log.i("Route Plan", "Saving " + noRows + " records for \n Route Plan Details..");
        long insertStatus = -1;

        if (routePlanList.size() > 0) {
            insertStatus = dbHelper.InsertToRoutePlanMaster(routePlanList);
        }
        if (accessStartDate.length() > 0 && accessEndDate.length() > 0 && period.length() > 0) {
    ...
    public void _DOWNLOAD_travel_sub_category() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.travelExpSubCategoryURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + (Constants.isFirstLoginOfApp ? "no" : "yes")
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ travel_sub_category: " + URL);

        Download_txt(URL);

        File csvFile = new File(Utils.getAppStoragePath(mContext) + status + ".txt");
        ArrayList<TravelExpSubCategory> subList = new ArrayList<TravelExpSubCategory>();
        FileReader file = null;
        try {
            file = new FileReader(csvFile);
        } catch (FileNotFoundException e1) {
        ...
        Log.i("Travel Sub Category", "Saving " + noRows + " records for \n Transport SubCategory..");
    ...
    public void _DOWNLOAD_loyalty_customer() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.loyaltyCustomerURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ loyalty_customer: " + URL);

        Download_txt(URL);

        File csvFile = new File(Utils.getAppStoragePath(mContext) + status + ".txt");
        ArrayList<LoyaltyCustomerDetails> loyalCustList = new ArrayList<LoyaltyCustomerDetails>();
        FileReader file = null;
        try {
            file = new FileReader(csvFile);
        } catch (FileNotFoundException e1) {
    ...
    public void _DOWNLOAD_scheme_details() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.capMasterURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ scheme_details: " + URL);

        Download_txt(URL);

        File csvFile = new File(Utils.getAppStoragePath(mContext) + status + ".txt");
        ArrayList<SchemeFreebiesDetails> schemeList = new ArrayList<SchemeFreebiesDetails>();
        FileReader file = null;
        try {
            file = new FileReader(csvFile);
        } catch (FileNotFoundException e1) {
        ...
        Log.i("Scheme", "Saving " + noRows + " records for \n Scheme Details..");
    ...
    public void _DOWNLOAD_loyalty_purchase_details() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.loyaltyPurchaseURL
                ...
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ loyalty_purchase_details: " + URL);
    ...
    public void _DOWNLOAD_redeeme_details() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.redeemPointURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ redeeme_details: " + URL);

        Download_txt(URL);

        File csvFile = new File(Utils.getAppStoragePath(mContext) + status + ".txt");
        ArrayList<RedeemeDetails> schemeList = new ArrayList<RedeemeDetails>();
        FileReader file = null;
        try {
            file = new FileReader(csvFile);
        } catch (FileNotFoundException e1) {
    ...
    public void _DOWNLOAD_rds_master() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.rdsMasterURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ rds_master: " + URL);
        ...
        Log.i("RDS", "Saving " + noRows + " records for \n RDS Details..");
    ...
    public void _DOWNLOAD_emp_master() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.otherEmployeeURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ emp_master: " + URL);
        ...
        ArrayList<EmployeeMasterDetails> empList = new ArrayList<EmployeeMasterDetails>();
        BufferedReader buffer = new BufferedReader(file);
        try {
            String line = "";
            while ((line = buffer.readLine()) != null) {
    ...
    public void _DOWNLOAD_branch_master() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.branchURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ branch_master: " + URL);
    ...
    public void DOWNLOAD_honey_comb_cost() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.honeyCombURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ honey_comb_cost: " + URL);
    ...
    public void DOWNLOAD_margin_cost() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.marginCostURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ margin_cost: " + URL);
...
//                        temp.setplantname(RowData[3]);
    ...
    public void _DOWNLOAD_vendor_master() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.vendorURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + (Constants.isFirstLoginOfApp ? "no" : "yes")
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ vendor_master: " + URL);
        ...
        Log.i("Vendor Master", "Saving " + noRows
                + " records for \n Vendor Details..");
    ...
    public void _DOWNLOAD_mis_transaction_log() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.misTransactionLogURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ mis_transaction_log: " + URL);

        Download_txt(URL);

        File csvFile = new File(
                Utils.getAppStoragePath(mContext) + status + ".txt");
        FileReader file = null;
        try {
            file = new FileReader(csvFile);
        } catch (FileNotFoundException e1) {
        ...
        Log.i("MIS TRANSACTION", "Saving " + noRows
                + " records for \n MIS Transaction Details..");
    ...
    public void _DOWNLOAD_user_access() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.userAccessURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + (Constants.isFirstLoginOfApp ? "no" : "yes")
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ user_access: " + URL);
        ...
        ArrayList<UserAccessDetails> accessList = new ArrayList<UserAccessDetails>();
        BufferedReader buffer = new BufferedReader(file);
        try {
            String line = "";
            while ((line = buffer.readLine()) != null) {
        ...
        Log.i("Access Details", "Saving " + noRows
                + " records for \n User Access Details..");
    ...
    public void _DOWNLOAD_customer_branch_relation() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.custBranchURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ customer_branch_relation: " + URL);
    ...
    public void DOWNLOAD_sample() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.sampleDownloadURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ sample: " + URL);
            ...
            while ((line = buffer.readLine()) != null) {
                if (line.indexOf("¥") > 0) {
                    ...
                    if (RowData.length == noColumn) {
                        ...
                        String samplePhoto = RowData[1];//example- /sample/thumbnail/thumb_sample_3456789_G05.jpeg
    ...
    public void _DOWNLOAD_survey_category_master() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.surveyCategoryDetailsURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&last_update_time=" + lastUpdate
                + "&incremental_download=" + (Constants.isFirstLoginOfApp ? "no" : "yes")
                + "&data_download_time=" + lastUpdate;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ survey_category_master: " + URL);
        ...
        ArrayList<SurveyCategoryMaster> mSurveyCategoryMasterList = new ArrayList<SurveyCategoryMaster>();
        BufferedReader buffer = new BufferedReader(file);
        try {
            String line = "";
            while ((line = buffer.readLine()) != null) {
        ...
        Log.i("Survey Category", "Saving " + noRows
                + " records for \n Survey Category Details..");

        long insertStatus = dbHelper
                .InsertToSurveyCategoryMaster(mSurveyCategoryMasterList);
    ...
    public void DOWNLOAD_boq_master() {
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.BoqMasterURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ boq_master: " + URL);
    ...
    public void DOWNLOAD_customer_proposed_product() {
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.customerProposedProductURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ customer_proposed_product: " + URL);
    ...
    public void DOWNLOAD_gift_master() {
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.GiftMasterDownloadURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ gift_master: " + URL);
...
//                    if (RowData.length == noColumn) {
                    commonDatabaseHelper temp = new commonDatabaseHelper();
                    temp.setItem0(RowData[0]);//gift_id
                    temp.setItem1(RowData[1]);//gift_name
                    temp.setItem2(RowData[2]);//cust_type
                    temp.setItem3(RowData[3]);//acedns
                    temp.setItem4(RowData[4]);//from_date
                    temp.setItem5(RowData[5]);//to_date
                    mGenericOilMasterList.add(temp);
                }
        ...
        long insertStatus = dbHelper.InsertToGiftMaster(mGenericOilMasterList);
        decideNavigation();

    }

    public void DOWNLOAD_additional_material_master() {
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.AdditionalMaterialURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ additional_material_master: " + URL);
    ...
    public void _DOWNLOAD_generic_oil_master() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.genericOilDetailsURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ generic_oil_master: " + URL);
        ...
        ArrayList<GenericOilMaster> mGenericOilMasterList = new ArrayList<GenericOilMaster>();
        BufferedReader buffer = new BufferedReader(file);
        try {
            String line = "";
            while ((line = buffer.readLine()) != null) {
    ...
    public void DOWNLOAD_self_appraisal_emp_week_wise() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.weekwiseTargetAchievementDetailsURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ self_appraisal_emp_week_wise: " + URL);
    ...
    public void DOWNLOAD_van_sales_stock_master() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.vanSalesStockAllocationURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ van_sales_stock_master: " + URL);
    ...
    public void DOWNLOAD_prospective_customer_master() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.prospectiveCustomerDetailsURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ prospective_customer_master: " + URL);
    ...
    public void _DOWNLOAD_menu_access() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.menuAccessURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ menu_access: " + URL);
    ...
    public void _DOWNLOAD_sauda_allocation_access() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.saudaAllocationAccessURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ sauda_allocation_access: " + URL);

        Download_txt(URL);

        File csvFile = new File(Utils.getAppStoragePath(mContext) + status + ".txt");
        ArrayList<SaudaOrTDAllocationAccess> mSaudaAllocationAccessList = new ArrayList<SaudaOrTDAllocationAccess>();
        FileReader file = null;
        try {
            file = new FileReader(csvFile);
        } catch (FileNotFoundException e1) {
        ...
        Log.i("Sauda Allocation Access", "Saving " + noRows + " records ...");
    ...
    public void _DOWNLOAD_TD_allocation_access() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.TDAllocationAccessURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ TD_allocation_access: " + URL);
    ...
    public void _DOWNLOAD_sauda_allocation_log() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.saudaAllocationLogURL + "?nick_name="
                + Constants.nickName + "&emp_code="
                + Constants.employeeDetailObject.getEmpCode()
                + "&last_update_time=" + lastUpdate
                + "&incremental_download=" + mIsInCremental
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ sauda_allocation_log: " + URL);
        ...
        ArrayList<SaudaAllocationLog> mSaudaAllocationLogList = new ArrayList<SaudaAllocationLog>();
        BufferedReader buffer = new BufferedReader(file);
        try {
            String line = "";
            while ((line = buffer.readLine()) != null) {
    ...
    public void _DOWNLOAD_street_master() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.masterStreetLogURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&last_update_time=" + lastUpdate
                + "&incremental_download=" + mIsInCremental
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ street_master: " + URL);
        ...
        ArrayList<StreetName> mStreetNameList = new ArrayList<StreetName>();
        BufferedReader buffer = new BufferedReader(file);
        try {
            String line = "";
            while ((line = buffer.readLine()) != null) {
    ...
    public void _DOWNLOAD_pending_contract() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.pendingContractURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ pending_contract: " + URL);
        ...
        Log.i("Pending Contract", "Saving " + noRows + " records for \n Pending Contract Details..");
    ...
    public void _DOWNLOAD_mall_survey_relation() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.mallSurveyRelationURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ mall_survey_relation: " + URL);
        ...
        ArrayList<MallSurveyRelation> mMallSurveyRelationList = new ArrayList<MallSurveyRelation>();
        BufferedReader buffer = new BufferedReader(file);
        try {
            String line = "";
            while ((line = buffer.readLine()) != null) {
    ...
    public void _DOWNLOAD_prev_order_counting_master() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.previousOrderCountingURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&last_update_time=" + lastUpdate
                + "&incremental_download=" + mIsInCremental
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ prev_order_counting_master: " + URL);
        ...
        ArrayList<PreviousOrderCounting> mPreviousOrderCountingList = new ArrayList<PreviousOrderCounting>();
        BufferedReader buffer = new BufferedReader(file);
        try {
            String line = "";
            while ((line = buffer.readLine()) != null) {
    ...
    public void DOWNLOAD_farmer_master() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.farmerMasterDownloadURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&last_update_time=" + lastUpdate
                + "&incremental_download=" + mIsInCremental
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ farmer_master: " + URL);
    ...
    public void _DOWNLOAD_order_status() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.orderStatusURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ order_status: " + URL);
        ...
        ArrayList<OrderStatus> mOrderStatusList = new ArrayList<OrderStatus>();
        BufferedReader buffer = new BufferedReader(file);
        try {
            String line = "";
            while ((line = buffer.readLine()) != null) {
    ...
    public void _DOWNLOAD_outstanding_ageing() {
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.outstandingAgeingURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ outstanding_ageing: " + URL);
        ...
        ArrayList<OutstandingAgeing> mOutstandingAgeingList = new ArrayList<OutstandingAgeing>();
        BufferedReader buffer = new BufferedReader(file);
        try {
            String line = "";
            while ((line = buffer.readLine()) != null) {
    ...
    public void downloadSaudaMrp() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.saudaMrpURL
                ...
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ SaudaMrp: " + URL);
    ...
    public void downloadBargainMrp() {
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.bargainMrpURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ BargainMrp: " + URL);
    ...
    public void downloadGrnDo() {
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.grnDoDownloadURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ GrnDo: " + URL);
    ...
    public void customerProductRelation() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.customerProductRelationURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ customerProductRelation: " + URL);
    ...
    public void customer_product_info() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.customerProductInfoURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ customer_product_info: " + URL);
        ...
        try {
            ...
            while ((line = buffer.readLine()) != null) {
                if (line.indexOf("¥") > 0) {
                    ...
                    if (RowData.length == noColumn) {
                        commonDatabaseHelper temp = new commonDatabaseHelper();
                        temp.setItem0(RowData[0]);//order_no
                        temp.setItem1(RowData[1]);//customer_code
                        temp.setItem2(RowData[2]);//prod_code
                        temp.setItem3(RowData[3]);//qty
                        temp.setItem4(RowData[4]);//entry_date/last transaction date
                        temp.setItem5(RowData[5]);//rate
                        temp.setItem6(RowData[6]);//amount
                        temp.setItem7(RowData[7]);//d_instruction
                        temp.setItem8(RowData[8]);//creation_type
                        saudaMrpList.add(temp);
                    }
                }
            }
    ...
    public void mcxRate() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.mcxRateIncrementalURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ mcxRate: " + URL);
    ...
    public void orderApproval() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.OrderApprovalIncrementalURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ orderApproval: " + URL);
        ...
        try {
            ...
            while ((line = buffer.readLine()) != null) {
                if (line.indexOf("¥") > 0) {
                    ...
                    String[] RowData = line.split("\\^");
                    if (RowData.length == noColumn) {
//                        TAP.id,TAP.APPORDERNO,TAP.order_date,TAP.order_for,TAP.customer_code,TAP.dns_customer_code,TAP.sub_dealer_code,TAP.prod_code ,TAP.dns_prod_code,TAP.prod_display_name
//                                ,TAP.QTY,TAP.STATUS,TAP.freight,TAP.destination_code,TAP.destination_name,TAP.destination_address,TAP.phone_no,TAP.dump_status,TAP.dump_code,TAP.dump_name,TAP.dealer_truck,TAP.approval_status
                        commonDatabaseHelper temp = new commonDatabaseHelper();
                        temp.setItem0(RowData[0]);
                        temp.setItem1(RowData[1]);
                        temp.setItem2(RowData[2]);
...
//                        temp.setItem24(RowData[24]);
    ...
    public void technicalMeetApproval() {
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.TechnicalMeetApprovalURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ technicalMeetApproval: " + URL);
...
//                        CREATE TABLE IF NOT EXISTS Tech_meet_details(meet_id TEXT NULL,meet_date TEXT NULL,no_of_mason TEXT NULL,dealer_code TEXT NULL,dealer_name TEXT NULL,is_approved TEXT NULL,approved_date_time TEXT NULL,approved_by TEXT NULL,flag TEXT NULL);
                        ...
                        commonDatabaseHelper temp = new commonDatabaseHelper();
                        temp.setItem0(RowData[0]);//meet_id
                        temp.setItem1(RowData[1]);//meet_date
                        temp.setItem2(RowData[2]);//no_of_mason
                        temp.setItem3(RowData[3]);//dealer_code
                        temp.setItem4(RowData[4]);//dealer_name
                        temp.setItem5(RowData[5]);//is_approved
                        temp.setItem6(RowData[6]);//approved_date_time
                        temp.setItem7(RowData[7]);//approved_by
//                        temp.setItem8(RowData[8]);//flag
                        masterList.add(temp);
                    }
                }
            }
    ...
    public void technicalMeetApprovalStatus() {
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.TechnicalMeetApprovalDetailsURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ technicalMeetApprovalStatus: " + URL);
...
//                        CREATE TABLE IF NOT EXISTS Tech_meet_details(meet_id TEXT NULL,meet_date TEXT NULL,no_of_mason TEXT NULL,dealer_code TEXT NULL,dealer_name TEXT NULL,mason_details TEXT NULL,meet_status TEXT NULL,status_update_date_time TEXT NULL,status_update_by TEXT NULL,flag TEXT NULL);
                        ...
                        temp.setItem3(RowData[3]);//dealer_code
                        temp.setItem4(RowData[4]);//dealer_name
                        temp.setItem5(RowData[5]);//mason_details
                        temp.setItem6(RowData[6]);//meet_status
    ...
    public void branchDestination() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.BranchDestinationIncrementalURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ branchDestination: " + URL);
...
//                        CREATE TABLE branch_dump(branch_code TEXT NULL,dump_code TEXT NULL,dump_name TEXT NULL,acedns TEXT NULL,is_plant TEXT NULL);
    ...
    public void branchDump() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.BranchDumpIncrementalURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ branchDump: " + URL);
...
//                        CREATE TABLE branch_destination(branch_code TEXT NULL,destination_code TEXT NULL,ex_for_type TEXT NULL,acedns TEXT NULL);
    ...
    public void customer_broker_relation() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.customerBrokerRelationURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ customer_broker_relation: " + URL);
    ...
    public void brokerage_cost() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.BrokerageCostURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ brokerage_cost: " + URL);
...
//        Increment_bargain_Transaction_Download();

        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.bargainTransactionURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ bargainTransactionDownload: " + URL);
        ...
        if (insertStatus == noRows && noRows > 0) {
//            Constants.isDepotCostTableUpdated = false;
            decideNavigation();
        } else if (PhoneStateChangeListener.ringing) {
...
//        Increment_bargain_Transaction_Download();
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.bargainReportDataDownloadModeWiseURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&mode=" + Constants.mode
                + "&from_date=" + Constants.from_date
                + "&to_date=" + Constants.to_date;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ bargainReportDownload: " + URL);
...
//        Increment_bargain_Transaction_Download();
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.doReportDataDownloadModeWiseURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&mode=" + Constants.mode
                + "&from_date=" + Constants.from_date
                + "&to_date=" + Constants.to_date;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ doReportDownload: " + URL);
    ...
    public void bargainReportDownloadLevel2() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.bargainReportDataDownloadModeWiseSaudaListURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&mode=" + Constants.mode
                + "&from_date=" + Constants.from_date
                + "&to_date=" + Constants.to_date
                + "&customer_code=" + Constants.customerCode;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ bargainReportDownloadLevel2: " + URL);
    ...
    public void doReportDownloadLevel2() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.doReportDataDownloadModeWiseSaudaListURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&mode=" + Constants.mode
                + "&from_date=" + Constants.from_date
                + "&to_date=" + Constants.to_date
                + "&customer_code=" + Constants.customerCode;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ doReportDownloadLevel2: " + URL);
    ...
    public int bargainReportLevel3(int saudaCount, String line) {
        ...
        URL = BaseUrl.baseUrl + AceDnsWebServiceURL.bargainReportDataDownloadModeWiseSaudaListWithDetailsURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&mode=" + Constants.mode
                + "&from_date=" + Constants.from_date
                + "&to_date=" + Constants.to_date
                + "&sauda_no=" + saudaNo;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ bargainReportLevel3: " + URL);
    ...
    public int doReportLevel3(int doCount, String line) {
        ...
        listDataHeaderGlobal.add(ListItemHeader);
        URL = BaseUrl.baseUrl + AceDnsWebServiceURL.doReportDataDownloadModeWiseSaudaListWithDetailsURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&mode=" + Constants.mode
                + "&from_date=" + Constants.from_date
                + "&to_date=" + Constants.to_date
                + "&DO_no=" + doNo;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ doReportLevel3: " + URL);
        Download_txt_with_custom_name(URL, status + "2");
        File csvFile2 = new File(Utils.getAppStoragePath(mContext) + status + "2.txt");
    ...
    public void depotCostDownload() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.depotCostURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ depotCostDownload: " + URL);
    ...
    public void freightCostDownload() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.primaryFreightURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ freightCostDownload: " + URL);
    ...
    public void _DOWNLOAD_sale_performance() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.salesPerformanceURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ sale_performance: " + URL);

        Download_txt(URL);

        File csvFile = new File(Utils.getAppStoragePath(mContext) + status + ".txt");
        ArrayList<SalesPerformance> pendingContractList = new ArrayList<SalesPerformance>();
        FileReader file = null;
        try {
            file = new FileReader(csvFile);
        } catch (FileNotFoundException e1) {
        ...
        Log.i("Sales Performance", "Saving " + noRows + " records for \n Sales Performance Details..");
    ...
    public void _DOWNLOAD_emp_menu_access() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.employeemenuAccessURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ emp_menu_access: " + URL);
        ...
        ArrayList<EmployeeMenuAccess> mEmployeeMenuAccessList = new ArrayList<EmployeeMenuAccess>();
        BufferedReader buffer = new BufferedReader(file);
        try {
            String line = "";
            while ((line = buffer.readLine()) != null) {
    ...
    public void _DOWNLOAD_customer_product_wise_orderplan() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.CustomerProductWiseOrderPlan
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ customer_product_wise_orderplan: " + URL);
    ...
    public void _DOWNLOAD_survey_publish() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.surveyPublishURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ survey_publish: " + URL);
    ...
    public void _DOWNLOAD_offer_publish() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.offerPublishURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ offer_publish: " + URL);
    ...
    public void _DOWNLOAD_non_trade_customer_master() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.nonTradeCustomerURL
                ...
                + "&incremental_download=" + mIsInCremental
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ non_trade_customer_master: " + URL);
    ...
    public void _DOWNLOAD_distributor_route_relation() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.distributorRouteDetailsURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ distributor_route_relation: " + URL);
        ...
        ArrayList<RouteDetails> mRouteDetailsList = new ArrayList<RouteDetails>();
        BufferedReader buffer = new BufferedReader(file);
        try {
            String line = "";
            while ((line = buffer.readLine()) != null) {
        ...
        Log.i("ROUTE DETAILS:", "Saving " + noRows + " records for \n Route Details..");
...
//            Constants.isDownLoadComplete=false;
    ...
    public void customerToDelete() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.customerToDeleteURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ customerToDelete: " + URL);
        ...
        if (customerToDeleteList.size() > 0) {
    ...
    private void customerDeleteConfirmationApi(String commaseparatedCustomerList) {
        ...
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ customerDeleteConfirmationApi: " + BaseUrl.baseUrl + AceDnsWebServiceURL.customerDeleteConfirmationURL);
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ customerDeleteConfirmationApi values: " + values);
    }

    public void _DOWNLOAD_catalogue_info() {
        Increment_catalogue_info();

        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.catalogueDownloaderUrl
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
//                + "&incremental_download=" + mIsInCremental
//                + "&last_update_time=" + lastUpdate
//                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ catalogue_info: " + URL);
...
//			Constants.isProductBrandTableUpdated = false;
    ...
    public void _DOWNLOAD_facilitator_master() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.facilitatorMasterDownloaderUrl
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ facilitator_master: " + URL);
    ...
    public void _DOWNLOAD_site_master() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.siteMasterDownloaderUrl
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ site_master: " + URL);
    ...
    public void _DOWNLOAD_self_appraisal_productgroup_wise() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.productGroupWiseTargetAchievement
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ self_appraisal_productgroup_wise: " + URL);
    ...
    public void DOWNLOAD_state_master() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.stateMasterUrl
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ state_master: " + URL);
    ...
    public void DOWNLOAD_yellow_card_date_validation() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.yellowCardValidationDate
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ yellow_card_date_validation: " + URL);
    ...
    public void DOWNLOAD_scheme_master() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.schemeMasterURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ scheme_master: " + URL);
    ...
    public void DOWNLOAD_freebies_master() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.freebieMasterURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ freebies_master: " + URL);
    ...
    public void DOWNLOAD_plant_product_wise_RA_rate() {
        try {
            ...
            Log.d("_DOWNLOAD_", "_DOWNLOAD_ plant_product_wise_RA_rate: " + parentURLLaravel + AceDnsWebServiceURL.RASaudaRateDownload);
            Log.d("_DOWNLOAD_", "_DOWNLOAD_ plant_product_wise_RA_rate value: " + jo);
        } catch (Exception e) {
        ...
        activity.runOnUiThread(new Runnable() {
            ...
            public void run() {
                Utils.cancelProgressDialog();
//                dbHelper.getPlantListForRaNewBid();
...
//                        Utils.showToast(mContext, "No customer found for auction! Please contact admin.");
    ...
    public void DOWNLOAD_RA_route_freight() {
        try {
            ...
            Log.d("_DOWNLOAD_", "_DOWNLOAD_ RA_route_freight: " + parentURLLaravel + AceDnsWebServiceURL.RARouteFreight);
            Log.d("_DOWNLOAD_", "_DOWNLOAD_ RA_route_freight value: " + jo);
        } catch (Exception e) {
    ...
    public void DOWNLOAD_plant_product_wise_RA_rate_accepted() {
        ...
        try {
            ...
            Log.d("_DOWNLOAD_", "_DOWNLOAD_ plant_product_wise_RA_rate_accepted: " + parentURLLaravel + AceDnsWebServiceURL.RASaudaAcceptedBidRateDownload);
            Log.d("_DOWNLOAD_", "_DOWNLOAD_ plant_product_wise_RA_rate_accepted value: " + jo);
        } catch (Exception e) {
...
//        DOWNLOAD_RA_margin_rate();
    ...
    public void DOWNLOAD_plant_product_wise_RA_rate_counter_bid_accepted() {
        ...
        try {
            ...
            Log.d("_DOWNLOAD_", "_DOWNLOAD_ plant_product_wise_RA_rate_counter_bid_accepted: " + parentURLLaravel + AceDnsWebServiceURL.RASaudaCounterBidAcceptedBidRateDownload);
            Log.d("_DOWNLOAD_", "_DOWNLOAD_ plant_product_wise_RA_rate_counter_bid_accepted value: " + jo);
        } catch (Exception e) {
    ...
    public void DOWNLOAD_RA_margin_rate() {
        ...
        try {
            ...
            Log.d("_DOWNLOAD_", "_DOWNLOAD_ RA_margin_rate: " + parentURLLaravel + AceDnsWebServiceURL.RAMarginDownload);
            Log.d("_DOWNLOAD_", "_DOWNLOAD_ RA_margin_rate value: " + jo);
        } catch (Exception e) {
    ...
    public void DOWNLOAD_RA_detention_rate() {
        ...
        try {
            ...
            Log.d("_DOWNLOAD_", "_DOWNLOAD_ RA_detention_rate: " + parentURLLaravel + AceDnsWebServiceURL.RADetentionCostDownload);
            Log.d("_DOWNLOAD_", "_DOWNLOAD_ RA_detention_rate value: " + jo);
        } catch (Exception e) {
    ...
    public void DOWNLOAD_plant_product_wise_RA_rate_rejected() {
        ...
        try {
            ...
            Log.d("_DOWNLOAD_", "_DOWNLOAD_ plant_product_wise_RA_rate_rejected: " + parentURLLaravel + AceDnsWebServiceURL.RASaudaRejectedBidRateDownload);
            Log.d("_DOWNLOAD_", "_DOWNLOAD_ plant_product_wise_RA_rate_rejected value: " + jo);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void DOWNLOAD_plant_product_wise_RA_rate_counter() {
        try {
            ...
            Log.d("_DOWNLOAD_", "_DOWNLOAD_ plant_product_wise_RA_rate_counter: " + parentURLLaravel + AceDnsWebServiceURL.RASaudaCounterBidRateDownload);
            Log.d("_DOWNLOAD_", "_DOWNLOAD_ plant_product_wise_RA_rate_counter value: " + jo);
        } catch (Exception e) {
...
//                dbHelper.getPlantListForRaNewBid();
                ...
                if (CounterBidListListForRAOnToday.size() > 0) {
                    Intent intent = new Intent(mContext, ReverseAuctionActivity.class);
                    mContext.startActivity(intent);
                } else {
                    Utils.showToast(mContext, "No auction data found! Please contact admin.");
    ...
    public void DOWNLOAD_RA_Window_Time_Download() {
        try {
            ...
            Log.d("_DOWNLOAD_", "_DOWNLOAD_ RA_Window_Time_Download: " + parentURLLaravel + AceDnsWebServiceURL.RAWindowTimeDownload);
            Log.d("_DOWNLOAD_", "_DOWNLOAD_ RA_Window_Time_Download value: " + jo);
...
//                        temp.setRateReleaseDate(RowData[0]);
...
//                        Utils.showToast(mContext, "Window is not open right now! Please contact admin.");
    ...
    public void stock_allocation_master() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.stockAllocationURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ stock_allocation_master: " + URL);
    ...
    public void stock_balance_details_master() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.stockBalanceURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ stock_balance_details_master: " + URL);
    ...
    public void zero_outlet_details() {
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.zeroOutletDetailsUrl
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ zero_outlet_details: " + URL);
...
//        mDetailsDialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
        ...
        TextView imeiLabel = (TextView) mDetailsDialog.findViewById(R.id.imeiLabel);
        TextView imeiLabel2 = (TextView) mDetailsDialog.findViewById(R.id.imeiLabe2);
...
//        ArrayList<ProductMasterDetails> zeroOutletMasterListlocal=new ArrayList<>(zeroOutletMasterList);
        ...
        dialogList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
                ...
                ArrayList<ProductMasterDetails> zeroOutletMasterListlocal = new ArrayList<>(zeroOutletMasterList);
                for (Iterator<ProductMasterDetails> i = zeroOutletMasterListlocal.iterator(); i.hasNext(); ) // assuming links has String as generic type
                {
                    ProductMasterDetails x = i.next(); // without generics you'll need to cast
                    if (!x.getcustomerCode().matches(custCodeOfClickedItem)) {
                        i.remove();
                    }
                }
                Collections.sort(zeroOutletMasterListlocal, new Comparator<ProductMasterDetails>() {
                    public int compare(ProductMasterDetails v1, ProductMasterDetails v2) {
                        return v1.getDesc().compareTo(v2.getDesc());
                    }
                });
                ShowEmpAttendanceDetailsDialogProduct(zeroOutletMasterListlocal, custNameOfClickedItem);
...
//        mDetailsDialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
    ...
    public void splashScreenDetailsApiCaling() {
        String URLSplashScrenDetails = BaseUrl.baseUrl + AceDnsWebServiceURL.splashScreenDetailsUrl
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ splashScreenDetailsApiCaling: " + URLSplashScrenDetails);
    ...
    public void managerActivityApiCaling() {
        String URLSplashScrenDetails = BaseUrl.baseUrl + AceDnsWebServiceURL.managerActivityUrl
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&dateval=" + Utils.getCurrentDateTimeInGivenFormat("yyyy-MM-dd")
                + "&timeval=" + timeVal;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ managerActivityApiCaling: " + URLSplashScrenDetails);
        Download_txt(URLSplashScrenDetails);
        File csvFile = new File(Utils.getAppStoragePath(mContext) + status + ".txt");
        FileReader file = null;
        try {
    ...
    public void managerActivityDetailsApiCaling() {
        ...
        String URLSplashScrenDetails = BaseUrl.baseUrl + AceDnsWebServiceURL.managerActivityOnClickUrl
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.cust_emp_selected
                + "&dateval=" + date;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ managerActivityDetailsApiCaling: " + URLSplashScrenDetails);
        Download_txt(URLSplashScrenDetails);
        File csvFile = new File(Utils.getAppStoragePath(mContext) + status + ".txt");
        FileReader file = null;
        try {
    ...
    public void priceGenerationApiCaling() {
        String URLSplashScrenDetails = BaseUrl.baseUrl + AceDnsWebServiceURL.baseOilRateApi
                + "?nick_name=" + Constants.nickName;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ priceGenerationApiCaling: " + URLSplashScrenDetails);
        Download_txt(URLSplashScrenDetails);
        File csvFile = new File(Utils.getAppStoragePath(mContext) + status + ".txt");
        FileReader file = null;
        try {
        ...
        try {
            ...
            while ((line = buffer.readLine()) != null) {
                if (line.indexOf("¥") > 0) {
                    ...
                    String[] RowData = line.split("\\^");
                    if (RowData.length == noColumn) {
                        commonDatabaseHelper temp = new commonDatabaseHelper();//base_oil^mandatory^lower_limit^upper_limit^oils_rate_input_last

                        temp.setItem0(RowData[0]);//base oil
                        temp.setItem1(RowData[1].toLowerCase());//mandatory
                        temp.setItem2(RowData[2]);//lower limit
                        temp.setItem3(RowData[3]);//upper limit
                        temp.setItem4(RowData[4]);//last input
                        empActivityList.add(temp);
                    }
                }
            }
    ...
    public void McxpriceGenerationApiCaling() {
        String URLSplashScrenDetails = BaseUrl.baseUrl + AceDnsWebServiceURL.mcxBaseOilRateApi
                + "?nick_name=" + Constants.nickName;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ McxpriceGenerationApiCaling: " + URLSplashScrenDetails);
        Download_txt(URLSplashScrenDetails);
        File csvFile = new File(Utils.getAppStoragePath(mContext) + status + ".txt");
        FileReader file = null;
        try {
        ...
        try {
            ...
            while ((line = buffer.readLine()) != null) {
                if (line.indexOf("¥") > 0) {
                    ...
                    String[] RowData = line.split("\\^");
                    if (RowData.length == noColumn) {
                        commonDatabaseHelper temp = new commonDatabaseHelper();//MCX_open_rate^74680 MCX_close_rate^74680
                        temp.setItem0(RowData[0]);//rate type
                        temp.setItem1(RowData[1]);//rate
                        itemList.add(temp);
                    }
                }
            }
    ...
    public void ShowProductDetailsDialog(ArrayList<EmployeeMasterDetails> empActivityList) {
        ...
        FrameLayout fl_ts = (FrameLayout) mDetailsDialog.findViewById(R.id.fl_ts);
        if (Constants.menuDetailsObj.getmanager_activity().equalsIgnoreCase("customize")) {
    ...
    public void ShowMcxRatePriceGenerationDialog(ArrayList<commonDatabaseHelper> empActivityList) {
        ...
        btn_generate.setOnClickListener(view ->
        {
            ...
            for (int i = 0; i < McxRatePriceGenerationInputAdapter.priceListOilGrp.size(); i++) {
                ...
                String prod = productMasterDetails.getItem0();//base oil
                String input = productMasterDetails.getItem1();//last input
...
//                }
            ...
            if (priceListOilGrpFinalList.size() > 0) {
                if (HTTPUtils.isConnectionPossible(mContext)) {
                    Utils.showProgressDialog(mContext, "Downloading Data Please Wait..");
                    new Thread() {
                        public void run() {
    ...
    public void ShowBaseOilRatePriceGenerationDialog(ArrayList<commonDatabaseHelper> empActivityList) {
        ...
        btn_generate.setOnClickListener(view ->
        {
            ...
            for (int i = 0; i < BaseOilRatePriceGenerationInputAdapter.priceListOilGrp.size(); i++) {
                ...
                String prod = productMasterDetails.getItem0();//base oil
                String mandatory = productMasterDetails.getItem1();//mandatory
                String lower = productMasterDetails.getItem2();//lower limit
                String upper = productMasterDetails.getItem3();//upper limit
                String input = productMasterDetails.getItem4();//last input
                if (Utils.isNumeric(input) && Double.parseDouble(input) > 0) {
...
//            String upper = productMasterDetails.getItem3();//upper limit
            String input = productMasterDetails.getItem4();//last input
            if (loose_rate.matches("")) {
                loose_rate = prod;
            } else {
                loose_rate = loose_rate + "," + prod;
            }
            if (oilsVal.matches("")) {
                oilsVal = input;
            } else {
                oilsVal = oilsVal + "," + input;
            }
        }
        ContentValues values = new ContentValues();
        values.put("loose_rate", oilsVal);
        values.put("oils_val", loose_rate);
        //priceListOilGrpFinalList
        String url = BaseUrl.baseUrl + AceDnsWebServiceURL.RateGenerationApi
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ priceGenerationFinalPArtApiCalling: " + url);
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ priceGenerationFinalPArtApiCalling value: " + values);
        ...
        try {
            ...
            while ((line = buffer.readLine()) != null) {
                if (line.indexOf("¥") > 0) {
                    ...
                    if (RowData.length == noColumn) {
                        commonDatabaseHelper temp = new commonDatabaseHelper();
                        temp.setItem0(RowData[0]);//prod code
                        temp.setItem1(RowData[1]);//prod desc
                        temp.setItem2(RowData[2]);//material_cost
                        temp.setItem3(RowData[3]);//process_cost
                        temp.setItem4(RowData[4]);//packing_realization
                        temp.setItem5(RowData[5]);//margin_cost
                        temp.setItem6(RowData[6]);//bargain rate
    ...
    public void McxPriceGenerationFinalPArtApiCalling() {
        ...
        values.put("oils_val", loose_rate);
        //priceListOilGrpFinalList
        String url = BaseUrl.baseUrl + AceDnsWebServiceURL.McxRateGenerationApi
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ McxPriceGenerationFinalPArtApiCalling: " + url);
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ McxPriceGenerationFinalPArtApiCalling value: " + values);
        String response = HttpCalling.httpPostCallWithXmlResponse(url, values);
            ...
            while ((line = buffer.readLine()) != null) {
                if (line.indexOf("¥") > 0) {
                    ...
                    if (RowData.length == noColumn) {
                        ...
                        temp.setItem0(RowData[0]);//prod code
                        temp.setItem1(RowData[1]);//prod desc
                        temp.setItem2(RowData[2]);//Loose rate open
                        temp.setItem3(RowData[3]);//Loose rate close
                        temp.setItem4(RowData[4]);//Process cost
                        temp.setItem5(RowData[5]);//Packing realization
                        temp.setItem6(RowData[6]);//Margin cost
                        temp.setItem7(RowData[7]);//MCX rate open
                        temp.setItem8(RowData[8]);//MCX rate close
        ...
        activity.runOnUiThread(() -> {
            Utils.cancelProgressDialog();
            if (generatedMcxPriceList.size() > 0) {
...
//        activity.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
    ...
    public void priceReleaseApiCalling() {
        ...
        String response = HttpCalling.httpGetCallWithXmlResponse(releasedRateDownload, values);//product_sub_group_name^prod_code ^ flashname ^release_date ^release_rate
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ priceReleaseApiCalling: " + releasedRateDownload);
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ priceReleaseApiCalling values: " + values);
        ...
        try {
            ...
            while ((line = buffer2.readLine()) != null) {
                if (line.indexOf("¥") > 0) {
                    ...
                    if (RowData.length == noColumn) {
                        commonDatabaseHelper temp = new commonDatabaseHelper();
                        temp.setItem0(RowData[0]);//product_sub_group_name
                        temp.setItem1(RowData[1]);//prod_code
                        temp.setItem2(RowData[2]);// flashname
                        temp.setItem3(RowData[3]);//release_date
                        temp.setItem4(RowData[4]);//release_rate
                        generatedPriceListDownloaded.add(temp);
                    }
                }
            }
            buffer2.close();
            if (generatedPriceListDownloaded.size() > 0) {
        ...
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ priceReleaseApiCalling: " + URLSplashScrenDetails);
        Download_txt(URLSplashScrenDetails);
        File csvFile = new File(Utils.getAppStoragePath(mContext) + status + ".txt");
        FileReader file = null;
        try {
        ...
        try {
            ...
            while ((line = buffer.readLine()) != null) {
                if (line.indexOf("¥") > 0) {
                    ...
                    String[] RowData = line.split("\\^");
                    if (RowData.length == noColumn) {
                        commonDatabaseHelper temp = new commonDatabaseHelper();//prod_code^prod_desc^Prod_sub_group_name^mrp_code^current_publish_rate^Previos_publish_rate

                        temp.setItem0(RowData[0]);//prod code
                        temp.setItem1(RowData[1]);//prod_desc
                        temp.setItem2(RowData[2]);//Prod_sub_group_name
                        temp.setItem3(RowData[3]);//mrp_code
                        temp.setItem4(RowData[4]);//current_publish_rate
                        temp.setItem5(RowData[5]);//previous_publish_rate
                        temp.setItem6("");//publish_rate_type
                        temp.setItem7("");//prev_rate_date
                        ...
                        new Thread() {
                            public void run() {
                                ...
                                for (int x = 0; x < publishRateList.size(); x++) {
                                    ...
                                    xmlData += "<publish_rate_info>"
                                            + "<product_sub_group_code><![CDATA[" + "" + "]]></product_sub_group_code>"
                                            + "<product_sub_group_name><![CDATA[" + currentItem.getItem2() + "]]></product_sub_group_name>"
                                            + "<prod_code><![CDATA[" + currentItem.getItem0() + "]]></prod_code>"
                                            + "<publish_rate_type><![CDATA[" + prevOrCurrent + "]]></publish_rate_type>"
                                            + "<publish_rate_date><![CDATA[" + date + "]]></publish_rate_date>"
                                            + "</publish_rate_info>";
                                }
                                xmlData += "</root>";
                                String POST_result = "";
                                try {
                                    String uri = BaseUrl.baseUrl +
                                            AceDnsWebServiceURL.RatePublishTransApi
                                            + "?nick_name=" + Constants.nickName
                                            + "&emp_code="
                                            + Constants.employeeDetailObject.getEmpCode();
                                    Log.d("_DOWNLOAD_", "_DOWNLOAD_ ShowPricePublishDialog: " + uri);
                                    Log.d("_DOWNLOAD_", "_DOWNLOAD_ ShowPricePublishDialog: " + xmlData);
...
//        BaseOilRatePriceGenerationInputAdapter ReportAdapterObject = new BaseOilRatePriceGenerationInputAdapter(mContext, R.layout.list_item__base_oil_price_input_material, empActivityList);
    ...
    public void DOWNLOAD_billing_info() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.billingInformationURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ billing_info: " + URL);
                ...
                public void run() {
                    ...
                    if (masterApiCallingFlagFromReport) {
                        ...
                        if (Constants.stockOutTypeRetailerApp.equalsIgnoreCase("special")) {
                            ...
                            if (Constants.retailerStockOutProductList.size() > 0) {
...
//        Increment_dealer_transaction();
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.dealerTransactionURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
//                + "&incremental_download=" + mIsInCremental
//                + "&last_update_time=" + lastUpdate;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ dealer_transaction: " + URL);
        ...
        long insertStatus = dbHelper.InsertToDealerTransaction(masterList);
//        if (masterList.size() > 0)
//        {
//            add_last_update_time(status);
//        }
...
//        if (insertStatus == noRows && noRows > 0)
//        {
//            Constants.isdealerTransactionUpdated = false;
//            decideNavigation();
//        }
//        else if (noRows == 0 && noColumn != 0)
//        {
...
//        }
    ...
    public void DOWNLOAD_order_summary() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.orderSummaryURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ order_summary: " + URL);
    ...
    public void DOWNLOAD_state_district_town() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.stateDistrictTownTableUrl
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ state_district_town: " + URL);
    ...
    public void _DOWNLOAD_self_appraisal_branch_wise() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.branchWiseTargetAchievement
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ self_appraisal_branch_wise: " + URL);
    ...
    public void DOWNLOAD_beat_wise_TA_DA() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.beatWiseTADADownload
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ beat_wise_TA_DA: " + URL);
        ...
        try {
            ...
            while ((line = buffer.readLine()) != null) {
                if (line.indexOf("¥") > 0) {
                    ...
                    if (RowData.length == noColumn) {
                        commonDatabaseHelper temp = new commonDatabaseHelper();
                        temp.setItem0(RowData[0]);//emp_code
                        temp.setItem1(RowData[1]);//emp_name
                        temp.setItem2(RowData[2]);//reporting_to
                        temp.setItem3(RowData[3]);//reporting_to_name
                        temp.setItem4(RowData[4]);//route_code
                        temp.setItem5(RowData[5]);//route_name
                        temp.setItem6(RowData[6]);//HQ_EX_OS
                        temp.setItem7(RowData[7]);//DA
                        temp.setItem8(RowData[8]);//distance
                        temp.setItem9(RowData[9]);//TA
                        temp.setItem10(RowData[10]);//acedns
    ...
    public void DOWNLOAD_tar_ach_retailer_wise() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.retailerWiseTargetAchievement
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ tar_ach_retailer_wise: " + URL);
        ...
        try {
            ...
            while ((line = buffer.readLine()) != null) {
                if (line.indexOf("¥") > 0) {
                    ...
                    if (RowData.length == noColumn) {
                        commonDatabaseHelper temp = new commonDatabaseHelper();
                        temp.setItem0(RowData[0]);//customer_code
                        temp.setItem1(RowData[1]);//customer_name
                        temp.setItem2(RowData[2]);//start_date
                        temp.setItem3(RowData[3]);//end_date
                        temp.setItem4(RowData[4]);//value_slab_target
                        temp.setItem5(RowData[5]);//value_slab_ach
                        temp.setItem6(RowData[6]);//sku_count_target
                        temp.setItem7(RowData[7]);//sku_count_ach
                        temp.setItem8(RowData[8]);//apr_freq_target
                        temp.setItem9(RowData[9]);//apr_freq_ach
                        temp.setItem10(RowData[10]);//may_freq_target
                        temp.setItem11(RowData[11]);//may_freq_ach
                        temp.setItem12(RowData[12]);//jun_freq_target
                        temp.setItem13(RowData[13]);//jun_freq_ach
                        temp.setItem14(RowData[14]);//acedns
                        mSelfAppraisalCustomerWiseList.add(temp);
    ...
    public void _DOWNLOAD_target_achievement() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.empTargetAcheivementURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ target_achievement: " + URL);
        ...
        ArrayList<EmployeeTargetAcheivement> mEmployeeTargetAcheivementList = new ArrayList<EmployeeTargetAcheivement>();
        BufferedReader buffer = new BufferedReader(file);
        try {
            String line = "";
            while ((line = buffer.readLine()) != null) {
    ...
    public void DOWNLOAD_emp_date_wise_route_allocation() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.empDateWiseRouteAllocationURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ emp_date_wise_route_allocation: " + URL);
        ...
        activity.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (allocatedRouteCodeTodayCrm.size() > 0) {
    ...
    public void _DOWNLOAD_fs_survey_publish() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.fssurveyPublishURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ fs_survey_publish: " + URL);
    ...
    public void _DOWNLOAD_survey_table_view() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.surveyTableViewURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&last_update_time=" + lastUpdate
                + "&incremental_download=" + mIsInCremental
    ...
    public void _DOWNLOAD_route_customer_plan() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.routeCustomerPlanDetailsURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&last_update_time=" + lastUpdate
                + "&incremental_download=" + mIsInCremental
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ route_customer_plan: " + URL);
        ...
        ArrayList<RoutePlanCustomer> routePlanCustomerList = new ArrayList<RoutePlanCustomer>();
        BufferedReader buffer = new BufferedReader(file);
        try {
            String line = "";
            while ((line = buffer.readLine()) != null) {
    ...
    public void _DOWNLOAD_competitor_group_master() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.competitorGroupURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&branch=" + branch;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ competitor_group_master: " + URL);
        ...
        ArrayList<CompetitorGroupMaster> mCompetitorGroupMasterList = new ArrayList<CompetitorGroupMaster>();
        BufferedReader buffer = new BufferedReader(file);
        try {
            String line = "";
            while ((line = buffer.readLine()) != null) {
    ...
    public void _DOWNLOAD_branchwise_geofencing_master() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.branchWiseGeoFencingURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ branchwise_geofencing_master: " + URL);
    ...
    public void _DOWNLOAD_sauda_allocation() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.saudaURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ sauda_allocation: " + URL);
        ...
        Log.i("Sauda Allocation", "Saving " + noRows + " records for \n Sauda Details..");
    ...
    public void _DOWNLOAD_TD_allocation() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.TDAllocationURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ TD_allocation: " + URL);
    ...
    public void _DOWNLOAD_customer_master() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.customerDetailsURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ customer_master: " + URL);
...
//                        temp.setDnsCustCode(RowData[43]);
            ...
            Log.d("TAG", "_DOWNLOAD_ customer_master: "+ex.getMessage());
            ex.printStackTrace();
        }
        Log.i("Customer Details", "_DOWNLOAD_ Saving " + noRows
                + " records for \n Customer Details..");
    ...
    public void DOWNLOAD_customer_master_crm() {
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.customerAlternateUrlForCrm
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ customer_master_crm: " + URL);
        ...
        Log.i("Customer Details", "Saving " + noRows
                + " records for \n Customer Details..");
    ...
    public void DOWNLOAD_customer_product_wise_msl() {
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.customerProductMsl
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ customer_product_wise_msl: " + URL);
    ...
    public void _DOWNLOAD_destination_master() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.destinationMasterURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ destination_master: " + URL);
    ...
    public void DOWNLOAD_scheme_pdf_master() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.branchWiseSchemePdfDownloadMasterURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ scheme_pdf_master: " + URL);
    ...
    public void DOWNLOAD_scheme_pdf_master_without_branch() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.SchemePdfDownloadMasterURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ scheme_pdf_master_without_branch: " + URL);
...
//                        temp.setbranch_code(RowData[0]);
    ...
    public void DOWNLOAD_branchwise_golden_rule() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.branchWiseGoldenRuleURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ branchwise_golden_rule: " + URL);
    ...
    public void _DOWNLOAD_git_master() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.gitURL
                ...
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ git_master: " + URL);
        ...
        ArrayList<GITDetails> gitList = new ArrayList<GITDetails>();
        BufferedReader buffer = new BufferedReader(file);
        try {
            String line = "";
            while ((line = buffer.readLine()) != null) {
    ...
    public void DOWNLOAD_cash_transfer_master() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.cashTransferMasterURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ cash_transfer_master: " + URL);
        ...
        activity.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (UnVerifiedCashReceiveList.size() > 0) {
    ...
    public void DOWNLOAD_customer_orientation_data() {
        ...
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ customer_orientation_data: " + BaseUrl.baseUrl + AceDnsWebServiceURL.updateCheckURL);
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ customer_orientation_data value: " + values);
    }

    public void _DOWNLOAD_sauda_transaction_log() {
        Increment_sauda_transaction_log();

        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.saudaTransactionLogURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&last_update_time=" + lastUpdate
                + "&incremental_download=" + mIsInCremental
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ sauda_transaction_log: " + URL);
        ...
        ArrayList<SauadaTransactionLog> mSauadaTransactionLogList = new ArrayList<SauadaTransactionLog>();
        BufferedReader buffer = new BufferedReader(file);
        try {
            String line = "";
            while ((line = buffer.readLine()) != null) {
    ...
    public void Increment_sauda_transaction_log() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isSaudaTransactionUpdated)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_destination_master() {
        if (true == Constants.isFirstLoginOfApp || true == Constants.isDestinationUpdated) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_scheme_pdf_master() {
        if (true == Constants.isFirstLoginOfApp || true == Constants.isSchemePdfMasterUpdated) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_scheme_pdf_master_without_branch() {
        if (true == Constants.isFirstLoginOfApp || true == Constants.isSchemePdfMasterWithoutBranchUpdated) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_branch_wise_golden_rule() {
        if (true == Constants.isFirstLoginOfApp || true == Constants.isBranchWiseGoldenRuleMasterUpdated) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_customer_master() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isCustomerTableUpdated)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_route_customer_plan() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isRouteCustomer)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_survey_table_view() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isTableView)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_fs_survey_publish() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isFsSurveyPublishTableUpdated)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_facilitator_master() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isFacilitatorTableUpdated)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_site_master() {
        if ((true == Constants.isFirstLoginOfApp || (true == Constants.isSiteTableUpdated))) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_distributor_route_relation() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isDistributorRouteTableUpdated)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_offer_publish() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isOfferPublishTableUpdated)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_product_master() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isProductTableUpdated)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_stock_balance_master() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isStockBalanceReportTableUpdated)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_customer_product_billing() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isCustomerProductBillingUpdated)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_product_group_master() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isProductGroupTableUpdated)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_load_distribution() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isLoadDistributionTableUpdated)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_branch_route_freight() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isBranchRouteFreightTableUpdated)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_bank_master() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isBankTableUpdated)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_attendance_report() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isAttendanceReportTableUpdated)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_broker_master() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isBrokerUpdated)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_product_sub_group_master() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isProductSubGroupTableUpdated)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_closing_stock() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isClosingStockUpdated)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_prev_stock_counting_master() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isPrevStockCountingUpdated)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_loyalty_customer() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isLoyaltyTableUpdated)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_rds_master() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isRDSTableUpdated)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_emp_master() {
        if (true == Constants.isFirstLoginOfApp || true == Constants.isEmployeeUpdated) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_branch_master() {
        if (true == Constants.isFirstLoginOfApp || true == Constants.isBranchUpdated) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_honey_comb_master() {
        if (true == Constants.isFirstLoginOfApp || true == Constants.isHoneyCombUpdated) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_margin_master() {
        if (true == Constants.isFirstLoginOfApp || true == Constants.isMarginCostUpdated) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_customer_branch_relation() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isCustBranchUpdated)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_sample() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isSampleMasterTableUpdated)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void InCrement_mis_transaction_log() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isMISTransactionTableUpdated)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_survey_input_details() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isSurveyTableUpdated)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_street_master() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isStreetUpdated)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_prev_order_counting_master() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isPreviousOrderCounting)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_farmer_master() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isFarmerMaster)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_order_status() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isOrderStatus)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_customer_product_relation() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isCustomerProductTableUpdated)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_customer_product_info() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isCustomerProductInfoTableUpdated)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_mcx_rate() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isMcxRateTableUpdated)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_order_approval() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isOrderApprovalTableUpdated)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_branch_destination() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isBranchDestinationTableUpdated)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_branch_dump() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isBranchDumpTableUpdated)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_customer_broker_relation() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isCustomerBrokerRelationTableUpdated)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_brokerage_cost() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isBrokarageCostTableUpdated)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_depot_cost() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isDepotCostTableUpdated)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_freight_cost() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isFreightCostTableUpdated)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_route_master() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isRouteTableUpdated)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_product_brand_master() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isProductBrandTableUpdated)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_survey_publish() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isSurveyPublishTableUpdated)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
...
//        dbHelper.closeDatabase();
    ...
    public void _DOWNLOAD_yellow_card_date_validation_customerwise() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.yellowCardValidationDateCustomerWise
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate
        ...
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ yellow_card_date_validation_customerwise: " + URL);
        Download_txt(URL);
    ...
    public void _DOWNLOAD_market_feedback_tagging_master() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.marketFeedbackTaggingDetails
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ market_feedback_tagging_master: " + URL);
        ...
        ArrayList<MarketFeedbackTagging> mCompetitorGroupMasterList = new ArrayList<MarketFeedbackTagging>();
        BufferedReader buffer = new BufferedReader(file);
        try {
            String line = "";
            while ((line = buffer.readLine()) != null) {
    ...
    public void _DOWNLOAD_VendorDetailsDownload() {
        //brand veryfication
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.vendorDetailsDownload
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ VendorDetailsDownload: " + URL);
        ...
        ArrayList<BrandingVendorDetails> mBrandingVendorDetails = new ArrayList<BrandingVendorDetails>();
        BufferedReader buffer = new BufferedReader(file);
        try {
            String line = "";
            while ((line = buffer.readLine()) != null) {
    ...
    public void DOWNLOAD_target_achievement_route_categorywise() {
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.targetAchievementDetailsRouteWise
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ target_achievement_route_categorywise: " + URL);
    ...
    public void _DOWNLOAD_complaint_master() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.complaint_master_masterURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate
        ...
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ complaint_master: " + URL);
        Download_txt(URL);
    ...
    public void _DOWNLOAD_lead_generation_master() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.lead_generation_masterURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate
        ...
        Log.d("TAG", "_DOWNLOAD_ lead_generation_master: " + URL);
    ...
    public void Increment_complaint_master() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isComplaintMasterTableUpdated)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_lead_generation_master() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isLeadGenerationMasterTableUpdated)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_quality_complaint_master() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isQualityComplaintMasterTableUpdated)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void Increment_MtlTestingFormat_master() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isMtlTestingMasterTableUpdated)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void _DOWNLOAD_quality_complaint_master() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.quality_complaint_masterURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ quality_complaint_master: " + URL);
            ...
            while ((line = buffer.readLine()) != null) {
                if (line.indexOf("¥") > 0) {
                    ...
                    if (RowData.length == noColumn) {
                        ...
                        temp.setQualityComplaintId(RowData[0]); // Note the corrected method name to setQualityComplaintId
    ...
    public void _DOWNLOAD_MtlTestingFormat_master() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.mtl_testing_masterURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
               + "&last_update_time=" + lastUpdate
//                                + "&last_update_time=" + "2014-06-09 18:19:20"
                + "&data_download_time=" + dwnldDictTime;
        Log.d("TAG", "_DOWNLOAD_ MtlTestingFormat_master: " + URL);
        Download_txt(URL);
                ...
                if (line.indexOf("¥") > 0) {
                    ...
                    if (RowData.length == noColumn) {
                        ...
                        MtlTestingFormat temp = new MtlTestingFormat();
                         Log.d("TAG", "_DOWNLOAD_ MtlTestingFormat_master: "+i+"  ---  " + RowData[42]+"  ---  "+RowData[6]);
                         i++;
    ...
    public void _DOWNLOAD_site_lead_conversion_masterURL() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.site_lead_conversion_masterURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + mIsInCremental
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ site_lead_conversion_masterURL: " + URL);
    ...
    public void Increment_site_lead_conversion_masterURL() {
        if ((true == Constants.isFirstLoginOfApp) || (true == Constants.isSteLeadConversionMasterUpdated)) {
            mIsInCremental = "no";
        } else {
            mIsInCremental = "yes";
        }
    ...
    public void _DOWNLOAD_customer_master_mf_taging() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.customerDetailsURL
                ...
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ customer_master_mf_taging: " + URL);
...
//                        temp.setDnsCustCode(RowData[43]);
    ...
    public void _DOWNLOAD_route_master_mf() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.routeDetailsURL
                ...
                + "&last_update_time=" + lastUpdate
                + "&data_download_time=" + dwnldDictTime;
        Log.d("_DOWNLOAD_", "_DOWNLOAD_ route_master_mf: " + URL);
...
//            Constants.isDownLoadComplete=false;
    ...
    public void _DOWNLOAD_KYC_MASTER() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.kyc_master_txt_incrementalURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=" + (Constants.isFirstLoginOfApp ? "no" : "yes");

        Log.d("_DOWNLOAD_", "_DOWNLOAD_ KYC_MASTER: " + URL);
        Download_txt(URL);
        ...
        ArrayList<KycMaster> routePlanList = new ArrayList<KycMaster>();
        BufferedReader buffer = new BufferedReader(file);
        try {
            String line = "";
            while ((line = buffer.readLine()) != null) {
        ...
        Log.i("kyc_master", "Saving " + noRows + " records for \n kyc_master Details..");
        long insertStatus = -1;
    ...
    public void _DOWNLOAD_SITE_LEAD_APPROVAL_MASTER() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.site_lead_download_approvalURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode()
                + "&incremental_download=no";// + (Constants.isFirstLoginOfApp ? "no" : "yes")

        Log.d("_DOWNLOAD_", "_DOWNLOAD_ SITE_LEAD_APPROVAL_MASTER: " + URL);
        ...
        Log.i("site_lead_approval", "Saving " + noRows + " records for \n  Details..");
        long insertStatus = -1;
    ...
    public void _DOWNLOAD_MIS_DASHBOARD() {
        ...
        String URL = BaseUrl.baseUrl + AceDnsWebServiceURL.dshboardDataURL
                + "?nick_name=" + Constants.nickName
                + "&emp_code=" + Constants.employeeDetailObject.getEmpCode();

        Log.d("_DOWNLOAD_", "_DOWNLOAD_ MIS_DASHBOARD: " + URL);
        ...
        ArrayList<DashboardData> routeList = new ArrayList<DashboardData>();
        BufferedReader buffer = new BufferedReader(file);
        try {
            String line = "";
            while ((line = buffer.readLine()) != null) {
