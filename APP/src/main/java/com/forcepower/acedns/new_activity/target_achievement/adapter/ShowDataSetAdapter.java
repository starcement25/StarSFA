...
public class ShowDataSetAdapter extends ArrayAdapter<DataSet> implements Filterable {
    ...
    private  ArrayList<DataSet> mFinalNameValues;
    ...
    public View getView(final int position, View convertView, @NonNull final ViewGroup parent) {
        ...
        viewHolder.txtView.setText(mFinalNameValues.get(position).getValue());
        viewHolder.txtView.setChecked(mFinalNameValues.get(position).getSelect());
        return convertView;
    }
    ...
    private class ItemFilter extends Filter {
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            mFinalNameValues = (ArrayList<DataSet>) results.values;
