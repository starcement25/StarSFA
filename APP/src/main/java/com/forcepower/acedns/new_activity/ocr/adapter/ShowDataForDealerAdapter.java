...
public class ShowDataForDealerAdapter extends ArrayAdapter<CustomerDetails> implements Filterable {
    private final Context context;
    private final ArrayList<CustomerDetails> nameValues;
    private final int resourceId;
    private ArrayList<CustomerDetails> mFinalSalesOfficerList;
    private final ItemFilter mFilter = new ItemFilter();

    public ShowDataForDealerAdapter(final Context context, final int resourceId, final ArrayList<CustomerDetails> nameValue) {
    ...
    public View getView(final int position, View convertView, @NonNull final ViewGroup parent) {
        ...
        viewHolder.txtView.setText(mFinalSalesOfficerList.get(position).getCustomerName());
        return convertView;
    }
    ...
    private class ItemFilter extends Filter {
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            mFinalSalesOfficerList = (ArrayList<CustomerDetails>) results.values;
