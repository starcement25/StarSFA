...
public class ShowDataForDataAdapter extends ArrayAdapter<DataSet> implements Filterable {
    ...
    public ShowDataForDataAdapter(final Context context, final int resourceId, final ArrayList<DataSet> nameValue) {
