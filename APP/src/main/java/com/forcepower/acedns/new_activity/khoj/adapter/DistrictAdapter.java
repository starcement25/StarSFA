...
public class DistrictAdapter extends ArrayAdapter<DistrictDataSet> implements Filterable {
    ...
    public DistrictAdapter(final Context context, final int resourceId, final ArrayList<DistrictDataSet> nameValue) {
    ...
    public View getView(final int position, View convertView, @NonNull final ViewGroup parent) {
        ...
        viewHolder.txtView.setText(mFinalSalesOfficerList.get(position).getDistrictName());
    ...
    private class ItemFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            for (int i = 0; i < count; i++) {
                filterableString = customerDetailslist.get(i).getDistrictName();
