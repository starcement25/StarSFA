...
public class RSARNameAdapter extends ArrayAdapter<RSARNameItem> implements Filterable {
    private final Context context;
    private final ArrayList<RSARNameItem> nameValues;
    private final int resourceId;
    private ArrayList<RSARNameItem> mFinalSalesOfficerList;
    private final ItemFilter mFilter = new ItemFilter();

    public RSARNameAdapter(final Context context, final int resourceId, final ArrayList<RSARNameItem> nameValue) {
    ...
    public RSARNameItem getItem(int position) {
    ...
    private class ItemFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            final ArrayList<RSARNameItem> customerDetailslist = nameValues;
            int count = customerDetailslist.size();
            final ArrayList<RSARNameItem> newcustomerDetailslist = new ArrayList<>(count);
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            mFinalSalesOfficerList = (ArrayList<RSARNameItem>) results.values;
