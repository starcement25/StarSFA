...
public class ShowCounterDataSetAdapter extends ArrayAdapter<CounterNameDataSet> implements Filterable {
    private final Context context;
    private final ArrayList<CounterNameDataSet> nameValues;
    private final int resourceId;
    private ArrayList<CounterNameDataSet> mFinalSalesOfficerList;
    private final ItemFilter mFilter = new ItemFilter();

    public ShowCounterDataSetAdapter(final Context context, final int resourceId, final ArrayList<CounterNameDataSet> nameValue) {
    ...
    public CounterNameDataSet getItem(int position) {
    ...
    private class ItemFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            final ArrayList<CounterNameDataSet> customerDetailslist = nameValues;
            int count = customerDetailslist.size();
            final ArrayList<CounterNameDataSet> newcustomerDetailslist = new ArrayList<>(count);
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            mFinalSalesOfficerList = (ArrayList<CounterNameDataSet>) results.values;
