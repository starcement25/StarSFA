...
public class DataObjSetAdapter extends ArrayAdapter<DataObjSet> implements Filterable {
    private final Context context;
    private final ArrayList<DataObjSet> nameValues;
    private final int resourceId;
    private ArrayList<DataObjSet> mFinalSalesOfficerList;
    private final ItemFilter mFilter = new ItemFilter();

    public DataObjSetAdapter(final Context context, final int resourceId, final ArrayList<DataObjSet> nameValue) {
    ...
    public DataObjSet getItem(int position) {
    ...
    private class ItemFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            final ArrayList<DataObjSet> customerDetailslist = nameValues;

            int count = customerDetailslist.size();
            final ArrayList<DataObjSet> newcustomerDetailslist = new ArrayList<>(count);
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            mFinalSalesOfficerList = (ArrayList<DataObjSet>) results.values;
