...
public class DataSetAdapter extends ArrayAdapter<DataSet> implements Filterable {
    private final Context context;
    private final ArrayList<DataSet> nameValues;
    private final int resourceId;
    private ArrayList<DataSet> mFinalSalesOfficerList;
    private final ItemFilter mFilter = new ItemFilter();

    public DataSetAdapter(final Context context, final int resourceId, final ArrayList<DataSet> nameValue) {
    ...
    public View getView(final int position, View convertView, @NonNull final ViewGroup parent) {
        ...
        viewHolder.txtView.setText(mFinalSalesOfficerList.get(position).getDataTitle());
    ...
    private class ItemFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            final ArrayList<DataSet> customerDetailslist = nameValues;

            int count = customerDetailslist.size();
            final ArrayList<DataSet> newcustomerDetailslist = new ArrayList<>(count);

            String filterableString;

            for (int i = 0; i < count; i++) {
                filterableString = customerDetailslist.get(i).getDataTitle();
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            mFinalSalesOfficerList = (ArrayList<DataSet>) results.values;
