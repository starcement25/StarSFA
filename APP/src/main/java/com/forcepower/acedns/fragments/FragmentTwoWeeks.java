 ...
 * Use the {@link FragmentTwoWeeks#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentTwoWeeks extends Fragment {
    ...
    public static FragmentTwoWeeks newInstance(String param1, String param2) {
        FragmentTwoWeeks fragment = new FragmentTwoWeeks();
    ...
    public void onResume() {
        ...
        viewModel.getSelectedItem().observe(this, item -> {
            ...
            ob.setItem0(viewModel.getSelectedItem().getValue()+" Two Weeks");
            ob.setItem1("300");
