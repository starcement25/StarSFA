 ...
 * Use the {@link FragmentProposedSku#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentProposedSku extends Fragment {
    ...
    public static FragmentProposedSku newInstance(String param1, String param2) {
        FragmentProposedSku fragment = new FragmentProposedSku();
...
//            ob.setItem0(viewModel.getSelectedItem().getValue()+" Proposed SKU");
//            ob.setItem1("300");
