 ...
 * Use the {@link FragmentTenDaysSku#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentTenDaysSku extends Fragment {
    ...
    public static FragmentTenDaysSku newInstance(String param1, String param2) {
        FragmentTenDaysSku fragment = new FragmentTenDaysSku();
...
//        viewModel.getSelectedItem().observe(this, item -> {
            ...
            ob.setItem0(viewModel.getSelectedItem().getValue()+" 10 Days");
            ob.setItem1("300");
