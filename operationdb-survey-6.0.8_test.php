	...
	for($x=0;$x<count($survey_array);$x++){
		...
		else
		{
			...
			$sql_insert_survey_header = "INSERT INTO survey_header SET 
										...
										//	echo $sqlinsertsurveylocation ."--". $sql_insert_survey_header;
											
					////need to uncomment						
									$sql_insert_survey_header_flg = false;
									$sqlinsertsurveylocation_flg = false;
									$sqlinsertsurveylocation_flg=mysqli_query($link,$sqlinsertsurveylocation);
											$sql_insert_survey_header_flg=mysqli_query($link,$sql_insert_survey_header);
				if($sqlinsertsurveylocation_flg && $sql_insert_survey_header_flg)
				{
					$flag=5;
				}
				else
