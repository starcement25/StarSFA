	...
	$emp_val_rds=' AND (LO.emp_code IN('.$employee_hierarchy.'))';
		...
		while($rowlocation = mysqli_fetch_assoc($resultlocation))
		{
		   ...
		   $total_customer_visit=$rowcustomervisit['tot_customer_visit'];
			...
			//if($total_customer_visit <=4){
				 $color='Yellow';
				 /*$pdf_html.="<tr>
					<td style=\"background-color:$color;\">$cntac</td>
					<td style=\"background-color:$color;\">$emp_name_lower</td>
					<td style=\"background-color:$color;\">$emp_designation_lower</td>
					<td style=\"background-color:$color;\">$emp_HQ_lower</td>
					<td align=\"right\" style=\"background-color:$color;\">$check_in_time</td>
					<td align=\"center\" style=\"background-color:$color;\">$total_customer_visit</td>
				  </tr>";*/
				  $pdf_html.="<tr>
					<td >$cntac</td>
			...
			{
				$display_val_string=$emp_name_lower.'##'.$emp_designation_lower.'##'.$emp_HQ_lower.'##'.$check_in_time.'##'.$total_customer_visit;
				array_push($display_val_array,$display_val_string);
			}*/
		  }
		  /*foreach($display_val_array as $display_val_final)
		  {
			  $display_val_final_array=explode('##',$display_val_final);
			   $pdf_html.="<tr>
					<td >".$cntac++."</td>
					<td >$display_val_final_array[0]</td>
					<td >$display_val_final_array[1]</td>
					<td >$display_val_final_array[2]</td>
					<td align=\"right\" >$display_val_final_array[3]</td>
					<td align=\"center\" >$display_val_final_array[4]</td>
				  </tr>";
			  //$cntac++; 
		  }*/
