...
/*$body="<?xml version='1.0' encoding='UTF-8'?><root><route_plan_change_approval><route_plan_details><route_plan_trans_id><![CDATA[RPE000420231101230150]]></route_plan_trans_id><emp_code><![CDATA[E0004]]></emp_code><route_code><![CDATA[RT/221]]></route_code><route_name><![CDATA[AASHAPUR]]></route_name><visit_date><![CDATA[01-11-2023]]></visit_date><remarks><![CDATA[test]]></remarks><create_date><![CDATA[2023-11-01 23:02:06]]></create_date></route_plan_details></route_plan_change_approval></root>";*/
$route_plan_trans_id = "*ROOT*ROUTE_PLAN_CHANGE_APPROVAL*ROUTE_PLAN_DETAILS*ROUTE_PLAN_TRANS_ID";
$route_plan_emp_code = "*ROOT*ROUTE_PLAN_CHANGE_APPROVAL*ROUTE_PLAN_DETAILS*EMP_CODE";
$route_plan_route_code ="*ROOT*ROUTE_PLAN_CHANGE_APPROVAL*ROUTE_PLAN_DETAILS*ROUTE_CODE";
$route_plan_route_name ="*ROOT*ROUTE_PLAN_CHANGE_APPROVAL*ROUTE_PLAN_DETAILS*ROUTE_NAME";
$route_plan_visit_date ="*ROOT*ROUTE_PLAN_CHANGE_APPROVAL*ROUTE_PLAN_DETAILS*VISIT_DATE";
$route_plan_remarks ="*ROOT*ROUTE_PLAN_CHANGE_APPROVAL*ROUTE_PLAN_DETAILS*REMARKS";
$route_plan_create_date ="*ROOT*ROUTE_PLAN_CHANGE_APPROVAL*ROUTE_PLAN_DETAILS*CREATE_DATE";
...
function contents($parser, $data){
	...
	if(substr($current_tag,0,32)=='*ROOT*ROUTE_PLAN_CHANGE_APPROVAL')
	{
		/*echo $current_tag.'<br />';
		echo $data.'<br />';*/
		switch($current_tag){
			...
			//if($route_plan_emp_code==$emp_code){
				...
				if(!in_array($routeplanemp_visitdate_merge,$route_plan_del_emp_code_array))
				{
					$sqldeleterouteplan="DELETE FROM route_plan WHERE  emp_code ='".$route_plan_emp_code."' AND 
										visit_date	='".$route_plan_visit_date_database."' AND is_approved='no'";
