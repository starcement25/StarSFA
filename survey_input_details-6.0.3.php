...
$sqlsurveydetails="SELECT row_id,action_id,menu_id,layout_name,display_name,type,display_table_name,mandatory,action,validation,display_order,
				survey_type,survey_sub_menu FROM survey_input WHERE UNIX_TIMESTAMP(download_time) > UNIX_TIMESTAMP('".$last_update_time."')";
...
if($count>0){
	...
	$emp_code='';
	$url = "http://www.acedns.in/acednsproduct/survey_input_details-6.0.3.php?nick_name=$nick_name&last_update_time=$last_update_time&type=$type";
