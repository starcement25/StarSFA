...
if(strtoupper($nick_name)=='VCONNECT' || strtoupper($nick_name)=='RUPA' || strtoupper($nick_name)=='DURO')
{
...
if(count($attendance_array)>0)
{
	for($x=0;$x<count($attendance_array);$x++){
		...
		if(strtoupper($nick_name)=='RUPA'  || strtoupper($nick_name)=='DURO' || strtoupper($nick_name)=='NIMBUS')
					{
