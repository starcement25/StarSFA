...
/*$body="<?xml version='1.0' encoding='UTF-8'?><root><new_customer><location><emp_code><![CDATA[E0052]]></emp_code><trans_id><![CDATA[NE005220161115205003]]></trans_id><latt><![CDATA[26.8576717]]></latt><longi><![CDATA[80.9789913]]></longi><date><![CDATA[2016-11-15 20:50:03]]></date></location><new_customer_details><customer_code><![CDATA[NE005220161115205003]]></customer_code><customer_name><![CDATA[SANA GN STORE]]></customer_name><Phone_no><![CDATA[7860228048]]></Phone_no><pin_code><![CDATA[226001]]></pin_code><area><![CDATA[RT/1635]]></area><area_name><![CDATA[Aminabad]]></area_name><rds_tag><![CDATA[]]></rds_tag><address><![CDATA[AMINABAD LUCKNOW]]></address><landline_no><![CDATA[]]></landline_no><owner_name><![CDATA[]]></owner_name><owner_phone><![CDATA[]]></owner_phone><cust_class><![CDATA[]]></cust_class><weekly_closing_day><![CDATA[TUESDAY]]></weekly_closing_day><coverage_type><![CDATA[]]></coverage_type><TIN><![CDATA[]]></TIN><PAN><![CDATA[]]></PAN></new_customer_details></new_customer></root>";*/
...
class xml_new_customer{
	var $location_emp_code,$location_trans_id,$location_latt,$location_longi,$location_date,$new_customer_code,$new_customer_name,$phone_no,$pin_code,$area,$area_name,$rds_tag,$address,$landline_no,$owner_name,$owner_phone,$cust_class,$weekly_closing_day,$coverage_type,$TIN,$PAN;	
}
...
function contents($parser, $data){
    global $current_tag,$counter,$location_emp_code,$location_trans_id,$location_latt,$location_longi,$location_date,$new_customer_code,$new_customer_name,$phone_no,$pin_code,$area,$area_name,$rds_tag,$address,$landline_no,$owner_name,$owner_phone,$cust_class,$weekly_closing_day,$coverage_type,$TIN,$PAN,$new_customer_array;
	//echo $current_tag.'<br />';
	//echo $data.'<br />';
	  ...
	  if(mysqli_query($link,$sqlinsertorlocation))
	   ...
	   /*$sqlinsertcustomerrelation = "INSERT INTO customer_route_emp_relation 
		...
		if(mysqli_query($link,$sqlinsertcustomer))
		{
			...
			if(tagged_distributor_for_order=='yes' && $nick_name=='HALDIRAM')
			{
				if(employeewise_hierarchy=='yes'){
					$employee_hierarchy=return_employee_hierarchy($emp_code);
					$emp_hierarchy_condition=' AND emp_code IN('.$employee_hierarchy.')';
					
					$sqlrouterdscust="SELECT customer_code FROM custyomer_master WHERE route_code='".$route_code."' AND rds_tag='".$rds_tag."'";
				}
			}
		}
		else
...
$url = APICALLLOGURL."/operationdb-newcustomer-6.0.4.php?nick_name=$nick_name&emp_code=$emp_code&last_update_time=$last_update_time";
