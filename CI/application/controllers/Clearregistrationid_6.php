...
class Clearregistrationid_6 extends REST_Controller{
	...
	function clearregistrationid_get(){
		$deviceId = $this->get('deviceId');
		$emp_code = $this->get('emp_code');
		$registrationid = $this->get('registrationid');
		
		if($this->Userdb_model->update_changepassword_clearregid($emp_code,$registrationid)){
			echo "1";
		}
		else{
			echo "0";
