...
$sqlquery="SELECT  DISTINCT CBR.customer_code,CBR.broker_code,CBR.acedns FROM customer_route_emp_relation CRR,customer_broker_relation CBR 
...
$count=mysqli_num_rows($result);
	...
	$url = "http://www.acedns.in/acednsproduct/customer-broker-relational-txt-incremental-6.0.0.php?nick_name=$nick_name&emp_code=$emp_code&last_update_time=$last_update_time&data_download_time=$data_download_time&incremental_download=$incremental_download";
