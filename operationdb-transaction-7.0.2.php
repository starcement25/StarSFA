...
if($nick_name=='ABDOS'   || $nick_name=='MAGIK' || $nick_name=='PALSONS' ||  strtoupper($nick_name)=='STAR' || strtoupper($nick_name)=='RUPA')
{
					...
					if(!in_array($orderdatadetails_order_no,$order_array_trans_id))
					{
						...
						if(mysqli_query($link,$sqlinsertorderdetails))
						{
							...
							/*if($nick_name=='START' || $nick_name=='STAR')
							{
								...
								$trans_type='O';
								$trans_sub_type='';
								update_achievement_STAR(substr($orderdatadetails_order_no,1,5),$orderdatadetails_order_no,$qty,$trans_type,$trans_sub_type);
							}*/
						...
						if(strtoupper($nick_name)=='PALSONS')
						{
							$sqlupdatestock="UPDATE customer_product_stock SET stock=(stock-$orderdatadetails_qty) WHERE 	
										customer_code='".$orderdataheader_customer_code."' AND prod_code='".$orderdatadetails_sku_code."'";
