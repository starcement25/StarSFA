...
/*$body="<?xml version='1.0' encoding='UTF-8'?><root><route_plan><routedata><route_plan_header><route_plan_trans_id><![CDATA[RPE000520160309135415]]></route_plan_trans_id><emp_code><![CDATA[E0005]]></emp_code><route_code><![CDATA[RT/1]]></route_code><route_name><![CDATA[Kamrup]]></route_name><visit_date><![CDATA[09-03-2016]]></visit_date><remarks><![CDATA[]]></remarks><create_date><![CDATA[2016-03-09 13:54:21]]></create_date></route_plan_header><route_plan_details><route_plan_trans_id><![CDATA[RPE000520160309135415]]></route_plan_trans_id><route_code><![CDATA[RT/1]]></route_code><visit_date><![CDATA[09-03-2016]]></visit_date><customer_code><![CDATA[C/0000001]]></customer_code></route_plan_details><route_plan_details><route_plan_trans_id><![CDATA[RPE000520160309135415]]></route_plan_trans_id><route_code><![CDATA[RT/1]]></route_code><visit_date><![CDATA[09-03-2016]]></visit_date><customer_code><![CDATA[C/0000003]]></customer_code></route_plan_details></routedata><routedata><route_plan_header><route_plan_trans_id><![CDATA[RPE000520160309135415]]></route_plan_trans_id><emp_code><![CDATA[E0005]]></emp_code><route_code><![CDATA[RT/5]]></route_code><route_name><![CDATA[Middle Assam]]></route_name><visit_date><![CDATA[09-03-2016]]></visit_date><remarks><![CDATA[]]></remarks><create_date><![CDATA[2016-03-09 13:54:34]]></create_date></route_plan_header><route_plan_details><route_plan_trans_id><![CDATA[RPE000520160309135415]]></route_plan_trans_id><route_code><![CDATA[RT/5]]></route_code><visit_date><![CDATA[09-03-2016]]></visit_date><customer_code><![CDATA[C/0000009]]></customer_code></route_plan_details></routedata></route_plan></root>";*/
...
if(count($route_plan_array)>0)
{
	...
	for($x=0;$x<count($route_plan_array);$x++){
		...
		if($flag==5){
			...
			$sqlselectrouteplanedit="SELECT route_plan_trans_id,current_route_code FROM route_plan_log 
									...
									visit_date	='".$route_plan_visit_date_database."'";
			$resselectrouteplanedit = mysqli_query($link,$sqlselectrouteplanedit) or die(mysqli_error()." Error in chk  route plan log: ".$sqlselectrouteplan); 
			$countselectrouteplanedit=mysqli_num_rows($resselectrouteplanedit);
			...
			if($countselectrouteplanedit<1)
			{
				$sqlinsertrouteplanelog="INSERT INTO route_plan_log SET route_plan_trans_id ='".$route_plan_header_trans_id."',
									  ...
									  created_by 		='USER',
									  create_date		='".$route_plan_header_create_date."'";					  
				if(mysqli_query($link,$sqlinsertrouteplanelog))
				{
					$flag=5;
				}
				else
	...
	if(count($route_plan_details_array)>0)
	{
		for($i=0;$i<count($route_plan_details_array);$i++){
			...
			$countselectroutecustomerplan=mysqli_num_rows($resselectroutecustomerplan);
