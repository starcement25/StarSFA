...
if($nick_name=='START' || $nick_name=='STAR')
{
	...
	$sqlquery="SELECT DISTINCT competitor_name,group_name,UOM FROM competitor_group_master WHERE acedns='yes' ".$condition_branch." AND branch_code <>'' ORDER BY competitor_name ASC";
