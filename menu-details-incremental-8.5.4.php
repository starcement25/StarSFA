...
$count=mysqli_num_rows($result);
	...
	<stockist_visit><![CDATA['.mb_convert_encoding($rowsmenudetails['stockist_visit'], 'UTF-8', 'UTF-8').']]></stockist_visit>	
	<prop_form_details><![CDATA['.mb_convert_encoding($rowsmenudetails['prop_form_details'], 'UTF-8', 'UTF-8').']]></prop_form_details>
	<order_summary_PDF><![CDATA['.mb_convert_encoding($rowsmenudetails['order_summary_PDF'], 'UTF-8', 'UTF-8').']]></order_summary_PDF>
	<TA_DA_km_tracking_mode><![CDATA['.mb_convert_encoding($rowsmenudetails['TA_DA_km_tracking_mode'], 'UTF-8', 'UTF-8').']]></TA_DA_km_tracking_mode>
	<dsr_pdf><![CDATA['.mb_convert_encoding($rowsmenudetails['dsr_pdf'], 'UTF-8', 'UTF-8').']]></dsr_pdf>	
	<yellow_card_cust_type><![CDATA['.mb_convert_encoding($rowsmenudetails['yellow_card_cust_type'], 'UTF-8', 'UTF-8').']]></yellow_card_cust_type>
	<yellow_card_product><![CDATA['.mb_convert_encoding($rowsmenudetails['yellow_card_product'], 'UTF-8', 'UTF-8').']]></yellow_card_product>
	<hoarding_emp_vendor><![CDATA['.mb_convert_encoding($rowsmenudetails['hoarding_emp_vendor'], 'UTF-8', 'UTF-8').']]></hoarding_emp_vendor>
	<mf_mandatory_details><![CDATA['.mb_convert_encoding($rowsmenudetails['mf_mandatory_details'], 'UTF-8', 'UTF-8').']]></mf_mandatory_details>
	<purpose_of_visit><![CDATA['.mb_convert_encoding($rowsmenudetails['purpose_of_visit'], 'UTF-8', 'UTF-8').']]></purpose_of_visit>
	<site_visit_approval><![CDATA['.mb_convert_encoding($rowsmenudetails['site_visit_approval'], 'UTF-8', 'UTF-8').']]></site_visit_approval>
	<multi_travel_mode><![CDATA['.mb_convert_encoding($rowsmenudetails['multi_travel_mode'], 'UTF-8', 'UTF-8').']]></multi_travel_mode>
	<feedback_backup><![CDATA['.mb_convert_encoding($rowsmenudetails['feedback_backup'], 'UTF-8', 'UTF-8').']]></feedback_backup>
	<dashboard><![CDATA['.mb_convert_encoding($rowsmenudetails['dashboard'], 'UTF-8', 'UTF-8').']]></dashboard>
	<manchtech><![CDATA['.mb_convert_encoding($rowsmenudetails['manchtech'], 'UTF-8', 'UTF-8').']]></manchtech>
	<leaderboard><![CDATA['.mb_convert_encoding($rowsmenudetails['leaderboard'], 'UTF-8', 'UTF-8').']]></leaderboard>
	<bd_leaderboard><![CDATA['.mb_convert_encoding($rowsmenudetails['bd_leaderboard'], 'UTF-8', 'UTF-8').']]></bd_leaderboard>
	<lead_generation_approval><![CDATA['.mb_convert_encoding($rowsmenudetails['lead_generation_approval'], 'UTF-8', 'UTF-8').']]></lead_generation_approval>
	<mle><![CDATA['.mb_convert_encoding($rowsmenudetails['mle'], 'UTF-8', 'UTF-8').']]></mle>
	...
	$url = APICALLLOGURL."/menu-details-incremental-8.5.1.php?nick_name=$nick_name&last_update_time=$last_update_time&incremental_download=$incremental_download&mode=$mode";
