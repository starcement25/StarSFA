...
if(survey=='yes' && $nick_name!='EMAMI')
{
	...
	$sqlquery="SELECT DISTINCT BM.branch_code,BM.branch_name,BM.comp_code,BM.HQ,BM.plant_name,is_plant FROM 
...
else
{
	...
	$sqlquery="SELECT BM.branch_code,BM.branch_name,BM.comp_code,BM.HQ,BM.plant_name,is_plant FROM branch_master BM WHERE 
	...
	$url = APICALLLOGURL."/branch-master-txt-6.0.4.php?nick_name=$nick_name&emp_code=$emp_code&last_update_time=$last_update_time&data_download_time=$data_download_time&incremental_download=$incremental_download";
