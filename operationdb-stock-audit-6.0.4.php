...
function contents($parser, $data){
	...
	$audit_emp_code,$audit_trans_id,$audit_latt,$audit_longi,$audit_trans_date,$stockaudit_trans_id,$stockaudit_customer_code,$stockaudit_product_code,$stockaudit_qty,$stockaudit_prod_mrp,$stockaudit_prod_details,$stockaudit_remarks,$stockaudit_hint_remarks,$stockaudit_mfd_date,$stockaudit_UOM,$stockaudit_weightage;
	//echo $current_tag.'<br />';
	//echo $data;
