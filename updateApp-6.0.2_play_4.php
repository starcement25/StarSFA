...
$url = APICALLLOGURL."/updateApp-6.0.2_play_3.php?nick_name=$nick_name&emp_code=$emp_code&deviceId=$deviceId&versionCode=$versionCode";
...
if(vertical_fields=='yes' && (strtoupper($_REQUEST['nick_name'])=='EMAMI' || strtoupper($_REQUEST['nick_name'])=='EMAMIT')){
	$sqlselectappversion="SELECT * FROM app_version_play WHERE vertical_value='".$vertical_value."'";
}
else{
	$sqlselectappversion="SELECT * FROM app_version_play";
}
