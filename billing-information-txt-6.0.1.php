...
echo $sqlquery="SELECT * FROM customer_product_billing WHERE customer_code IN (".$customer_code.")";
...
else
{
	...
	$url = "http://salesmpower.acedns.in/billing-information-txt-6.0.1.php?nick_name=$nick_name&emp_code=$emp_code";
