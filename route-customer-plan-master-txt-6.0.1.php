...
$count=mysqli_num_rows($result);
	...
	if($count>0){
		...
		while($rowroutecustomerplan = mysqli_fetch_assoc($result))
		{
	...
	$url = "http://www.acedns.in/acednsproduct/route-customer-plan-master-txt-6.0.1.php?nick_name=$nick_name&emp_code=$emp_code&last_update_time=$last_update_time&data_download_time=$data_download_time&incremental_download=$incremental_download";
