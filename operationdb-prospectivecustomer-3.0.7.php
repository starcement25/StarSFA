...
class xml_customer_header{
    var $emp_code, $trans_id,$prospect_date,$latt,$longi,$prospectiveheader_trans_id,$customer_name,$address,$pin,$area,$phone_no,$remarks,$tagged_customer_code;
}
...
function contents($parser, $data){
    global $current_tag, $emp_code,$trans_id,$prospect_date,$latt,$longi,$prospectiveheader_trans_id,$customer_name,$address,$pin,$area,$phone_no,$remarks,$prospectiveheader_trans_id,$tagged_customer_code,$counter, $counterdetails,$prospectivedetails_trans_id,$prospectivedetails_product_code,$prospective_customer_array,$prospective_customer_details_array;
	//echo $current_tag.'<br />';
	//echo $data;
