...
else
{
	...
	{
		$sqlquery="SELECT MRP.* FROM sauda_mrp MRP WHERE acedns='Y'";
	}
	else
	{
...
$count=mysqli_num_rows($result);
	...
	$url = APICALLLOGURL."/sauda-mrp-txt-incremental-6.0.3.php?nick_name=$nick_name&emp_code=$emp_code&last_update_time=$last_update_time&data_download_time=$data_download_time&incremental_download=$incremental_download";
