...
if($nick_name=='ABDOS' || $nick_name=='ABDOST'  || $nick_name=='MAGIK' || $nick_name=='PALSONS' ||  strtoupper($nick_name)=='STAR' || strtoupper($nick_name)=='SYLVAN' || strtoupper($nick_name)=='GOLDSTONET')
{
			...
			for($i=0;$i<count($order_details_array);$i++){
				...
				if($nick_name=='DNV' || $nick_name=='HALDIRAM')
				{
					...
					if($orderdatadetails_weightage==""){
					    $orderdatadetails_weightage="0";
					}
						
					if($orderdatadetails_mrp_code==""){
					    $orderdatadetails_mrp_code="0";
					}
