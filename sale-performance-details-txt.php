...
if($emp_code!='C0007'){
	$sqlquery="SELECT customer_code,customer_name,emp_code,emp_name,product_group_code,YTD_sale,MTD_sale FROM sale_performance_details 
...
$totcount=0;	
	if($count>0){
		...
		while($rowsaleperformance = mysqli_fetch_assoc($result))
		{
